...
for runfile in /vols/lhcb/ss4314/final_tuples_analyser/mc/sig_mc_PHSP/2012/bin/B23MuNuMCPHSP_MCtruth_L0MuonDecisionTOS_trigger_Jpsi.root
...
for myfile in B23MuNuMCPHSP_MCtruth_L0MuonDecisionTOS_trigger_Jpsi.root
