...
trainingname=MCSig2012_vs_DATAMisidRun1
namediff=_ONLY_PiMuMu
tag=$trainingname$namediff
bdt=MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection
...
for runfile in /vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_ONLY_PiMuMu/MC_B2PiMuMu_L0MuonDecisionTOS_trigger_Jpsi.root 
...
for myfile in MC_B2PiMuMu_L0MuonDecisionTOS_trigger_Jpsi.root
