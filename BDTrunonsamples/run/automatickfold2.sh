...
runfile=/vols/lhcbdisk05/ss4314/BDTtrainings/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSig/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root

bdtname=trialthing

echo "Changing directory to BDTtrainings to get the training"

cd /vols/lhcbdisk05/ss4314/BDTtrainings/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSig/
...
newrunfileloc=/vols/lhcbdisk05/ss4314/BDTrunonsamples/datasets/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root
