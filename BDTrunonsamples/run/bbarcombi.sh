...
trainingname=60treesCombinatorialSamplevsMCSigNormalBDT
#runfilename=B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root
tag=combibdtonbbbarcombi
runfile=/vols/lhcbdisk05/ss4314/bbarsample/CAT110.root
myfile=CAT110.root
bdt=Combinatorial60TreesPfinaltuplesNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection
dktree=DecayTree
