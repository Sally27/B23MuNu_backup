...
trainingname=coolbdt
tag=coolbdtMARCH2016withJpsi
bdt=CombinatorialNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection
dktree=DecayTree
