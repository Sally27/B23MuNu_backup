...
tag=normalBDTCombvsMCqsqcutonPartRecoMARCH2016withJpsi
runfile=/vols/lhcbdisk05/ss4314/preparetuplesforBDTfinal/B2D3pimupreparetuple/B2D3pimufinal_MCtruth_Jpsi_cut_mu3nShared_qmin.root 
myfile=B2D3pimufinal_MCtruth_Jpsi_cut_mu3nShared_qmin.root 
