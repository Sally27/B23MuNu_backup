...
trainingname=400treesMisIDSamplevsMCSigNormalBDT
tag=400treesandPnormalBDTMisidvsMCMARCH2016withJpsi
bdt=MisIDNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection
dktree=DecayTree
