...
trainingname=uBDTcombvsmcsigbeforensharedflattenedsignal
runfilename=CombinatorialBackgroundcutqmin.root
...
tag=uBDTcombvsmcsigbeforensharedflattenedsignal
runfile=/vols/lhcbdisk05/ss4314/BDTtrainings/CombinatorialBackgroundcutqmin.root
#runfilename=B23MuNuSignal2012and2011data_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmin_corrm_ctr_reg.root
