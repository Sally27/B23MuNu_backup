...
VAR14=mu3_MINIPCHI2;
VAR10=Bplus_TAU;
VAR11=Bplus_DIRA_OWNPV;
VAR16=Bplus_ENDVERTEX_CHI2;
VAR17=Bplus_FD_CHI2;
VAR15=Bplus_pmu_ISOLATION_BDT1_weights;
VAR18=mu1_Xmu_SV_CHI2;
VAR19=Bplus_Corrected_Mass;


weight=W

dirname=/vols/lhcbdisk05/ss4314/BDTtrainings/
trainingname=qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/
runfilename=B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root

runfile=$dirname$trainingname$runfilename
...
if [ -e $file ]; then
	echo "File exists"
#        $file -s $VAR1 -b $VAR2 -o $VAR3 -k $VAR4 -w $weight -r $newrunfileloc 
	$file -s $VAR1 -b $VAR2 -o $VAR3 -k $VAR4 -w $weight -v $VAR5 -v $VAR6 -v $VAR7 -v $VAR8 -v $VAR9 -v $VAR10 -v $VAR11 -v $VAR12 -v $VAR13 -v $VAR14 -v $VAR15 -v $VAR16 -v$VAR10 -v $VAR17 -v $VAR18 -r $newrunfileloc  
