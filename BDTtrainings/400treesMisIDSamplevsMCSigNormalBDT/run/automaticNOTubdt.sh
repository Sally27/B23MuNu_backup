...
cp $VAR2 $VAR1 /vols/lhcbdisk05/ss4314/TMVA/kfoldandubdt/kfoldold/datasets/
...
bkg=/vols/lhcbdisk05/ss4314/TMVA/kfoldandubdt/kfoldold/datasets/SSmuonStrSmallDatapreparetuple/B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut.root
