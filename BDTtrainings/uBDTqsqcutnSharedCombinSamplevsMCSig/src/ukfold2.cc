...
//  }
  ...
  kf.run("/afs/cern.ch/work/s/slstefko/kfoldoldandubdt/kfoldold/datasets/newdatasets_combinatorial/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root", "trialthing", "all");
