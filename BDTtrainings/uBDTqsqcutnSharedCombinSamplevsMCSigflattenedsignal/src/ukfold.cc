...
//  kf.addTrainingVars(boost::assign::list_of 
 ...
 //     ("KFold")
  ...
  kf.addTrainingOpt("combvsmcsignotreversed", "UBDT_Num=100:!H:!V:NTrees=200:nEventsMin=100:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=1.0:PruneMethod=NoPruning:SeparationType=GiniIndex:nCuts=200:uBoostFlag=1");  
