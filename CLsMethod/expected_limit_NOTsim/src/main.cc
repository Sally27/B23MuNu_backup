...
//    }
    ...
    RooArgSet signalandbkg = ws->argSet("eff_ratio_pr_con,BRpr_con,eff_ratio_run1_con,eff_ratio_2016_con,jpsik_run1_con,jpsik_2016_con,BRnorm_con");
//    RooAbsArg* signalandbkg = ws->arg("signalandbkg");
//    RooAbsPdf* ses_2016_con = ws->pdf("ses_2016_con");
//    RooAbsPdf* ses_con = ws->pdf("ses_con");
     if(!pdf_sb_int || !pdf_b_int || !data_int || !BF_int || !mass_int)
        {
...
//    RooArgSet constraints(*npr_con,*ses_2016_con, *ses_con);
    ...
    RooFitResult* data_intresult_free = pdf_sb_int->fitTo(*data_int,RooFit::Extended(true),RooFit::Range("low,high"),ExternalConstraints(signalandbkg),RooFit::Save(true));
    ...
    pdf_sb_int->plotOn(frame1,RooFit::Range("low,high"));
    ...
    RooFitResult* data_intresult_fixed = pdf_sb_int->fitTo(*data_int,RooFit::Extended(true),RooFit::Range("low1,high1"),ExternalConstraints(signalandbkg),RooFit::Save(true));
    ...
    pdf_sb_int->plotOn(frame2,RooFit::Range("low1,high1"));
