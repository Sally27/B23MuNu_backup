...
double fitTwiceOld(RooRealVar* BF,RooAbsPdf* model,RooDataSet* data,int nToys, double CLsBF, RooRealVar* Bplus_Corrected_Mass, TTree* treename, bool update, int toyfit)
{       
    BF->setConstant(false);
    BF->setVal(CLsBF);
    BF->removeError();
