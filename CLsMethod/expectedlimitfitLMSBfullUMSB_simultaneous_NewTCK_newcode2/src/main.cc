...
//   double CLsBF = 7;
    ...
    RooFitResult* dataresult_free = pdf->fitTo(*data,RooFit::Extended(true),RooFit::Range("low,high"),RooFit::Save(true));
    ...
    RooFitResult* dataresult_fixed = pdf->fitTo(*data,RooFit::Extended(true),RooFit::Extended("low1,high1"),RooFit::Save(true));
