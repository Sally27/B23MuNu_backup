...
//    cat.defineType("HighFCME") ;
    ...
    firstfit->SaveAs(("fitTwiceOld2_dataresult_free_numoftoys_"+i2s(nToys)+"_injectsig"+ cleanNameString(d2s(CLsBF))+".pdf").c_str());
...
//    treename->Write();
 ...
 //   rfrestree.Branch("CLsOneSigma",&dataresult_free->minNll(), "CLsOneSigma/D");
    ...
    secondfit->SaveAs(("fitTwiceOld2_dataresult_fixed_numoftoys_"+i2s(nToys)+"_injectsig"+ cleanNameString(d2s(CLsBF))+".pdf").c_str());
