...
VAR1="fitallafterMCnSharedRemovedIncludeLMSB";

cp /vols/lhcb/ss4314/roofitincludecrossfeedonebinntracks/withmcsigreweight/after2bdts/$VAR1/bin/myworkspace_$VAR1.root bin/
