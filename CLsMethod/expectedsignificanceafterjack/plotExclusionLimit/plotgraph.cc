...
//        mg->Add(grfirst);
        ...
        //grsecond->SetFillStyle(3005);
        grsecond->SetFillColor(kGreen); 
        grsecond->Draw("AF");     
        cout<<"I am still still ok"<<endl;
//        mg->Add(grsecond);
        ...
        grthird->SetMarkerColor(i+1);
        grthird->SetLineColor(i+1);
        grthird->SetMarkerStyle(i+20);
//        grthird->SetFillStyle(0);
        grthird->SetFillColor(kGreen);
        grthird->Draw("F");
        cout<<"I am still still ok"<<endl;
