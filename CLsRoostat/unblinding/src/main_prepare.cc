...
//  w->defineSet("poi", "s");
    ...
    TFile f_int("fitresults_sigandbkghypo_forCLs_syst_100_final.root");
...
//    RooAbsPdf* model_DD = ws_int->pdf("normsigpdf_HighFCME");
    ...
    ws_int->factory("PROD:model_new(simPdfsig,eff_ratio_run1_low_err_tot_100_con)");
 //   ws_int->import("model_new");
    ws_int->factory("PROD:model_new1(model_new,eff_ratio_run1_high_err_tot_100_con)");
...
//    ws_int->import("model_new3");
    ...
    ws_int->factory("PROD:model_new4(model_new3,eff_ratio_2016_low_err_tot_100_con)");
//    ws_int->import("model_new4");

    ws_int->factory("PROD:model_new5(model_new4,eff_ratio_2016_high_err_tot_100_con)");
