...
{ 
   ...
   piddir("/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateJpsiKst/misideff/kaon"),
   pidpifile("PerfHists_K_Strip21_P_ETA.root")
//   mcfilename("JpsiKMC2012NNmumore03")
   ...
   void prepare2DhistMyAndPIDCalibRatio(string pidfile, string pidcut, string mypiddir);
