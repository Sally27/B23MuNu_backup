...
resultPID.readEfficiency2DHist("PerfHists_K_Strip21_P_ETA.root","K_(IsMuon==1.0)_All");
resultPID.prepare2DhistMyAndPIDCalibRatio("PerfHists_K_Strip21_P_ETA.root","K_(IsMuon==1.0)_All","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_idPION_play/NOFCME/PIDtables");
