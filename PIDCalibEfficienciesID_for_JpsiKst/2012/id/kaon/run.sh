python $PIDPERFSCRIPTSROOT/scripts/python/MultiTrack/MakePerfHistsRunRange.py -Z ""  "21" "MagUp" "K" "[DLLK > 0.0 && IsMuon==0.0 && (DLLK-DLLp) > 0.0]" > logidkaonstrip21logup.txt

python $PIDPERFSCRIPTSROOT/scripts/python/MultiTrack/MakePerfHistsRunRange.py -Z ""  "21" "MagDown" "K" "[DLLK > 0.0 && IsMuon==0.0 && (DLLK-DLLp) > 0.0]" > logidkaonstrip21logdown.txt
