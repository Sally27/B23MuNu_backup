...
//  a->Scale(scale);
  ...
  DataSample hist2("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvar/SSmuonStrSmallDatapreparetuple/bin/SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_mu1nShared_mu2nShared.root", "DecayTree");
...
//  a->Scale(scale);
  ...
  DataSample hist2("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvar/SSmuonStrSmallDatapreparetuple/bin/SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_mu1nShared_mu2nShared_qmincut.root", "DecayTree");
  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", nbins, low, high);
  double nSel2 = hist2.t->GetEntries();
  double scale2;
  scale2=nSel3/nSel2;
...
void plotvariablePID(string pidcalibvar, string tuplevar, double low, double high, string xaxis)
{
  ...
  int nbins=100;
//  printLHCb("L","Prelim","");
  DataSample hist3("/vols/lhcb/ss4314/cutonBDTs/MisidAfterCombiRestripEta1and3/B23MuNuMCallvar_MCtruth_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComb_60TreesMisID.root", "DecayTree");
  ...
  DataSample hist2("/vols/lhcb/ss4314/cutonBDTs/MisidAfterCombiRestripEta1and3/SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_60TreesComb_60TreesMisID.root", "DecayTree");
  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", nbins, low, high);
  double nSel2 = hist2.t->GetEntries();
  double scale2;
  scale2=nSel3/nSel2;
...
void plotvariablePIDbinPandETAsweight(string pidcalibvar, string tuplevar, double low, double high, string xaxis, double lowPbin, double highPbin, double lowETAbin, double highETAbin)
{
  ...
  int nbins=100;
//  printLHCb("L","Prelim","");
  DataSample hist3("/vols/lhcb/ss4314/cutonBDTs/MisidAfterCombiRestripEta1and3/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root", "DecayTree");
  ...
  DataSample hist2("/vols/lhcb/ss4314/cutonBDTs/MisidAfterCombiRestripEta1and3/B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic_MisidBasic.root", "DecayTree");
  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", nbins, low, high);
  double nSel2 = hist2.t->GetEntries();
  double scale2;
  scale2=nSel3/nSel2;
  ...
  DataSample hist4("/vols/lhcb/ss4314/cutonBDTs/MisidAfterCombiRestripEta1and3/BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic.root", "DecayTree");
  TH1F* ho = new TH1F("bplusmm2", "bplusmm2", nbins, low, high);
  double nSel4 = hist4.t->GetEntries();
  double scale3;
  scale3=nSel3/nSel4;
