...
//vector<double> binningz = binz();
        ...
        allcuts.push_back(pidcut_isMuon_K);
        allcuts.push_back(pidcut_isMuon_nShared_K);
        allcuts.push_back(pidcut_both_probnnmu_K);
        allcuts.push_back(pidcut_dllmu_K);
        allcuts.push_back(pure_K);
        allcuts.push_back(pure_new_K);
