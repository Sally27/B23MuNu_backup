...
string start_sig("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparedefandnorm/startingtuples/Bu23MuNuMC2012_MCtruth.root");
string final_sig("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparedefandnorm/finaltuples/B23MuNuMC2012probnnmu035Strip21.root");

string start_norm("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparedefandnorm/startingtuples/MC_B2JpsiK_2012MCTruth__misidstrippingfull.root");
string final_norm("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparedefandnorm/finaltuples/JpsiKMC2012probnnmu035.root"); 
string dec("decprodcuteff");
double dec_sig(0.1856);
double dec_norm(0.162);

string reco("recoeff");
double reco_sig(0.10841);
double reco_norm(0.177);
...

{
	...
	fileNamesPass.push_back("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparedefandnorm/newtuples/sig_final_reco_2.root");
	...
	fileNamesTot.push_back("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparedefandnorm/newtuples/sig_start_reco_2.root");
...

{
	...
	fileNamesPass.push_back("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparedefandnorm/newtuples/norm_final_reco_2.root");
	...
	fileNamesTot.push_back("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparedefandnorm/newtuples/norm_start_reco_2.root");
	...
	vector<string> legEntries;
	legEntries.push_back("B^{+} #rightarrow (J/#psi #rightarrow #mu^{+} #mu^{-}) K^{+}");
...

{
	...
	vector<string> legEntries;
	legEntries.push_back("B^{+} #rightarrow #mu^{+} #mu^{-} #mu^{+} #nu SIG MC");
	legEntries.push_back("B^{+} #rightarrow (J/#psi #rightarrow #mu^{+} #mu^{-}) K^{+} NORM MC");
