...
string start_sig("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparephspanddef/startingtuples/Bu23MuNuMC2012_MCtruth.root");
string final_sig("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparephspanddef/finaltuples/B23MuNuMC2012probnnmu035Strip21.root");

string start_norm("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparephspanddef/startingtuples/B23MuNuMCPHSP_MCtruth.root");
string final_norm("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparephspanddef/finaltuples/B23MuNuMCPHSP_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM.root");
...

{
	...
	fileNamesPass.push_back("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparephspanddef/newtuples/sig_final_reco_2.root");
	...
	fileNamesTot.push_back("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparephspanddef/newtuples/sig_start_reco_2.root");
...

{
	...
	fileNamesPass.push_back("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparephspanddef/newtuples/norm_final_reco_2.root");
	...
	fileNamesTot.push_back("/vols/lhcb/ss4314/ProduceEfficiencyPlots/comparephspanddef/newtuples/norm_start_reco_2.root");
...

{
	...
	vector<string> legEntries;
	legEntries.push_back("B^{+} #rightarrow #mu^{+} #mu^{-} #mu^{+} #nu DEFAULT MC");
	legEntries.push_back("B^{+} #rightarrow #mu^{+} #mu^{-} #mu^{+} #nu PHSP MC");
