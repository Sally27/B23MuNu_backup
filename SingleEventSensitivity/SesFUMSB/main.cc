...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        double toteffsig=decprodcutsig*effrecostrsig*effmyrecosig*combibdtsig*misidbdtsig*sigPID;
        double toteffjpsikmc=decprodcutjpsik*effrecostrjpsik*effmyrecostrjpsik*combibdtjpsik*misidbdtjpsik*jpsikPID;
        ...
        out<<"\\hline"<<endl;
        out << "$\\epsilon_{total}$ &" << toteffsig << " & " << toteffjpsikmc <<" \\\\ "<<endl;
	...
	double effrecostrip= 0.111;
        ...
        double numberofevents = 175250.0;
