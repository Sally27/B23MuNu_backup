...
//        double highFCMEjpsik=0.303809;
  ...
  //      double highFCMEsigPID=0.680185;
   ...
   //     double jpsikPID = 0.71386;       
        ...
        double crosschecksiglow=decprodcutsig*effrecostrsig*(double(12701.0/124051.0))*sigPID;
        double crosscheckjpsikmclow=decprodcutjpsik*effrecostrjpsik*(double(245665.0/1531615.0))*jpsikPID;

        double crosschecksiglowerr=(sqrt(double(12701.0)*(1.0-((double(12701.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmclowerr=(sqrt(double(245665.0)*(1.0-((double(245665.0)/double(8043820))))))*(1/double(8043820));
	...
	double effrecostrip= 0.111;
        ...
        double numberofevents_low = 169139;
