...
//        double highFCMEjpsik=0.303809;
        ...
        double sigPID=0.400584;
        double jpsikPID=0.521295;
  ...
  //      double highFCMEsigPID=0.680185;
   ...
   //     double jpsikPID = 0.71386;       
        ...
        double crosschecksiglow=decprodcutsig*effrecostrsig*(double(9419.0/104212.0))*sigPID;
        double crosscheckjpsikmclow=decprodcutjpsik*effrecostrjpsik*(double(104499.0/702105.0))*jpsikPID;

        double crosschecksiglowerr=(sqrt(double(9419.0)*(1.0-((double(9419.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmclowerr=(sqrt(double(104499.0)*(1.0-((double(104499.0)/double(8043820))))))*(1/double(8043820));
	...
	double effrecostrip= 0.111;
        ...
        double numberofevents_low = 15310;
...
//        double expsensitivity_low_error = sqrt((pow(crosschecksiglowerr/crosschecksiglow),2)+(pow(crosscheckjpsikmclowerr/crosscheckjpsikmclow),2))*expsensitivity_low;
	...
	TTree fillinfotree("Info_2015","Info_2015");
        double year;
        double numofevents;
        double effi_sig;
        double effi_norm;
