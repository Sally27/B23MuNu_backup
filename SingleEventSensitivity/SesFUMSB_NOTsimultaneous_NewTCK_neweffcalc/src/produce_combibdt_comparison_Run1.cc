...
int main(){
	...
	for(int z(0);z<mytcks.size();z++){
		...
		years.push_back(2016);
                ...
                decprodcutsig=returnEff(("../efficiencytuples_sig/Efficiencies_SigMC_"+i2s(years.at(1))+"_Combi.root").c_str(), ("MC_Sig_"+i2s(years.at(1))).c_str(), "combibdt");
		...
		double cormjpsik(0);
        	...
        	decprodcutjpsik=returnEff(("../efficiencytuples_norm/Efficiencies_NormMC_"+i2s(years.at(1))+"_Combi.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "combibdt");
	...
	out<<"\\hline"<<endl;
        out<<"Weighted efficiency" <<" & " << decprodcutsig<<" & "<<effrecostrsig<<" & "<< decprodcutjpsik <<" & "<<effrecostrjpsik<<" \\\\ "<<endl;
	out<<"\\hline"<<endl;
