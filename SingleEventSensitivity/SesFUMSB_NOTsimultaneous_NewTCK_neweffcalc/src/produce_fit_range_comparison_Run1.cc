...
int main(){
	...
	for(int z(0);z<mytcks.size();z++){
		...
		years.push_back(2016);
                ...
                decprodcutsig=returnEff(("../efficiencytuples_sig/Efficiencies_SigMC_"+i2s(years.at(1))+"_Fitrange.root").c_str(), ("MC_Sig_"+i2s(years.at(1))).c_str(), "fitrange");
  //              effrecostrsig=returnEff(("../efficiencytuples_sig/Efficiencies_SigMC_"+i2s(years.at(1))+"_Misid.root").c_str(), ("MC_Sig_"+i2s(years.at(1))).c_str(), "misidbdt");
         //       effmyrecosig=returnEff(("../efficiencytuples_sig/Efficiencies_SigMC_"+i2s(years.at(1))+".root").c_str(), ("MC_Sig_"+i2s(years.at(1))).c_str(), "Hlt2orofDecisions");
		...
		double cormjpsik(0);
        	...
        	decprodcutjpsik=returnEff(("../efficiencytuples_norm/Efficiencies_NormMC_"+i2s(years.at(1))+"_Fitrange.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "fitrange");
    //    	effrecostrjpsik=(returnEff(("../efficiencytuples_norm/Efficiencies_NormMC_"+i2s(years.at(1))+"_Misid.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "misidbdt"));
        //	effmyrecostrjpsik=(returnEff(("../efficiencytuples_norm/Efficiencies_NormMC_"+i2s(years.at(1))+".root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "Hlt2orofDecisions"));


		//out<<mytcks.at(z) <<" & " << decprodcutsig<<" & "<<effrecostrsig<<" & "<< decprodcutjpsik <<" & "<<effrecostrjpsik<<" \\\\ "<<endl;
	...
	out<<"\\hline"<<endl;
        out<<"Weighted efficiency" <<" & " << decprodcutsig<<"  & "<< decprodcutjpsik <<" \\\\ "<<endl;
	out<<"\\hline"<<endl;
