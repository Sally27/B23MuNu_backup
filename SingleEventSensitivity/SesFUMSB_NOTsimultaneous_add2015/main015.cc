...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        double misidbdtjpsik = 0.480757;

        double cormsig=0.928164;
        double cormjpsik=0.99767;
...
//        double highFCMEjpsik=0.303809;
        ...
        double sigPID=0.673297;
        double jpsikPID=0.735631;
  ...
  //      double highFCMEsigPID=0.680185;
   ...
   //     double jpsikPID = 0.71386;       
        ...
        double crosschecksiglow=decprodcutsig*effrecostrsig*(double(9122.0/104212.0))*sigPID;
        double crosscheckjpsikmclow=decprodcutjpsik*effrecostrjpsik*(double(100200.0/702105.0))*jpsikPID;

        double crosschecksiglowerr=(sqrt(double(9122.0)*(1.0-((double(9122.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmclowerr=(sqrt(double(100200.0)*(1.0-((double(100200.0)/double(8043820))))))*(1/double(8043820));
	...
	double effrecostrip= 0.111;
        ...
        double numberofevents_low = 14179;
