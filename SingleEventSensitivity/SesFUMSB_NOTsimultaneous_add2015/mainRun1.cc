...
//        double highFCMEjpsik=0.303809;
        ...
        double sigPID=0.655902;
        double jpsikPID=0.716011;
  ...
  //      double highFCMEsigPID=0.680185;
   ...
   //     double jpsikPID = 0.71386;       
        ...
        double crosschecksiglow=decprodcutsig*effrecostrsig*(double(12658.0/115289.0))*sigPID;
        double crosscheckjpsikmclow=decprodcutjpsik*effrecostrjpsik*(double(262205.0/1459813.0))*jpsikPID;

        double crosschecksiglowerr=(sqrt(double(12658.0)*(1.0-((double(12658.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmclowerr=(sqrt(double(262205.0)*(1.0-((double(262205.0)/double(8043820))))))*(1/double(8043820));
	...
	double effrecostrip= 0.111;
        ...
        double numberofevents_low = 158690;
