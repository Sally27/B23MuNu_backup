...
//        double highFCMEjpsik=0.303809;
        ...
        double sigPID=0.661565;
        double jpsikPID=0.721209;
  ...
  //      double highFCMEsigPID=0.680185;
   ...
   //     double jpsikPID = 0.71386;       
        ...
        double crosschecksiglow=decprodcutsig*effrecostrsig*(double(15276.0/138330.0))*sigPID;
        double crosscheckjpsikmclow=decprodcutjpsik*effrecostrjpsik*(double(169972.0/909303.0))*jpsikPID;

        double crosschecksiglowerr=(sqrt(double(15276.0)*(1.0-((double(15276.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmclowerr=(sqrt(double(169972.0)*(1.0-((double(169972.0)/double(8043820))))))*(1/double(8043820));
	...
	double effrecostrip= 0.111;
        ...
        double numberofevents_low = 95488;
