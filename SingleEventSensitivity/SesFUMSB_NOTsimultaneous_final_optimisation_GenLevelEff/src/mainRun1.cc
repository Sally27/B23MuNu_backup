  ...
  //      double highFCMEsigPID=0.680185;
   ...
   //     double jpsikPID = 0.71386;       
	...
	double crosscheckjpsikmclowerr=calcEffErr(int(number_bkk_nor),t_final_norm->GetEntries());//still need to add on error from dec prodcut
        ...
        ValError sig_pid(readPIDvar(("/vols/lhcb/ss4314/preparesignalweights/preparesignalweights_FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/bin/B23MuNuMC2012"+PIDcut+"Strip21_selected.root").c_str(), "DecayTree", "PIDweight"),0.005);
