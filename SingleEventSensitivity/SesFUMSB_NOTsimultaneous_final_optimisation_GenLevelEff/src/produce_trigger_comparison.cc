...
//		out<<mytcks.at(z)<<" & " << decprodcutsig<<" & "<<effrecostrsig<<" & "<< effmyrecosig <<" & "<<decprodcutjpsik <<" & "<<effrecostrjpsik<<" & "<<effmyrecostrjpsik<<" \\\\ "<<endl;
	...
	out<<"\\hline"<<endl;
       ...
       // out<<"Weighted efficiency" <<" & " << decprodcutsig<<" & "<<effrecostrsig<<" & "<< effmyrecosig <<" & "<<decprodcutjpsik <<" & "<<effrecostrjpsik<<" & "<<effmyrecostrjpsik<<" \\\\ "<<endl;
	out<<"\\hline"<<endl;
