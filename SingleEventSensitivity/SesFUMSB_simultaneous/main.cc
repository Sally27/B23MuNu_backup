...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        double cormsig=0.926945;
        double cormjpsik=1.0;
        ...
        double lowFCMEsigPID=0.653448;
        double lowFCMEjpsikPID=0.705984;
   ...
   //     double jpsikPID = 0.71386;       
        ...
        double crosschecksiglow=decprodcutsig*effrecostrsig*(double(7359.0/124051.0))*lowFCMEsigPID;
        double crosscheckjpsikmclow=decprodcutjpsik*effrecostrjpsik*(double(193096.0/1531615.0))*lowFCMEjpsikPID;
        double crosschecksighigh=decprodcutsig*effrecostrsig*(double(5342.0/124051.0))*highFCMEsigPID;
        double crosscheckjpsikmchigh=decprodcutjpsik*effrecostrjpsik*(double(87718.0/1531615.0))*highFCMEjpsikPID;   

        double crosschecksiglowerr=(sqrt(double(7359.0)*(1.0-((double(7359.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmclowerr=(sqrt(double(193096.0)*(1.0-((double(193096.0)/double(8043820))))))*(1/double(8043820));
        double crosschecksighigherr=(sqrt(double(5342.0)*(1.0-((double(5342.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmchigherr=(sqrt(double(87718.0)*(1.0-((double(87718.0)/double(8043820))))))*(1/double(8043820));
	...
	double effrecostrip= 0.111;
        ...
        double numberofevents_low = 121243.0;
        double numberofevents_high = 45987.0;
