...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        double effrecostrjpsik= double(0.3165)*double(0.573404) ;
        ...
        double combibdtjpsik = 0.4895; 

        double misidbdtsig = 0.418599;
        double misidbdtjpsik = 0.47422;

        double cormsig=0.923807;
        double cormjpsik=0.995981;

        double lowFCMEsig=0.50474; 
        double lowFCMEjpsik=0.614046;

        double highFCMEsig=0.49526;
        double highFCMEjpsik=0.385954;

        double lowFCMEsigPID=0.643493;
        double lowFCMEjpsikPID=0.70978;

        double highFCMEsigPID=0.66839;
        double highFCMEjpsikPID=0.726008;
   ...
   //     double jpsikPID = 0.71386;       
        ...
        double crosschecksiglow=decprodcutsig*effrecostrsig*(double(6389.0/115289.0))*lowFCMEsigPID;
        double crosscheckjpsikmclow=decprodcutjpsik*effrecostrjpsik*(double(161006.0/1459813.0))*lowFCMEjpsikPID;
        double crosschecksighigh=decprodcutsig*effrecostrsig*(double(6269.0/115289.0))*highFCMEsigPID;
        double crosscheckjpsikmchigh=decprodcutjpsik*effrecostrjpsik*(double(101199.0/1459813.0))*highFCMEjpsikPID;   

        double crosschecksiglowerr=(sqrt(double(6389.0)*(1.0-((double(6389.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmclowerr=(sqrt(double(161006.0)*(1.0-((double(161006.0)/double(8043820))))))*(1/double(8043820));
        double crosschecksighigherr=(sqrt(double(6269.0)*(1.0-((double(6269.0)/double(1114130))))))*(1/double(1114130));
        double crosscheckjpsikmchigherr=(sqrt(double(101199.0)*(1.0-((double(101199.0)/double(8043820))))))*(1/double(8043820));
...
//DCB        double numberofevents_high = 55147.0;
        double numberofevents_low = 103055.0; //Hypa
        double numberofevents_high = 55625.0; //Hypa
