...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        double lowFCMEsigPID=0.664258;
        double lowFCMEjpsikPID=0.727244;

        double highFCMEsigPID=0.682429;
        double highFCMEjpsikPID=0.746133;
...
//DCB        double numberofevents_high = 55147.0;
        double numberofevents_low = 9098.0; //Hypa
        double numberofevents_high = 6222.0; //Hypa
