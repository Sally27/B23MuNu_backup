...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        double lowFCMEsigPID=0.384;
        double lowFCMEjpsikPID=0.505093;

        double highFCMEsigPID=0.383;
        double highFCMEjpsikPID=0.500764;
...
//DCB        double numberofevents_high = 55147.0;
        double numberofevents_low = 57292.0; //Hypa
        double numberofevents_high = 38482.0; //Hypa
