...
if [ -e $file ]; then
	echo "File exists"
	$file -s $VAR1 -b $VAR2 --sig-tree DecayTree --bkg-tree DecayTree -o $VAR3 -k $VAR4 -w $weight -v $VAR5 -v $VAR6 -v $VAR10 -v $VAR11 -v $VAR12 -v $VAR13 -v $VAR14 -v $VAR15 -v $VAR16 -v $VAR17 -v $VAR18 -v $VAR19 -v $VAR20 -v $VAR21
#for i in "${mine[@]}"
else 
