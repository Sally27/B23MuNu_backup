...
Float_t W, Bplus_PT_f, Bplus_P_f, Bplus_M_f, Bplus_Corrected_Mass_f,  mu1_P_f, mu2_P_f, mu3_P_f, mu1_PT_f, mu2_PT_f, mu3_PT_f, mu1_MINIP_f, mu2_MINIP_f, mu3_MINIP_f, mu1_ghost_f, mu2_ghost_f, mu3_ghost_f, mu1_TRACK_CHI2_f, mu2_TRACK_CHI2_f, mu3_TRACK_CHI2_f, mu1_MINIPCHI2_f, mu2_MINIPCHI2_f, mu3_MINIPCHI2_f, Bplus_pmu_ISOLATION_BDT1_weights_f, Bplus_ENDVERTEX_CHI2_f, Bplus_TAU_f, Bplus_FD_CHI2_f, Bplus_X_travelled_f, Bplus_Y_travelled_f, Bplus_Z_travelled_f;



Double_t Bplus_PT, Bplus_P, Bplus_M, Bplus_Corrected_Mass, mu1_P, mu2_P, mu3_P, mu1_PT, mu2_PT, mu3_PT, mu1_MINIP, mu2_MINIP, mu3_MINIP, mu1_ghost, mu2_ghost, mu3_ghost, mu1_TRACK_CHI2, mu2_TRACK_CHI2, mu3_TRACK_CHI2, mu1_MINIPCHI2, mu2_MINIPCHI2, mu3_MINIPCHI2, Bplus_pmu_ISOLATION_BDT1_weights, Bplus_ENDVERTEX_CHI2,Bplus_TAU, Bplus_FD_CHI2, Bplus_X_travelled, Bplus_Y_travelled, Bplus_Z_travelled;


TFile* f = new TFile("my25000background.root","update");
...
t3->SetBranchAddress("Bplus_pmu_ISOLATION_BDT1_weights", &Bplus_pmu_ISOLATION_BDT1_weights);
t3->SetBranchAddress("Bplus_ENDVERTEX_CHI2",&Bplus_ENDVERTEX_CHI2);
t3->SetBranchAddress("Bplus_TAU",&Bplus_TAU);
...
TBranch *newBranch23 = t3->Branch("Bplus_pmu_ISOLATION_BDT1_weights_f",&Bplus_pmu_ISOLATION_BDT1_weights_f,"Bplus_pmu_ISOLATION_BDT1_weights_f/F");
TBranch *newBranch24 = t3->Branch("Bplus_ENDVERTEX_CHI2_f",&Bplus_ENDVERTEX_CHI2_f,"Bplus_ENDVERTEX_CHI2_f/F");
TBranch *newBranch25 = t3->Branch("Bplus_TAU_f",&Bplus_TAU_f,"Bplus_TAU_f/F");
TBranch *newBranch26 = t3->Branch("Bplus_FD_CHI2_f",&Bplus_FD_CHI2_f,"Bplus_FD_CHI2_f/F");
TBranch *newBranch27 = t3->Branch("Bplus_X_travelled_f",&Bplus_X_travelled_f,"Bplus_X_travelled_f/F");
TBranch *newBranch28 = t3->Branch("Bplus_Y_travelled_f",&Bplus_Y_travelled_f,"Bplus_Y_travelled_f/F");
TBranch *newBranch29 = t3->Branch("Bplus_Z_travelled_f",&Bplus_Z_travelled_f,"Bplus_Z_travelled_f/F");
...
//        t4->GetEntry(i);
        ...
        Bplus_pmu_ISOLATION_BDT1_weights_f=Bplus_pmu_ISOLATION_BDT1_weights; 
        Bplus_ENDVERTEX_CHI2_f= Bplus_ENDVERTEX_CHI2;
        Bplus_TAU_f=Bplus_TAU;
