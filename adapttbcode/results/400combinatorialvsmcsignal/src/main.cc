...
double wSig = 1.0;
double wBkg = 1.0;
string bdtvar = "Combinatorial400TreesPfinaltuplesNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
double mincut = -1.0;
double maxcut = 1.0;
int nstep = 300;
...
string var2name="Combinatorial400TreesPfinaltuplesNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
bool draw="true";
...
string bdtvarintuples="Combinatorial400TreesPfinaltuples";
