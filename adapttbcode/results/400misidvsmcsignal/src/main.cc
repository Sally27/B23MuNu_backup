...
string fileBkg="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/400treesandPnormalBDTMisidvsMCMARCH2016withJpsi/B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut.root";

string fileSig="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/400treesandPnormalBDTMisidvsMCMARCH2016withJpsi/B23MuNuNewMCNShared_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root";

//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
double wSig = 1.0;
double wBkg = 1.0;
string bdtvar = "MisIDNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
double mincut = -1.0;
double maxcut = 1.0;
int nstep = 300;
...
string var2name="MisIDNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
bool draw="true";
...
KFolder ke;
ke.setNFolds(7); 
ke.setOutFile("/vols/lhcbdisk05/ss4314/BDTtrainings/400treesMisIDSamplevsMCSigNormalBDT/tmva/");
string pathname="/vols/lhcbdisk05/ss4314/BDTtrainings/400treesMisIDSamplevsMCSigNormalBDT/tmva/";
string bdtvarintuples="MisIDNormalBDTfinal400TreesandP";
