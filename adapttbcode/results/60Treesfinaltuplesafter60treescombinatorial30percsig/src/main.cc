...
string fileBkg="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/60Treesfinaltuplesafter60treescombinatorial30percsig/B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_60andPPUNZIoptBDT.root";

string fileSig="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/60Treesfinaltuplesafter60treescombinatorial30percsig/B23MuNuNewMCNShared_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60andPPUNZIoptBDT.root";

//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
double wSig = 1.0;
double wBkg = 1.0;
string bdtvar = "60Treesfinaltuplesafter60treescombinatorial30percsigNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
double mincut = -1.0;
double maxcut = 1.0;
int nstep = 300;
...
string var2name="60Treesfinaltuplesafter60treescombinatorial30percsigNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
bool draw="true";
...
KFolder ke;
ke.setNFolds(9); 
ke.setOutFile("/vols/lhcbdisk05/ss4314/BDTtrainings/60Treesfinaltuplesafter60treescombinatorial30percsig/tmva/");
string pathname="/vols/lhcbdisk05/ss4314/BDTtrainings/60Treesfinaltuplesafter60treescombinatorial30percsig/tmva/";
string bdtvarintuples="60Treesfinaltuplesafter60treescombinatorial30percsig";
