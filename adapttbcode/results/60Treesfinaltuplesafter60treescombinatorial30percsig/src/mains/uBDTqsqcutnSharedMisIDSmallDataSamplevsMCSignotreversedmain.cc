...
string fileBkg="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSigflattenedsignal2/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";

string fileSig="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSigflattenedsignal2/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";

double wSig = 1.0;
double wBkg = 1.0;
string bdtvar = "misidvsmcsignotreversed";
double mincut = 0.0;
double maxcut = 1.0;
int nstep = 300;
...
string fileBkg2="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSigflattenedsignal2/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";

string fileSig2="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSigflattenedsignal2/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";
...
string fileBkgnew="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSigflattenedsignal2/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";
...
string fileSignew="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSigflattenedsignal2/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";
...
string var2name="misidvsmcsignotreversed";
string cut="";
bool draw="true";
...
KFolder ke;
ke.setNFolds(10); 
ke.setOutFile("/vols/lhcbdisk05/ss4314/BDTtrainings/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSigflattenedsignal2/tmva/");
...
string pathname="/vols/lhcbdisk05/ss4314/BDTtrainings/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSigflattenedsignal2/tmva/";
