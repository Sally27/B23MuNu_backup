...
int main()
{
	...
	string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiBackTonomu1mu3ETA/Data2012and2011_corrm_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";

	string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiBackTonomu1mu3ETA/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";

	string nameofbdt = "CombiBackTonomu1mu3ETA";
...
//	varstoexplore.push_back("mu3_PT");
	...
	//string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiAfterCombiBackTonomu1mu3ETA/B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut.root";
	//string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiAfterCombiBackTonomu1mu3ETA/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";


	//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
	double wSig = 1.0;
	double wBkg = 1.0;
	string bdtvar = "CombiBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	double mincut = -1.0;
	double maxcut = 1.0;
	int nstep = 300;
...
//        plotCutEffVsVarNonBDT(fileBkg,"CombiBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.57","CombiBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Bkg", extracuts);
//        plotCutEffVsVarNonBDT(fileSig,"CombiBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.57","CombiBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Sig", extracuts);
//        return(1);
	...
	string var2name="CombiBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	...
	getCorrelationCoefficient(fileSig, var5name, var2name, cuts, draw, fileSig, plotname2, mincut, maxcut, nstep);
        ...
        //------------------Plot efficiencies-------------------------------------------------------------///////
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var3name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.57").c_str(),var2name,var3name,0.0,6000,50,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var4name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.57").c_str(),var2name,var4name,0.0,6000,50,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var5name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.57").c_str(),var2name,var5name,0.0,6000,50,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var1name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.57").c_str(),var2name,var1name,0.0,6000,50,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var6name,-0.1,0.4,100,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.57").c_str(),var2name,var6name,-0.1,0.4,100,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var7name,-0.1,0.4,100,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.57").c_str(),var2name,var7name,-0.1,0.4,100,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var8name,-0.1,0.4,100,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.57").c_str(),var2name,var8name,-0.1,0.4,100,"Sig", extracuts);
	...
	KFolder ke;
	ke.setNFolds(10); 
	ke.setOutFile("/vols/lhcb/ss4314/BDTtrainings/CombiBackTonomu1mu3ETA/tmva/");
	string pathname="/vols/lhcb/ss4314/BDTtrainings/CombiBackTonomu1mu3ETA/tmva/";
	string bdtvarintuples="CombiBackTonomu1mu3ETA";
...
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var3name,0.0,6000,50,"", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiBackTonomu1mu3ETA/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.57").c_str(),var2name,var3name,0.0,6000,50,"PHSPSig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var4name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiBackTonomu1mu3ETA/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.57").c_str(),var2name,var4name,0.0,6000,50,"PHSPSig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.57").c_str(),var2name,var5name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiBackTonomu1mu3ETA/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.57").c_str(),var2name,var5name,0.0,6000,50,"PHSPSig", extracuts);
