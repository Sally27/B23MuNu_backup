...
int main()
{
	...
	string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiTriggerNoSSVertex/Data2012and2011_corrm_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root";

	string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiTriggerNoSSVertex/B23MuNuMCallvar_MCtruth_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
...
//	varstoexplore.push_back("mu3_PT");
	...
	//string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterCombiTriggerNoSSVertex/B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root";
	//string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterCombiTriggerNoSSVertex/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root";


	//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
	double wSig = 1.0;
	double wBkg = 1.0;
	string bdtvar = "CombiTriggerNoSSVertexNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	double mincut = -1.0;
	double maxcut = 1.0;
	int nstep = 300;
	...
	string var2name="CombiTriggerNoSSVertexNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	...
	KFolder ke;
	ke.setNFolds(10); 
	ke.setOutFile("/vols/lhcb/ss4314/BDTtrainings/CombiTriggerNoSSVertex/tmva/");
	string pathname="/vols/lhcb/ss4314/BDTtrainings/CombiTriggerNoSSVertex/tmva/";
	string bdtvarintuples="CombiTriggerNoSSVertex";
