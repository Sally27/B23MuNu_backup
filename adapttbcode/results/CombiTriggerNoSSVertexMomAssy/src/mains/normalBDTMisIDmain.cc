...
string fileBkg="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";

string fileSig="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";

double wSig = 1.0;
double wBkg = 1.0;
string bdtvar = "MisIDNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
double mincut = -1.0;
double maxcut = 1.0;
int nstep = 300;
...
string fileBkg2="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";

string fileSig2="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";
...
string fileBkgnew="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";
...
string fileSignew="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";
...
string var2name="MisIDNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
string cut="";
bool draw="true";
...
KFolder ke;
ke.setNFolds(10); 
ke.setOutFile("/vols/lhcbdisk05/ss4314/BDTtrainings/qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/tmva/");
...
string pathname="/vols/lhcbdisk05/ss4314/BDTtrainings/qsqcutnSharedMisIDSmallDataSamplevsMCSigNormalBDT/tmva/";
