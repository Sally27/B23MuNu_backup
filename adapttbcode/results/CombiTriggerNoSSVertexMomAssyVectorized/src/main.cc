...
string fileBkg="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiTriggerNoSSVertexMomAssyVectorized/Data2012and2011_corrm_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root";

string fileSig="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiTriggerNoSSVertexMomAssyVectorized/B23MuNuMCallvar_MCtruth_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root";

//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
double wSig = 1.0;
double wBkg = 1.0;
string bdtvar = "CombiTriggerNoSSVertexMomAssyVectorizedNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
double mincut = -1.0;
double maxcut = 1.0;
int nstep = 300;
...
string var2name="CombiTriggerNoSSVertexMomAssyVectorizedNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
bool draw="true";
...
KFolder ke;
ke.setNFolds(10); 
ke.setOutFile("/vols/lhcbdisk05/ss4314/BDTtrainings/CombiTriggerNoSSVertexMomAssyVectorized/tmva/");
string pathname="/vols/lhcbdisk05/ss4314/BDTtrainings/CombiTriggerNoSSVertexMomAssyVectorized/tmva/";
string bdtvarintuples="CombiTriggerNoSSVertexMomAssyVectorized";
