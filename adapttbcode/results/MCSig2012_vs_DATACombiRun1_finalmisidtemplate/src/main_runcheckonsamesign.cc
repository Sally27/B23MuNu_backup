...
int main()
{
	...
	string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_onlyRun1/B23SameSignMuonTotal_trigger_mu1nShared_mu2nShared_mu3nShared.root";

	string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_onlyRun1/Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut.root";

	string nameofbdt = "MCSig2012_vs_DATACombiRun1";
...
//        getCorrelationMatrix(allvar, fileBkg, "CorrelationALLVARSbkg"+nameofbdt+".pdf", "", true);
	...
	//string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiAfterMCSig2012_vs_DATACombiRun1/B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut.root";
	//string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiAfterMCSig2012_vs_DATACombiRun1/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
//
//
...
//	FOMPUNZISCALED = optimiseBdtPunziScaled(fileSig, fileBkg, nsigexp, nbkgexp, wSig, wBkg, bdtvar, mincut, maxcut, 100, nameplot);



//	string fileBkg2="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/Bu23MuNuData2016_corrmFUSMB_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu3isMuonTight_mu1MuonNShared_mu2MuonNShared_mu3MuonNShared_qmincut.root";

//	string fileSig2="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut.root";

//	string nameofbdt = "MCSig2016_288888335_vs_DATACombi2016";

//	string bdtvar = "MCSig2016_288888335_vs_DATACombi2016NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
...
//        
//  
////        plotCutEffVsVarNonBDT(fileBkg,"MCSig2012_vs_DATACombiRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.47","MCSig2012_vs_DATACombiRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Bkg", extracuts);
////        plotCutEffVsVarNonBDT(fileSig,"MCSig2012_vs_DATACombiRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.47","MCSig2012_vs_DATACombiRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Sig", extracuts);
////        return(1);
//
//	//------------Plot the Profile X Plot-------------------------------//
	...
	string var2name="MCSig2012_vs_DATACombiRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	...
	bool draw="true";
	string plotname="SameSignBDT";
	getCorrelationCoefficient_nice(fileBkg, (var1name+";4000;10000").c_str(), (var2name+";-1;1").c_str(), "M_{B_{corr}} [MeV/c^{2}]",var2name,cuts, draw, fileBkg, plotname, mincut, maxcut, nstep);
//	getCorrelationCoefficient_nice(fileBkg, var3name, var2name, cuts, draw, fileBkg, plotname, mincut, maxcut, nstep);
...
//	getCorrelationCoefficient_nice(fileSig, var3name, var2name, cuts, draw, fileSig, plotname2, mincut, maxcut, nstep);
...
//	string plotname2="MCsig";
	...
	string fileMisid="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_onlyRun1/Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut.root"; 
        plotCutEffVsVarNonBDT(fileMisid,(var2name+">0.47").c_str(),var2name,var1name,4000,7000,50,"Misid", extracuts);//range of var3name
//        plotCutEffVsVarNonBDT(fileMisid,(var2name+">0.47").c_str(),var2name,var3name,0.0,6000,50,"Sig", extracuts);
//        return(1);
	...
	KFolder ke;
	ke.setNFolds(10); 
	ke.setOutFile("/vols/lhcb/ss4314/BDTtrainings/MCSig2012_vs_DATACombiRun1/tmva/");
	string pathname="/vols/lhcb/ss4314/BDTtrainings/MCSig2012_vs_DATACombiRun1/tmva/";
	string bdtvarintuples="MCSig2012_vs_DATACombiRun1";
...
//        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_2016only/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.47").c_str(),var2name,var3name,0.0,6000,50,"PHSPSig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.47").c_str(),var2name,var4name,0.0,6000,50,"Bkg", extracuts);//range of var3name
//        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_2016only/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.47").c_str(),var2name,var4name,0.0,6000,50,"PHSPSig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.47").c_str(),var2name,var5name,0.0,6000,50,"Bkg", extracuts);//range of var3name
//        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_2016only/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.47").c_str(),var2name,var5name,0.0,6000,50,"PHSPSig", extracuts);
