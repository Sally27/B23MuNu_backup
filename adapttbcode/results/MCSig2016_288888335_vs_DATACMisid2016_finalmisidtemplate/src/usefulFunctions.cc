...
//   reth.GetYaxis()->SetTitleOffset(1.4);
   ...
   TLine* myline=new TLine(0.27, 0.0,0.27,gPad->GetUymax());
...
//   leg->SetTextSize(0.02);
 ...
 //-------------------Make nice histograms----------------------//
   ...
   leg2->SetHeader(("#varepsilon_{MisidBDT} : "+d2s(round_to_digits(eff,3))).c_str());
   leg2->AddEntry(hb,"Before MisidBDT","l");
   leg2->AddEntry(t,"After MisidBDT","l");
