...
string namecuttree2="B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut_BDTPunziOPTbkg.root";

string myvar="Bplus_Corrected_Mass";
...
string mycuts2="CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection < 0.578"; 

cutTree(nametree, decaytreename, namecuttree, mycuts);

cutTree(nametree, decaytreename, namecuttree2, mycuts2);

plotCutEffVsVar(nametree, mycuts, myvar , 0.0, 10000, 100, "EfficiencyofcutasafunctionofCorrectedMass.pdf", "");
plotCutEffVsVar(nametree, mycuts2, myvar , 0.0, 10000, 100, "EfficiencyofcutasafunctionofCorrectedMassbkg.pdf", "");
...
string namethat = "B23MuNuSignal2012and2011data_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmin_corrmBDTPunziOPT.root";
string namethat2 = "B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincutBDTPunziOPT.root";
//cutTree(fileBkg, decaytreename, namethat, mycuts);
//cutTree(fileSig, decaytreename, namethat2, mycuts);

//plotCutEffVsVar(fileBkg, mycuts, "CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection" , -1.0, 1.0, 100, "EffofBDTcutCombiPunziOPTbkg.pdf", "");
plotCutEffVsVar(fileSig, mycuts, "CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection" , -1.0, 1.0, 100, "EffofBDTcutCombiPunziOPTsig.pdf", "");
plotCutEffVsVar(fileBkg, mycuts, "CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection" , -1.0, 1.0, 100, "EffofBDTcutCombiPunziOPTbkg.pdf", "");
...
SIGEFF = SigEffandBkgEff(fileSig, fileBkg, wSig, wBkg, bdtvar, mincut, maxcut, nstep, nameplot);
 
string nameforplot = "TH_FOM_SCALED.pdf";
double numofsigexp=135.0;
double numofbkgexp=80000.0;
FOMSCALED= optimiseBdtScaled(fileSig, fileBkg, wSig, wBkg, bdtvar, mincut, maxcut, nstep, numofsigexp, numofbkgexp, nameforplot);

string nameforplot2 = "TH_FOM_SCALED2.pdf";
double numofsigexp2=1000.0;
double numofbkgexp2=1000.0;
FOMSCALED2= optimiseBdtScaled(fileSig, fileBkg, wSig, wBkg, bdtvar, mincut, maxcut, nstep, numofsigexp2, numofbkgexp2, nameforplot2);
...
bool top=false;
plotRocCurves(fsigname, fbkgname, bdtvars, outputfilename, extracuts, top, namemything1, minvar, maxvar, weightBranchSig, weightBranchBkg);
plotRocCurvesPunzi(fsigname, fbkgname, bdtvars, outputfilename, extracuts, top, namemything1, minvar, maxvar);
