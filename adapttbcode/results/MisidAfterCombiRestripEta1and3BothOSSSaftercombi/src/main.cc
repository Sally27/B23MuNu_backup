...
int main()
{
	...
	string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterCombiRestripEta1and3BothOSSSaftercombi/B23MuNuFakebothtotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_CombBasic.root";

	string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterCombiRestripEta1and3BothOSSSaftercombi/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root";

	string nameofbdt = "MisidAfterCombiRestripEta1and3BothOSSSaftercombi";
...
//	varstoexplore.push_back("mu3_PT");
	...
	//string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterMisidAfterCombiRestripEta1and3BothOSSSaftercombi/B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root";
	//string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterMisidAfterCombiRestripEta1and3BothOSSSaftercombi/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root";


	//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
	double wSig = 1.0;
	double wBkg = 1.0;
	string bdtvar = "MisidAfterCombiRestripEta1and3BothOSSSaftercombiNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	double mincut = -1.0;
	double maxcut = 1.0;
	int nstep = 300;
...
//        plotCutEffVsVarNonBDT(fileBkg,"MisidAfterCombiRestripEta1and3BothOSSSaftercombiNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.18","MisidAfterCombiRestripEta1and3BothOSSSaftercombiNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Bkg", extracuts);
//        plotCutEffVsVarNonBDT(fileSig,"MisidAfterCombiRestripEta1and3BothOSSSaftercombiNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.18","MisidAfterCombiRestripEta1and3BothOSSSaftercombiNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Sig", extracuts);
//        return(1);
	...
	string var2name="MisidAfterCombiRestripEta1and3BothOSSSaftercombiNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	...
	getCorrelationCoefficient(fileSig, var5name, var2name, cuts, draw, fileSig, plotname2, mincut, maxcut, nstep);
        ...
        //------------------Plot efficiencies-------------------------------------------------------------///////
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.18").c_str(),var2name,var3name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.18").c_str(),var2name,var3name,0.0,6000,50,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.18").c_str(),var2name,var4name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.18").c_str(),var2name,var4name,0.0,6000,50,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.18").c_str(),var2name,var5name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.18").c_str(),var2name,var5name,0.0,6000,50,"Sig", extracuts);
	...
	KFolder ke;
	ke.setNFolds(10); 
	ke.setOutFile("/vols/lhcb/ss4314/BDTtrainings/MisidAfterCombiRestripEta1and3BothOSSSaftercombi/tmva/");
	string pathname="/vols/lhcb/ss4314/BDTtrainings/MisidAfterCombiRestripEta1and3BothOSSSaftercombi/tmva/";
	string bdtvarintuples="MisidAfterCombiRestripEta1and3BothOSSSaftercombi";
