...
string fileSig="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSig/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";

string fileBkg="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSig/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";
...
string fileBkg2="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSig/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";

string fileSig2="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSig/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";
...
string fileBkgnew="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSig/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut.root";

string fileSignew="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/uBDTqsqcutnSharedMisIDSmallDataSamplevsMCSig/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root";
...
plotSigEffvsCorrMass(fileSignew, var2name, var1name, minmine, maxmine, mincut2, maxcut2, numofbdtsteps, "SigMCSampleeff.pdf", extracuts);

plotSigEffvsCorrMass(fileBkgnew, var2name, var1name, minmine, maxmine, mincut2, maxcut2, numofbdtsteps, "BkgMisIDSampleeff.pdf", extracuts);
