...
//   TH2D eff("eff", "eff", 100,2400,10000,100, 0.0 , 1.0);
   ...
   if(cuts != "") setBranchStatusTTF(t, cuts);
   if(cuts == "") cuts = "1"; 
   TH2F th2f("th2f", "th2f", 100,2400,10000,100, -1.0 ,1.0);
   TH2D eff("eff", "eff", 100,2400,10000,100, -1.0 , 1.0);
...
double plotSigEffBdtPunziScaled(string fileSig,
      string fileBkg,
      double nsigexp,
      double nbkgexp,
      double wSig,
...
//   target[0]=reth.GetXaxis()->GetBinCenter(0.3);
   ...
   if(nameplot.size()>1) canv.Print(("Scaled"+punzi+"asfnofSigeff"+nameplot).c_str());
...
//   TH1D* hc(0);
   ...
   ha->Draw();
   canv.Print(("CutEfficiency_"+var+nameplot+".pdf").c_str());
   ...
   canvgn.cd(4);
   t->Draw(var.c_str());
   canvgn.Print(("CutEfficiency_"+var+nameplot+"_complex.pdf").c_str());
