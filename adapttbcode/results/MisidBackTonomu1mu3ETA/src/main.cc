...
int main()
{
	...
	string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETA/B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root";

	string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETA/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root";

	string nameofbdt = "MisidBackTonomu1mu3ETA";
...
//	varstoexplore.push_back("mu3_PT");
	...
	//string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterMisidBackTonomu1mu3ETA/B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root";
	//string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterMisidBackTonomu1mu3ETA/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root";


	//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
	double wSig = 1.0;
	double wBkg = 1.0;
	string bdtvar = "MisidBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	double mincut = -1.0;
	double maxcut = 1.0;
	int nstep = 300;
...
//        plotCutEffVsVarNonBDT(fileBkg,"MisidBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.22","MisidBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Bkg", extracuts);
//        plotCutEffVsVarNonBDT(fileSig,"MisidBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.22","MisidBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Sig", extracuts);
//        return(1);
	...
	string var2name="MisidBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	...
	plotSigEffvsCorrMass(fileBkg, var2name, var1name, minmine, maxmine, mincut, maxcut, numofbdtsteps, "BkgMisidSampleeff.pdf", extracuts);
        ...
        plotSigEffvsCorrMass(fileBkg, var2name, var3name, minmine, maxmine, mincut, maxcut, numofbdtsteps, "invmu1andmu2BkgMisidSampleeff.pdf", extracuts);
	...
	KFolder ke;
	ke.setNFolds(10); 
	ke.setOutFile("/vols/lhcb/ss4314/BDTtrainings/MisidBackTonomu1mu3ETA/tmva/");
	string pathname="/vols/lhcb/ss4314/BDTtrainings/MisidBackTonomu1mu3ETA/tmva/";
	string bdtvarintuples="MisidBackTonomu1mu3ETA";
...
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.22").c_str(),var2name,var3name,0.0,6000,50,"", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETA/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root",(var2name+">0.22").c_str(),var2name,var3name,0.0,6000,50,"PHSPSig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.22").c_str(),var2name,var4name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETA/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root",(var2name+">0.22").c_str(),var2name,var4name,0.0,6000,50,"PHSPSig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.22").c_str(),var2name,var5name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETA/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root",(var2name+">0.22").c_str(),var2name,var5name,0.0,6000,50,"PHSPSig", extracuts);
	...
	//string mycuts="MisidnatorialNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.228";
