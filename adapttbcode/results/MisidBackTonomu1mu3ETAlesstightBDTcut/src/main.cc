...
int main()
{
	...
	string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETAlesstightBDTcut/B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root";

	string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETAlesstightBDTcut/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root";

	string nameofbdt = "MisidBackTonomu1mu3ETAlesstightBDTcut";
...
//	varstoexplore.push_back("mu3_PT");
	...
	//string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiAfterMisidBackTonomu1mu3ETAlesstightBDTcut/B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root";
	//string fileSig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiAfterMisidBackTonomu1mu3ETAlesstightBDTcut/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic.root";


	//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
	double wSig = 1.0;
	double wBkg = 1.0;
	string bdtvar = "MisidBackTonomu1mu3ETAlesstightBDTcutNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	double mincut = -1.0;
	double maxcut = 1.0;
	int nstep = 300;
	...
	//double nbkgexp = 13242.1;
        ...
        int tageff2=5;
	double nsigexp = 36.15;
	double nbkgexp = 11000;
	...
	maxsigeff=plotSigEffBdtPunziScaled(tageff1,fileSig, fileBkg, nsigexp, nbkgexp, wSig, wBkg, bdtvar, mincut, maxcut, nstep, nameplot);
        maxsigeff=plotSigEffBdtPunziScaled(tageff2,fileSig, fileBkg, nsigexp, nbkgexp, wSig, wBkg, bdtvar, mincut, maxcut, nstep, nameplot);        
...
//        plotCutEffVsVarNonBDT(fileBkg,"MisidBackTonomu1mu3ETAlesstightBDTcutNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.29","MisidBackTonomu1mu3ETAlesstightBDTcutNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Bkg", extracuts);
//        plotCutEffVsVarNonBDT(fileSig,"MisidBackTonomu1mu3ETAlesstightBDTcutNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.29","MisidBackTonomu1mu3ETAlesstightBDTcutNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","invmu1andmu2",0.0,6000,50,"Sig", extracuts);
//        return(1);
	...
	string var2name="MisidBackTonomu1mu3ETAlesstightBDTcutNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
	...
	getCorrelationCoefficient(fileSig, var5name, var2name, cuts, draw, fileSig, plotname2, mincut, maxcut, nstep);
        ...
        //------------------Plot efficiencies-------------------------------------------------------------///////
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var3name,0.0,6000,50,"Bkg", extracuts);//range of var3name
//        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.29").c_str(),var2name,var3name,0.0,6000,50,"Sig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var4name,0.0,6000,50,"Bkg", extracuts);//range of var3name
//        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.29").c_str(),var2name,var4name,0.0,6000,50,"Sig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var5name,0.0,6000,50,"Bkg", extracuts);//range of var3name
//        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.29").c_str(),var2name,var5name,0.0,6000,50,"Sig", extracuts);

        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var3name,0.0,6000,30,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.29").c_str(),var2name,var3name,0.0,6000,30,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var4name,0.0,6000,30,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.29").c_str(),var2name,var4name,0.0,6000,30,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var5name,0.0,6000,30,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.29").c_str(),var2name,var5name,0.0,6000,30,"Sig", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var1name,6000,10000,30,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.29").c_str(),var2name,var1name,0.0,10000,30,"Sig", extracuts);

        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.19").c_str(),var2name,var3name,0.0,6000,30,"Bkg42", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.19").c_str(),var2name,var3name,0.0,6000,30,"Sig42", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.19").c_str(),var2name,var4name,0.0,6000,30,"Bkg42", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.19").c_str(),var2name,var4name,0.0,6000,30,"Sig42", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.19").c_str(),var2name,var5name,0.0,6000,30,"Bkg42", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.19").c_str(),var2name,var5name,0.0,6000,30,"Sig42", extracuts);
        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.19").c_str(),var2name,var1name,6000,10000,30,"Bkg42", extracuts);//range of var3name
        plotCutEffVsVarNonBDT(fileSig,(var2name+">0.19").c_str(),var2name,var1name,0.0,10000,30,"Sig42", extracuts);
	...
	KFolder ke;
	ke.setNFolds(10); 
	ke.setOutFile("/vols/lhcb/ss4314/BDTtrainings/MisidBackTonomu1mu3ETAlesstightBDTcut/tmva/");
	string pathname="/vols/lhcb/ss4314/BDTtrainings/MisidBackTonomu1mu3ETAlesstightBDTcut/tmva/";
	string bdtvarintuples="MisidBackTonomu1mu3ETAlesstightBDTcut";
...
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var3name,0.0,6000,50,"", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETAlesstightBDTcut/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.29").c_str(),var2name,var3name,0.0,6000,50,"PHSPSig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var4name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETAlesstightBDTcut/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.29").c_str(),var2name,var4name,0.0,6000,50,"PHSPSig", extracuts);
//        plotCutEffVsVarNonBDT(fileBkg,(var2name+">0.29").c_str(),var2name,var5name,0.0,6000,50,"Bkg", extracuts);//range of var3name
        plotCutEffVsVarNonBDT("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETAlesstightBDTcut/B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root",(var2name+">0.29").c_str(),var2name,var5name,0.0,6000,50,"PHSPSig", extracuts);
	...
	//string mycuts="CombinatorialNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.298";
