...
int main()
{
	...
	string fileBkg="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/misidonthreesssample/B23SameSignMuonTotal_trigger_mu1nShared_mu2nShared_mu3nShared.root";
