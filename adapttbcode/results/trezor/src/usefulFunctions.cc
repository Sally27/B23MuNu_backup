...
//   TH1D* hc(0);
   ...
   canvgn.cd(4);
   t->Draw("CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection");
   canvgn.Print(("working"+nameplot).c_str());
