...
string fileBkg="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/400treesandPnormalBDTCombvsMCMARCH2016withJpsi/B23MuNuSignal2012and2011data_corrm_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmin.root";

string fileSig="/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/400treesandPnormalBDTCombvsMCMARCH2016withJpsi/B23MuNuNewMCNShared_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root";

//------------Define the bdt var, range and number of steps to obtain FOM and PUNZI fom---//
double wSig = 1.0;
double wBkg = 1.0;
string bdtvar = "CombinatorialNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
double mincut = -1.0;
double maxcut = 1.0;
int nstep = 300;
...
string var2name="CombinatorialNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
bool draw="true";
...
KFolder ke;
ke.setNFolds(10); 
ke.setOutFile("/vols/lhcbdisk05/ss4314/BDTtrainings/400treesCombinatorialSamplevsMCSigNormalBDT/tmva/");
string pathname="/vols/lhcbdisk05/ss4314/BDTtrainings/400treesCombinatorialSamplevsMCSigNormalBDT/tmva/";
...
plotOverTraining(ke, outputFileName, bdtvar, weight, pathname, mincut, maxcut, fsigname, fbkgname);
...
string mycuts="CombinatorialNormalBDTNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.578";
