...
void extremevaluesexchange(string filename, string decaytree, string newfilename)
{
	...
	Double_t mu3_P, mu3_ETA, Bplus_Corrected_Mass;
        ...
        t->SetBranchStatus("mu3_P",0);
        t->SetBranchStatus("mu3_ETA",0);
//	t->SetBranchAddress("mu3_P_new", &mu3_P_new);
//	t->SetBranchAddress("mu3_ETA_new", &mu3_ETA_new);
...
void extremevaluesFinal(string filename, string decaytree, string newfilename) {
	...
	Double_t mu3_P_new, mu3_ETA_new; 
	...
	Double_t mu3_P;
	Double_t mu3_ETA;
        newtree->Branch("mu3_P",&mu3_P,"mu3_P/D");
	newtree->Branch("mu3_ETA", &mu3_ETA, "mu3_ETA/D");
...
void extremevalues(string filename, string decaytree, string newfilename) {
	...
	Double_t mu3_P_new;
	Double_t mu3_ETA_new;
        newtree->Branch("mu3_P_new",&mu3_P_new,"mu3_P_new/D");
	newtree->Branch("mu3_ETA_new", &mu3_ETA_new, "mu3_ETA_new/D");
...
//	Double_t* yedges = &binningy[0];
	...
	for(int n=0; n<t->GetEntries(); ++n)
	{
		...
		int resulty(20);
                ...
                if (mu3_P<binningx.at(0))
                {
                cout<<"Old value of momentum "<<mu3_P<<endl;

                (mu3_P_new=(binningx.at(0)+1));
                mu3_ETA_new=mu3_ETA;
                cout<<"New value of momentum "<<mu3_P_new<<endl;
		newtree->Fill();
                }

                if (mu3_P>binningx.at(18))
                {
                cout<<"Old value of momentum "<<mu3_P<<endl;
                (mu3_P_new=(binningx.at(18)-1));
                mu3_ETA_new=mu3_ETA;
                cout<<"New value of momentum "<<mu3_P_new<<endl;
		newtree->Fill();
                }

                if (mu3_ETA>binningy.at(4))
                {
                cout<<"Old value of eta "<<mu3_ETA<<endl;
                (mu3_ETA_new=(binningy.at(4)-0.01));
                mu3_P_new=mu3_P;
                cout<<"New value of eta "<<mu3_ETA_new<<endl;
		newtree->Fill();
                }
                if (mu3_ETA<binningy.at(0))
                {
                cout<<"Old value of eta "<<mu3_ETA<<endl;
                (mu3_ETA_new=(binningy.at(0)+0.01));
                mu3_P_new=mu3_P;
                cout<<"New value of eta "<<mu3_ETA_new<<endl;
		newtree->Fill();
                }

		if (mu3_P_new<binningx.at(0) || mu3_P_new>binningx.at(18) || mu3_ETA_new<binningy.at(0) || mu3_ETA_new>binningy.at(4)) 
		{
			cout<< "Need to thow away this"<<endl;
			cout<< "Num of thrown away events: "<<numberofthrownevents++<<endl;
			cout<< "Borders:"<< binningx.at(0) <<" "<<binningx.at(18)<< " "<<binningy.at(0)<< " "<<binningy.at(4) << " "<<endl;
...
//	Double_t* yedges = &binningy[0];
	...
	for(int n=0; n<t->GetEntries(); ++n)
	{
		...
		int resulty(20);
                ...
                (mu3_P=(binningx.at(0)+1));
                cout<<"New value of momentum "<<mu3_P<<endl;
                }

                if (mu3_P>binningx.at(18))
                {
                cout<<"Old value of momentum "<<mu3_P<<endl;
                (mu3_P=(binningx.at(18)-1));
                cout<<"New value of momentum "<<mu3_P<<endl;
                }
                ...
                {
                cout<<"Old value of eta "<<mu3_ETA<<endl;
                (mu3_ETA=(binningy.at(4)-0.01));
                cout<<"New value of eta "<<mu3_ETA<<endl;
                }
                if (mu3_ETA<binningy.at(0))
                {
                cout<<"Old value of eta "<<mu3_ETA<<endl;
                (mu3_ETA=(binningy.at(0)+0.01));
                cout<<"New value of eta "<<mu3_ETA<<endl;
                }
...
float totmisidnobinofcorrmimp(string filename, string filename2, string species, string species2 ,string misidPIDcalib, string misidcuts, string misidPIDcalib2, string misidcuts2, string idPIDcalib, string idcuts,  string idPIDcalib2, string idcuts2, string ktopimisidfilename, string ktopimisidcuts, string pitokmisidfilename, string pitokmisidcuts, string tags, string stripping, string polarity, int ntoy) {
	...
	///------------ ADD Weights ------------///
        ...
        cout<<"Satrting to calculate corssfeed"<<endl;
	addweighttotree(filename, decaytree, idPIDcalib, idcuts, "idPIDcalib", ("modified_"+i2s(ntoy)+"_"+stripping+polarity+filename).c_str());
        plotheatmapPID(filename, decaytree, idPIDcalib, idcuts, "idPIDcalib",polarity, stripping);
	...
	addweighttotree(filename2, decaytree2, idPIDcalib2, idcuts2, "idPIDcalib", ("modified_"+i2s(ntoy)+"_"+stripping+polarity+filename2).c_str());
        ...
        cout<<"Finished with one species"<<endl;
	...
	//addweighttotree(filename, decaytree); 
        ...
        cout<<"Finished with both species"<<endl;
