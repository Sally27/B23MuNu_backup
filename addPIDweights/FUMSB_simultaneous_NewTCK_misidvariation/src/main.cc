...
int main(int argc, char *argv[]){
	...
	string ntoy=argv[6];
        string numberoftoys=argv[7];




	for ( int c(s2i(ntoy));c<s2i(numberoftoys);c++)
	{
			...
			//-------------------------------------------PID Calib ID histograms and cuts---------------------------------------//
		{
			...
			//			string filename2=("/vols/lhcb/ss4314/prepare_misidvariations/FUMSB_NOTsimultaneous_NewTCK_misidvariation/generatedtuples/"+stripping+"_"+cleanNameString(cuts2)+"_"+i2s(ntoy)+".root").c_str();
			...
			//			string filename="/vols/lhcb/ss4314/prepare_misidvariations/FUMSB_NOTsimultaneous_NewTCK_misidvariation/generatedtuples/"+stripping+"_"+cleanNameString(cuts)+"_"+i2s(ntoy)+".root";        
			...
			for(int i(6);i<7;i++)
			{
				...
				string filename2=("/vols/lhcb/ss4314/prepare_misidvariations/FUMSB_NOTsimultaneous_NewTCK_misidvariation/generatedtuples/"+stripping+"_"+cleanNameString(cuts2.at(i))+"_"+i2s(c)+".root").c_str();
				string filename="/vols/lhcb/ss4314/prepare_misidvariations/FUMSB_NOTsimultaneous_NewTCK_misidvariation/generatedtuples/"+stripping+"_"+cleanNameString(cuts.at(i))+"_"+i2s(c)+".root";        

				p=totmisidnobinofcorrmimp(kaonsample,pionsample,"kaon","pion",filename, (cuts.at(i)+"_new").c_str(), filename2, (cuts2.at(i)+"_new").c_str(), idPIDcalib, idcuts,idPIDcalib2, idcuts2, ktopimisidfilename, ktopimisidcuts, pitokmisidfilename, pitokmisidcuts ,(tags.at(i)).c_str(), stripping, polarity, c);
				eff.push_back(p);
				float l;
				l=totmisidproton(protonsample, "proton", filename4, (cuts4.at(i)).c_str(), idPIDcalib4, idcuts4, (tags.at(i)).c_str(), stripping, polarity, c); 
				double e;
				double f;
				double g;
			...
			//-------------------------------------------PID Calib ID histograms and cuts---------------------------------------//
		{
			...
			//		string filename2="/vols/lhcb/ss4314/prepare_misidvariations/FUMSB_NOTsimultaneous_NewTCK_misidvariation/generatedtuples/"+stripping+"_"+cleanNameString(cuts2)+"_"+i2s(ntoy)+".root";
