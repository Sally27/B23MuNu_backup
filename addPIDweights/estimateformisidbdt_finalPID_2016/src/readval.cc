...
int main(int argc, char *argv[]){
	...
	//         gROOT->ProcessLine(".x lhcbSally.C");
	 ...
	 //	string kaonsample="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_PUNZIoptBDT.root";
        ...
        readvalue(sample2, "DecayTree","mu3_ETA_new");

        string sample3="modifiedprobmu3Strip26MagDownBu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_PionPID_CombBasic_MisidBasic_FitCorM_Strip26MagDown.root";

        string sample4="modifiedandcutprobnnmu03Strip21r1MagUpData_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic_FitCorM_Strip21r1MagUp.root";
        cout<<"New sample final"<<sample3<<endl;

        readvalue(sample4, "DecayTree","misidPIDcalib");
}
