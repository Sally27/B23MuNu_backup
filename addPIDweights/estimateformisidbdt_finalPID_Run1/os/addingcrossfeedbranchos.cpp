...
float totmisidproton(string filename, string species, string misidPIDcalib, string misidcuts, string idPIDcalib, string idcuts, string tags, string stripping, string polarity) {
	...
	{ 
		...
		addweighttotree(("modifiedjack"+stripping+polarity+filename).c_str(), decaytree, misidPIDcalib, misidcuts, "misidPIDcalibold", ("modified"+tags+stripping+polarity+filename).c_str());
                plotheatmapPID(("modifiedjack"+stripping+polarity+filename).c_str(), decaytree, misidPIDcalib, misidcuts, "misidPIDcalibold",polarity, stripping);
		...
		TFile f2(("modifiedandcut"+tags+stripping+polarity+filename).c_str());
		TTree* t2 = (TTree*)f2.Get(decaytree.c_str());

		//   TFile f1(("modifiedandcut"+tags+stripping+polarity+filename2).c_str());
...
float totmisidnobinofcorrmimp(string filename, string filename2, string species, string species2 ,string misidPIDcalib, string misidcuts, string misidPIDcalib2, string misidcuts2, string idPIDcalib, string idcuts,  string idPIDcalib2, string idcuts2, string ktopimisidfilename, string ktopimisidcuts, string pitokmisidfilename, string pitokmisidcuts, string tags, string stripping, string polarity) {
	...
	addweighttotree(filename, decaytree, idPIDcalib, idcuts, "idPIDcalib", ("modified"+stripping+polarity+filename).c_str());
        plotheatmapPID(filename, decaytree, idPIDcalib, idcuts, "idPIDcalib",polarity, stripping);
	addweighttotree(("modified"+stripping+polarity+filename).c_str(), decaytree, misidPIDcalib, misidcuts, "misidPIDcalib", ("modified"+tags+stripping+polarity+filename).c_str());
        plotheatmapPID(("modified"+stripping+polarity+filename).c_str(), decaytree, misidPIDcalib, misidcuts, "misidPIDcalib",polarity, stripping);
	...
	addweighttotree(("modified"+stripping+polarity+filename2).c_str(), decaytree2, misidPIDcalib2, misidcuts2, "misidPIDcalib", ("modified"+tags+stripping+polarity+filename2).c_str());
        plotheatmapPID(("modified"+stripping+polarity+filename2).c_str(), decaytree2, misidPIDcalib2, misidcuts2, "misidPIDcalib",polarity, stripping);
	//addweighttotree(filename, decaytree); 

	///------------Cut the stupid entries------///
	cutTree(("modified"+tags+stripping+polarity+filename).c_str(), decaytree, ("modifiedandcut"+tags+stripping+polarity+filename).c_str(), "(idPIDcalib != 3.0  && misidPIDcalib != 3.0)");
	cutTree(("modified"+tags+stripping+polarity+filename2).c_str(), decaytree, ("modifiedandcut"+tags+stripping+polarity+filename2).c_str(), "(idPIDcalib != 3.0  && misidPIDcalib != 3.0)");
