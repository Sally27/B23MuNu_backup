...
cd /vols/lhcb/ss4314/addPIDweights/
#mkdir estimateforcombibdt_newTCK_2016
cd estimateforcombibdt_newTCK_2016
...
mkdir ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016
mkdir ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016/ss

rm ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016/ss/*pdf


cp *pdf ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016/ss/
cp *txt ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016/ss/
##
#
cd /vols/lhcb/ss4314/addPIDweights/
cd estimateforcombibdt_newTCK_2016
...
mkdir ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016/os

rm ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016/os/*pdf


cp *pdf ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016/os/
cp *txt ~/public_html/addPIDweights/estimateforcombibdt_newTCK_2016/os/
