...
mkdir estimateforcombibdt_newTCK_Run1
cd estimateforcombibdt_newTCK_Run1
...
mkdir ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1
mkdir ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1/ss

rm ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1/ss/*pdf


cp *pdf ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1/ss/
cp *txt ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1/ss/
...
mkdir ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1/os

rm ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1/os/*pdf


cp *pdf ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1/os/
cp *txt ~/public_html/addPIDweights/estimateforcombibdt_newTCK_Run1/os/
