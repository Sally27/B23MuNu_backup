trainingname=estimateformisidbdt #NEW simultaneous year
new=estimateformisidbdt_2016_newtuples #NEW NOT simultaneous year
...
cd bin
rm *tex
cd /vols/lhcb/ss4314/misidsplitting/estimateformisidbdt_2016_newtuples
...
path3=/vols/lhcb/ss4314/cutonBDTs/MCsig_vs_CombiFUMSB_new2016tuples/bin/
path4=/vols/lhcb/ss4314/cutonBDTs/MCsig_vs_CombiFUMSB_new2016tuples/bin/
