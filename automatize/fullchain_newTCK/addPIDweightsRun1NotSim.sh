...
mkdir FUMSB_NOTsimultaneous_NewTCK


#sourc=$PWD/estimateformisidbdt_newTCK_Run1
#desti=$PWD/FUMSB_NOTsimultaneous_NewTCK
#
#cp $sourc/* $desti/
...
#desti2=$PWD/FUMSB_NOTsimultaneous_NewTCK/os
#
#cp $sourc2/* $desti2/
...
mkdir FUMSB_NOTsimultaneous_NewTCK
cd FUMSB_NOTsimultaneous_NewTCK
...
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/ss/
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/ss/Run1

rm ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/ss/Run1/*pdf


cp *pdf ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/ss/Run1/
cp *txt ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/ss/Run1/
...
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/os
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/os/Run1

rm ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/os/Run1/*pdf


cp *pdf ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/os/Run1/
cp *txt ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK/os/Run1/
