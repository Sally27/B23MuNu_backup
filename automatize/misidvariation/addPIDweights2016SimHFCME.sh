...
do
    ...
    var3=Strip26MagDown
    var4=Strip26MagUp
    beg=../finaltuples2016/HFCME/$genius
    ...
    beg3=../finaltuples2016/HFCME/$genius
    ...
    beg5=../finaltuples2016/HFCME/$genius
    ...
    mkdir ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/ss/HFCME/2016
    mkdir ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/ss/HFCME/2016/$ntoy
    ...
    rm ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/ss/HFCME/2016/$ntoy/*pdf
    rm ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/ss/HFCME/2016/$ntoy/*txt
    
    cp *pdf ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/ss/HFCME/2016/$ntoy
    cp *txt ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/ss/HFCME/2016/$ntoy
...
do
    ...
    mkdir ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/os/HFCME/2016
    mkdir ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/os/HFCME/2016/$ntoy
    
    rm ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/os/$ntoy/*pdf
    rm ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/os/HFCME/2016/$ntoy/*pdf
    
    cp *pdf ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/os/HFCME/2016/$ntoy/
    cp *txt ~/public_html/addPIDweights/FUMSB_simultaneous_NewTCK_misidvariation/os/HFCME/2016/$ntoy/
