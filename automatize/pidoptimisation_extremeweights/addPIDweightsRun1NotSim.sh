...
mkdir FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights


#sourc=$PWD/estimateformisidbdt_newTCK_Run1
#desti=$PWD/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights
#
#cp $sourc/* $desti/
...
#desti2=$PWD/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/os
#
#cp $sourc2/* $desti2/
...
mkdir FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights
cd FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights
...
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/ss/
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/ss/Run1

rm ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/ss/Run1/*pdf


cp *pdf ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/ss/Run1/
cp *txt ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/ss/Run1/
...
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/os
mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/os/Run1

rm ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/os/Run1/*pdf


cp *pdf ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/os/Run1/
cp *txt ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/os/Run1/
