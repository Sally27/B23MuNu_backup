...
sim=FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level #NEW simultaneous year
notsim=FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level #NEW NOT simultaneous year
