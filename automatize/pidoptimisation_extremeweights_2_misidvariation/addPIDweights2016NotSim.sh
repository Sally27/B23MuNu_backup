...
for ntoy in {0..100..1}
   ...
   genius=modified_andcut_${ntoy}_
    ...
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/2016/
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/2016/$ntoy
    
    rm ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/2016/$ntoy/*
    
    
    cp *pdf ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/2016/$ntoy
    cp *txt ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/2016/$ntoy
...
#    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/2016
#    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/2016/$ntoy    
#
#    rm ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/2016/$ntoy/*
#    
#    
#    cp *pdf ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/2016/$ntoy/
#    cp *txt ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/2016/$ntoy/
#
#done
