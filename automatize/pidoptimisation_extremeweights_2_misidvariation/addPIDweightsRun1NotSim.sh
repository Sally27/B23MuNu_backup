...
mkdir FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation

SetupProject Urania v5r0

#sourc=$PWD/estimateformisidbdt_newTCK_Run1
#desti=$PWD/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation
#
#cp $sourc/* $desti/
...
#desti2=$PWD/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os
#
#cp $sourc2/* $desti2/
...
mkdir FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation
cd FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation
...
for ntoy in {0..100..1}
    ...
    for wohoo in PIDK nSharednew probnnmunew probnnmu02 probnnmu025 probnnmu03 probnnmu035 probnnmupi04 probnnmupi05 probnnmupi06 
    ...
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/Run1
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/Run1/$ntoy
    
    rm ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/Run1/$ntoy/*pdf
    
    
    cp *pdf ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/Run1/$ntoy
    cp *txt ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/ss/Run1/$ntoy
...
for ntoy in {0..100..1}
    ...
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/Run1
    mkdir ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/Run1/$ntoy
    
    rm ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/Run1/$ntoy/*pdf
    
    
    cp *pdf ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/Run1/$ntoy
    cp *txt ~/public_html/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_2_misidvariation/os/Run1/$ntoy
