...
void PlotMisidVariations::create_bin_histograms(vector< vector<double> > values, string PIDcut)
{
...
{
	TFile* F1 = new TFile((bindir+"/BinInfo_"+i2s(numberofhistograms)+"_"+PIDcut+".root").c_str(),"READ");
...
void PlotMisidVariations::plot_bin_histograms(string PIDcut)
{
	TFile* F1 = new TFile((bindir+"/BinInfo_"+i2s(numberofhistograms)+"_"+PIDcut+".root").c_str(),"READ");
