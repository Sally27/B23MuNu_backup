...
void PlotMisidVariations::create_bin_histograms(vector< vector<double> > values)
{
...
{
	TFile* F1 = new TFile((bindir+"/BinInfo_"+i2s(numberofhistograms)+".root").c_str(),"READ");
...
void PlotMisidVariations::plot_bin_histograms()
{
	TFile* F1 = new TFile((bindir+"/BinInfo_"+i2s(numberofhistograms)+".root").c_str(),"READ");
	...
	for (int l(0); l<numberofpdf; l++){
		...
		cv->Divide(3,3);
               ...
               cv->SaveAs((bindir+"/BinInfo_"+i2s(numberofhistograms)+"_"+i2s(l)+".pdf").c_str());
	}
...
vector<double> PlotMisidVariations::plotdistributions_perbin(vector <string> &dir,vector <string> &misidfilenames, vector <string> &weights, vector <string> &species, string type, int toynumber)
{
...
void PlotMisidVariations::plotmisidcomponents_pertoy(vector <string> &dir,vector <string> &misidfilenames, vector <string> &weights, vector <string> &species, string type, int toynumber)
{
