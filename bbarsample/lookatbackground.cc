...
void pid()
{
  Int_t mu2_TRUEID, mu1_TRUEID, mu3_TRUEID, Bplus_TRUEID, Bplus_BKGCAT;
  ...
  for(int i=0; i<t->GetEntries(); ++i)
  {
     ...
     // cout<<count<<endl;
      if (((!Bplus_BKGCAT==40)&&(!Bplus_BKGCAT==50)&&(!Bplus_BKGCAT==60)&&(!Bplus_BKGCAT==70)&&(!Bplus_BKGCAT==100)&&(!Bplus_BKGCAT==110) (mu2_TRUEID==-13) && (mu1_TRUEID==13) )||( (!Bplus_BKGCAT==40)&&(!Bplus_BKGCAT==50)&&(!Bplus_BKGCAT==60)&&(!Bplus_BKGCAT==70)&&(!Bplus_BKGCAT==100)&&(!Bplus_BKGCAT==110)&&(mu2_TRUEID==13) && (mu1_TRUEID==-13)))
     {       
      	t2->Fill();
        count2++;
      //  cout<<"YouMayPass,";
  ...
  filefort2->Write();
  t2->SetScanField(0);
  t2->Scan("Bplus_BKGCAT:mu1_TRUEID:mu2_TRUEID:mu3_TRUEID"); 
  return;
