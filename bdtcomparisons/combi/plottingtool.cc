...
//  printLHCb("L","Prelim","");
  ...
  DataSample hist3("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsCombiFUMSB_add2016_newPID/B23MuNuMCallvar_MCtruth_trigger_Jpsi_qmincut.root", "DecayTree");
...
//  a->Scale(scale);
  ...
  DataSample hist2("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsCombiFUMSB_add2016_newPID/B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut.root", "DecayTree");
  ...
  DataSample hist4("/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsCombiFUMSB_add2016_newPID/B2JpsiKDataDetached2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID.root", "DecayTree");
...
//  hs->Add(ho,"nostack");
  ...
  gStyle->SetOptStat(0);
   ...
   la->SetXTitle("M_{B}_{Corr} (MeV/c^{2})");
 ...
 //  ho->Draw("same");
    ...
    Double_t xl1=.3, yl1=0.75, xl2=xl1+.4, yl2=yl1+.185;
    TLegend *leg = new TLegend(xl1,yl1,xl2,yl2);
//    leg->SetTextSize(0.02);
    leg->SetBorderSize(0);
    leg->AddEntry(la,"Signal simulation","l");
    leg->AddEntry(hm,"Misidentified data","l");
    leg->AddEntry(a,"Partially rec. simulation","l");   // h1 and h2 are histogram pointers
...
plotvariable("Bplus_Corrected_Mass", 0, 7000);

break;

string file1="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsCombiFUMSB_add2016_newPID/B23MuNuMCallvar_MCtruth_trigger_Jpsi_qmincut.root";

string file2="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsCombiFUMSB_add2016_newPID/B23MuNuMC2015_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut.root";

string file3="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsCombiFUMSB_add2016_newPID/B23MuNuMC2016_MCtruth_trigger_Jpsi_qmincut.root";
...
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "MCnonsharedvsCombiFUMSBNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection", -1, 1,"CombiBDT","CombiBDT","1");
//
//
