...
void plotvariableone(string scale,string nameforplot, string file1, string tag1, string k, double low, double high, string xaxis, string variable)
{
...
//   mp3->SetLogx();   
   mp3->Update();
   mp3->SaveAs(("plotjustonevariable"+variable+scale+".pdf").c_str());
...
void plot2variables2histos(string scale,string nameforplot, string file1, string file2,string tag1, string tag2, string k1, string k2,double low, double high, string xaxis, string variable)
{
  ...
  int nbins=100;
//  printLHCb("L","Prelim","");
  DataSample hist1(file1.c_str(), "finalTree_KMuMu"); 
  TH1F* h1 = new TH1F("bplusmm2", "bplusmm2", nbins, low, high);
  hs->Add(h1,"nostack");
  hist1.t->Draw((k1+">>bplusmm2").c_str());
  double nSel1 = hist1.t->GetEntries();
  cout<<"number of events combi"<<nSel1<<endl;
...
//  a->Scale(scale);
  cout<<"This is scale2: "<<scale2<<endl;
  hist2.t->Draw((k2+">>bpluscorrmass").c_str());
  h2->Scale(scale2);
  hs->Add(h2,"nostack");
  cout<<"number of events in misid kaon"<<nSel2<<endl; 
  /*print nSel1;*/
...
string file1="/vols/lhcb/ss4314/tuplesallvar/MCPatrickJpsipi/Bu2JpsiPi_cut.root";

string file2="/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/JpsiPiMCafterall/bin/BuPiMuMuMC_misidstrippingfull_trigger_CombBasic_MisidBasic_FitCorM_PTkaon_Blifetime.root";
...
plotvariablefourdisnoscale("SallyPatrick",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "Bplus_MM", 5000, 6000,"Bplus_MM_NoKaonHypo","Bplus_MM_NoKaonHypo");

//plotvariableone("NormalizedPID",plot1, file2, tag2, "Bplus_MM", 5000, 6000,"Bplus_MM","Bplus_MM");
//plotvariableone("mycalculation",plot1, file2, tag2, "(sqrt(((mu1_M*mu1_M)+(mu2_M*mu2_M)+(mu3_M*mu3_M))-2(Bplus_P*Bplus_P))", 5000, 6000,"mycalc","mycalc");
//plotvariableone("mycalculation",plot1, file2, tag2, "sqrt((Bplus_PE*Bplus_PE)-((Bplus_PX*Bplus_PX)+(Bplus_PY*Bplus_PY)+(Bplus_PZ*Bplus_PZ)))", 5000, 6000,"mycalc","mycalc");

//plotvariableone("mycalculationmu1",plot1, file2, tag2, "sqrt((mu1_PE*mu1_PE)-((mu1_PX*mu1_PX)+(mu1_PY*mu1_PY)+(mu1_PZ*mu1_PZ)))", 0, 1000,"mycalcmu1","mycalcmu1");
//plotvariableone("mycalculationmu2",plot1, file2, tag2, "sqrt((mu2_PE*mu2_PE)-((mu2_PX*mu2_PX)+(mu2_PY*mu2_PY)+(mu2_PZ*mu2_PZ)))", 0, 1000,"mycalcmu2","mycalcmu2");
//plotvariableone("mycalculationmu3",plot1, file2, tag2, "sqrt((mu3_PE*mu3_PE)-((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ)))", 0, 1000,"mycalcmu3","mycalcmu3");


//plotvariableone("newenergydistr",plot1, file2, tag2, "sqrt(((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ))+(493.667*493.667))", 0, 150000,"newenergydistr","newenergydistr");
//plotvariableone("newBmass",plot1, file2, tag2, "sqrt((sqrt(((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ))+(493.667*493.667)) + (mu2_PE) + (mu1_PE)) - (((mu1_PX+mu2_PX+mu3_PX)+(mu1_PY+mu2_PY+mu3_PY)+(mu1_PZ+mu2_PZ+mu3_PZ)))) ", 5000, 6000,"newbmass","newbmass");

//plotvariableone("newmass",plot1, file2, tag2, "sqrt(((sqrt(((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ))+(493.667*493.667)) + (mu2_PE) + (mu1_PE))*(sqrt(((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ))+(493.667*493.667)) + (mu2_PE) + (mu1_PE)))-(((mu1_PX+mu2_PX+mu3_PX)*(mu1_PX+mu2_PX+mu3_PX))+((mu1_PY+mu2_PY+mu3_PY)*(mu1_PY+mu2_PY+mu3_PY))+ ((mu1_PZ+mu2_PZ+mu3_PZ)*(mu1_PZ+mu2_PZ+mu3_PZ))))", 5000, 6000,"mhm","mhm");

//plotvariableone("newmass_kaonhypo",plot1, file2, tag2, "sqrt(((sqrt(((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ))+(493.667*493.667)) + (mu2_PE) + (mu1_PE))*(sqrt(((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ))+(493.667*493.667)) + (mu2_PE) + (mu1_PE)))-(((mu1_PX+mu2_PX+mu3_PX)*(mu1_PX+mu2_PX+mu3_PX))+((mu1_PY+mu2_PY+mu3_PY)*(mu1_PY+mu2_PY+mu3_PY))+ ((mu1_PZ+mu2_PZ+mu3_PZ)*(mu1_PZ+mu2_PZ+mu3_PZ))))", 5000, 6000,"Bplus_MM_KaonHypo","Bplus_MM_KaonHypo");


plot2variables2histos("SallyPatrick",plot1, file1, file2, tag1, tag2,"Bplus_MM", "sqrt(((sqrt(((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ))+(493.667*493.667)) + (mu2_PE) + (mu1_PE))*(sqrt(((mu3_PX*mu3_PX)+(mu3_PY*mu3_PY)+(mu3_PZ*mu3_PZ))+(493.667*493.667)) + (mu2_PE) + (mu1_PE)))-(((mu1_PX+mu2_PX+mu3_PX)*(mu1_PX+mu2_PX+mu3_PX))+((mu1_PY+mu2_PY+mu3_PY)*(mu1_PY+mu2_PY+mu3_PY))+ ((mu1_PZ+mu2_PZ+mu3_PZ)*(mu1_PZ+mu2_PZ+mu3_PZ))))",5000, 8000,"Bplus_MM_KaonHypo","Bplus_MM_KaonHypo");



//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "Bplus_P", 0, 300000,"B P","B_P");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "Bplus_PT", 0, 150000,"B PT","B_PT");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu1_PT", 0, 50000,"mu1 PT","mu1_PT");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu2_PT", 0, 50000,"mu2 PT","mu2_PT");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu3_PT", 0, 50000,"mu3 PT","mu3_PT");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu1_P", 0, 150000,"mu1 P","mu1_P");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu2_P", 0, 150000,"mu2 P","mu2_P");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu3_P", 0, 150000,"mu3 P","mu3_P");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu1_MINIPCHI2", 0, 20000,"mu1_MINIPCHI2","mu1_MINIPCHI2");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu2_MINIPCHI2", 0, 20000,"mu2_MINIPCHI2","mu2_MINIPCHI2");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "mu3_MINIPCHI2", 0, 20000,"mu3_MINIPCHI2","mu3_MINIPCHI2");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "Bplus_TAU", -1, 1,"Bplus_TAU","Bplus_TAU");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "Bplus_DIRA_OWNPV", 0.998, 1,"Bplus_DIRA_OWNPV","Bplus_DIRA_OWNPV");
//plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "Bplus_pmu_ISOLATION_BDT1_weights", -3, 3,"Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights");
