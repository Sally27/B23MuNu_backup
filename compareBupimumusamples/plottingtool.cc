...
//  printLHCb("L","Prelim","");
  ...
  DataSample hist2(file2.c_str(), "B2JpsiPi_Tuple/DecayTree");
  double nSel2 = hist2.t->GetEntries();
  double scale2;
  scale2 = nSel1/nSel2;
  TH1F* h2 = new TH1F("bpluscorrmass", "bplusmm", nbins, low, high);
...
string file2="/vols/lhcb/ss4314/tuplesallvar/MCSallyJpsipi/BuPiMuMuMC.root";
...
plotvariablefourdisnoscale("Normalized",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "Bplus_MM", 5000, 6000,"Bplus_MM","Bplus_MM");
