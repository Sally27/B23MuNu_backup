...
string file2="/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/JpsiPiMCafterall/bin/BuPiMuMuMC_misidstrippingfull_trigger_CombBasic_MisidBasic_FitCorM_PTkaon_Blifetime_firstpid_secondpid.root";
...
plotvariablefourdisnoscale("NormalizedPID",plot1, file1, file2, file3, file4, tag1, tag2, tag3, tag4, "Bplus_MM", 5000, 6000,"Bplus_MM","Bplus_MM");
