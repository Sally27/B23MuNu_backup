...
//          expoun.paramOn(frame6,Layout(0.3,0.7,0.5));
          expoun.paramOn(frame6,Layout(0.3,0.7,0.3),Format("NELU", AutoPrecision(3)));
 ...
 //---------------------------------------------Pull Plot------------------------------------------------------------//
	 ...
	 TCanvas cpull("pullplot", "pullplot", 700, 150);
...
//--------------------------------------------------------------------------------------------------------------------//
	  ...
	  TCanvas* canv2 = new TCanvas("myattempt3","myattempt3",700,800) ;
	  canv2->Divide(2,2) ;
	  ...
	  canv2->SaveAs("newANAcombi_new.pdf");

          TCanvas* mine = new TCanvas("mine","mine",700,800) ;
         gPad->SetRightMargin(0.1) ; 
 //         gPad->SetLogy();
          frame6->GetYaxis()->SetTitleOffset(1.0) ;
          frame6->GetYaxis()->SetTitle("Events / 500 MeV/c^{2}");
          frame6->GetXaxis()->SetTitle("M_{B_{corr}} [MeV/c^{2}]");
          frame6->Print("v");
          frame6->getAttLine("expoun_paramBox")->SetLineWidth(0);
          frame6->Draw();
          mine->Update();
          ...
          mine->SaveAs("nicenewANAcombi_new.pdf");

//          break;

	  TCanvas canvTot("canvTot", "canvTot", 700,800);
	  ...
	  canvTot.SaveAs("nicenewANAcombi_WITHPULL_new.pdf");
//	  canvTot.Print("nicenewANAcombi_WITHPULL_new.pdf");
...
//--------------------------------------------------------------------------------------------------------------------//
	  ...
	  canv2->cd(2) ; gPad->SetLeftMargin(0.15) ; framecom1->GetYaxis()->SetTitleOffset(1.4) ; framecom1->Draw() ;
	  canv2->cd(3) ; gPad->SetLeftMargin(0.15) ; framecom2->GetYaxis()->SetTitleOffset(1.4) ; framecom2->Draw() ;
	  canv2->SaveAs("newANAcombiUPMS_new.pdf");

          TCanvas* mine = new TCanvas("mine","mine",700,800) ;
          gPad->SetRightMargin(0.1) ; 
//          gPad->SetLogy();
          frame6->GetYaxis()->SetTitleOffset(1.0) ;
          frame6->GetYaxis()->SetTitle("Entries / (500 MeV/c^{2})");
          frame6->GetXaxis()->SetTitle("M_{B_{corr}} [MeV/c^{2}]");
          frame6->Print("v");
          frame6->getAttLine("expoun_paramBox")->SetLineWidth(0);
//          frame6->SetMinimum(1.0);
//          frame6->SetMaximum(100.0);
          ...
          frame6->SetMaximum(max+(0.1*max));
          frame6->SetMinimum(1.0);
          mine->SaveAs("nicenewANAcombiUMSB_new.pdf");
...
//          break;
	  ...
	  canvTot.Print("nicenewANAcombiUMSB_WITHPULL_new.pdf");
	  canvTot.Print("nicenewANAcombiUMSB_WITHPULL_new.pdf");
...
//--------------------------------------------------------------------------------------------------------------------//
	  ...
	  canv2->cd(2) ; gPad->SetLeftMargin(0.15) ; framecom1->GetYaxis()->SetTitleOffset(1.4) ; framecom1->Draw() ;
	  canv2->cd(3) ; gPad->SetLeftMargin(0.15) ; framecom2->GetYaxis()->SetTitleOffset(1.4) ; framecom2->Draw() ;
	  canv2->SaveAs("newANAcombi3same_new.pdf");
...
//          frame6->SetMaximum(100.0);
          ...
          frame6->SetMaximum(max+(0.1*max));
          frame6->SetMinimum(1.0);
          mine->SaveAs("nicenewANAcombi3same_new.pdf");
	  ...
	  canvTot.Print("nicenewANAcombi3same_WITHPULL_new.pdf");
	  canvTot.Print("nicenewANAcombi3same_WITHPULL_new.pdf");
