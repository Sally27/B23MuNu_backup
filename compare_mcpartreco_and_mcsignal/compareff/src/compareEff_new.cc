...
int main(){
	...
	decprodcutsig=returnEff(("../tuples/Efficiencies_"+i2s(years.at(1))+"_NORM.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "decprodcut");
	...
	//	double	effqminsig=returnEff(("../tuples/Efficiencies_"+i2s(years.at(1))+"_NORM.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "qmincut");
	double	effjpsisig=1.0;//returnEff(("../tuples/Efficiencies_"+i2s(years.at(1))+"_NORM.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "jpsi");



	//	combibdtsig=returnEff(("../tuples/Efficiencies_SigMC_"+i2s(years.at(1))+"_Combi.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "combibdt");	
	//	misidbdtsig=returnEff(("../tuples/Efficiencies_SigMC_"+i2s(years.at(1))+"_Misid.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "misidbdt");
	//	cormsig=returnEff(("../tuples/Efficiencies_SigMC_"+i2s(years.at(1))+"_Fitrange.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "fitrange");
	...
	double sigfirst=decprodcutsig*effstripsig*effrecostrsig*efftriggersig*effjpsisig;
	double partrecofisrt=decprodcutjpsik*effstripsig*effrecostrjpsik*efftriggerjpsik*effjpsijpsik;
	double firstratio=double(double(sigfirst)*double(1.0e-8))/double(double(partrecofisrt)*double(1.0e-7));
	double sigsec=decprodcutsig*effstripsig*effrecostrsig*efftriggersig*effjpsisig*combibdtsig*misidbdtsig;
	double partrecosec=decprodcutjpsik*effstripjpsik*effrecostrjpsik*efftriggerjpsik*effjpsijpsik*combibdtjpsik*misidbdtjpsik;
	double secratio=double(double(sigsec)*double(1.0e-8))/double(double(partrecosec)*double(1.0e-7));
	...
	ValError passed(double(numofontriesnofcme),0.0);

	ValError total(double(number_bkk_nor),0.0);
	...
	ValError passed_low(double(numofontriesnofcme_low),0.0);
	...
	ValError passed_high(double(numofontriesnofcme_high),0.0);
	...
	double alto=fitreff*combibdtjpsik*misidbdtjpsik*effjpsijpsik*efftriggerjpsik*effrecostrjpsik*effstripjpsik;
