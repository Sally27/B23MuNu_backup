...
{ 
   ...
   :branching_frac_PR_1(9.8e-2),//pdg dlnu
    ...
    pr_no("/vols/lhcb/ss4314/cutonFCME/FUMSB_simultaneous_NewTCK/bin/MC_PartReco_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM.root"),
...
//    ValError EfficiencyClass::calculateProduct_BR_eff(string type, string species, ValError gen_eff, ValError sel_eff)
    ...
    ValError calculateProduct_eff(string type, string species, ValError gen_eff, ValError sel_eff);
    ...
    ValError return_brbdmunu();
    ValError return_brdkpimumu();
