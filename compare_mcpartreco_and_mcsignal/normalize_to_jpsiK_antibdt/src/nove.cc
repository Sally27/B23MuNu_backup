...
int main(){
	...
	ofstream out;
	out.open("EfficiencyComparison_compared_toNormalisation_nove_AntiBDT.tex");
...
//        alleff.push_back(effmyrecosig); 
	...
	misidbdtjpsik=(1.0-0.635529);
        double fitrangejpsik(0.17573);
