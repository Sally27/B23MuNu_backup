...
*/
  ...
  DataSample hist1("B2D3piD0inclusive.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  /*Double_t nSel1, nGen1, nSel2, nGen2, nSel3, nGen3, nSel4, nGen4;*/
  ...
  DataSample hist2("/afs/cern.ch/work/s/slstefko/week6oct/MCSigpreparetuple/B23MuNuNewMCsamplevetoJpsi.root", "DecayTree");
...
*/
   ...
   mp3->Update();
   mp3->SaveAs("B2D3pimunuMCinclusiveD0.pdf");
