...
void invmass()
{
  ...
  TFile* f = new TFile("/afs/cern.ch/work/s/slstefko/gangadir/workspace/slstefko/LocalXML/382/B2piandmu.root");
  TTree* t = (TTree*)f->Get("B2D3pimu_Tuple/DecayTree");

  TFile *f1 = new TFile("B2D3pimuonlyD0.root","RECREATE");
...
//   t->SetBranchAddress("Bplus_BKGCAT", &Bplus_BKGCAT);
 ...
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   TBranch *bpt1 = t2->Branch("invmassmupi1",&invmassmupi1,"invmassmupi1/D");
   TBranch *bpt2 = t2->Branch("invmasspi1pi2",&invmasspi1pi2,"invmasspi1pi2/D");
   TBranch *bpt3 = t2->Branch("invmassmupi2",&invmassmupi2,"invmassmupi2/D");
   TBranch *bpt4 = t2->Branch("invmasspi2nu",&invmasspi2nu,"invmasspi2nu/D");
...
//             cout<<"mu_id: "<<mu_TRUEID<<" "<<" pi1_id: "<<pi1_TRUEID<<" "<<" pi2_id: "<<pi2_TRUEID<<" "<<" Bplus: "<<Bplus_TRUEID<<" "<<" mu_motherid: "<<" "<<mu_MC_MOTHER_ID<<" "<<" pi1_motherid: "<<pi1_MC_MOTHER_ID<<" "<<" pi2_motherid: "<<pi2_MC_MOTHER_ID<<" "<<" mu_gdmtid: "<<mu_MC_GD_MOTHER_ID<<" "<<" pi1_gdmtid: "<<" "<<pi1_MC_GD_MOTHER_ID<<" pi2_gdmtid: "<<" "<<pi2_MC_GD_MOTHER_ID<<endl;
              ...
              if (((mu_MC_MOTHER_ID==521) && (pi1_MC_MOTHER_ID==-421) && (pi2_MC_MOTHER_ID==-421) && (pi1_MC_GD_MOTHER_ID==521) && (pi2_MC_GD_MOTHER_ID==521))||((mu_MC_MOTHER_ID==-521) && (pi1_MC_MOTHER_ID==421) && (pi2_MC_MOTHER_ID==421) && (pi1_MC_GD_MOTHER_ID==-521) && (pi2_MC_GD_MOTHER_ID==-521)))
//if (((mu_MC_MOTHER_ID==521) && (((pi1_TRUEID==211) && (pi2_TRUEID==-211)) || ((pi1_TRUEID==-211) && (pi2_TRUEID==211))) && (pi1_MC_GD_MOTHER_ID==pi2_MC_GD_MOTHER_ID))||( (((pi1_TRUEID==211) && (pi2_TRUEID==-211)) || ((pi1_TRUEID==-211) && (pi2_TRUEID==211))) &&  (mu_MC_MOTHER_ID==-521)&&(pi1_MC_GD_MOTHER_ID==pi2_MC_GD_MOTHER_ID)))

//if (((Bplus_TRUEID==-521) && (mu_TRUEID==13) && (((pi1_TRUEID==-211) && (pi2_TRUEID==211))||((pi1_TRUEID==211) && (pi2_TRUEID==-211)))) || ((Bplus_TRUEID==521)&&(mu_TRUEID==-13) && (((pi1_TRUEID==-211) && (pi2_TRUEID==211))||((pi1_TRUEID==211) && (pi2_TRUEID==-211)))))
...
//
	      ...
	      nu[3] = Bplus_TRUEP_E - (pi2_TRUEP_E+pi1_TRUEP_E+mu_TRUEP_E);
              ...
              pi2nu[0] = nu[0];// + mu_TRUEP_X;
      	      pi2nu[1] = nu[1];// + mu_TRUEP_Y;
              pi2nu[2] = nu[2];// + mu_TRUEP_Z;
              pi2nu[3] = nu[3];// + mu_TRUEP_E;
