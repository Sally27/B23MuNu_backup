...
//  double nSel2 = hist2.t->GetEntries();
  ...
  DataSample hist1("B2D3piD0inclusivelow.root", "DecayTree");
...
//  a->Scale(0.800456);
  ...
  DataSample hist2("B2D3piD0inclusivehigh.root", "DecayTree");
...
*/
   ...
   mp3->Update();
   mp3->SaveAs("compareinvpiplusandpiminusinclusive.pdf");
