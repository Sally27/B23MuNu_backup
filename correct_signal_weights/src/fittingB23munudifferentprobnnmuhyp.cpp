...
void CopyTreeSelectedBranches(string filename, string newfilename)
{
        ...
        t->SetBranchStatus("Runweight", 1);
        t->SetBranchStatus("PIDweight", 1);
...
void printcharax_new()
{
	...
	double geneff_2012=(0.1856);
	double geneff_2016=(0.1959);
	...
	variable1=double(((N2012+N2016)/(N2012*(1.0+double(cond16/cond12)))));
	variable2=double(((N2016+N2012)/(N2016*(1.0+double(cond12/cond16)))));

	cout<<"NEW RUN 1 CHARACTERISTIX weight: "<<variable1<<endl;
	cout<<"NEW 2016 CHARACTERISTIX weight: "<<variable2<<endl;
...
void printcharax()
{
	...
	cout<<"RUN 1 CHARACTERISTIX weight: "<<variable1<<endl;
	cout<<"2016 CHARACTERISTIX weight: "<<variable2<<endl;
