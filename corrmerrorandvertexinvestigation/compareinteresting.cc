...
//  hist1.t->Draw("mu1_mpMuMu_PV_CHI2 >> bpluscorrmass");
//  a->Scale(0.01);
...
//  hist2.t->Draw("mu1_mpMuMu_PV_CHI2 >>bplusmm2");
...
*/
  ...
  DataSample hist1("/vols/lhcbdisk05/ss4314/tupleswithcorrmandvertex/B23MuNuMC/B23munufinal.root", "B23MuNu_Tuple/DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  /*Double_t nSel1, nGen1, nSel2, nGen2, nSel3, nGen3, nSel4, nGen4;*/
...
//  printLHCb("L","Prelim","");
  ...
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, -0.0, 100.0);
  hist1.t->Draw("mu1_mpMuMu_PV_CHI2 >> bpluscorrmass");
  double nSel1 = hist1.t->GetEntries();
...
//  cout<<"number of events signal"<<nSel2<<endl;
  ...
  double scale;
  scale = nSel3/nSel1;
  TH1F* la = new TH1F("bplusmm2", "bplusmm2", 100, -0.0, 100.0);
  hist3.t->Draw("mu1_mpMuMu_PV_CHI2>>bplusmm2");
  a->Scale(scale);
  ...
  gStyle->SetOptStat(0);
   ...
   a->SetLineColor(8);
   a->SetTitle("mu1_mpMuMu_PV_CHI2 NOT TO SCALE");
   a->SetXTitle("mu1_mpMuMu_PV_CHI2");
   ...
   la->SetTitle("mu1_mpMuMu_PV_CHI2 NOT TO SCALE");
   la->SetXTitle("mu1_mpMuMu_PV_CHI2");
   la->SetYTitle("Number of Events");
   la->Draw("same");

//   hm->SetTitle("mu1_mpMuMu_PV_CHI2 NOT TO SCALE");
//   hm->SetXTitle("mu1_mpMuMu_PV_CHI2");
...
//    leg->AddEntry(hm,"PION","l");
   ...
   //mp3->Update();
   mp3->SaveAs("compareinputvarforinvmu1_mpMuMu_PV_CHI2.pdf");
