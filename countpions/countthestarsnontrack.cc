...
statistics= newbinmydata("/vols/lhcbdisk05/ss4314/cutonBDTs/allvarcombvsmcsigMISIDafterCOMB/SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60TreesComb_60TreesMisID.root", "DecayTree", "kaon");
int numofpioninabin;
int num[18][4];
int z=0;
...
//ntracks=binz();
        ...
        ofstream out;
        out.open("countthekaonsnontrack.tex");
        out<<"THIS IS FOR KAON SAMPLE: SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60TreesComb_60TreesMisID.root"<<endl;
        out<<"\\begin{table}[ht]"<<endl;
        out<<"\\begin{center}"<<endl;
...
int togetherpioninbinetaandntracks(0);
        ofstream out2;
        out2.open("countthekaongivenbinofeta.tex");
