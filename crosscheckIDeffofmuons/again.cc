...
void main()
{
	...
	mg->SetTitle(("Difference for "+cutname).c_str());
	int i=1;
	...
	mg->Add(grfirst);
        ...
        string filename="/vols/lhcb/ss4314/crosscheckIDeffofmuons/bin/info_basic_mu3.root";
        string treename="Info";
	...
	mg->Add(grfirst);
        ...
        string filename="/vols/lhcb/ss4314/crosscheckIDeffofmuons/bin/info_basic_mu2.root";
        string treename="Info";
	...
	mg->Add(grfirst);
        ...
        string filename="/vols/lhcb/ss4314/crosscheckIDeffofmuons/bin/info_basic_mu1.root";
        string treename="Info";
	...
	mg->Add(grfirst);
        ...
        string filename="/vols/lhcb/ss4314/crosscheckIDeffofmuons/bin/info_basic_mu1_mu2.root";
        string treename="Info";
	...
	mg->Add(grfirst);
        ...
        string filename="/vols/lhcb/ss4314/crosscheckIDeffofmuons/bin/info_basic_mu3_mu2.root";
        string treename="Info";
	...
	//mg->Add(grfirst);
        ...
        string filename="/vols/lhcb/ss4314/crosscheckIDeffofmuons/bin/info_basic_mu3_mu1.root";
        string treename="Info";
	...
	c1->SaveAs(("SeeDifferencesFor_"+cutname+".pdf").c_str());
	delete c1;
	delete grfirst;
	return;
}
