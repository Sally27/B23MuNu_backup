...
int main(int argc, char *argv[]){
	...
	vector<string> tuples;
        ...
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2012nSharedStrip21");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2012nSharedDllmuStrip21");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2012nSharedDllmuDllKStrip21");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2012nSharedDllmuDllKProbnnStrip21");


        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2015nSharedStrip23_MCTuneV1");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2015nSharedDllmuStrip23_MCTuneV1");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2015nSharedDllmuDllKStrip23_MCTuneV1");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2015nSharedDllmuDllKProbnnStrip23_MCTuneV1");



        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2016nSharedStrip26");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2016nSharedDllmuStrip26");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2016nSharedDllmuDllKStrip26");
        tuples.push_back("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_forMCcutvsPIDreweight/bin/JpsiKMC2016nSharedDllmuDllKProbnnStrip26");

	vector<string> tags;

	tags.push_back("mccontrolrun1nShared");
	tags.push_back("mccontrolrun1nSharedDllmu");
	tags.push_back("mccontrolrun1nSharedDllmuDllK");
        tags.push_back("mccontrolrun1nSharedDllmuDllKProbnn");

	tags.push_back("mccontrol2015nShared");
	tags.push_back("mccontrol2015nSharedDllmu");
	tags.push_back("mccontrol2015nSharedDllmuDllK");
        tags.push_back("mccontrol2015nSharedDllmuDllKProbnn");
	

	tags.push_back("mccontrol2016nShared");
	tags.push_back("mccontrol2016nSharedDllmu");
	tags.push_back("mccontrol2016nSharedDllmuDllK");
        tags.push_back("mccontrol2016nSharedDllmuDllKProbnn");



        vector<string> cuts;

	cuts.push_back("(mu1_isMuon==1.0) && (mu2_isMuon==1.0) && mu1_nShared==0 && mu2_nShared==0 && mu3_isMuon==0.0 && mu3_inMuon==1.0 && mu3_PIDK > 0.0 && (mu3_PIDp - mu3_PIDK) < 5.0");
        cuts.push_back("(mu1_isMuon==1.0) && (mu2_isMuon==1.0) && mu1_nShared==0 && mu2_nShared==0 && (mu1_PIDmu > 0.0) && (mu2_PIDmu > 0.0) && mu3_isMuon==0.0 && mu3_inMuon==1.0 && mu3_PIDK > 0.0 && (mu3_PIDp - mu3_PIDK) < 5.0");
        cuts.push_back("(mu1_isMuon==1.0) && (mu2_isMuon==1.0) && mu1_nShared==0 && mu2_nShared==0 && (mu1_PIDmu > 0.0) && (mu2_PIDmu > 0.0) && ((mu1_PIDmu - mu1_PIDK) > 0.0) && ((mu2_PIDmu - mu2_PIDK)> 0.0) && mu3_isMuon==0.0 && mu3_inMuon==1.0 && mu3_PIDK > 0.0 && (mu3_PIDp - mu3_PIDK) < 5.0");
	cuts.push_back("(mu1_isMuon==1.0) && (mu2_isMuon==1.0) && (mu1_PIDmu > 0.0) && (mu2_PIDmu > 0.0) && ((mu1_PIDmu - mu1_PIDK) > 0.0) && ((mu2_PIDmu - mu2_PIDK)> 0.0) && mu1_nShared==0 && mu2_nShared==0 && (mu2_ProbNNmu > 0.3) && (mu1_ProbNNmu > 0.3) && mu3_isMuon==0.0 && mu3_inMuon==1.0 && mu3_PIDK > 0.0 && (mu3_PIDp - mu3_PIDK) < 5.0");
	...
	ofstream out2;
	out2.open("EfficienciesIDPIDfromMCandPIDreweightBasic_ControlChannel.tex");
	...
	ofstream out;
	out.open("EfficienciesIDPIDfromMCafterAllSelectionNOFCMEBasic_ControlChannel.tex");
