...
int main(int argc, char *argv[]){
	...
	cuts.push_back("(mu3_isMuon==1.0) && (mu1_isMuon==1.0) && mu3_nShared==0 && mu1_nShared==0 ");
        cuts.push_back("(mu3_isMuon==1.0) && (mu1_isMuon==1.0) && mu3_nShared==0 && mu1_nShared==0 && (mu3_PIDmu > 0.0) && (mu1_PIDmu > 0.0)");
        cuts.push_back("(mu3_isMuon==1.0) && (mu1_isMuon==1.0) && mu3_nShared==0 && mu1_nShared==0 && (mu3_PIDmu > 0.0) && (mu1_PIDmu > 0.0) && ((mu3_PIDmu - mu3_PIDK) > 0.0) && ((mu1_PIDmu - mu1_PIDK)> 0.0) ");
	cuts.push_back("(mu3_isMuon==1.0) && (mu1_isMuon==1.0) && (mu3_PIDmu > 0.0) && (mu1_PIDmu > 0.0) && ((mu3_PIDmu - mu3_PIDK) > 0.0) && ((mu1_PIDmu - mu1_PIDK)> 0.0) && mu3_nShared==0 && mu1_nShared==0 && (mu1_ProbNNmu > 0.3) && (mu3_ProbNNmu > 0.3)");
	...
	for(int j(0); j<tuples.size(); j++){
		...
		pidweighthold=calculatePIDfromWeights2muons(tuples.at(j), "DecayTree", "mu3weight","mu1weight");
		pidweight.push_back(pidweighthold);
	}

	ofstream out2;
	out2.open("EfficienciesIDPIDfromMCandPIDreweightBasic_mu3_mu1.tex");
	...
	ofstream out3;
	out3.open("Basicforpython_mu3_mu1.tex");


      TFile fillinfo("info_basic_mu3_mu1.root","RECREATE");
	...
	ofstream out;
	out.open("EfficienciesIDPIDfromMCafterAllSelectionNOFCMEBasic_mu3_mu1.tex");
