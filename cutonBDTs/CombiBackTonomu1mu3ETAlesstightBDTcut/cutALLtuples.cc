...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiBackTonomu1mu3ETAtighterproton/";
	...
	string cut2 = "CombiBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.42";
	string cutinfile = "CombiBackTonomu1mu3ETA $>$ 0.42";
	...
	ofstream out;
	out.open("Combinatorial60TreesPfinaltuplesNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection042.tex");
