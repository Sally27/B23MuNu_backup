...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/CombiRestripEta1and3/";
	...
	string cut2 = "CombiRestripEta1and3NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.57";
	string cutinfile = "CombiRestripEta1and3 $>$ 0.57";
