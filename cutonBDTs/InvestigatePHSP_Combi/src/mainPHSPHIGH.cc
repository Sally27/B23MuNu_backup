...
//	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/";
	...
	tuples.push_back("B23MuNuMCPHSP_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM");
        ...
        tags.push_back("SigMC2012_PHSP_afterfitrange");
	...
	for(int i(0); i<tuples.size(); i++)
	{
        ...
        ofstream out;
	out.open("EfficienciesCombiBDT_PHSP_HighFCME.tex");
	...
	TFile *fillinfos = new TFile("../efficiencytuples_sig/Efficiencies_PHSP_SigMC_2012_Combi_HighFCME.root","RECREATE");
	...
	FillEffInfo(fillinfotrees, "highfcme",double(collection.find("SigMC2012_PHSP_afterfitrange")->second),false);
	fillinfos->cd();
