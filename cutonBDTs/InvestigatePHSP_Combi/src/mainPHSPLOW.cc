...
//	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/";
	...
	for(int i(0); i<tuples.size(); i++)
	{
        ...
        ofstream out;
	out.open("EfficienciesCombiBDT_PHSP_LowFCME.tex");
	...
	TFile *fillinfos = new TFile("../efficiencytuples_sig/Efficiencies_PHSP_SigMC_2012_Combi_LowFCME.root","RECREATE");
	...
	FillEffInfo(fillinfotrees, "lowfcme",double(collection.find("SigMC2012_PHSP_afterfitrange")->second),false);
	fillinfos->cd();
