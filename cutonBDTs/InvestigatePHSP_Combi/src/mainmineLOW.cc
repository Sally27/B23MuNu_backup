...
//	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/";
	...
	tuples.push_back("Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM");
        ...
        tags.push_back("SigMC2012_Mine_afterlowfcme");
	...
	for(int i(0); i<tuples.size(); i++)
	{
        ...
        ofstream out;
	out.open("EfficienciesCombiBDT_Mine_LowFCME.tex");
	...
	TFile *fillinfos = new TFile("../efficiencytuples_sig/Efficiencies_Mine_SigMC_2012_Combi_LowFCME.root","RECREATE");
	...
	FillEffInfo(fillinfotrees, "lowfcme",double(collection.find("SigMC2012_Mine_afterlowfcme")->second),false);
	fillinfos->cd();
