...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsCombiFUMSB_clean/";
	...
	string filename6="B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut";
        ...
        string filename16="Data2012and2011_corrmLSD_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut";
        string filename17="Data2012and2011_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut";
        string filename18="BuKMuMuMCtotal_misidstrippingfull_trigger";
        string filename19="BuKMuMuMC2011total_misidstrippingfull_trigger";
        string filename20="B23MuNuMCallvar_MCtruth_trigger_Jpsi_qmincut";
        string filename21="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID";
        string filename22="B23SameSignMuonTotal_trigger_mu1nShared_mu2nShared_mu3nShared";
        string filename23="Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut";
        string filename24="Data2012and2011_SigReg_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut";
	...
	double partreco;
        ...
        double jpsikmctotal;
        double mcsigPHSP;
        double lowermassdata;
        double lowermassdatafull;
        double mcsigNew;
	...
	partreco=cutTree((pathname+filename6+ext).c_str(), decaytreename, (namecuttree6+ext).c_str(), cut2);
        ...
        lowermassdata=cutTree((pathname+filename16+ext).c_str(), decaytreename, (namecuttree16+ext).c_str(), cut2);
        lowermassdatafull=cutTree((pathname+filename17+ext).c_str(), decaytreename, (namecuttree17+ext).c_str(), cut2);
        ...
        threesame=cutTree((pathname+filename22+ext).c_str(), decaytreename, (namecuttree22+ext).c_str(), cut2);
        combifull=cutTree((pathname+filename23+ext).c_str(), decaytreename, (namecuttree23+ext).c_str(), cut2);
        sigreg=cutTree((pathname+filename24+ext).c_str(), decaytreename, (namecuttree24+ext).c_str(), cut2);
	...
	out<<"partreco  & "<<cutinfile<<" & "<< partreco << " & " << numofpartreco*partreco  << " \\\\ "<<endl;
        ...
        out<<"lowermassdata & "<<cutinfile<<" &  "<< lowermassdata << " \\\\ "<<endl;
        out<<"lowermassdatafull & "<<cutinfile<<" &  "<< lowermassdatafull << " \\\\ "<<endl;
        ...
        out<<"JpsiKdataNew & "<<cutinfile<<" & "<<jpsikdatanew<< " \\\\ "<<endl;
        out<<"3samesign & "<<cutinfile<<" & "<<threesame<< " \\\\ "<<endl;
        out<<"combifull & "<<cutinfile<<" & "<<combifull<< " \\\\ "<<endl;
        out<<"sigreg & "<<cutinfile<<" & "<<sigreg<< " \\\\ "<<endl;
	out<<"\\hline"<<endl;
	...
	out<<"\\end{document}"<<endl;
        ...
        out2<<"lowermassdata & "<<cutinfile<<" & "<<getmyentries((namecuttree16+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
        out2<<"lowermassdatafull & "<<cutinfile<<" & "<<getmyentries((namecuttree17+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
        ...
        out2<<"three same sign & "<<cutinfile<<" & "<<getmyentries((namecuttree22+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
        out2<<"combi full & "<<cutinfile<<" & "<<getmyentries((namecuttree23+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
        out2<<"sigreg & "<<cutinfile<<" & "<<getmyentries((namecuttree24+ext).c_str(),"DecayTree")<< " \\\\ "<<endl; 
        out2<<"\\hline"<<endl;
