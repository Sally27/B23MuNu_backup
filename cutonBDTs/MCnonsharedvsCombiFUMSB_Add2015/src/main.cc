...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsCombiFUMSB_Add2015/";
	...
	tuples.push_back("B2JpsiKDataDetached2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID");
        ...
        tuples.push_back("B23MuNuData_2015_corrmFUSMB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut");
        tuples.push_back("B23MuNuData_2015_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut");
        tuples.push_back("B23MuNuSSMisid2015_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID");
        tuples.push_back("B23MuNuSSMisid2015_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID");
        tuples.push_back("B23MuNuSSMisid2015_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID");
        tuples.push_back("B23MuNuSSMisid2015_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut");
        tuples.push_back("B23MuNuOSMisid2015_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_KaonPID");        
        tuples.push_back("B23MuNuOSMisid2015_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_PionPID");
        tuples.push_back("B23MuNuOSMisid2015_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_ProtonPID");
        tuples.push_back("B23MuNuOSMisid2015_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut");
        tuples.push_back("JpsiKMCDetached_2015_misidstrippingfull_trigger");
        tuples.push_back("B2JpsiKDataDetached2015_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID");
