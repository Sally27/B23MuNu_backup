...
//	tuples.push_back("Data2012and2011_SigReg_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic");
  ...
  //      tuples.push_back("B23MuNuData_2015_corrmFUSMB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic");
        tuples.push_back("B23MuNuData_2015_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic");
        tuples.push_back("B23MuNuSSMisid2015_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic");
        tuples.push_back("B23MuNuSSMisid2015_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic");
        tuples.push_back("B23MuNuSSMisid2015_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic");
        tuples.push_back("B23MuNuSSMisid2015_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic");
        tuples.push_back("B23MuNuOSMisid2015_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_KaonPID_CombBasic");        
        tuples.push_back("B23MuNuOSMisid2015_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_PionPID_CombBasic");
//        tuples.push_back("B23MuNuOSMisid2015_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_ProtonPID_CombBasic");
        tuples.push_back("B23MuNuOSMisid2015_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_CombBasic");
        tuples.push_back("JpsiKMCDetached_2015_misidstrippingfull_trigger_CombBasic");
        tuples.push_back("B2JpsiKDataDetached2015_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic");
...
//	string cutinfile = "MCnonsharedvsCombiFUMSB $>$ 0.47";
        ...
        string cut2 = "MCnonsharedvsMisidFUMSBNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.22";
        string cutinfile = "MCnonsharedvsMisidFUMSB $>$ 0.22";
