...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsMisidFUMSB_clean/";
	...
	string filename6="B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic";
        string filename7="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_KaonPID_CombBasic";
        string filename8="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_ProtonPID_CombBasic";
        string filename9="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_PionPID_CombBasic";
        string filename11="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_CombBasic";
        ...
        string filename15="B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic";
        string filename16="Data2012and2011_corrmLSD_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic";
        string filename17="Data2012and2011_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic";
        string filename18="BuKMuMuMCtotal_misidstrippingfull_trigger_CombBasic";
        string filename19="BuKMuMuMC2011total_misidstrippingfull_trigger_CombBasic";
        string filename20="B23MuNuMCallvar_MCtruth_trigger_Jpsi_qmincut_CombBasic";
        string filename21="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic";
        string filename22="Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic";
        string filename23="Data2012and2011_SigReg_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic";

	string decaytreename = "DecayTree";
	string ext = ".root";
	string cuttag = "_AntiMisidBasic";
	...
	partreco=cutTree((pathname+filename6+ext).c_str(), decaytreename, (namecuttree6+ext).c_str(), cut2);
        ...
        antisig=cutTree((pathname+filename23+ext).c_str(), decaytreename, (namecuttree23+ext).c_str(), cut2);
	...
	out<<"partreco  & "<<cutinfile<<" & "<< partreco << " & " << numofpartreco*partreco  << " \\\\ "<<endl;
        ...
        out<<"antisig & "<<cutinfile<<" & "<<antisig<< " \\\\ "<<endl;
	out<<"\\hline"<<endl;
	...
	out<<"\\end{document}"<<endl;
        ...
        out2<<"antisig & "<<cutinfile<<" & "<<getmyentries((namecuttree23+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
        out2<<"\\hline"<<endl;
