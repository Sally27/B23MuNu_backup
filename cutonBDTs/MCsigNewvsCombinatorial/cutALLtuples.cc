...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCsigNewvsCombinatorial/";
	...
	string cut2 = "MCsigNewvsCombinatorialNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.57";
	string cutinfile = "MCsigNewvsCombinatorial $>$ 0.57";
