...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCsigNewvsMisid/";
	...
	string cut2 = "MCsigNewvsMisidNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.22";
	string cutinfile = "MCsigNewvsMisid $>$ 0.22";
	...
	ofstream out;
	out.open("MCsigNewvsMisidNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection022.tex");
