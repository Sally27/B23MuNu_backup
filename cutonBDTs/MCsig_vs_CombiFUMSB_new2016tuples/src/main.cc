...
int main(){
	...
	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/NewTuples_2016_CombinatorialBDT/";
	...
	tuples.push_back("B2JpsiKDataDetached2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID");
        ...
        tuples2.push_back("Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared");
...
//        tags.push_back("MC2016Sig");
	...
	string cut3 = "NewTuples_2016_CombinatorialBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.57";
	string cutinfile2 = "NewTuples_2016_CombinatorialBDT $>$ 0.57";
