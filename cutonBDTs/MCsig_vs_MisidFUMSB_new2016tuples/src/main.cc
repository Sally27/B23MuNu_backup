...
int main(){
	...
	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/NewTuples_2016_MisidBDT/";
...
//        tuples.push_back("B23MuNuFakeOS_2015_DV41r2_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_ProtonPID_CombBasic");
        ...
        tuples2.push_back("Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_CombBasic");
...
//        tags.push_back("JpsiKMCDetached2015");
	...
	for(int i(0); i<tuples2.size(); i++)
	{
        ...
        string cut3 = "NewTuples_2016_MisidBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.21";
        string cutinfile2 = "NewTuples_2016_MisidBDT $>$ 0.21";
