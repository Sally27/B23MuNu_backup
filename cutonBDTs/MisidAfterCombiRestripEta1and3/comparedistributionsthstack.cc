...
//  printLHCb("L","Prelim","");
  ...
  DataSample hist3("/vols/lhcbdisk05/ss4314/preparetuplesforBDTfinalallvar/MCSigpreparetuple/bin/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root", "DecayTree");
