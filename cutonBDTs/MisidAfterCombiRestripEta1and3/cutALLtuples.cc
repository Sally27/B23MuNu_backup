...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterCombiRestripEta1and3/";
	...
	string cut2 = "MisidAfterCombiRestripEta1and3NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.186";
	string cutinfile = "MisidAfterCombiRestripEta1and3 $>$ 0.186";
