...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETAlesstightBDTcut/";
	...
	string cut2 = "MisidBackTonomu1mu3ETAlesstightBDTcutNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.19";
	string cutinfile = "MisidBackTonomu1mu3ETAlesstightBDTcut $>$ 0.19";
	...
	ofstream out;
	out.open("MisidBackTonomu1mu3ETAlesstightBDTcutNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection019.tex");
