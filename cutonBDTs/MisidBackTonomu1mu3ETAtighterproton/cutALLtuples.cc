...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidBackTonomu1mu3ETA/";
	...
	string cut2 = "MisidBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.22";
	string cutinfile = "MisidBackTonomu1mu3ETA $>$ 0.22";
	...
	ofstream out;
	out.open("MisidBackTonomu1mu3ETANTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection022.tex");
