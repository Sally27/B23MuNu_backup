...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/allvarcombvsmcsig/";
...
string cut2 = "allvarcombvsmcsigNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.56";
string cutinfile = "allvarcombvsmcsig $>$ 0.56";
