...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/allvarcombvsmcsigMISIDafterCOMB/";

string filename1="SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60TreesComb";
string filename2="SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60TreesComb";
string filename3="SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_60TreesComb";
string filename4="B23MuNuMCallvar_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComb";
string filename5="Data2012and2011_corrm_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComb";
string filename6="B23Pimu_MCtruth_Jpsi_cut_mu3nShared_qmincut_60TreesComb";


string decaytreename = "DecayTree";
string ext = ".root";
string cuttag = "_60TreesMisID";
...
string cut2 = "allvarcombvsmcsigMISIDafterCOMBNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.2066";
string cutinfile = "allvarcombvsmcsigMISIDafterCOMB $>$ 0.2066";
