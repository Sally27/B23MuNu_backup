...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MisidAfterCombiTriggerNoSSVertex/";

	string filename1="B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic";
	string filename2="B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic";
	string filename3="B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_qmincut_CombBasic";
	...
	string filename6="B23Pimu_MCtruth_cut_trigger_Jpsi_cut_mu3nShared_qmincut_CombBasic";
        string filename7="B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic";
	...
	string cut2 = "MisidAfterCombiTriggerNoSSVertexNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.18";
	string cutinfile = "MisidafterCombiTriggerNoSSVertex $>$ 0.18";
	...
	ofstream out;
	out.open("Combinatorial60TreesPfinaltuplesNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection018.tex");
	...
	out<<"pionmisid  & "<<cutinfile<<" & "<< pionmisid << " & " << " \\\\ "<<endl;
        out<<"pionmisid  & "<<cutinfile<<" & "<< protonmisid << " & " << " \\\\ "<<endl;
