...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/coolbdtMARCH2016withJpsi/";
...
string cutinfile = "Combinatorial400TreesPfinaltuplesN $>$ 0.324";
