...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/normalBDTCombvsMCqsqcutonPartRecoMARCH2016/";
string filename = "B2D3pimufinal_MCtruth_cut_mu3nShared_qmincut";
