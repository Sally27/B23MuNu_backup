...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/normalBDTCombvsMCqsqcutonPartRecoMARCH2016withJpsi/";
string filename = "B2D3pimufinal_MCtruth_Jpsi_cut_mu3nShared_qmin";
