...
void cutTree(string nametree, string decaytreename, string namecuttree, string cuts)
{
   ...
   cout<<"Num of events"<<t2->GetEntries()<<endl;
...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/normalBDTCombvsMCqsqcutonMCsignalMARCH2016withJpsi/";
string filename = "B23MuNuNewMCNShared_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut";
