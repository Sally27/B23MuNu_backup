...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/normalBDTCombvsMCqsqcutonPIONmisidMARCH2016withJpsi/";
string filename = "B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID";
...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/normalBDTCombvsMCqsqcutonKAONmisidMARCH2016withJpsi/";
string filename = "B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID";
string decaytreename = "DecayTree";
string ext = ".root";
string cuttag = "_PUNZIoptBDT";
string namecuttree2 = (filename+cuttag).c_str();
