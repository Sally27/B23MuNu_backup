...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/400treesandPnormalBDTMisidvsMCMARCH2016withJpsi/";
...
string ext = ".root";
string cuttag = "_400andPMISidPUNZIoptBDT";
...
string cut2 = "MisIDNormalBDTfinal400TreesandPNTrees400_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.137";
string cutinfile = "MisIDNormalBDTfinal400 $>$ 0.137";
...
ofstream out;
out.open("MisIDNormalBDTfinal400.txt");
...
out<<"\\end{center}"<<endl;
out<<"\\caption{MisIDNormalBDTfinal400.txt}"<<endl;
out<<"\\end{table}"<<endl;
