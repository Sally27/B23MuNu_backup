...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/60Treesfinaltuplesafter60treescombinatorial30percsig/";

string filename1="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60andPPUNZIoptBDT";
string filename2="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60andPPUNZIoptBDT";
string filename3="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_60andPPUNZIoptBDT";
string filename4="B23MuNuNewMCNShared_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60andPPUNZIoptBDT";
string filename5="B23MuNuSignal2012and2011data_corrm_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmin_60andPPUNZIoptBDT";
string filename6="B2D3pimufinal_MCtruth_Jpsi_cut_mu3nShared_qmin_60andPPUNZIoptBDT";


string decaytreename = "DecayTree";
string ext = ".root";
string cuttag = "_MISIDafter60";
...
string cut2 = "60Treesfinaltuplesafter60treescombinatorial30percsigNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.2066";
string cutinfile = "60Treesfinaltuplesafter60treescombinatorial30percsig $>$ 0.2066";
...
double numofmcsig = 29.000;
double numofpartreco = 134.5;
double numofmisid = 7755;
double numofcombinatorial = 1000;




ofstream out;
out.open("60Treesfinaltuplesafter60treescombinatorial30percsigNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection0016.txt");
