...
string pathname = "/vols/lhcbdisk05/ss4314/BDTrunonsamples/tuplesandbdtrun/60TreesMisIDAppliedonAllVarafter60TreesCombiAppliedonAllVar/";

string filename1="SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60TreesComAllVar";
string filename2="SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60TreesComAllVar";
string filename3="SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_60TreesComAllVar";
string filename4="B23MuNuMCallvar_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComAllVar";
string filename5="Data2012and2011_corrm_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComAllVar";
string filename6="B23Pimu_MCtruth_Jpsi_cut_mu3nShared_qmincut_60TreesComAllVar";


string decaytreename = "DecayTree";
string ext = ".root";
string cuttag = "_60TreesMisAllVar";
...
ofstream out;
out.open("60Treesfinaltuplesafter60treescombinatorial30percsigNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection002066.txt");
