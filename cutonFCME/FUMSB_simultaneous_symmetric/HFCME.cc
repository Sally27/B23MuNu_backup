...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/cutonFitRange/FUMSB_simultaneous_symmetric/";
	...
	convertbranchname((pathname+filename1).c_str(), decaytreename, (filename1).c_str());
	convertbranchname((pathname+filename2).c_str(), decaytreename, (filename2).c_str());
        convertbranchname((pathname+filename10).c_str(), decaytreename, (filename10).c_str()); 
	convertbranchname((pathname+filename3).c_str(), decaytreename, (filename3).c_str());
	convertbranchname((pathname+filename4).c_str(), decaytreename, (filename4).c_str());
	convertbranchname((pathname+filename5).c_str(), decaytreename, (filename5).c_str());
	convertbranchname((pathname+filename6).c_str(), decaytreename, (filename6).c_str());
        convertbranchname((pathname+filename7).c_str(), decaytreename, (filename7).c_str());
        convertbranchname((pathname+filename8).c_str(), decaytreename, (filename8).c_str());
        convertbranchname((pathname+filename9).c_str(), decaytreename, (filename9).c_str());
        convertbranchname((pathname+filename11).c_str(), decaytreename, (filename11).c_str());
        convertbranchname((pathname+filename12).c_str(), decaytreename, (filename12).c_str());
        convertbranchname((pathname+filename13).c_str(), decaytreename, (filename13).c_str());
        convertbranchname((pathname+filename14).c_str(), decaytreename, (filename14).c_str());
        convertbranchname((pathname+filename15).c_str(), decaytreename, (filename15).c_str());
        convertbranchname((pathname+filename16).c_str(), decaytreename, (filename16).c_str());
        convertbranchname((pathname+filename17).c_str(), decaytreename, (filename17).c_str());
        convertbranchname((pathname+filename18).c_str(), decaytreename, (filename18).c_str());
        convertbranchname((pathname+filename19).c_str(), decaytreename, (filename19).c_str());
        convertbranchname((pathname+filename20).c_str(), decaytreename, (filename20).c_str());
        convertbranchname((pathname+filename21).c_str(), decaytreename, (filename21).c_str());
        convertbranchname((pathname+filename22).c_str(), decaytreename, (filename22).c_str());
        convertbranchname((pathname+filename23).c_str(), decaytreename, (filename23).c_str());
	...
	kaonmisid=cutTree((filename1+ext).c_str(), decaytreename, (namecuttree1+ext).c_str(), cut2);
	pionmisid=cutTree((filename2+ext).c_str(), decaytreename, (namecuttree2+ext).c_str(), cut2);
        protonmisid=cutTree((filename10+ext).c_str(), decaytreename, (namecuttree10+ext).c_str(), cut2); 
	misid=cutTree((filename3+ext).c_str(), decaytreename, (namecuttree3+ext).c_str(), cut2);
	mcsig=cutTree((filename4+ext).c_str(), decaytreename, (namecuttree4+ext).c_str(), cut2);
	combi=cutTree((filename5+ext).c_str(), decaytreename, (namecuttree5+ext).c_str(), cut2);
	partreco=cutTree((filename6+ext).c_str(), decaytreename, (namecuttree6+ext).c_str(), cut2);
        kaonosmis=cutTree((filename7+ext).c_str(), decaytreename, (namecuttree7+ext).c_str(), cut2);
        protonosmis=cutTree((filename8+ext).c_str(), decaytreename, (namecuttree8+ext).c_str(), cut2);
        pionosmis=cutTree((filename9+ext).c_str(), decaytreename, (namecuttree9+ext).c_str(), cut2);
        osmis=cutTree((filename11+ext).c_str(), decaytreename, (namecuttree11+ext).c_str(), cut2);
        jpsikdata=cutTree((filename12+ext).c_str(), decaytreename, (namecuttree12+ext).c_str(), cut2);
        jpsikmc2012=cutTree((filename13+ext).c_str(), decaytreename, (namecuttree13+ext).c_str(), cut2);
        jpsikmc2011=cutTree((filename14+ext).c_str(), decaytreename, (namecuttree14+ext).c_str(), cut2);
        mcsigPHSP=cutTree((filename15+ext).c_str(), decaytreename, (namecuttree15+ext).c_str(), cut2);
        lowermasssdata=cutTree((filename16+ext).c_str(), decaytreename, (namecuttree16+ext).c_str(), cut2);
        lowermasssdatafull=cutTree((filename17+ext).c_str(), decaytreename, (namecuttree17+ext).c_str(), cut2);
        jpsikmc2012New=cutTree((filename18+ext).c_str(), decaytreename, (namecuttree18+ext).c_str(), cut2);
        jpsikmc2011New=cutTree((filename19+ext).c_str(), decaytreename, (namecuttree19+ext).c_str(), cut2);
        mcsigNew=cutTree((filename20+ext).c_str(), decaytreename, (namecuttree20+ext).c_str(), cut2);
        jpsikdatanew=cutTree((filename21+ext).c_str(), decaytreename, (namecuttree21+ext).c_str(), cut2);
        fullcombi=cutTree((filename22+ext).c_str(), decaytreename, (namecuttree22+ext).c_str(), cut2);
        finalfitdata=cutTree((filename23+ext).c_str(), decaytreename, (namecuttree23+ext).c_str(), cut2);
	...
	ofstream out;
	out.open("EfficienciesHCFME.tex");
	...
	out<<"\\end{document}"<<endl;
        ...
        ofstream out2;
        out2.open("numofeventsleftintuplesHCFME.tex");
