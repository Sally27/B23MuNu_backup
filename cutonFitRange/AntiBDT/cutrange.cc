...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/cutonBDTs/MCnonsharedvsMisidFUMSB_clean/";

	string filename1="B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_AntiMisidBasic";
        string filename10="B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_AntiMisidBasic";
	string filename2="B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_AntiMisidBasic";
	string filename3="B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic_AntiMisidBasic";
	string filename4="B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
	string filename5="Data2012and2011_corrm_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
	string filename6="B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
        string filename7="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_KaonPID_CombBasic_AntiMisidBasic";
        string filename8="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_ProtonPID_CombBasic_AntiMisidBasic";
        string filename9="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_PionPID_CombBasic_AntiMisidBasic";
        string filename11="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
        string filename12="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_AntiMisidBasic";        
                           
        string filename13="BuKMuMuMCtotal_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_AntiMisidBasic";
        string filename14="BuKMuMuMC2011total_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_AntiMisidBasic";
        string filename15="B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
        string filename16="Data2012and2011_corrmLSD_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
        string filename17="Data2012and2011_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
        string filename18="BuKMuMuMCtotal_misidstrippingfull_trigger_CombBasic_AntiMisidBasic";
        string filename19="BuKMuMuMC2011total_misidstrippingfull_trigger_CombBasic_AntiMisidBasic";
        string filename20="B23MuNuMCallvar_MCtruth_trigger_Jpsi_qmincut_CombBasic_AntiMisidBasic";
        string filename21="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_AntiMisidBasic";
        string filename22="Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
        string filename23="finaldata";
        string filename24="Data2012and2011_SigReg_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiMisidBasic";
	...
	string namecuttree6 = (filename6+cuttag).c_str();
        ...
        string namecuttree24 = (filename24+cuttag).c_str();

	string cut2 = "Bplus_Corrected_Mass>4000 && Bplus_Corrected_Mass<7000";
	string cutinfile = "corrm greater 4000 less 7000";
	...
	partreco=cutTree((pathname+filename6+ext).c_str(), decaytreename, (namecuttree6+ext).c_str(), cut2);
        ...
        sigregdata=cutTree((pathname+filename24+ext).c_str(), decaytreename, (namecuttree24+ext).c_str(), cut2);
	...
	out<<"partreco  & "<<cutinfile<<" & "<< partreco << " & " << numofpartreco*partreco  << " \\\\ "<<endl;
        ...
        out<<"sigregdata & "<<cutinfile<<" & "<<sigregdata<< " \\\\ "<<endl;
	out<<"\\hline"<<endl;
	...
	out<<"\\end{document}"<<endl;
        ...
        ofstream out2;
        out2.open("numofeventsleftintuplesCorM.tex");
        ...
        out2<<"sigregdata & "<<cutinfile<<" & "<<getmyentries((namecuttree24+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
        out2<<"\\hline"<<endl;
