...
int main(){
	...
	vector<string> tuples2;
        ...
        string pathname = "/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/";
	string pathname2 = "/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/";

	tuples.push_back("Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic");
	tuples.push_back("Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic");
	tuples.push_back("Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic");
	tuples.push_back("Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic_MisidBasic");

	tuples.push_back("Data_B23MuNu_MisidOS_Run1_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_KaonPID_CombBasic_MisidBasic");
	tuples.push_back("Data_B23MuNu_MisidOS_Run1_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_ProtonPID_CombBasic_MisidBasic");
	tuples.push_back("Data_B23MuNu_MisidOS_Run1_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_PionPID_CombBasic_MisidBasic");
	tuples.push_back("Data_B23MuNu_MisidOS_Run1_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_CombBasic_MisidBasic");

	tuples.push_back("Data_B23MuNu_Run1_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic");
	tuples.push_back("Data_B23MuNu_Run1_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic");


	tuples.push_back("Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic");
	tuples.push_back("Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic");


	tuples.push_back("BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic");//not dvv36r1p3
	tuples.push_back("B23SameSignMuonTotal_trigger_mu1nShared_mu2nShared_mu3nShared_CombBasic_MisidBasic");//not dvv36r1p3
	tuples.push_back("Data2012and2011_SigReg_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic");// not dvv36r1p3

	tuples.push_back("Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic_MisidBasic");

	tuples.push_back("MC_B2JpsiK_2011MCTruth_misidstrippingfull_trigger_CombBasic_MisidBasic");
	tuples.push_back("MC_B2JpsiK_2012MCTruth__misidstrippingfull_trigger_CombBasic_MisidBasic");

	tuples.push_back("MC_PartReco_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic_MisidBasic");
	
        tuples.push_back("B23MuNuMCPHSP_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic");//not dvv36r1p3
	tuples.push_back("BuKMuMuMCtotal_misidstrippingfull_trigger_CombBasic_MisidBasic");// not dvv36r1p3
	tuples.push_back("BuKMuMuMC2011total_misidstrippingfull_trigger_CombBasic_MisidBasic"); //not dvv36r1p3
        tuples.push_back("MC_2012_B2PiMuMu_misidstrippingfull_trigger_CombBasic_MisidBasic"); 
...
//        tuples.push_back("B2JpsiKDataDetached2015_v42r1_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic");
        ...
        tuples2.push_back("Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_KaonPID_CombBasic_MisidBasic");
	...
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_287905280_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_287905283_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_287905284_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_287905285_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288495113_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288626185_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288691721_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288757257_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288822793_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288822798_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888329_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888334_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888337_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888338_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	tuples2.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888339_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic");


	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_287905280_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_287905283_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_287905284_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_287905285_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288495113_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288626185_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288691721_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288757257_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288822793_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288822798_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288888329_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288888334_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288888337_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288888338_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
	tuples2.push_back("B2JpsiKMC2016_MCtruth_misidstrippingfull_L0MuonDecisionTOS_288888339_Hlt1TrackMuonDecision_trigger_CombBasic_MisidBasic");
