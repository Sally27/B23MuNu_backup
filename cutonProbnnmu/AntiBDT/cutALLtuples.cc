...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/cutonFitRange/AntiBDT/";

	string filename1="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_AntiMisidBasic_FitCorM";
