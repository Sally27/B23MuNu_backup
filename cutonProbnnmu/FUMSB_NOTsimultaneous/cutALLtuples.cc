...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous/";

	string filename1="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM";
	...
	//string filename3="finaldata_FitCorM_HighFCME";
        string filename4="finaldata_FitCorM";
