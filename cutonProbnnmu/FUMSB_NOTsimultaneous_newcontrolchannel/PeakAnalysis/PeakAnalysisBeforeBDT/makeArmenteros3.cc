...
// tin->SetBranchStatus("Kpi_M",1); 
  ...
  tin->SetBranchAddress("mu3_PX",&e_plus_P[0]);  
  tin->SetBranchAddress("mu3_PY",&e_plus_P[1]);
  tin->SetBranchAddress("mu3_PZ",&e_plus_P[2]);
  tin->SetBranchAddress("mu3_ID",&e_plus_ID);
  ...
  TH2D* AKpi = new TH2D("Amumu","Amumu",100,-1,1,100,0,4000);
  ...
  cv->SaveAs((plotdir+"armenteros_mu2_mu3.pdf").c_str());
  cv->SaveAs("armenteros_mu2_mu3.root");
...
int main() 
{
  ...
  std::string filename = "/vols/lhcb/ss4314/cutonProbnnmu/AntiBDT/PeakAnalysis/PeakAnalysisBeforeBDT/Data2012and2011_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
  std::string treename = "DecayTree";
  std::string plotdir = "/vols/lhcb/ss4314/cutonProbnnmu/AntiBDT/PeakAnalysis/PeakAnalysisBeforeBDT/";
