...
//	string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsMisidFUMSB_Add2015/";
	...
	tuples.push_back("Data2012and2011_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_LowFCME");
	tuples.push_back("Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_LowFCME");
	tuples.push_back("B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_LowFCME");
	tuples.push_back("B2JpsiKDataDetached2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_LowFCME");

        //---------2015--------//
        //
        tuples.push_back("B23MuNuData2015_DV41r2_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_LowFCME");
        tuples.push_back("B2JpsiKDataDetached2015_v42r1_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_LowFCME");

        //---------2016-------//
        tuples.push_back("B23MuNuData2016_corrmFUSMB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_LowFCME");
        tuples.push_back("B23MuNuData2016_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_LowFCME");
        tuples.push_back("B2JpsiK2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_LowFCME");



	tuples.push_back("Data2012and2011_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_HighFCME");
	tuples.push_back("Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_HighFCME");
	tuples.push_back("B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_HighFCME");
	tuples.push_back("B2JpsiKDataDetached2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_HighFCME");

        //---------2015--------//
        //
        tuples.push_back("B23MuNuData2015_DV41r2_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_HighFCME");
        tuples.push_back("B2JpsiKDataDetached2015_v42r1_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_HighFCME");

        //---------2016-------//
	tuples.push_back("B23MuNuData2016_corrmFUSMB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_HighFCME");
	tuples.push_back("B23MuNuData2016_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM_HighFCME");
	tuples.push_back("B2JpsiK2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_HighFCME");
        ...
        tags.push_back("DataLMSBRun1Low");
        tags.push_back("DataUMSBRun1Low");



        tags.push_back("JpsiKDataDetached2011Low");
        tags.push_back("JpsiKDataDetached2012Low");
       
        tags.push_back("DataLMSB2015Low");
        tags.push_back("JpsiKDataDetached2015Low");

        tags.push_back("DataUMSB2016Low");
        tags.push_back("DataLMSB2016Low");
        tags.push_back("JpsiKDataDetached2016Low");



        tags.push_back("DataLMSBRun1High");
        tags.push_back("DataUMSBRun1High");
        tags.push_back("JpsiKDataDetached2011High");
        tags.push_back("JpsiKDataDetached2012High");

        tags.push_back("DataLMSB2015High");
        tags.push_back("JpsiKDataDetached2015High");

        tags.push_back("DataUMSB2016High");
        tags.push_back("DataLMSB2016High");
        tags.push_back("JpsiKDataDetached2016High");
