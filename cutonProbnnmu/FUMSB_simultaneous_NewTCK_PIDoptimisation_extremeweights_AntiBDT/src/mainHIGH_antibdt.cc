...
int main(){
	...
	vector<string> PIDcut2016;
        ...
        string pathname = "/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_AntiBDT/haddtuples/";
	string pathname2 = "/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_AntiBDT/haddtuples/";
...
//	PIDcut.push_back("probnnmupi06");
	...
	for (int g(0); g<PIDcut.size(); g++)
	{
		...
		tuples.push_back(("Data2012and2011_SigReg_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiBDT_FitCorM_"+PIDcut.at(g)).c_str());
...
//	{
//
//		tuples2.push_back(("Data2012and2011_SigReg_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_AntiBDT_FitCorM_"+PIDcut2016.at(g)).c_str());
//
//	}
//
...
//	}
        ...
        ofstream out;
	out.open("EfficienciesHCME_antibdt.tex");
