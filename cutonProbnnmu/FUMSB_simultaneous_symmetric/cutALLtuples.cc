...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/cutonFCME/FUMSB_simultaneous_symmetric/";

	string filename1="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_LowFCME";
        string filename2="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM_HighFCME";
	string filename3="finaldata_FitCorM_HighFCME";
        string filename4="finaldata_FitCorM_LowFCME";
