...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/cutonBDTs/MisidBackTonomu1mu3ETAtighterproton/";
...
//        out<<"mcsigPHSP & "<<cutinfile<<" &  "<< mcsigPHSP << " \\\\ "<<endl;
        ...
        out<<"lowermasssdata & "<<cutinfile<<" &  "<< lowermasssdatafull << " \\\\ "<<endl;
...
//        out2<<"mcsigPHSP  & "<<cutinfile<<" & "<<getmyentries((namecuttree15+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
        ...
        out2<<"lowermasssdata & "<<cutinfile<<" & "<<getmyentries((namecuttree15+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
