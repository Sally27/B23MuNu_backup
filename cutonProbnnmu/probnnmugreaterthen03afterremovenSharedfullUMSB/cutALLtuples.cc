...
//	string filename4="B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic";
	string filename5="Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic";
...
//        string filename14="BuKMuMuMC2011total_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic";
        string filename15="Data2012and2011_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic";
...
//        mcsigPHSP=cutTree((pathname+filename15+ext).c_str(), decaytreename, (namecuttree15+ext).c_str(), cut2);
        ...
        lowermasssdatafull=cutTree((pathname+filename15+ext).c_str(), decaytreename, (namecuttree15+ext).c_str(), cut2);
...
//        out2<<"mcsigPHSP  & "<<cutinfile<<" & "<<getmyentries((namecuttree15+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
        ...
        out2<<"lowermasssdatafull & "<<cutinfile<<" & "<<getmyentries((namecuttree15+ext).c_str(),"DecayTree")<< " \\\\ "<<endl;
