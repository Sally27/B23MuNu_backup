...
int main(int argc, char *argv[]){
	...
	cuts.push_back("");
	cuts.push_back("(mu3_PIDmu > 0.5) && (mu1_PIDmu > 0.5)");
	cuts.push_back("(mu3_PIDmu > 1.0) && (mu1_PIDmu > 1.0)");
	cuts.push_back("(mu3_PIDmu > 1.5) && (mu1_PIDmu > 1.5)");
	cuts.push_back("(mu3_PIDmu > 2.0) && (mu1_PIDmu > 2.0)");
	cuts.push_back("(mu3_PIDmu - mu3_PIDK > 0.5) && (mu1_PIDmu - mu3_PIDK > 0.5)");
	cuts.push_back("(mu3_PIDmu - mu3_PIDK > 1.0) && (mu1_PIDmu - mu3_PIDK > 1.0)");
	cuts.push_back("(mu3_PIDmu - mu3_PIDK > 1.5) && (mu1_PIDmu - mu3_PIDK > 1.5)");
	cuts.push_back("(mu3_PIDmu - mu3_PIDK > 2.0) && (mu1_PIDmu - mu3_PIDK > 2.0)");
	cuts.push_back("(mu3_ProbNNmu - mu3_ProbNNpi > -0.6) && (mu1_ProbNNmu - mu1_ProbNNpi > -0.6)");
	cuts.push_back("(mu3_ProbNNmu - mu3_ProbNNpi > -0.5) && (mu1_ProbNNmu - mu1_ProbNNpi > -0.5)");
	cuts.push_back("(mu3_ProbNNmu - mu3_ProbNNpi > -0.4) && (mu1_ProbNNmu - mu1_ProbNNpi > -0.4)");
	cuts.push_back("(mu3_ProbNNmu > 0.2) && (mu1_ProbNNmu > 0.2)");
	cuts.push_back("(mu3_ProbNNmu > 0.25) && (mu1_ProbNNmu > 0.25)");
	cuts.push_back("(mu3_ProbNNmu > 0.3) && (mu1_ProbNNmu > 0.3)");
	cuts.push_back("(mu3_ProbNNmu > 0.35) && (mu1_ProbNNmu > 0.35)");
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_"+species+"PID_CombBasic_MisidBasic_FitCorM_"+fcme+"FCME").c_str());
        }
...
//		}
	...
	ofstream out;
	out.open(("EfficienciesMisidPID"+species+tuple+fcme+"FCME.tex").c_str());
