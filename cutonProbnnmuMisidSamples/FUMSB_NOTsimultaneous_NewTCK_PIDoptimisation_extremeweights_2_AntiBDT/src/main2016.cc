...
int main(int argc, char *argv[]){
	...
	cuts.push_back("(mu2_ProbNNmu > 0.35) && (mu1_ProbNNmu > 0.35)");
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_"+species+"PID_CombBasic_AntiBDT_FitCorM").c_str());
        }
