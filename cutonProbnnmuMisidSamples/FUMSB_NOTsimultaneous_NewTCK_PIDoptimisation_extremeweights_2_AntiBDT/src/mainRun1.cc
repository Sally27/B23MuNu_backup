...
int main(int argc, char *argv[]){
	...
	cuts.push_back("(mu2_ProbNNmu - mu2_ProbNNpi > -0.6) && (mu1_ProbNNmu - mu1_ProbNNpi > -0.6)");
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_"+species+"PID_CombBasic_AntiBDT_FitCorM").c_str());
        }
