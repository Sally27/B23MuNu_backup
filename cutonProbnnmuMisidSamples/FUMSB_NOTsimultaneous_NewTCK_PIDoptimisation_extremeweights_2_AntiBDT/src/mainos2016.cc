...
int main(int argc, char *argv[]){
	...
	cuts.push_back("(mu3_ProbNNmu > 0.35) && (mu1_ProbNNmu > 0.35)");
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_"+species+"PID_CombBasic_AntiBDT_FitCorM").c_str());
        }
