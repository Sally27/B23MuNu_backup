...
int main(int argc, char *argv[]){
	...
	cuts.push_back("(mu3_ProbNNmu - mu3_ProbNNpi > -0.6) && (mu1_ProbNNmu - mu1_ProbNNpi > -0.6)");
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_"+species+"PID_CombBasic_AntiBDT_FitCorM").c_str());
        }
