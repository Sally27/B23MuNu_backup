...
int main(int argc, char *argv[]){
	...
	cuts.push_back("(mu3_ProbNNmu > 0.35) && (mu1_ProbNNmu > 0.35)");
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_"+species+"PID_CombBasic_MisidBasic_FitCorM").c_str());
        }
...
//		}
	...
	ofstream out;
	out.open(("EfficienciesMisidPID"+species+tuple+"NOFCME.tex").c_str());
