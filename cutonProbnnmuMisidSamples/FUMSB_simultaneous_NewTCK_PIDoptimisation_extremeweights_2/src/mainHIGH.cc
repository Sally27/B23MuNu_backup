...
//tuples
        string pathname = "../tuples_nonsim/";
	string pathname2 = "../tuples_nonsim/";
...
//	PIDcut.push_back("probnnmupi06");
	...
	for (int g(0); g<PIDcut.size(); g++)
	{
                ...
                string ok=PIDcut.at(g);
		tuples.push_back(("modifiedandcut"+ok+"Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic_FitCorM_"+ok).c_str());
		tuples.push_back(("modifiedandcut"+ok+"Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic_FitCorM_"+ok).c_str());
		tuples.push_back(("modifiedandcut"+ok+"Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic_FitCorM_"+ok).c_str());
		tuples.push_back(("modifiedandcut"+ok+"Data_B23MuNu_MisidOS_Run1_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_KaonPID_CombBasic_MisidBasic_FitCorM_"+ok).c_str());
		tuples.push_back(("modifiedandcut"+ok+"Data_B23MuNu_MisidOS_Run1_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_PionPID_CombBasic_MisidBasic_FitCorM_"+ok).c_str());
		tuples.push_back(("modifiedandcut"+ok+"Data_B23MuNu_MisidOS_Run1_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_ProtonPID_CombBasic_MisidBasic_FitCorM_"+ok).c_str());
                tags.push_back(ok);
                tags.push_back(ok);
                tags.push_back(ok);
                tags.push_back(ok);
...
//	PIDcut2016.push_back("BasicCut");
	...
	for (int g(0); g<PIDcut2016.size(); g++)
	{
		...
		string pid2=PIDcut2016.at(g);
		tuples2.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_KaonPID_CombBasic_MisidBasic_FitCorM_"+pid2).c_str());
		tuples2.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_PionPID_CombBasic_MisidBasic_FitCorM_"+pid2).c_str());
		tuples2.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_ProtonPID_CombBasic_MisidBasic_FitCorM_"+pid2).c_str());
		tuples2.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_OSmisid_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_KaonPID_CombBasic_MisidBasic_FitCorM_"+pid2).c_str());
		tuples2.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_OSmisid_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_PionPID_CombBasic_MisidBasic_FitCorM_"+pid2).c_str());
		tuples2.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_OSmisid_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_ProtonPID_CombBasic_MisidBasic_FitCorM_"+pid2).c_str());
                tags2.push_back(pid2);
                tags2.push_back(pid2);
                tags2.push_back(pid2);
                tags2.push_back(pid2);
                tags2.push_back(pid2);
