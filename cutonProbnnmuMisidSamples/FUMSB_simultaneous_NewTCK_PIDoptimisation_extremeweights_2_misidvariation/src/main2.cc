...
int main(int argc, char *argv[]){
   ...
   //     string fcme=argv[4];
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_"+species+"PID_CombBasic_MisidBasic_FitCorM").c_str());
        }
