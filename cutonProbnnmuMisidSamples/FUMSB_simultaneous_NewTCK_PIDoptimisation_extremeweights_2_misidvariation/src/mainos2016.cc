...
int main(int argc, char *argv[]){
	...
	cuts.push_back("(mu3_ProbNNmu > 0.1) && (mu1_ProbNNmu > 0.1)");
	cuts.push_back("(mu3_ProbNNmu > 0.15) && (mu1_ProbNNmu > 0.15)");
...
//        string beg="modifiedandcut";  
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_"+species+"PID_CombBasic_MisidBasic_FitCorM").c_str());
        }
