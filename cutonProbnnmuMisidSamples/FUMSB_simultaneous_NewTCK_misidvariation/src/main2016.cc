...
int main(int argc, char *argv[]){
	...
	cuts.push_back("");
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_"+species+"PID_CombBasic_MisidBasic_FitCorM_"+fcme+"FCME").c_str());
        }
