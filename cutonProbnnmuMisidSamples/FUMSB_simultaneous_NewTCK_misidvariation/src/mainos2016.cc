...
int main(int argc, char *argv[]){
	...
	cuts.push_back("");
        ...
        {
                tuplesnamekaonhigh.push_back((beg+tags.at(i)+tuple+"_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_"+species+"PID_CombBasic_MisidBasic_FitCorM_"+fcme+"FCME").c_str());
        }
