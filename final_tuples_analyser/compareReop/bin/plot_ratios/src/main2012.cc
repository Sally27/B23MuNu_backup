...
int main()
{
	...
	vector<string> tuples4;
        ...
        tuples1.push_back("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/MCSigpreparetupleNewL0/bin/B23MuMC2012L0data_MCtruth_L0MuonDecisionTOS_trigger_Jpsi");
        tuples1.push_back("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/LowerMassSideBandFullDatapreparetuple/bin/Data2012and2011_corrmLSDfull_trigger_Jpsi");
        tuples1.push_back("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/FullUpperMassSideBand/bin/Data2012and2011_corrmFUMSB_trigger_Jpsi");

        tuples4.push_back("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/JpsiKMCDetachedLine/2012/bin/JpsiKMCDetachedLine_2012_misidstrippingfull_trigger");
        tuples4.push_back("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/JpsiKDataDetachedLine/2012/bin/B2JpsiKDataDetached2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger");


        tuples3.push_back("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/OSMisIDRestrippingpreparetuple/bin/B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger");

        tuples2.push_back("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/SSMisIDRestrippingpreparetuple/bin/B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi");
	...
	for(int j(0); j<tuples1.size(); j++){
		...
		for(int i(0); i<cuts1.size(); i++)
		{
			...
			cout<<"OK filename "<<(tags1.at(j)+tagcut.at(i)+ext)<<endl;
                        plotvariableratio("SCALED", (tags1.at(j)+tagcut.at(i)).c_str(), filename1, ("/vols/lhcb/ss4314/final_tuples_analyser/compareReop/bin/"+(tags1.at(j)+tagcut.at(i)+ext)).c_str(), tags1.at(j), tagcut.at(i).c_str(), "Bplus_Corrected_Mass", 2500, 10000, "Corrected Mass [MeV]");
                       filenames.push_back(("/vols/lhcb/ss4314/final_tuples_analyser/compareReop/bin/"+(tags1.at(j)+tagcut.at(i)+ext)).c_str());
	...
	for(int j(0); j<tuples2.size(); j++){
		...
		for(int i(0); i<cuts2.size(); i++)
		{
			...
			cout<<"OK filename "<<(tags2.at(j)+tagcut.at(i)+ext)<<endl;
                        plotvariableratio("SCALED", (tags2.at(j)+tagcut.at(i)).c_str(), filename1, ("/vols/lhcb/ss4314/final_tuples_analyser/compareReop/bin/"+(tags2.at(j)+tagcut.at(i)+ext)).c_str(), tags2.at(j), tagcut.at(i).c_str(), "Bplus_Corrected_Mass", 2500, 10000, "Corrected Mass [MeV]");
                       
                       filenames2.push_back(("/vols/lhcb/ss4314/final_tuples_analyser/compareReop/bin/"+(tags2.at(j)+tagcut.at(i)+ext)).c_str());
	...
	for(int j(0); j<tuples3.size(); j++){
		...
		for(int i(0); i<cuts3.size(); i++)
		{
			...
			plotvariableratio("SCALED", (tags3.at(j)+tagcut.at(i)).c_str(), filename1, ("/vols/lhcb/ss4314/final_tuples_analyser/compareReop/bin/"+(tags3.at(j)+tagcut.at(i)+ext)).c_str(), tags3.at(j), tagcut.at(i).c_str(), "Bplus_Corrected_Mass", 2500, 10000, "Corrected Mass [MeV]");

			filenames3.push_back(("/vols/lhcb/ss4314/final_tuples_analyser/compareReop/bin/"+(tags3.at(j)+tagcut.at(i)+ext)).c_str());
		...
		for(int i(0); i<cuts4.size(); i++)
		{
			...
			cout<<"OK filename "<<(tags4.at(j)+tagcut.at(i)+ext)<<endl;
                        plotvariableratio("SCALED", (tags4.at(j)+tagcut.at(i)).c_str(), filename1, ("/vols/lhcb/ss4314/final_tuples_analyser/compareReop/bin/"+(tags4.at(j)+tagcut.at(i)+ext)).c_str(), tags4.at(j), tagcut.at(i).c_str(), "Bplus_Corrected_Mass", 2500, 10000, "Corrected Mass [MeV]");
                        
                       filenames4.push_back(("/vols/lhcb/ss4314/final_tuples_analyser/compareReop/bin/"+(tags4.at(j)+tagcut.at(i)+ext)).c_str());
