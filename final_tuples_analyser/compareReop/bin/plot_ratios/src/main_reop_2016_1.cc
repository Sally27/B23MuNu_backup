...
int main()
{
	...
	tags1.push_back("dataCOMBI2016");
        ...
        cuts1.push_back("mu1_MuonNShared==0 && mu2_MuonNShared==0 && mu3_MuonNShared==0");
        cuts1.push_back("minq2 < 960400");

       
        vector<string> cuts2;
 
        cuts2.push_back("mu1_MuonNShared==0 && mu2_MuonNShared==0");
        ...
        cuts3.push_back("mu1_MuonNShared==0 && mu3_MuonNShared==0");
        cuts3.push_back("minq2 < 960400");

        vector<string> cuts4;
        
        
        cuts4.push_back("mu1_MuonNShared==0 && mu2_MuonNShared==0");
        cuts4.push_back("");

        vector<string> tagcut;
        tagcut.push_back("opt_1_nShared0");
        tagcut.push_back("opt_1_minq2");
