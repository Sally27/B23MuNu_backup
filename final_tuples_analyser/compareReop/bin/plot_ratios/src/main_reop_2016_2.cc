...
int main()
{
	...
	tags1.push_back("dataCOMBI2016");
        ...
        cuts1.push_back("mu1_MuonNShared < 2 && mu2_MuonNShared==0 && mu3_MuonNShared < 2");
        ...
        cuts2.push_back("mu1_MuonNShared < 2 && mu2_MuonNShared==0");
        ...
        cuts4.push_back("mu1_MuonNShared < 2 && mu2_MuonNShared==0");
        cuts4.push_back("");

        vector<string> tagcut;
        tagcut.push_back("opt_2_isMuonTight");
        tagcut.push_back("opt_2_nSharedCombi");
        tagcut.push_back("opt_2_minq2");
