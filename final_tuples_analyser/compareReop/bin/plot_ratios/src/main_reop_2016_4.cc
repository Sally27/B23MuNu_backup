...
int main()
{
	...
	tags1.push_back("dataCOMBI2016");
        ...
        cuts1.push_back("invmu1andmu3>216");
        cuts1.push_back("mu1_isMuonTight == 1.0 && mu2_isMuonTight == 1.0 && mu3_isMuonTight == 1.0");
        cuts1.push_back("mu1_MuonNShared < 2 && mu2_MuonNShared < 2 && mu3_MuonNShared < 2");
        cuts1.push_back("minq2 < 960400");

       
        vector<string> cuts2;
 
        cuts2.push_back("invmu1andmu3>216");
        ...
        cuts3.push_back("invmu1andmu3>216");
        cuts3.push_back("mu1_isMuonTight == 1.0 && mu3_isMuonTight == 1.0");
        cuts3.push_back("mu1_MuonNShared < 2 && mu3_MuonNShared < 2");
        ...
        tagcut.push_back("opt_4_clone");
        tagcut.push_back("opt_4_isMuonTight");
        tagcut.push_back("opt_4_nShared2");
        tagcut.push_back("opt_4_minq2");
