...
int main(int argc, char *argv[]){
	...
	tags1.push_back("dataCOMBI2016");
        ...
        tagcut.push_back("isMuonTight");
        tagcut.push_back("nShared2");
        tagcut.push_back("minq2");
	...
	ofstream out3;
	out3.open("EfficienciesPlay.tex");
...
//	out3<<"\\begin{tabular}{| l | l | l | }"<<endl;
	...
	out3<<"\\caption{maybedoastruct.txt}"<<endl;
	out3<<"\\end{table}"<<endl;
