...
int main(int argc, char *argv[]){
	...
	tags1.push_back("dataCOMBI2016");
        ...
        tagcut.push_back("opt_5_isMuonTight");
        tagcut.push_back("opt_5_minq2");
	...
	ofstream out2;
	out2.open("Efficiencies_2016_ALL_opt_5.tex");
	...
	ofstream out3;
	out3.open("EfficienciesPlay_2016_allcuts_opt_5.tex");
...
//	out3<<"\\begin{tabular}{| l | l | l | }"<<endl;
	...
	for(int z(0); z<maps.size(); z++){
		if ((maps.at(z)).cut=="opt_5_isMuonTight"){
			out3<<"Sample & ";
