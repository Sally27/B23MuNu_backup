...
int main(){
	...
	out<<"\\hline"<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/final_tuples/data/B2jpsik_data/Run1/";
	string filename = "Data_B2JpsiK_2011";
...
//	addcostheta(filename2, "DecayTree", filename2);
	...
	vals.push_back("Bplus_Corrected_Mass > 2500 && Bplus_Corrected_Mass < 10000");
        ...
        TFile *fillinfo = new TFile("Efficiencies_2011.root","RECREATE");
        TTree *fillinfotree = new TTree("Data_Norm_2011","Data_Norm_2011");

       //FillEffInfo(fillinfotree, varia.at(0),0.1,false); 
       //FillEffInfo(fillinfotree, varia.at(1),0.2,true);
        //       FillEffInfo(fillinfotree, varia.at(2),0.3,true);
...
//	vals.push_back("minq2 < 960400");
	...
	string filename3="Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc";
	...
	string filename4="Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS";
	...
	//
        ...
        {
        double eff;
        eff=cutTree("B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut.root", "DecayTree", "B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID.root", "(mu3_PIDK > 0) && (mu3_PIDp - mu3_PIDK < 5)");
        out<<"(mu3_PIDK > 0) && (mu3_PIDp - mu3_PIDK < 5) & "<<eff<<" \\\\ "<<endl;
        addKFoldandW("B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID", "DecayTree", "B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID");
        }
