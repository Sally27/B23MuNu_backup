...
int main(){
	...
	ofstream out;
	out.open("EfficienciesRecalibrateIT.tex");
	...
	out<<"\\hline"<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/final_tuples/data/B2jpsik_data/2016/";
	string filename = "Bu23JpsiKData2016";
...
//	addcostheta(filename2, "DecayTree", filename2);
        ...
        //need to recalibrate first

        mimiqueL0effMC("Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc", "DecayTree", "myattempt_later");
        mimiqueHLT1effMC("myattempt_later", "DecayTree", "myattemptHLT1_later");
	...
	vals.push_back("mu3_isMuon == 0.0 && mu3_InAccMuon == 1.0");
	...
	string filename3="Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc";
	...
	string filename4="Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS";
	...
	//	filename3=(filename3+"_"+varia.at(i)).c_str();
        ...
        {
        double eff;
        eff=cutTree("B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1MuonNShared_mu2MuonNShared_qmincut.root", "DecayTree", "B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1MuonNShared_mu2MuonNShared_qmincut_KaonPID.root", "(mu3_PIDK > 0) && (mu3_PIDp - mu3_PIDK < 5)");
        out<<"(mu3_PIDK > 0) && (mu3_PIDp - mu3_PIDK < 5) & "<<eff<<" \\\\ "<<endl;
        addKFoldandW("B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1MuonNShared_mu2MuonNShared_qmincut_KaonPID", "DecayTree", "B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1MuonNShared_mu2MuonNShared_qmincut_KaonPID");
        }
	...
	//        string namecuttree2 = (filename+cuttag).c_str();
	//        string cut2 = "mu3_isMuon == 0.0 && mu3_InAccMuon == 1.0";
	//        double notmuoneff;
	...
	//	string ext3 = ".root";
	//	string cuttag3 = "_mu1MuonNShared_mu2MuonNShared";
	//	string namecuttree23 = (filename3+"_cut"+cuttag3).c_str();
	//	string cut23 = "mu1_MuonNShared == 0.0 && mu2_MuonNShared == 0.0";
	//
	//	double MuonNSharedeff;
	//	MuonNSharedeff=cutTree((filename3+ext3).c_str(), decaytreename3, (namecuttree23+ext3).c_str(), cut23);
	//      
	//        cout<<"NShared eff: "<<MuonNSharedeff<<endl;
	//        out <<"Nshared eff &" << MuonNSharedeff << " \\\\ "<<endl;
	//
	//       
	//
