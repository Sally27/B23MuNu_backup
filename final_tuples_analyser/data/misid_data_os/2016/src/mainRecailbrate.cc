...
int main(){
        ...
        ofstream out;
        out.open("EfficienciesRecalibrate.tex");
	...
	out<<"\\begin{document}"<<endl;
        ...
        string pathname = "/vols/lhcb/ss4314/final_tuples/data/misid_data_os/2016/";
        string filename = "Bu23MuNuData2016_OSmisid";
	...
	string filename2 = (filename+cuttag).c_str();
      ...
      //  addcostheta(filename2, "DecayTree", filename2);  
        ...
        varia.push_back("mu1isMuonTight_mu3isMuonTight");
        varia.push_back("mu1MuonNShared_mu3MuonNShared");
        varia.push_back("qmincut"); 

        vector<string> vals;
        vals.push_back("mu2_isMuon == 0.0 && mu2_InAccMuon == 1.0");
        ...
        vals.push_back("mu1_isMuonTight == 1.0 && mu3_isMuonTight == 1.0");
        vals.push_back("mu1_MuonNShared < 2 && mu3_MuonNShared < 2");
...
//        filename2=(filename2+"_Jpsi").c_str();
	...
	idenkaon=cutTree((filenamekaon+ext).c_str(), "DecayTree", (namecuttreekaon+ext).c_str(), cutkaon);
        ...
        string cutprot = "(mu2_PIDp > 5) && (mu2_PIDp - mu2_PIDK > 5)";
	...
	string filename3=(filenameclean+"_mu2isNotMuon_mu2inMuonAcc").c_str();
	...
	string filename4=(filenameclean+"_mu2isNotMuon_mu2inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS").c_str();        
