...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        string pathname = "/vols/lhcb/ss4314/final_tuples/data/misid_data_ss/Run1/";
        string filename = "Data_B23MuNu_MisidSS_Run1";
