...
int main(){
        ...
        ofstream out;
        out.open("EfficienciesRecalibrate_Dec.tex");
...
//        return(1);
        ...
        vector<string> varia;
        varia.push_back("corrmFUSMB");
        varia.push_back("triggerDec");
        ...
        vals.push_back("(Bplus_L0MuonDecision_Dec==1.0) && (Bplus_Hlt1TrackMuonDecision_TOS==1.0) && ((Bplus_Hlt2TopoMu2BodyDecision_TOS==1.0) || (Bplus_Hlt2TopoMu3BodyDecision_TOS==1.0) || (Bplus_Hlt2DiMuonDetachedDecision_TOS==1.0) || (Bplus_Hlt2DiMuonDetachedHeavyDecision_TOS==1.0))");
...
//        vals.push_back("mu1_MuonNShared == 0.0 && mu2_MuonNShared == 0.0 && mu3_MuonNShared == 0.0");
	...
	addKFoldandW(filename2, "DecayTree", filename2);
        ...
        vals.push_back("Bplus_L0MuonDecision_Dec==1.0");
        ...
        varia.push_back("L0MuonDecisionDec");
        ...
        string filename4=(filenameclean+"_corrmFUSMB_L0MuonDecisionDec_Hlt1TrackMuonDecisionTOS").c_str();
