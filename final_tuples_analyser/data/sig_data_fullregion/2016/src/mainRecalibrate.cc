...
//        emulatetrigger(filename2+"_sigregion", "DecayTree", (filename2+"_sigregion_emulated").c_str());
//        return(1);

        vector<string> varia;
        varia.push_back("sigregion");
        ...
        vector<string> vals;
        vals.push_back(" Bplus_Corrected_Mass > 4500 && Bplus_Corrected_Mass < 5500");
...
//        vals.push_back("mu1_MuonNShared == 0.0 && mu2_MuonNShared == 0.0 && mu3_MuonNShared == 0.0");
	...
	addKFoldandW(filename2, "DecayTree", filename2);
        ...
        string filename3=(filenameclean+"_sigregion").c_str();
        ...
        string filename4=(filenameclean+"_sigregion_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS").c_str();
