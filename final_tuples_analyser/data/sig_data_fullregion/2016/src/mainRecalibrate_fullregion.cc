...
int main(){
        ...
        ofstream out;
        out.open("EfficienciesRecalibrate_fullregion.tex");
...
//        emulatetrigger(filename2+"_fullregion", "DecayTree", (filename2+"_fullregion_emulated").c_str());
//        return(1);

        vector<string> varia;
        varia.push_back("fullregion");
...
//        vals.push_back("mu1_MuonNShared == 0.0 && mu2_MuonNShared == 0.0 && mu3_MuonNShared == 0.0");
	...
	addKFoldandW(filename2, "DecayTree", filename2);
        ...
        string filename3=(filenameclean+"_fullregion").c_str();
        ...
        string filename4=(filenameclean+"_fullregion_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS").c_str();
