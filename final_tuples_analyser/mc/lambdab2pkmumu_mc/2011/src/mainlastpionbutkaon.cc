...
int main(){
	...
	out<<"or strip and reco & 0.144209 & 1277956(8861780) & TBD  \\\\ "<<endl;
        ...
        string pathname = "/vols/lhcb/ss4314/tuplesallvar/Lambdab2jpsikproton/2012/Sim08abi/";
        string filename = "LambdaB2jpsiK2012MC";
...
//	vector<string> vals;
 ...
 //       vector<double> errors;
	...
	varia.push_back("trigger");
        ...
        //varia.push_back("PIDcuts");
        
        varia.push_back("PIDPiforK");  
        varia.push_back("JpsiKveto");
        varia.push_back("tightMuon");
//        varia.push_back("tightKaon");
        varia.push_back("tightPionforK"); 
...
//        varia.push_back("PIDPi");
 ...
 //  //        varia.push_back("PIDisnotmuon");
  // 
        varia.push_back("muonptcut");  
//   //        varia.push_back("PIDpip");
 //  //        varia.push_back("PIDpiisnotmuon");
  // 
  // 
   	vector<string> vals;
	...
	vals.push_back("B0_DIRA_OWNPV > 0.99996 && B0_ENDVERTEX_CHI2 < 7 && mu1_ghost < 0.35 && mu2_ghost < 0.35 && K_ghost < 0.35 && Pi_ghost < 0.35 && mu1_TRACK_CHI2 < 3.0 && mu2_TRACK_CHI2 < 3.0 && K_TRACK_CHI2 < 3.0 && Pi_TRACK_CHI2 < 3.0 && mu1_MINIPCHI2 > 9.0 && mu2_MINIPCHI2 > 9.0 && K_MINIPCHI2 > 9.0 && Pi_MINIPCHI2 > 9.0 ");
      ...
      //  vals.push_back("Pi_PIDK < 0 && Pi_PIDp < 0 && Pi_isMuon==0.0 && ((K_PIDp-K_PIDK) < 0) && K_PIDK > 0 && K_isMuon==0.0");
        vals.push_back("K_PIDp < 0 && K_PIDK < 0 && K_isMuon==0.0");        
...
//        vals.push_back("(K_ProbNNk*(1-K_ProbNNp))>0.05");
        vals.push_back("((K_ProbNNpi)*(1-K_ProbNNk)*(1-K_ProbNNp))>0.1");
...
//        vals.push_back("Pi_PIDp < 0 && Pi_PIDK < 0 && Pi_isMuon==0.0");
  //      vals.push_back("mu1_ProbNNmu>0.5 && mu2_ProbNNmu>0.5");
        ...
        vals.push_back("mu1_PT>800 && mu2_PT>800");
