...
double mctruth(string filename, string decaytreename, string newfilename)
{
  ...
  t->SetBranchAddress("Bplus_BKGCAT", &Bplus_BKGCAT);
   ...
   TFile *filefort3 = new TFile((newfilename+"_NOTMCtruth_"+ext).c_str(), "RECREATE");
   TTree *t3 = t->CloneTree(0);


 
   Double_t invmassmu2nu, invmassmu3mu1, invmassmu3mu2, invmassmu1mu2;
   Int_t count,count2;
   TLorentzVector nu, mu2nu, mu3mu1, mu3mu2, mu1mu2, newmu3mu1;
   t2->Branch("invmassmu3mu1",&invmassmu3mu1,"invmassmu3mu1/D");
   t2->Branch("invmassmu1mu2",&invmassmu1mu2,"invmassmu1mu2/D");
   t2->Branch("invmassmu3mu2",&invmassmu3mu2,"invmassmu3mu2/D");
   t2->Branch("invmassmu2nu",&invmassmu2nu,"invmassmu2nu/D");
   ...
   for(int i(0); i<t->GetEntries(); ++i)
   {
      ...
      if ((((abs(mu3_TRUEID)==13) && (abs(mu1_TRUEID)==211) && (abs(mu2_TRUEID)==211)) && (abs(Bplus_TRUEID)==521))&&(((mu3_MC_MOTHER_ID==521) && (mu1_MC_MOTHER_ID==-421) && (mu2_MC_MOTHER_ID==-421))||((mu3_MC_MOTHER_ID==-521) && (mu1_MC_MOTHER_ID==421) && (mu2_MC_MOTHER_ID==421))))
//       if (((mu3_MC_MOTHER_ID==521) && (mu1_MC_MOTHER_ID!=310) && (mu2_MC_MOTHER_ID!=310) )||((mu3_MC_MOTHER_ID==-521) && (mu1_MC_MOTHER_ID!=310) && (mu2_MC_MOTHER_ID!=310)))
        {
     ...
     cout<<"NOT MC TRUTH MATCH where does it come from ? : mu_id: "<<mu3_TRUEID<<" "<<" mu1_id: "<<mu1_TRUEID<<" "<<" mu2_id: "<<mu2_TRUEID<<" "<<" Bplus: "<<Bplus_TRUEID<<" "<<" mu_motherid: "<<" "<<mu3_MC_MOTHER_ID<<" "<<" mu1_motherid: "<<mu1_MC_MOTHER_ID<<" "<<" mu2_motherid: "<<mu2_MC_MOTHER_ID<<" "<<" mu_gdmtid: "<<mu3_MC_GD_MOTHER_ID<<" "<<" mu1_gdmtid: "<<" "<<mu1_MC_GD_MOTHER_ID<<" mu2_gdmtid: "<<" "<<mu2_MC_GD_MOTHER_ID<<endl;
