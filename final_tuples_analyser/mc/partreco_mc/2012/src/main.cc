...
//        FillEffInfo(fillinfotree, "strip",double( double(getmyentries("/vols/lhcb/ss4314/final_tuples/mc/partreco_mc/2012/MC_PartReco.root","DecayTree"))/double(numberofevents)),true);
