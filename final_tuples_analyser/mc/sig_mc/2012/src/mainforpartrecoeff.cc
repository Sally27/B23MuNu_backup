...
int main(){
        ...
        ofstream out;
        out.open("EfficienciesforPartReco.tex");
	...
	string filename = "Bu23MuNuMC2012";
        ...
        FillEffInfo(fillinfotree, "numbkk",double(1114130),true);
        FillEffInfo(fillinfotree, "strip",double( double(getmyentries("/vols/lhcb/ss4314/final_tuples/mc/sig_mc/2012/Bu23MuNuMC2012.root","B23MuNu_Tuple/DecayTree"))/double(1114130)),true);
        FillEffInfo(fillinfotree, "mctruth",mctrutheff,true);
//        FillEffInfo(fillinfotree, "reco",double( double(getmyentries((filename2+ext).c_str(),"DecayTree"))/double(1114130)),true);
