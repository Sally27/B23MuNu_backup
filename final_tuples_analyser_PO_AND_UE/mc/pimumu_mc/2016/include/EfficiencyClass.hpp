...
{ 
   ...
   EfficiencyClass()
   :gen_eff(0.1977,0.0004),
    numbkk(2000118),
    numgen(25000),

    pathname("/vols/lhcb/ss4314/final_tuples/mc/mumupi_mc/2016/"),
    filename("MC_B2PiMuMu_2016"), 
    decaytreename("B23MuNu_Tuple/DecayTree"),
    extension(".root"),
    qmin_genlevel("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel/rungeneratorlevel/2016/pythia8/calculate_minq2eff/bin/MC_2016_nocuts_PYTHIA8_qmincut.root"),
    qmin_inacc_genlevel("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel/rungeneratorlevel/2016/pythia8/calculate_minq2eff/bin/MC_2016_nocuts_PYTHIA8_qmincut_inacc.root")
    {}
