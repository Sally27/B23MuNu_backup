...
int main(){
	...
	vector<string> tuples;
        ...
        string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATAMisid2016_ONLY_PiMuMu/";
//	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/";
        string pathname2 = "/vols/lhcb/ss4314/final_tuples_analyser_PO_AND_UE/mc/pimumu_mc/2016_applyfurthercuts/bin/";
	...
	tuples.push_back("MC_B2PiMuMu_2016_L0MuonDecisionTOS_trigger_Jpsi");
	tuples.push_back("MC_B2PiMuMu_2016_L0MuonDecisionTOS_trigger_Jpsi_CombBasic");
	tuples.push_back("MC_B2PiMuMu_2016_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic");
	...
	TFile *fillinfos = new TFile("../efficiencytuples_sig/Efficiencies_SigMC_2016_Combi.root","RECREATE");
