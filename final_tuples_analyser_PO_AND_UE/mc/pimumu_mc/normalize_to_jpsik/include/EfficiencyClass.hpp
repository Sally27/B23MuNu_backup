...
{ 
   ...
   EfficiencyClass()
   :branching_frac_PR_1(1.0),//pdg dlnu
    branching_frac_NORM_1(1.026e-3), //BtoJpsi

    branching_frac_PR_1_err(0.0),
    branching_frac_NORM_1_err(0.031e-3),


    branching_frac_PR_2(1.79e-8),//addstatandsyst(0.12e-6, 0.40e-6)),//d-kpimumu rho omega region
    branching_frac_NORM_2(5.961e-2), //jspi2mumu

    branching_frac_PR_2_err(0.23e-8),
    branching_frac_NORM_2_err(0.033e-2),

    gen_eff_PR(double(returnEff("/vols/lhcb/ss4314/final_tuples_analyser_PO_AND_UE/mc/pimumu_mc/normalize_to_jpsik/tuples/Efficiencies_2012_PIMUMU.root", "MC_Sig_2012", "effgen"))),
    gen_eff_PR_err(double(returnEff("/vols/lhcb/ss4314/final_tuples_analyser_PO_AND_UE/mc/pimumu_mc/normalize_to_jpsik/tuples/Efficiencies_2012_PIMUMU.root", "MC_Sig_2012", "effgen_err"))),
    ...
    number_obs_NOFCME(double(returnEff("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/NOFCME/FitResults/FitControl_Run1_probnnmu035.root", "FitControl_Run1", "NumNormObs"))),
    number_obs_NOFCME_err(double(returnEff("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/NOFCME/FitResults/FitControl_Run1_probnnmu035.root", "FitControl_Run1", "NumNormObs_Err"))),
    ...
    number_obs_NOFCME_2016(double(returnEff("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/NOFCME/FitResults/FitControl_2016_probmu35.root", "FitControl_2016", "NumNormObs"))),
    number_obs_NOFCME_err_2016(double(returnEff("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/NOFCME/FitResults/FitControl_2016_probmu35.root", "FitControl_2016", "NumNormObs_Err"))),
    ...
    pr_no("/vols/lhcb/ss4314/final_tuples_analyser_PO_AND_UE/mc/pimumu_mc/2012_applyfurthercuts/bin/MC_B2PiMuMu_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM.root"),
    ...
    norm_no("/vols/lhcb/ss4314/cutonFCME/FUMSB_simultaneous_NewTCK/bin/MC_B2JpsiK_2012MCTruth__misidstrippingfull_trigger_CombBasic_MisidBasic_FitCorM.root")
    {}
