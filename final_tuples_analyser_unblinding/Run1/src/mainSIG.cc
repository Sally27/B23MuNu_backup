...
int main(){
	...
	for (int p(0); p<iteration.size();p++)
	{
		...
		tuples.push_back(("Data_B23MuNu_Run1_"+iteration.at(p)+"_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut").c_str());
		tuples.push_back(("Data_B23MuNu_Run1_"+iteration.at(p)+"_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic").c_str());
		tuples.push_back(("Data_B23MuNu_Run1_"+iteration.at(p)+"_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic").c_str());
		tuples.push_back(("Data_B23MuNu_Run1_"+iteration.at(p)+"_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_FitCorM").c_str());
