...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/NOFCME/workspace/"),
...
//   tuplename("JpsiKdata_NOFCME_Probnnmu3.root"), 
   ...
   mcsavedir("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/NOFCME/mcsavedir/"),
   pimumudir("/vols/lhcb/ss4314/preparejpsipiweights/preparejpsipiweights_FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/bin/") 
//   mcfilename("JpsiKMC2012NNmumore03")
   ...
   void plotprettyhypathia3_plotnicely_paper_sigsim_drive(string dataset, string pathtoworkspace, string type);

   void plotprettyhypathia3_plotnicely_paper_pimumusim_drive(string dataset, string pathtoworkspace, string type);
