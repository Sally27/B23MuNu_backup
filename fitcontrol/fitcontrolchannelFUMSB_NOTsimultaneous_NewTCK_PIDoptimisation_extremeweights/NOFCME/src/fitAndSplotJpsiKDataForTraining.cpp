...
void FitAndSplotJpsiKDataForTraining::plotprettyhypathia3_plotnicely_paper_pimumusim_drive(string dataset, string pathtoworkspace, string type)
{
...
//	TFile wrkspc8((plotdir+"myworkspace_"+namews8+"_"+type+".root").c_str()); 
   ...
   cout<<"Plotting result of the fit"<<endl;
   TFile fw((pathtoworkspace+"myworkspaceWEIGHT_"+namews8+"_"+type+".root").c_str());
   ...
   RooAbsPdf* model_total = workspaceFit->pdf(("piblah_"+type).c_str());
...
//   model_total->plotOn(frame, RooFit::Components("cb1"), RooFit::Name("signal"),RooFit::LineStyle(kDashed), RooFit::LineColor(kBlack));
   ...
   TLegend *leg = new TLegend(0.2,0.64,0.55,0.72);
   leg->AddEntry(frame->findObject("tot"),"B^{+} #rightarrow (J/#psi #rightarrow #mu^{+} #mu^{-}) #pi^{+}","l");
...
//   lhcbSally();
 ...
 //  printLHCb();
   ...
   canvTot.Print((pathtoworkspace+"SimPiMuMu_HypatiaplotJpsiKFitPretty_veryniceplot_paper"+dataset+".pdf").c_str());
   canvTot.Print((pathtoworkspace+"SimPiMuMu_HypatiaplotJpsiKFitPretty_veryniceplot_paper"+dataset+".root").c_str());

   canv.Print((pathtoworkspace+"SimPiMuMu_HypatiaplotJpsiKFitPretty_nopull_veryniceplot_paper"+dataset+".pdf").c_str());
   canv.Print((pathtoworkspace+"SimPiMuMu_HypatiaplotJpsiKFitPretty_nopull_veryniceplot_paper"+dataset+".root").c_str());

   gPad->SetLeftMargin(0.17);
   frame->GetYaxis()->SetTitleOffset(1.0);
   frame->SetMaximum(100000.0);
   canv.SetLogy();
//   canvTot.cd(1);
//   canv.DrawClonePad();
//   frame->SetMaximum(200000.0);
   ...
   canv.Print((pathtoworkspace+"SimPiMuMu_HypatiaplotJpsiKFitLogyPretty_veryniceplot_nopull_paper"+dataset+".pdf").c_str());
   canv.Print((pathtoworkspace+"SimPiMuMu_HypatiaplotJpsiKFitLogyPretty_veryniceplot_nopull_paper"+dataset+".root").c_str());
...
//   canvTot.Update();
   ...
   canvTotn.Print((pathtoworkspace+"SimPiMuMu_HypatiaplotJpsiKFitLogyPretty_veryniceplot_paper"+dataset+".pdf").c_str());
   canvTotn.Print((pathtoworkspace+"SimPiMuMu_HypatiaplotJpsiKFitLogyPretty_veryniceplot_paper"+dataset+".root").c_str());

   fw.Close();
   fpull.Close();
}
void FitAndSplotJpsiKDataForTraining::plotprettyhypathia3_plotnicely_paper_sigsim_drive(string dataset, string pathtoworkspace, string type)
{
...
//	TFile wrkspc8((plotdir+"myworkspace_"+namews8+"_"+type+".root").c_str()); 
   ...
   cout<<"Plotting result of the fit"<<endl;
   TFile fw((pathtoworkspace+"myworkspace_"+namews8+"_"+type+".root").c_str());
...
//   model_total->plotOn(frame, RooFit::Components("cb1"), RooFit::Name("signal"),RooFit::LineStyle(kDashed), RooFit::LineColor(kBlack));
   ...
   TLegend *leg = new TLegend(0.56,0.8,0.92,0.92);
   leg->AddEntry(frame->findObject("tot"),"B^{+} #rightarrow (J/#psi #rightarrow #mu^{+} #mu^{-}) K^{+}","l");
//   leg->AddEntry(frame->findObject("signal"),"B^{+} #rightarrow (J/#psi #rightarrow #mu^{+} #mu^{-}) K^{+}","l");
//   leg->AddEntry(frame->findObject("pimumu"),"B^{+} #rightarrow (J/#psi #rightarrow #mu^{+} #mu^{-}) #pi^{+}","l");
//   leg->AddEntry(frame->findObject("combinatorial"),"Combinatorial","l");
...
//   lhcbSally();
 ...
 //  printLHCb();
   ...
   canvTot.Print((pathtoworkspace+"SimSig_HypatiaplotJpsiKFitPretty_veryniceplot_paper"+dataset+".pdf").c_str());
   canvTot.Print((pathtoworkspace+"SimSig_HypatiaplotJpsiKFitPretty_veryniceplot_paper"+dataset+".root").c_str());

   canv.Print((pathtoworkspace+"SimSig_HypatiaplotJpsiKFitPretty_nopull_veryniceplot_paper"+dataset+".pdf").c_str());
   canv.Print((pathtoworkspace+"SimSig_HypatiaplotJpsiKFitPretty_nopull_veryniceplot_paper"+dataset+".root").c_str());
...
//   frame->SetMaximum(200000.0);
   ...
   canv.Print((pathtoworkspace+"SimSig_HypatiaplotJpsiKFitLogyPretty_veryniceplot_nopull_paper"+dataset+".pdf").c_str());
   canv.Print((pathtoworkspace+"SimSig_HypatiaplotJpsiKFitLogyPretty_veryniceplot_nopull_paper"+dataset+".root").c_str());
...
//   canvTot.Update();
   ...
   canvTotn.Print((pathtoworkspace+"SimSig_HypatiaplotJpsiKFitLogyPretty_veryniceplot_paper"+dataset+".pdf").c_str());
   canvTotn.Print((pathtoworkspace+"SimSig_HypatiaplotJpsiKFitLogyPretty_veryniceplot_paper"+dataset+".root").c_str());
...
//   model_total->plotOn(frame, RooFit::Components("cb1"), RooFit::Name("signal"),RooFit::LineStyle(kDashed), RooFit::LineColor(kBlack));
 ...
 //  leg->AddEntry(frame->findObject("pimumu"),"B^{+} #rightarrow J/#psi #pi^{+}","l");
   ...
   frame->SetMinimum(0.1);
//   frame->SetMaximum(200000.0);
//   frame->GetYaxis()->SetUserRange(0.1,200000.0);
   frame->Draw();
   leg->Draw("same");
   ...
   canvTot.Divide(1,2);
   canvTot.cd(1);
   gPad->SetPad(0.005, 0.205, 0.995, 0.995);//995);
...
//        delete canvlog;
	...
	//
	TFile wrkspc9((mcsavedir+"myworkspace_"+namews8+"_"+type+"_"+dataset+".root").c_str(),"RECREATE"); 
	w9->import(Bplus_Corrected_Mass);
	w9->import(weightnamevar);
	w9->import(dr);
	w9->import(blah);
