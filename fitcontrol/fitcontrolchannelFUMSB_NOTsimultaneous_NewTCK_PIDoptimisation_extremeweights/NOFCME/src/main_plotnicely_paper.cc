...
string pathtoworkspace(("/home/hep/ss4314/public_html/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/"+cut+"/NOFCME/").c_str());
string pathtoworkspace_2016(("/home/hep/ss4314/public_html/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/"+cut2+"/NOFCME/").c_str());
...
run.plotprettyhypathia3_plotnicely_paper("Run1",pathtoworkspace.c_str());
run.plotprettyhypathia3_plotnicely_paper("2016",pathtoworkspace_2016.c_str());

//run.plotprettyhypathia3_plotnicely_paper_sigsim_drive("Run1",pathtoworkspace.c_str(),"");
//run.plotprettyhypathia3_plotnicely_paper_sigsim_drive("2016",pathtoworkspace_2016.c_str(),"");

run.plotprettyhypathia3_plotnicely_paper_pimumusim_drive("Run1",pathtoworkspace.c_str(),"");
run.plotprettyhypathia3_plotnicely_paper_pimumusim_drive("2016",pathtoworkspace_2016.c_str(),"");
