...
run3.sigfithypathia("mcweight","",("JpsiKMC2012"+cut).c_str(),"2016");
run3.pimumufitweight("","JpsiPiMC2012BasicCut","mcweight");
run3.prepareWorkspace("Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_KaonPID.root");
