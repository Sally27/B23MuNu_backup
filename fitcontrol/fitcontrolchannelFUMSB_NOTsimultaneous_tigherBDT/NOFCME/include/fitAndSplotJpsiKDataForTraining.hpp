...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_tigherBDT/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_NOTsimultaneous_tigherBDT/NOFCME/workspace/"),
...
//   mcfilename("JpsiKMC2012NNmumore03")
   ...
   void prepareWorkspace(string tuplename, string furthervar,string furthercut);
   ...
   vector<double> sigfithypathia(string weightname, string type, string mcfilename, string dataset, string furthervar,string furthercut);
   vector<double> pimumufitnoweight(string type, string pimumufilename);
   vector<double> pimumufitweight(string type, string pimumufilename, string weightname, string furthervar,string furthercut);
