...
string furthervar=("MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection");
string furthercut=("(MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection>0.3)");
//string furthercut="Bplus_MM>5500";

FitAndSplotJpsiKDataForTraining run;
run.sigfithypathia("mcweight","",("JpsiKMC2012"+cut).c_str(),"Run1",furthervar,furthercut.c_str());
run.pimumufitweight("",("JpsiPiMC2012"+cut).c_str(),"mcweight",furthervar,furthercut.c_str());
run.prepareWorkspace(("JpsiKdata_Run1_"+cut+".root").c_str(),furthervar,furthercut.c_str());
