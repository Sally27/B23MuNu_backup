...
run.plotprettyhypathia3_plotnicely("Run1",pathtoworkspace_h.c_str());
run.plotprettyhypathia3_plotnicely("2016",pathtoworkspace_h_2016.c_str());
run.plotprettyhypathia3_plotnicely("Run1",pathtoworkspace_l.c_str());
run.plotprettyhypathia3_plotnicely("2016",pathtoworkspace_l_2016.c_str());
