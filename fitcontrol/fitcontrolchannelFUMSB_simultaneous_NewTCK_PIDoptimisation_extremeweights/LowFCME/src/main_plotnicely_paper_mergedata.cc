...
string pathtoworkspace_combined("/home/hep/ss4314/public_html/fitcontrol/fitcontrolchannelFUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights/combined/");
...
run.plotprettyhypathia3_plotnicely_paper_both("Combined_high_",pathtoworkspace_h.c_str(),pathtoworkspace_h_2016.c_str(),pathtoworkspace_combined);
run.plotprettyhypathia3_plotnicely_paper_both("Combined_low_",pathtoworkspace_l.c_str(),pathtoworkspace_l_2016.c_str(),pathtoworkspace_combined);
run.plotprettyhypathia3_plotnicely_paper_allfour("Combined_allfour_",pathtoworkspace_h.c_str(),pathtoworkspace_h_2016.c_str(),pathtoworkspace_l.c_str(),pathtoworkspace_l_2016.c_str(),pathtoworkspace_combined);
//run.plotprettyhypathia3_plotnicely_paper_both("2016",pathtoworkspace_h_2016.c_str(),pathtoworkspace_combined);
