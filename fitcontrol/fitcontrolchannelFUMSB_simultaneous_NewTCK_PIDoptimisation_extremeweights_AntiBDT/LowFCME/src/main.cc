...
run.sigfithypathia("mcweight","",("JpsiKMC2012"+cut+"_"+fcme).c_str(),"Run1");
run.pimumufitweight("",("JpsiPiMC2012"+cut).c_str(),"mcweight");
run.prepareWorkspace(("JpsiKdata_Run1_"+cut+"_"+fcme+".root").c_str());
run.fitJpsiKDataHypathia3(false,"","Run1");
run.plotprettyhypathia3("Run1");
run.GetYields("Run1",(cut+fcme).c_str());
