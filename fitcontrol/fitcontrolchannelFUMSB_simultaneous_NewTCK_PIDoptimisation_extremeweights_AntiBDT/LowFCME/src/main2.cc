...
run3.sigfithypathia("mcweight","",("JpsiKMC2016"+cut+"_"+fcme).c_str(),"2016");
run3.pimumufitweight("","JpsiPiMC2012BasicCut","mcweight");
run3.prepareWorkspace(("JpsiKdata_2016_"+cut+"_"+fcme+".root").c_str());
run3.fitJpsiKDataHypathia3(false,"","2016");
run3.plotprettyhypathia3("2016");
run3.GetYields("2016",(cut+fcme).c_str());
