...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_simultaneous_add2016/HighFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitcontrol/fitcontrolchannelFUMSB_simultaneous_add2016/HighFCME/workspace/"),
   tupledir("/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_simultaneous_add2016/bin"),
   tuplename("JpsiKdata_HighFCME_Probnnmu3.root"), 
   treename("DecayTree"),
   Bplus_MM_min(5150), 
   Bplus_MM_max(5450), 
   mcdir("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_FUMSB_simultaneous_add2016/bin/"),
   datadir("/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_simultaneous_add2016/haddtuples"),
   pimumudir("/vols/lhcb/ss4314/tuplesallvar/MCPatrickJpsipi/") 
