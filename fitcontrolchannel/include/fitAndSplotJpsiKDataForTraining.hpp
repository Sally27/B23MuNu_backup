...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitcontrolchannel/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitcontrolchannel/workspace/"),
      tupledir("/vols/lhcb/ss4314/cutonBDTs/MCsigNewvsMisid/"), tuplename("BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic.root"), treename("DecayTree"), Bplus_MM_min(5180), Bplus_MM_max(5450)
   {}
