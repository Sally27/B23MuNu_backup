...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitcontrolchannelFUMSB_simultaneous_symmetric_newcontrolchannel/HighFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitcontrolchannelFUMSB_simultaneous_symmetric_newcontrolchannel/HighFCME/workspace/"),
      tupledir("/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_simultaneous_symmetric_newcontrolchannel/"), tuplename("JpsiKdata_HighFCME_Probnnmu3.root"), treename("DecayTree"), Bplus_MM_min(5150), Bplus_MM_max(5450), mcdir("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_simultaneous_symmetric_newcontrolchannel/bin/"), mcfilename("B23MuNuMCNNmumore03Strip21MagUp")
   {}
