...
//-----------------Just fit all of JpsiKst with rookeys pdf-----------//
//FitAndSplotJpsiKDataForTraining run;  
//run.prepareWorkspaceSigMC();  //prepare workspace for mc
//run.sigfitnoweight("","");   //fit mc
//run.prepareWorkspaceLambdaMC();
...
////-----------------------PLOT Merger fitd PIDK--------------------//
//
//plotMergedFits(binningx, binningy,"Pi_PIDK<0","BeforeRookeys");
//plotMergedFits(binningx, binningy,"Pi_PIDK<-2","AfterRookeys");
//
//
//out<<"\\hline"<<endl;
//out<<"\\end{tabular}"<<endl;
