...
void plotMergedFits(vector<double> binningx, vector<double> binningy, string pidcut, string state)
{
...
//				string pidcut = "Pi_PIDK<0";
				...
				TFile f(("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_firstattempt/NOFCME/workspace/plotJpsiKst_"+cleanNameString(kinbinstring)+"_"+cleanNameString(pidcut)+".root").c_str(),"READ");
