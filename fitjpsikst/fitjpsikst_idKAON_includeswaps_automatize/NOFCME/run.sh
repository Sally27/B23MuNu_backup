...
curdir=fitjpsikst_idKAON_includeswaps_automatize

#./main "Pi_isMuon==1.0"
#./mainrunbig "Pi_isMuon==1.0"
...
#./mainrunbig "Pi_isMuon==1.0 && Pi_nShared==0 && Pi_ProbNNmu>0.5"
...
#./mainrunbig "Pi_isMuon==1.0 && Pi_PIDmu>0"
...
#./mainrunbig "Pi_isMuon==1.0 && Pi_PIDmu>0 && Pi_PIDmu-Pi_PIDK>0"
#./mainPIDCalib "Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All" "PID_2DPi_isMuon__1_0_&&_Pi_PIDmu>0_&&_Pi_PIDmu_Pi_PIDK>0_.root"
