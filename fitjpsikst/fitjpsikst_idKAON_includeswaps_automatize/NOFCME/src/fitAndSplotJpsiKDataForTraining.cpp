...
//   out<<cleanAbsolutelyNameString(kinbinstring)<<" & "<<d2s(double(total_pid)/double(total))<<" $\\pm$ "<<errorratio<<" & "<<eff->GetBinContent(i,j)<<" $\\pm$ "<<eff->GetBinError(i,j)<<"  \\\\ "<<endl;
   out<<cleanAbsolutelyNameString(kinbinstring)<<" & "<<d2s(double(total_pid)/double(total))<<" $\\pm$ "<<errorratio<<" & "<<eff->GetBinContent(i,j)<<" $\\pm$ "<<eff->GetBinError(i,j)<<" & "<<d2s((double(total_pid)/double(total))/(eff_pidcalib->GetBinContent(i,j)))<<" & "<<d2s(eff->GetBinContent(i,j)/eff_pidcalib->GetBinContent(i,j))<<"  \\\\ "<<endl;
