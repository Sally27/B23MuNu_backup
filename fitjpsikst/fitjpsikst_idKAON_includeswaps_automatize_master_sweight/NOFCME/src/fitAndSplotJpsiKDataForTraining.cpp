...
vector<double> FitAndSplotJpsiKDataForTraining::readEfficiency2DHist_all(string PIDcut, string branchname){
...
vector<double> FitAndSplotJpsiKDataForTraining::readEfficiency2DHist_all_err(string PIDcut, string branchname){
