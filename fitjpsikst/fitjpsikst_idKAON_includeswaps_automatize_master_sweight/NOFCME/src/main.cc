...
plotMergedFits(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
plotMergedFits(binningx, binningy, pidcutafter,"After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");

plotMergedFitsPretty(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
plotMergedFitsPretty(binningx, binningy, pidcutafter,"After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");

plotMergedFitsPrettyLogy(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
plotMergedFitsPrettyLogy(binningx, binningy, pidcutafter,"After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");

//plotMergedFits(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"Pi_isMuon==1.0 && Pi_nShared==0 && Pi_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");

//plotMergedFitsPretty(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
//plotMergedFitsPretty(binningx, binningy,"Pi_isMuon==1.0 && Pi_nShared==0 && Pi_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");

//plotMergedFitsPrettyLogy(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
//plotMergedFitsPrettyLogy(binningx, binningy,"Pi_isMuon==1.0 && Pi_nShared==0 && Pi_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
...
//
//plotMergedFits(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"Pi_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight/NOFCME/workspace");
//
//out<<"\\hline"<<endl;
//out<<"\\end{tabular}"<<endl;
//out<<"\\end{center}"<<endl;
