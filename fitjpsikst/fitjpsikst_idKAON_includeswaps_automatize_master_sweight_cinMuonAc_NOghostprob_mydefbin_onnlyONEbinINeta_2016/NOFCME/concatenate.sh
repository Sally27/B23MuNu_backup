...
cat PIDtables/beg.txt PIDtables/OverallResult_Sweights*1.5_5.txt PIDtables/end.txt > PIDtables/all_1.5_5.tex
cat PIDtables/beg.txt PIDtables/OverallResult_ONLYSweights*1.5_5.txt PIDtables/end.txt > PIDtables/all_onlysweights_1.5_5.tex
