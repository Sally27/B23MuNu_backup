...
//        string basicplusprob ="Pi_isMuon==1.0 && Pi_DLLmu>0 && Pi_DLLmu-Pi_DLLK>0 && Pi_isMuonTight==1.0";
        string beforelast_cut="Pi_isMuon==1.0 && Pi_DLLmu>0 && Pi_DLLmu-Pi_DLLK>0 && Pi_isMuonTight==1.0 && Pi_MuonNShared<2";      
...
//        allcut_ts.push_back(basicplusprob);
        allcut_ts.push_back(beforelast_cut);
...
//                                delete set1_gr;
	...
	mg->GetYaxis()->SetTitle("#frac{#pi #rightarrow #mu misID from B #rightarrow J/#psi K^{*0}}{#pi #rightarrow #mu misID from PIDCalib}");
        ...
        cv->SaveAs("Visualize_Ratios_PionMisid_2016_small_thesis.pdf");    

        TCanvas *cv2 = new TCanvas("set2_cv", "set2_cv",1200,600);
        leg->SetTextSize(0.05);
	leg->Draw();
        
        cv2->SaveAs("Visualize_Ratios_PionMisid_2016_small_thesis_leg.root");    
        cv2->SaveAs("Visualize_Ratios_PionMisid_2016_small_thesis_leg.pdf");    
