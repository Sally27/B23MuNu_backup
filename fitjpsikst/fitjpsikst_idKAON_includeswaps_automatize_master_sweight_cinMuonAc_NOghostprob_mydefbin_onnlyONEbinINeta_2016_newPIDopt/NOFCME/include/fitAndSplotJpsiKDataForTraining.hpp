...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2016_newPIDopt/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2016_newPIDopt/NOFCME/workspace/"),
   ...
   mcfile("Bd2JpsiKstMC2016_weights"),
   ...
   datafile("B2JpsiKst_Data_2016_newtrigger_Jpsi_relevantcutsNOGHOST_KstVeto_JpsiKveto_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_muonptcut_tightMuon_DLLK"),
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2016_newPIDopt/NOFCME/PIDtables"),
   mcdirlambda("/vols/lhcb/ss4314/preparejpsikstweights/prepareweightsforDLLK_noghostprob_2016/bin"),
   mcfilelambda("LambdaB2jpsiK2016MC_MCtm_weights"),
   mcswapdir("/vols/lhcb/ss4314/preparejpsikstweights/prepareweightsforDLLK_noghostprob_2016/bin"),
   mcswapfile("Bd2JpsiKstMC2016_MCTruth_KPiswap_weights"),
   pidcalibdir("/vols/lhcb/ss4314/PIDCalibEfficienciesID_for_JpsiKst/2016/misid/pion/guard"),
   pidcalibfiledo("PerfHists_Pi_Turbo16_MagUp_Sally_P_ETA_All.root")
//   mcfilename("JpsiKMC2012NNmumore03")
   ...
   void plotprettyjpsikstrookeys_thesis(string dataset);
