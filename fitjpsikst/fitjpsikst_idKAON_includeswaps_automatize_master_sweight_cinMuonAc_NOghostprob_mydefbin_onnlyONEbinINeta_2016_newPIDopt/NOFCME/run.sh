...
curdir=fitjpsikst_idKAON_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2016_newPIDopt
...
do
    ...
    ./main "Pi_isMuon==1.0 && Pi_PIDmu>0 && (Pi_PIDmu-Pi_PIDK)>0 && Pi_isMuonTight==1.0 && Pi_MuonNShared<2 && Pi_MC15TuneV1_ProbNNmu>0.$values"
    ./mainrunbig "Pi_isMuon==1.0 && Pi_PIDmu>0 && (Pi_PIDmu-Pi_PIDK)>0 && Pi_isMuonTight==1.0 && Pi_MuonNShared<2 && Pi_MC15TuneV1_ProbNNmu>0.$values" "Pi_(Brunel_IsMuon==1.0) && (Brunel_DLLmu > 0.0) && ((Brunel_DLLmu - Brunel_DLLK) > 0.0) && (Brunel_IsMuonTight==1.0) && (Brunel_nShared<2)_All"
#./mainPIDCalib "Pi_(Brunel_IsMuon==1.0) && (Brunel_DLLmu > 0.0) && ((Brunel_DLLmu - Brunel_DLLK) > 0.0) && (Brunel_IsMuonTight==1.0) && (Brunel_nShared<2)_All" "PID_2DPi_isMuon__1_0_&&_Pi_PIDmu>0_&&__Pi_PIDmu_Pi_PIDPi_>0_&&_Pi_isMuonTight__1_0_&&_Pi_MuonNShared<2.root"
    tagcut7=Pi_isMuon_true_and_Pi_PIDmu_gr0_and_Pi_PIDPi_gr0_Pi_isMuTig_Pi_MuonNShared_l2_and_Pi_probnnmu_$values
