...
curdir=fitjpsikst_idKAON_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta
...
./mainrunbig "Pi_isMuon==1.0 && Pi_nShared==0 && Pi_ProbNNmu>0.5" "Pi_(IsMuon==1.0) && (nShared==0) && (V2ProbNNmu > 0.5)_All"
./mainPIDCalib "Pi_(IsMuon==1.0) && (nShared==0) && (V2ProbNNmu > 0.5)_All" "PID_2DPi_isMuon__1_0_&&_Pi_nShared__0_&&_Pi_ProbNNmu>0_5.root" 
...
./mainrunbig "Pi_isMuon==1.0 && Pi_PIDmu>0 && Pi_PIDmu-Pi_PIDK>0 && Pi_nShared==0 && Pi_ProbNNmu>0.3" "Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All"
./mainPIDCalib "Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All" "PID_2DPi_isMuon__1_0_&&_Pi_PIDmu>0_&&_Pi_PIDmu_Pi_PIDK>0_&&_Pi_nShared__0_&&_Pi_ProbNNmu>0_3.root"
