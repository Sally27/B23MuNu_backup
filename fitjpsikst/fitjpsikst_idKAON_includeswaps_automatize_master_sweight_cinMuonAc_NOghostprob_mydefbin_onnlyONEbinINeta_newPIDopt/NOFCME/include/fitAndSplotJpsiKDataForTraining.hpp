...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_newPIDopt/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_newPIDopt/NOFCME/workspace/"),
   ...
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idKAON_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_newPIDopt/NOFCME/PIDtables"),
   ...
   pidcalibdir("/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateJpsiKst/misideff/pion/mybin_includeswaps_onlyonebinineta"),
   pidcalibfiledo("PerfHists_Pi_Strip21_MagUp_Sally_P_ETA.root")
