...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_coarsebin/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_coarsebin/NOFCME/workspace/"),
   ...
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_coarsebin/NOFCME/PIDtables"),
   mcdirlambda("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/Lambdab2jpsikprotonMCSim8abi/2012/bin"),
   mcfilelambda("LambdaB2jpsiK2012MC_trigger_Jpsi_relevantcuts_KstVeto_PIDPi_JpsiKveto_tightMuon_tightPion_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp")
