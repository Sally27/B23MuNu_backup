...
plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_coarsebin/NOFCME/workspace");
plotMergedFits(binningx, binningy,"K_isMuon==1.0 && K_nShared==0 && K_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_coarsebin/NOFCME/workspace");
