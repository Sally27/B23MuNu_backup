...
//        holder=run.readEfficiency2DHist_all(pidcut,"PIDHist_MyRefit");
//        holder2=run.readEfficiency2DHist_all(pidcut,"PIDHist_PIDCalib");
//        holder3=run.readEfficiency2DHist_all(pidcut,"PIDHist_MyRefit");
//        holder4=run.readEfficiency2DHist_all(pidcut,"PIDHist_RatioMyRefit");


//        holder5=run.readEfficiency2DHist_all(pidcut,"PIDHist_RatioMyRefit");
//        holder5_err=run.readEfficiency2DHist_all_err(pidcut,"PIDHist_RatioMyRefit");
	...
	for(int k(0); k<numoffiles ;k++){
		ofstream out;
                int lol=k;
                cout<<"Filing "<<k<<endl; 
		out.open(("../PIDtables/OverallResult_MyRefit"+i2s(lol)+".txt").c_str());
		...
		for(int i(0); i<allcuts.size() ;i++)
		{
			...
			holder5=run.readEfficiency2DHist_all(allcuts.at(i),"PIDHist_RatioMyRefit");
			holder5_err=run.readEfficiency2DHist_all_err(allcuts.at(i),"PIDHist_RatioMyRefit");
...
//		{
//
//			holder5=run2.readEfficiency2DHist_all(allcuts.at(i),"PIDHist_RatioMyRefit");
//			holder5_err=run2.readEfficiency2DHist_all_err(allcuts.at(i),"PIDHist_RatioMyRefit");
//
