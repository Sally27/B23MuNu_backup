...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc/NOFCME/workspace/"),
   ...
   datafile("BuKstMuMu2012_newtrigger_Jpsi_relevantcuts_KstVeto_JpsiKveto_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_muonptcut_tightMuon_DLLPi"),
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc/NOFCME/PIDtables"),
   ...
   pidcalibdir("/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateJpsiKst/misideff/kaon/jackbin_includeswaps/tupleswithcinMuonAccaswell")
//   mcfilename("JpsiKMC2012NNmumore03")
   ...
   void makeMasterTable(string extracut, string pbin, string etabin, string pidcut, string kinbinstring, string pidstring, ofstream &out, int i, int j, string pidcalibfile ,string pidcalibcut); 
   ...
   vector<double> readEfficiency2DHist_all_err(string PIDcut, string branchname);
   vector<double> readEfficiency2DHist_all(string PIDcut, string branchname);
