...
plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
plotMergedFits(binningx, binningy, pidcutafter,"After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");

plotMergedFitsPretty(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
plotMergedFitsPretty(binningx, binningy, pidcutafter,"After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");

plotMergedFitsPrettyLogy(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
plotMergedFitsPrettyLogy(binningx, binningy, pidcutafter,"After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");

//plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"K_isMuon==1.0 && K_nShared==0 && K_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");

//plotMergedFitsPretty(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
//plotMergedFitsPretty(binningx, binningy,"K_isMuon==1.0 && K_nShared==0 && K_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");

//plotMergedFitsPrettyLogy(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
//plotMergedFitsPrettyLogy(binningx, binningy,"K_isMuon==1.0 && K_nShared==0 && K_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
...
//
//plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"K_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob/NOFCME/workspace");
//
//out<<"\\hline"<<endl;
//out<<"\\end{tabular}"<<endl;
//out<<"\\end{center}"<<endl;
