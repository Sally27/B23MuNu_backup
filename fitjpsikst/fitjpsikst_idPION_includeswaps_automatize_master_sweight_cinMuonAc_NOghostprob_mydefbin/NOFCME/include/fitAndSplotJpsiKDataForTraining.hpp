...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin/NOFCME/workspace/"),
   ...
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin/NOFCME/PIDtables"),
   ...
   pidcalibdir("/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateJpsiKst/misideff/kaon/mybin_includeswaps")
