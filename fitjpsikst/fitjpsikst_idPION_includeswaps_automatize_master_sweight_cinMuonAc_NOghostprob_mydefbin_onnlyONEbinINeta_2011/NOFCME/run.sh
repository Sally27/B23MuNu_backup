...
curdir=fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2011
...
./mainrunbig "K_isMuon==1.0 && K_nShared==0 && K_ProbNNmu>0.5" "K_(IsMuon==1.0) && (nShared==0) && (MC12TuneV2_ProbNNmu > 0.5)_All"
./mainPIDCalib "K_(IsMuon==1.0) && (nShared==0) && (MC12TuneV2_ProbNNmu > 0.5)_All" "PID_2DK_isMuon__1_0_&&_K_nShared__0_&&_K_ProbNNmu>0_5.root" 
...
./mainPIDCalib "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All" "PID_2DK_isMuon__1_0_&&_K_PIDmu>0_&&__K_PIDmu_K_PIDK_>0.root"
...
./main "K_isMuon==1.0 && K_PIDmu>0 && (K_PIDmu-K_PIDK)>0 && K_nShared==0"
./mainrunbig "K_isMuon==1.0 && K_PIDmu>0 && (K_PIDmu-K_PIDK)>0 && K_nShared==0" "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All"
./mainPIDCalib "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All" "PID_2DK_isMuon__1_0_&&_K_PIDmu>0_&&__K_PIDmu_K_PIDK_>0_&&_K_nShared__0.root"
tagcut6=K_isMuon_true_and_K_PIDmu_gr0_and_K_PIDK_gr0_K_nShared_0
...
./main "K_isMuon==1.0 && K_PIDmu>0 && (K_PIDmu-K_PIDK)>0 && K_nShared==0 && K_ProbNNmu>0.3"
./mainrunbig "K_isMuon==1.0 && K_PIDmu>0 && (K_PIDmu-K_PIDK)>0 && K_nShared==0 && K_ProbNNmu>0.3" "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (MC12TuneV2_ProbNNmu > 0.3)_All"
./mainPIDCalib "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (MC12TuneV2_ProbNNmu > 0.3)_All" "PID_2DK_isMuon__1_0_&&_K_PIDmu>0_&&__K_PIDmu_K_PIDK_>0_&&_K_nShared__0_&&_K_ProbNNmu>0_3.root"
tagcut7=K_isMuon_true_and_K_PIDmu_gr0_and_K_PIDK_gr0_K_nShared_0_K_PIDmugr0_3
