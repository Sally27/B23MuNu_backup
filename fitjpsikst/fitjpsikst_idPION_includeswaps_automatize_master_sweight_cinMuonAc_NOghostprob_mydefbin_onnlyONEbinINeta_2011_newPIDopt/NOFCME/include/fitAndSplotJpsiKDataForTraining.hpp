...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2011_newPIDopt/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2011_newPIDopt/NOFCME/workspace/"),
   ...
   B0_MM_min(5150), 
   B0_MM_max(5450), 
   mcdir("/vols/lhcb/ss4314/preparejpsikstweights/prepareweightsforDLLK_noghostprob_2011/bin"),
   mcfile("Bd2JpsiKstMC2011_pionweights"),
   datadir("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsikst_data/2011/bin"),
   pimumudir("/vols/lhcb/ss4314/preparejpsipiweights/preparejpsipiweights_FUMSB_NOTsimultaneous_add2016_scalesig/bin/"),
   datafile("B2JpsiKst_Data_2011_newtrigger_Jpsi_relevantcutsNOGHOST_KstVeto_JpsiKveto_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_muonptcut_tightMuon_DLLPi"),
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2011_newPIDopt/NOFCME/PIDtables"),
   mcdirlambda("/vols/lhcb/ss4314/preparejpsikstweights/prepareweightsforDLLK_noghostprob_2011/bin"),
   mcfilelambda("LambdaB2jpsiK2011MC_MCtm_pionweights"),
   mcswapdir("/vols/lhcb/ss4314/preparejpsikstweights/prepareweightsforDLLK_noghostprob_2011/bin"),
   mcswapfile("Bd2JpsiKstMC2011_MCTruth_KPiswap_pionweights"),   
   pidcalibfiledo("PerfHists_K_Strip21r1_MagDown_Sally_P_ETA.root"),
   pidcalibdir("/vols/lhcb/ss4314/PIDCalibEfficienciesID_for_JpsiKst/2011/misid/kaon")
