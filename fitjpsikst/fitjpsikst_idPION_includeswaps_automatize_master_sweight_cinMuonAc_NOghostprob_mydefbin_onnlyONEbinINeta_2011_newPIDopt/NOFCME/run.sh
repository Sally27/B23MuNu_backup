...
curdir=fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2011_newPIDopt
...
do 
    ...
    ./mainrunbig "K_isMuon==1.0 && K_PIDmu>0 && (K_PIDmu-K_PIDK)>0 && K_nShared==0 && (K_ProbNNmu - K_ProbNNpi)>-0.$values" "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((MC12TuneV2_ProbNNmu - MC12TuneV2_ProbNNpi) > -0.$values)_All"
    ./mainPIDCalib "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((MC12TuneV2_ProbNNmu - MC12TuneV2_ProbNNpi) > -0.$values)_All" "PID_2DK_isMuon__1_0_&&_K_PIDmu>0_&&__K_PIDmu_K_PIDK_>0_&&_K_nShared__0_&&__K_ProbNNmu___K_ProbNNpi_>_0_$newvar"
...
#    ./mainrunbig "K_isMuon==1.0 && K_PIDmu>0 && (K_PIDmu-K_PIDK)>0 && K_nShared==0 && K_ProbNNmu>0.$values" "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (MC12TuneV2_ProbNNmu > 0.$values)_All"
#    ./mainPIDCalib "K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (MC12TuneV2_ProbNNmu > 0.$values)_All" "PID_2DK_isMuon__1_0_&&_K_PIDmu>0_&&__K_PIDmu_K_PIDK_>0_&&_K_nShared__0_&&_K_ProbNNmu>0_$newvar"
