...
curdir=fitjpsikst_idPION_includeswaps_automatize_master_sweight_cinMuonAc_NOghostprob_mydefbin_onnlyONEbinINeta_2016
...
./main "K_isMuon==1.0 && K_PIDmu>0 && (K_PIDmu-K_PIDK)>0 && K_isMuonTight==1.0 && K_MuonNShared<2"
./mainrunbig "K_isMuon==1.0 && K_PIDmu>0 && (K_PIDmu-K_PIDK)>0 && K_isMuonTight==1.0 && K_MuonNShared<2" "K_(Brunel_IsMuon==1.0) && (Brunel_DLLmu > 0.0) && ((Brunel_DLLmu - Brunel_DLLK) > 0.0) && (Brunel_IsMuonTight==1.0) && (Brunel_nShared<2)_All"
...
tagcut7=K_isMuon_true_and_K_PIDmu_gr0_and_K_PIDK_gr0_K_isMuTig_K_MuonNShared_l2
