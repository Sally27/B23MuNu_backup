...
string pidcutafter = "K_isMuon==1.0 && K_nShared==0";// && K_ProbNNmu>0.5";
...
//plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"K_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");

//plotMergedFitsPretty(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
//plotMergedFitsPretty(binningx, binningy,"K_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");

//plotMergedFitsPrettyLogy(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
//plotMergedFitsPrettyLogy(binningx, binningy,"K_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");


if (pidcutafter=="K_isMuon==1.0 && K_nShared==0"){
plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
plotMergedFits(binningx, binningy,"K_isMuon==1.0 && K_nShared==0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");

plotMergedFitsPretty(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
plotMergedFitsPretty(binningx, binningy,"K_isMuon==1.0 && K_nShared==0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");

plotMergedFitsPrettyLogy(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
plotMergedFitsPrettyLogy(binningx, binningy,"K_isMuon==1.0 && K_nShared==0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
}
//plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"K_isMuon==1.0 && K_nShared==0 && K_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");

//plotMergedFitsPretty(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
//plotMergedFitsPretty(binningx, binningy,"K_isMuon==1.0 && K_nShared==0 && K_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");

//plotMergedFitsPrettyLogy(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
//plotMergedFitsPrettyLogy(binningx, binningy,"K_isMuon==1.0 && K_nShared==0 && K_ProbNNmu>0.5","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
...
//
//
//plotMergedFits(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"Pi_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_clean/NOFCME/workspace");
//
//out<<"\\hline"<<endl;
//out<<"\\end{tabular}"<<endl;
//out<<"\\end{center}"<<endl;
