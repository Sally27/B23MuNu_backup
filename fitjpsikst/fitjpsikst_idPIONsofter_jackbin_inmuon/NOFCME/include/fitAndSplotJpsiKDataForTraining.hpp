...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace/"),
   ...
   mcfile("Bd2JpsiKstMC2012_MCTruth_trigger_Jpsi_relevantcuts_KstVeto_JpsiKveto_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_muonptcut_tightMuon_probnnpi_pidllkismuon"),
   ...
   datafile("BuKstMuMu2012_trigger_Jpsi_relevantcuts_KstVeto_JpsiKveto_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_muonptcut_tightMuon_probnnpi_pidllkismuon"),
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/PIDtables"),
   mcdirlambda("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/Lambdab2jpsikprotonMCSim8abi/2012/bin"),
   mcfilelambda("LambdaB2jpsiK2012MC_MCtm_trigger_Jpsi_relevantcuts_KstVeto_JpsiKveto_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_muonptcut_tightMuon"),
   swapsdir("la"),
   swapsfile("la")
