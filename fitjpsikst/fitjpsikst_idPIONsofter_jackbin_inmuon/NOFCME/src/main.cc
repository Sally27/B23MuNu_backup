...
string pidcutafter = "K_inMuon==1.0";
...
plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace");
plotMergedFits(binningx, binningy,"K_inMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace");

plotMergedFitsPretty(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace");
plotMergedFitsPretty(binningx, binningy,"K_inMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace");

plotMergedFitsPrettyLogy(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace");
plotMergedFitsPrettyLogy(binningx, binningy,"K_inMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace");
...
//        string pidcutafter = "Pi_inMuon==1.0";
...
//
//
//plotMergedFits(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"Pi_inMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPIONsofter_jackbin_inmuon/NOFCME/workspace");
//
//out<<"\\hline"<<endl;
//out<<"\\end{tabular}"<<endl;
//out<<"\\end{center}"<<endl;
