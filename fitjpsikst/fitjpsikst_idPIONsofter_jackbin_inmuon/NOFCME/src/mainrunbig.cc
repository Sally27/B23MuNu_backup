...
out2<<"\\hline"<<endl;
out2<<"kinmatic bin & sweight eff & refit eff & refit err\\\\ "<<endl;
...
//
//
//plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_jackbin/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"K_inMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_jackbin/NOFCME/workspace");
//
//out<<"\\hline"<<endl;
//out<<"\\end{tabular}"<<endl;
//out<<"\\end{center}"<<endl;
...
//plotMergedFits(binningx, binningy,"Pi_inMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_idPION_jackbin/NOFCME/workspace");
//
//out<<"\\hline"<<endl;
//out<<"\\end{tabular}"<<endl;
//out<<"\\end{center}"<<endl;
