...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu/NOFCME/workspace/"),
   ...
   mcfilelambda("Lambdab2jpsikpMC2012_trigger_Jpsi_DIRA_PT_ENDVERTEX_CHI2_mu1ghost_mu2ghost_Kghost_Pighost_mu1trchi2_mu2trchi2_ktrchi2_pitrchi2_mu1minichi2_mu2minichi2_Kminichi2"),
   ...
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu/NOFCME/PIDtables")
//   mcfilename("JpsiKMC2012NNmumore03")
   ...
   vector<double> lambdafitnoweight(string type, string mcfilename);
