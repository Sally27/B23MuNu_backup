...
//   RooRealVar* cbsignalrar=ws->var("cbsignalrar");
   ...
   RooRealVar Bs_mu("Bs_mu","Bs_mu",(cbsigmarar->getVal())*(1.0), (cbsigmarar->getVal())*(1.5));
...
//   RooRealVar vc1("vc1", "vc1",0.75, 0.15,0.9);
   RooRealVar sig("sig","sig",300000 ,200000,400000);
   RooRealVar bkg("bkg","bkg",18000, 5000.0 ,30000) ;
   RooRealVar Bs("Bs","Bs",600, 100.0 ,15000) ;
   RooRealVar Lam("Lam","Lam",18000, 5000.0,30000) ;
...
vector<double> FitAndSplotJpsiKDataForTraining::sigfitnoweighthyp()
{ 
...
//		return(1.0);
        ...
        RooRealVar l("l","l",-2.44, -3.0, -2.1);
	RooRealVar zeta("zeta","l",1.0e-5, 1.0e-8, 1.0);
        RooRealVar fb("fb","l",-2.20960e-04,-3.00960e-04,-1.20960e-04);
        RooRealVar sigma("sigma","l",8.37, 8.3, 9.0);//,8.0,10.0);//,0.1,50) ;
        RooRealVar mean("mean","l", 5280.0); 
        RooRealVar a1coeff("a1coeff","l",2.75, 2.0, 3.0);
	RooRealVar n1coeff("n1coeff","l",1.419,1.0,2.0);
        RooRealVar a2coeff("a2coeff","a2co",2.1664, 2.1,2.2);
        RooRealVar n2coeff("n2coeff","l",2.70,2.6,2.8);
...
//		return(1.0);
	...
	RooRealVar cbsigmarar("cbsigmarar","cbsigmarar",8.6,7.0,10.0);//,0.1,50) ;
