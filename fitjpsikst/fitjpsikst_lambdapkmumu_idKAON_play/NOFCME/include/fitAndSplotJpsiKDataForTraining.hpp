...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_PiisMuon_play/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_PiisMuon_play/NOFCME/workspace/"),
   ...
   mcfile("Bd2JpsiKstMC2012_MCTruth_trigger_Jpsi_relevantcuts_KstVeto_PIDK_JpsiKveto_tightMuon_tightKaon_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_PIDPi"),
   ...
   datafile("BuKstMuMu2012_trigger_Jpsi_relevantcuts_KstVeto_PIDK_JpsiKVeto_tightMuon_tightKaon_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_PIDPi"),
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_PiisMuon_play/NOFCME/PIDtables"),
   mcdirlambda("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/Lambdab2jpsikprotonMC/2012/bin"),
   mcfilelambda("Lambdab2jpsikpMC2012_trigger_Jpsi_relevantcuts_KstVeto_PIDK_JpsiKveto_tightMuon_tightKaon_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp_PIDpi")
...
//   mcfilename("JpsiKMC2012NNmumore03")
   ...
   vector<double> sigfitnoweighthyp();
