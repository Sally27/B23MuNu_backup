...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_idPION_play/NOFCME/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_idPION_play/NOFCME/workspace/"),
   ...
   mcfile("Bd2JpsiKstMC2012_MCTruth_trigger_Jpsi_relevantcuts_KstVeto_PIDPi_JpsiKveto_tightMuon_tightPion_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp"),
   ...
   datafile("BuKstMuMu2012_trigger_Jpsi_relevantcuts_KstVeto_PIDPi_JpsiKVeto_tightMuon_tightPion_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp"),
   piddir("/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_idPION_play/NOFCME/PIDtables"),
   mcdirlambda("/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/Lambdab2jpsikprotonMC/2012/bin"),
   mcfilelambda("Lambdab2jpsikpMC2012_trigger_Jpsi_relevantcuts_KstVeto_PIDPi_JpsiKveto_tightMuon_tightPion_phiveto_ptcut_PionAsMuon1Hyp_PionAsMuon2Hyp_KaonAsMuon1Hyp_KaonAsMuon2Hyp")
...
//   mcfilename("JpsiKMC2012NNmumore03")
   ...
   void fitJpsiKstDataAndMakePIDbeforeRookeysHyp(bool binnedFit, string dataset, string cut, int binx, int biny, string PIDcut ,ofstream &out);
