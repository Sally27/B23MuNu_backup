...
void FitAndSplotJpsiKDataForTraining::fitJpsiKstDataRookeysHyp(bool binnedFit, string dataset, string cut)
{
   ...
   RooRealVar Bs_mean("Bs_mean","Bs_mean",((mean->getVal())+(1.0*offset)));
...
void FitAndSplotJpsiKDataForTraining::fitJpsiKstDataAndMakePIDbeforeRookeysHyp(bool binnedFit, string dataset, string cut, int binx, int biny, string PIDcut, ofstream &out)
{
...
//		return(1.0);
	...
	RooRealVar zeta("zeta","l",1.0e-5, 1.0e-8, 1.0);
        ...
        RooRealVar sigma("sigma","l",8.37, 7.0, 11.0);//,8.0,10.0);//,0.1,50) ;
