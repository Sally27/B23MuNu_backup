...
//	runPID.fitJpsiKstData(false, "",("Pi_P_"+d2s(binningx.at(i))+"_Pi_P_"+d2s(binningx.at(i+1))+"_Pi_ETA_"+d2s(binningy.at(j))+"_Pi_ETA_"+d2s(binningy.at(j+1))).c_str()); //fitdata ws
        runPID.fitJpsiKstDataAndMakePIDbeforeRookeysHyp(false, "",kinbinstring.c_str(), i, j, pidcut.c_str(),out); //fitdata ws and fill pidtable
...
//plotMergedFits(binningx, binningy,"Pi_PIDK<0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_idPION_play/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"K_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_idPION_play/NOFCME/workspace");
...
//
//
//plotMergedFits(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_idPION_play/NOFCME/workspace");
//plotMergedFits(binningx, binningy,"Pi_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_lambdapkmumu_idPION_play/NOFCME/workspace");
//
//out<<"\\hline"<<endl;
//out<<"\\end{tabular}"<<endl;
//out<<"\\end{center}"<<endl;
