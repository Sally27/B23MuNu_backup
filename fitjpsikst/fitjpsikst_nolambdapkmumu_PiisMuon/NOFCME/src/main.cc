...
plotMergedFits(binningx, binningy,"K_PIDK>0","Before","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_nolambdapkmumu_PiisMuon/NOFCME/workspace");
plotMergedFits(binningx, binningy,"Pi_isMuon==1.0","After","/vols/lhcb/ss4314/fitjpsikst/fitjpsikst_nolambdapkmumu_PiisMuon/NOFCME/workspace");
