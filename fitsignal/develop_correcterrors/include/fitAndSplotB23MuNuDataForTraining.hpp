...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal/develop_correcterrors/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal/develop_correcterrors/workspace_plots/"), 
    workspacedir("/vols/lhcb/ss4314/fitsignal/develop_correcterrors/workspace_preparation/"),
    workspaceFileNameSim("FitB23MuNuworkspace"),
    fitdir("/vols/lhcb/ss4314/fitsignal/develop_correcterrors/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal/develop_correcterrors/workspace_fitcls/"),
