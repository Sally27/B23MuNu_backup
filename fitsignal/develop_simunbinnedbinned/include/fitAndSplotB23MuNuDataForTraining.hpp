...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal/develop_simunbinnedbinned/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal/develop_simunbinnedbinned/workspace_plots/"), 
    workspacedir("/vols/lhcb/ss4314/fitsignal/develop_simunbinnedbinned/workspace_preparation/"),
    workspaceFileNameSim("FitB23MuNuworkspace"),
    fitdir("/vols/lhcb/ss4314/fitsignal/develop_simunbinnedbinned/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal/develop_simunbinnedbinned/workspace_fitcls/"),
