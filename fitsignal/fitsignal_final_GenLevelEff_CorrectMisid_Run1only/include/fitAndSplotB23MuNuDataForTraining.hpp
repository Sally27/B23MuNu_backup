...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal/fitsignal_final_GenLevelEff_CorrectMisid_Run1only/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal/fitsignal_final_GenLevelEff_CorrectMisid_Run1only/workspace_plots/"), 
    fitdir("/vols/lhcb/ss4314/fitsignal/fitsignal_final_GenLevelEff_CorrectMisid_Run1only/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal/fitsignal_final_GenLevelEff_CorrectMisid_Run1only/workspace_fitcls/"),
    workspacedir("/vols/lhcb/ss4314/fitsignal/fitsignal_final_GenLevelEff_CorrectMisid_Run1only/workspace_preparation/"),
    fitresdir("/vols/lhcb/ss4314/fitsignal/fitsignal_final_GenLevelEff_CorrectMisid_Run1only/fit_results"),
    comparedir("/vols/lhcb/ss4314/fitsignal/fitsignal_final_GenLevelEff_CorrectMisid_Run1only/compare_fits"),
...
//    ses2016(returnVar("/vols/lhcb/ss4314/SingleEventSensitivity/SesFUMSB_NOTsimultaneous_final_optimisation_GenLevelEff/info/info_SES_2016_probmu35.root", "Info_2016", "sensitivity")),
 //   ses2016err(returnVar("/vols/lhcb/ss4314/SingleEventSensitivity/SesFUMSB_NOTsimultaneous_final_optimisation_GenLevelEff/info/info_SES_2016_probmu35.root", "Info_2016", "sensitivity_err")),
    ...
    numberofpartreco(returnVar("/vols/lhcb/ss4314/compare_mcpartreco_and_mcsignal/normalize_to_jpsiK/PR_info/PR_Yield.root", "PR_Yield_no", "numofevents_no")),
    numberofpartreco_error(returnVar("/vols/lhcb/ss4314/compare_mcpartreco_and_mcsignal/normalize_to_jpsiK/PR_info/PR_Yield.root", "PR_Yield_no", "numofevents_err_no"))
    {}
