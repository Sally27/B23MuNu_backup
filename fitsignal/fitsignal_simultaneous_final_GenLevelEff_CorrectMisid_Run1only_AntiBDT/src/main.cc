...
//	run.fitpartrecocomponent("");
	run.fitsignalcomponent("mcweight","LowFCME","",PIDcut_Run1);
	run.fitsignalcomponent("mcweight","HighFCME","",PIDcut_Run1);
	...
	dir.push_back("/vols/lhcb/ss4314/cutonProbnnmuMisidSamples/FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_2_AntiBDT/bin");
	dir.push_back("/vols/lhcb/ss4314/cutonProbnnmuMisidSamples/FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_2_AntiBDT/bin");
	dir.push_back("/vols/lhcb/ss4314/cutonProbnnmuMisidSamples/FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_2_AntiBDT/bin");
	dir.push_back("/vols/lhcb/ss4314/cutonProbnnmuMisidSamples/FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_2_AntiBDT/bin");
	dir.push_back("/vols/lhcb/ss4314/cutonProbnnmuMisidSamples/FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_2_AntiBDT/bin");
...
////
////
//	misidfilenames.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_KaonPID_CombBasic_AntiBDT_FitCorM_"+pid2).c_str());
//	misidfilenames.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_PionPID_CombBasic_AntiBDT_FitCorM_"+pid2).c_str());
//	misidfilenames.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_ProtonPID_CombBasic_AntiBDT_FitCorM_"+pid2).c_str());
//	misidfilenames.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_OSmisid_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_KaonPID_CombBasic_AntiBDT_FitCorM_"+pid2).c_str());
//	misidfilenames.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_OSmisid_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_PionPID_CombBasic_AntiBDT_FitCorM_"+pid2).c_str());
//	misidfilenames.push_back(("modifiedandcut"+pid2+"Bu23MuNuData2016_OSmisid_mu2isNotMuon_mu2inMuonAcc_trigger_mu1isMuonTight_mu3isMuonTight_mu1MuonNShared_mu3MuonNShared_qmincut_ProtonPID_CombBasic_AntiBDT_FitCorM_"+pid2).c_str());
...
//	//-----------------------RUN chi2 fit-----------------//
        ...
        run.fitmisidcomponentall_chi2(dir,misidfilenames,weights,species, "LowFCME",ok.c_str(),"");
	run.fitmisidcomponentall_chi2(dir,misidfilenames,weights,species, "HighFCME",ok.c_str(),"");
        run.compareplots("plotsig");
        run.prepareWorkspaceForSimultaneousFit("LowFCME","",ok.c_str()); //Have to reprepare data if needed for other fits
        run.prepareWorkspaceForSimultaneousFit("HighFCME","",ok.c_str());
        run.prepareWorkspaceForSimultaneousFit_NoFitData("LowFCME","",ok.c_str());
        run.prepareWorkspaceForSimultaneousFit_NoFitData("HighFCME","",ok.c_str());

        run.simfitseparateandsavesig_chi2fit();
        run.calculateFOM_chi2("LowFCME",ok.c_str(),"");
        run.calculateFOM_chi2("HighFCME",ok.c_str(),"");
	run.plotprettysim_chi2("LowFCME",ok.c_str(),"");
	run.plotprettysim_chi2("HighFCME",ok.c_str(),"");
	run.plotprettysim_chi2_overlay("LowFCME",ok.c_str(),"");
	run.plotprettysim_chi2_overlay("HighFCME",ok.c_str(),"");
}
