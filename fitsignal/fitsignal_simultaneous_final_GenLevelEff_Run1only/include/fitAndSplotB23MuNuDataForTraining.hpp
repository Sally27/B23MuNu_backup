...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_GenLevelEff_Run1only/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_GenLevelEff_Run1only/workspace_plots/"), 
    fitdir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_GenLevelEff_Run1only/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_GenLevelEff_Run1only/workspace_fitcls/"),
    workspacedir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_GenLevelEff_Run1only/workspace_preparation/"),
    fitresdir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_GenLevelEff_Run1only/fit_results"),
    comparedir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_GenLevelEff_Run1only/compare_fits"),
