...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_genlevelcor_allsyst_Run1only/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_genlevelcor_allsyst_Run1only/workspace_plots/"), 
    fitdir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_genlevelcor_allsyst_Run1only/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_genlevelcor_allsyst_Run1only/workspace_fitcls/"),
    workspacedir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_genlevelcor_allsyst_Run1only/workspace_preparation/"),
    fitresdir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_genlevelcor_allsyst_Run1only/fit_results"),
    comparedir("/vols/lhcb/ss4314/fitsignal/fitsignal_simultaneous_final_genlevelcor_allsyst_Run1only/compare_fits"),
    ...
    sigdir2("/vols/lhcb/ss4314/preparesignalweights/preparesignalweights_FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level/bin"),
...
//Sally's addition//
  ...
  void plotpretty_plotnicely_paper_misiddata_drive(string type, bool parameters,string PIDcut_Run1, string PIDcut_Run2);
   ...
   vector<double> fitsignalcomponent(string weightname, string type, string year, string PIDcut, bool onlyRun1);
...
//   vector<double> fitmisidcomponent(string type);
   ...
   vector<double> fitmisidcomponentall_chi2(vector <string> &dir,vector <string> &misidfilenames, vector <string> &weights, vector <string> &species, string type, string PIDcut_Run1, string PIDcut_Run2, bool Run1only);

   double fitmisidone(string type, string dir ,string filename, string weight, string species);
  
   void prepareWorkspaceForSimultaneousFit(string type, string year,string PIDcut, bool Run1only);
...
//   void simfitseparateandsavesig_chi2fit(string year, string PIDcut); //nonsimultaneous and year based fit
   void simfitseparateandsavesig_chi2fit_100cor(bool Run1only); //100 correlation
