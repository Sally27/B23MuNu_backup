...
void FitAndSplotB23MuNuDataForTraining::simfitseparateandsavesig()
{
	  ...
	  RooRealVar ses_low("ses","Single event sensitivity",sesrun1,9.4e-10,9.5e-10);
          RooRealVar ses_low_2015("ses_2015","Single event sensitivity",ses2015,1.0e-8,1.1e-8);
