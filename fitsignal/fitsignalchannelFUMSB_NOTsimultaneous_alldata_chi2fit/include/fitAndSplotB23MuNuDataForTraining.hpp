...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal/fitsignalchannelFUMSB_NOTsimultaneous_alldata_chi2fit/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal/fitsignalchannelFUMSB_NOTsimultaneous_alldata_chi2fit/workspace_plots/"), 
    workspacedir("/vols/lhcb/ss4314/fitsignal/fitsignalchannelFUMSB_NOTsimultaneous_alldata_chi2fit/workspace_preparation/"),
    workspaceFileNameSim("FitB23MuNuworkspace"),
    fitdir("/vols/lhcb/ss4314/fitsignal/fitsignalchannelFUMSB_NOTsimultaneous_alldata_chi2fit/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal/fitsignalchannelFUMSB_NOTsimultaneous_alldata_chi2fit/workspace_fitcls/"),
    ...
    fitresdir("/vols/lhcb/ss4314/fitsignal/fitsignalchannelFUMSB_NOTsimultaneous_alldata_chi2fit/fit_results"),
    comparedir("/vols/lhcb/ss4314/fitsignal/fitsignalchannelFUMSB_NOTsimultaneous_alldata_chi2fit/compare_fits")
    {}
