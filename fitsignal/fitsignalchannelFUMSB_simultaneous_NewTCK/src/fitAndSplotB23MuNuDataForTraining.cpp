...
//---- Setup all thing for 3 different fits--------//
        ...
        RooRealVar nr4(("nr4_"+type).c_str(),"",1.24);//, 0.8, 5.0);
        RooRealVar alphar4(("alphar4_"+type).c_str(),"",0.6);//, 0.1, 1.0);
...
//---------------------get values for mean from the chi2 fit------------------------------------------------------//
	...
	//cout<<" value scaled: "<<sig4.getValV()<<endl;
        ...
        cbmeanr4.setRange(cbmeanr4.getVal()-(5*sqrt(cov_chi[0][0])), cbmeanr4.getVal()+(5*sqrt(cov_chi[0][0])));
        cbsigmar4.setRange(cbsigmar4.getVal()-(5*sqrt(cov_chi[1][1])), cbsigmar4.getVal()+(5*sqrt(cov_chi[1][1]))); 
        sig4.setRange(sig4.getVal()-(5*sqrt(cov_chi[2][2])), sig4.getVal()+(5*sqrt(cov_chi[2][2])));
...
//	 RooRealVar scale_for_misid("scale_for_misid","scale_for_misid",100.0);
         ...
         RooRealVar misid_scaled(("misid_scaled_"+type).c_str(),"misid_scaled",(sig4.getVal()*100.0),(double(sig4.getVal()-(5*sqrt(cov_chi[2][2])))*100.0),(double(sig4.getVal()+(5*sqrt(cov_chi[2][2])))*100.0));
//         misid_scaled.setError(double(sig4.getError())*100.0);
	 ...
	 RooMultiVarGaussian mvg(("mvg_"+type).c_str(), "mvg",RooArgSet(misid_scaled,cbmeanr4,cbsigmar4),RooArgSet(mu_sig4,mu_cbmeanr4,mu_cbsigmar4),cov_chi_new);
...
//
        ...
        newexpocon_low.setRange(newexpocon_low.getVal()-newexpocon_low.getError(), newexpocon_low.getVal()+newexpocon_low.getError());
        newexpocon_high.setRange(newexpocon_high.getVal()-newexpocon_high.getError(), newexpocon_high.getVal()+newexpocon_high.getError());
