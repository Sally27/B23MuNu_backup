...
//	  RooExponential newexpoun("newexpoun", "exponential",Bplus_Corrected_Mass,newexpocon);
	...
	// Perform simultaneous fit of model to data and model_ctl to data_ctl
	simPdf.fitTo(combData,RooFit::Range("low,high"),ExternalConstraints(RooArgSet(*m_num_low,*m_num_high,*m_sigma_low,*m_sigma_high,*m_mean_low,*m_mean_high)),Extended(kTRUE),Save(kTRUE));//, ExternalConstrain(rmg)) ; //externalconstraint
