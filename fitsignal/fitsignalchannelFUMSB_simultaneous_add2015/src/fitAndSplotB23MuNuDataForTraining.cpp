...
void FitAndSplotB23MuNuDataForTraining::simfitseparateandsavesig()
{
	  ...
	  ws_low->Print();
         ...
         // misid_low->Close();
          ...
          seslowrun1=1.9059e-9;
          seshighrun1=2.2266e-9;
          seslow2015=2.3366e-8;//*double(285.0/3000.0);
          seshigh2015=1.97245e-8;//*(285.0/3000.0);
	  ...
	  RooRealVar ses_low("ses_LowFCME","Single event sensitivity",seslowrun1,1.85e-9,1.95e-9);
          RooRealVar ses_high("ses_HighFCME","Single event sensitivity",seshighrun1,2.17e-9,2.32e-9);
          RooRealVar ses_low_2015("ses_LowFCME_2015","Single event sensitivity",seslow2015,2.3e-8,2.4e-8);
          RooRealVar ses_high_2015("ses_HighFCME_2015","Single event sensitivity",seshigh2015,1.92e-8,2.02e-8);
	  ...
	  RooFormulaVar nsigform_low("nsigform_LowFCME","nsigfromformula","(@2/@0)+(@2/@1)",RooArgList(ses_low,ses_low_2015,BR));
          RooFormulaVar nsigform_high("nsigform_HighFCME","nsigfromformula","(@2/@0)+(@2/@1)",RooArgList(ses_high,ses_high_2015,BR));
