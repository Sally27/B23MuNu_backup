...
void FitAndSplotB23MuNuDataForTraining::simfitseparateandsavesig()
{
	  ...
	  ws_low->Print();
         ...
         // misid_low->Close();
          ...
          seslow2015=2.3366e-8*(285.0/3000.0);
	  ...
	  RooRealVar ses_low("ses_LowFCME","Single event sensitivity",seslow,1.85e-9,2.05e-9);
          RooRealVar ses_high("ses_HighFCME","Single event sensitivity",seshigh,2.17e-9,2.32e-9);
