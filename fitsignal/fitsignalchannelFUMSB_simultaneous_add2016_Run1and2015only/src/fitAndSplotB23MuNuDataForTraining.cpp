...
void FitAndSplotB23MuNuDataForTraining::simfitseparateandsavesig()
{
	  ...
	  ws_low->Print();
         ...
         // misid_low->Close();
          ...
          seslowrun1=1.7359e-9;
          seshighrun1=2.0076e-9;
          seslow2015=2.1511e-8;//*double(285.0/3000.0);
          seshigh2015=1.92802e-8;//*(285.0/3000.0);
//          seslow2016=3.600e-9;//*double(285.0/3000.0);
//          seshigh2016=3.22816e-9;//*(285.0/3000.0);
	  ...
	  RooRealVar ses_low("ses_LowFCME","Single event sensitivity",seslowrun1,double(seslowrun1-1.7e-10),double(seslowrun1+1.7e-10));
          ...
          RooRealVar ses_low_2015("ses_LowFCME_2015","Single event sensitivity",seslow2015,double(seslow2015-2.38e-9),double(seslow2015+2.38e-9));
          RooRealVar ses_high_2015("ses_HighFCME_2015","Single event sensitivity",seshigh2015,double(seshigh2015-1.827e-9),double(seshigh2015+1.827e-9));
  //        RooRealVar ses_low_2016("ses_LowFCME_2016","Single event sensitivity",seslow2016,double(seslow2016-3.29e-10),double(seslow2016+3.29e-10));
   //       RooRealVar ses_high_2016("ses_HighFCME_2016","Single event sensitivity",seshigh2016,double(seshigh2016-2.68e-10),double(seshigh2016+2.68e-10));
	  ...
	  RooFormulaVar nsigform_low("nsigform_LowFCME","nsigfromformula","(@2/@1)+(@2/@0)",RooArgList(ses_low,ses_low_2015,BR));
          RooFormulaVar nsigform_high("nsigform_HighFCME","nsigfromformula","(@2/@1)+(@2/@0)",RooArgList(ses_high,ses_high_2015,BR));
