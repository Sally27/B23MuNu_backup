...
{      
	...
	TTree* treez = (TTree*)fpr->Get("DecayTree");
        ...
        double num(0);
        num=(double(nEntries)/56747.0)*758.419*1.1;
...
void FitAndSplotB23MuNuDataForTraining::simfitseparateandsavesig()
{
	  ...
	  ws_low->Print();
         ...
         // misid_low->Close();
          ...
          seslow2016=4.280e-9;//*double(285.0/3000.0);
          seshigh2016=3.90253e-9;//*(285.0/3000.0);
	  ...
	  RooRealVar ses_low("ses_LowFCME","Single event sensitivity",seslowrun1,double(seslowrun1-1.7e-10),double(seslowrun1+1.7e-10));
       ...
       //   RooRealVar ses_low_2016("ses_LowFCME_2016","Single event sensitivity",seslow2016,double(seslow2016-6.586e-10),double(seslow2016+6.58657e-10));
       //   RooRealVar ses_high_2016("ses_HighFCME_2016","Single event sensitivity",seshigh2016,double(seshigh2016-5.67e-10),double(seshigh2016+5.67e-10));
