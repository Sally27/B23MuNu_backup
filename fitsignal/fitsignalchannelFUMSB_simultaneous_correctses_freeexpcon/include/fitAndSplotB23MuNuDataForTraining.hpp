...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_correctses_freeexpcon/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_correctses_freeexpcon/workspace_plots/"), 
    workspacedir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_correctses_freeexpcon/workspace_preparation/"),
    workspaceFileNameSim("FitB23MuNuworkspace"),
    fitdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_correctses_freeexpcon/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_correctses_freeexpcon/workspace_fitcls/"),
    tupledir("/vols/lhcb/ss4314/cutonFCME/FUMSB_simultaneous"), 
    misiddir("/vols/lhcb/ss4314/addPIDweights/FUMSB_simultaneous/finaltuples"),
    tuplename("finaldata_FitCorM"), 
    tuplenamelow("finaldata_LowFCME.root"),
    treename("DecayTree"),
    datadir("/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_simultaneous"),
    ...
    typelow("LowFCME"),
    typehigh("HighFCME"),
    sigdir("/vols/lhcb/ss4314/preparesignalweights_simultaneous/bin/")
    {}
