...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/adapttbcode/estimateforcombibdt/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/adapttbcode/estimateforcombibdt/workspace_plots/"), 
    workspacedir("/vols/lhcb/ss4314/adapttbcode/estimateforcombibdt/workspace_preparation/"),
    workspaceFileNameSim("FitB23MuNuworkspace"),
    fitdir("/vols/lhcb/ss4314/adapttbcode/estimateforcombibdt/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/adapttbcode/estimateforcombibdt/workspace_fitcls/"),
    ...
    treename("DecayTree"),
    datadir("/vols/lhcb/ss4314/beforecombibdt/Run1/bin"),
