...
//---- Setup all thing for 3 different fits--------//
	...
	vector<double> params;
        ...
        RooRealVar sig4(("sig4"),"frac of events in sig4",2.83,2.0,1000.0);
        RooRealVar cbmeanr4(("cbmeanr4"),"cbmeanr", 4195.4, 3800.0, 4400.0);
        RooRealVar cbsigmar4(("cbsigmar4"),"cbsigmar",511.,400.,2000.0);//,0.1,50) ;
        RooRealVar nr4(("nr4"),"",1.24);// 0.8, 5.0);
        RooRealVar alphar4(("alphar4"),"",0.6);//, 0.1, 1.0);
	RooCBShape twocbs2(("twocbs2"), "c2", Bplus_Corrected_Mass, cbmeanr4, cbsigmar4, alphar4, nr4); 
//        RooExtendPdf two_ext4("two_ext4","two_ext4",twocbs3,sig4);

        RooRealVar newexpocon_low(("newexpoconmis"),"newexpocon_low",-0.3,0.3);
        RooExponential newexpoun_low(("newexpounmis"), "exponential_low",Bplus_Corrected_Mass,newexpocon_low);
        RooRealVar frac1("frac1","frac of events in cb 1",0.1,1.0);

        RooAddPdf twocbs3("twocbs3","c3",RooArgList(twocbs2,newexpoun_low),RooArgList(frac1));
        RooExtendPdf two_ext4("two_ext4","two_ext4",twocbs3,sig4);

//        RooRealVar cbmeanr4("cbmeanr4","cbmeanr", 3300.0,3500.0);
//        RooRealVar cbsigmar4("cbsigmar4","cbsigmar",100,1000);//,0.1,50) ;
//        RooRealVar nr4("nr4","",0.1,0.7);
//        RooRealVar alphar4("alphar4","",0.7,0.8);
//        RooCBShape cballr1("cballr1", "crystal ball", Bplus_Corrected_Mass, cbmeanr4, cbsigmar4, alphar4, nr4);
...
//        RooRealVar nr2("nr2","",0.1, 5.0);
//        RooRealVar alphar2("alphar2","",0.1,5.0);
//        RooCBShape cballr2("cballr2", "crystal ball", Bplus_Corrected_Mass, cbmeanr2, cbsigmar2, alphar2, nr2);
//
//        RooRealVar newexpocon_low(("newexpoconmis"),"newexpocon_low",-0.3,0.3);
//        RooExponential newexpoun_low(("newexpounmis"), "exponential_low",Bplus_Corrected_Mass,newexpocon_low);
//        RooRealVar frac2("frac2","frac of events in cb 1",0.0001,1.0);
//        RooRealVar frac3("frac3","frac of events in cb 1",0.0001,1.0);
//
//        RooAddPdf twocbs3("twocbs3","c3",RooArgList(cballr1,cballr2,newexpoun_low),RooArgList(frac1,frac2,frac3));
//        RooExtendPdf two_ext4("two_ext4","two_ext4",twocbs3,sig4);
...
//--off  //      Double_t newbinning[9]={4000,4200,4400,4600,4800,5000,5200,5400,5600,5800,7000};
//--off
//--off
//--off        
//--off        RooBinning newbinning(4000,7000);
//--off        newbinning.addBoundary(4200);
//--off        newbinning.addBoundary(4400);
//--off        newbinning.addBoundary(4600);
//--off        newbinning.addBoundary(4800);
//--off        newbinning.addBoundary(5000);
//--off        newbinning.addBoundary(5200);
//--off        newbinning.addBoundary(5400);
//--off        newbinning.addBoundary(5600);
//--off        newbinning.addBoundary(5800);
//--off//        newbinning.addBoundary(7000);
//--off    
//--off        newbinning.Print();
//--off       Bplus_Corrected_Mass.setBinning(newbinning);
//--off//        newbinning.add(4200);
//--off	RooDataHist binnedData("binnedData","binnedData",RooArgSet(Bplus_Corrected_Mass));//,RooArgSet(newbinning));
//--off
//--off	for (int z(0); z<9; z++)
//--off	{
//--off		binnedData.get(z);
//--off		binnedData.get(z);
//--off		binnedData.set(binnedData.weight(),binnedData.weightError(RooAbsData::SumW2));
//--off
//--off	}
//--off
//--off	cout<<"See what happened to values by merging bins: "<<endl; 
//--off	errorsheet<<"----------------merging last 6 bins-------------"<<endl;
//--off	for (int i(0); i<9; i++)
//--off	{
//--off		binnedData.get(i);
//--off		cout<<" Bin "<<i<<" x = "<<binnedData.get(i)->getRealValue("Bplus_Corrected_Mass")<<" Weight="<<binnedData.weight()<<"New Weight Error= "<<binnedData.weightError(RooAbsData::SumW2)<<endl;
//--off		errorsheet<<i<<" & "<<binnedData.get(i)->getRealValue("Bplus_Corrected_Mass")<<"& "<<binnedData.weight()<<" & "<<binnedData.weightError(RooAbsData::SumW2)<<endl;
...
//--off
//--off
//--off	cout<<"cummulative info about last 6 bins: "<<endl;
//--off	double value(0);
//--off	double error(0);
//--off
//--off	for (int j(9); j<15; j++)
//--off	{
//--off
//--off		binnedData.get(j);
//--off		value+=binnedData.weight();
//--off                errorsheet<<" Adding value for the last bin "<<binnedData.weight()<<endl;
//--off		error+=(binnedData.weightError(RooAbsData::SumW2)*binnedData.weightError(RooAbsData::SumW2));
//--off                errorsheet<<" Adding error for the last bin "<<binnedData.weightError(RooAbsData::SumW2)<<endl;
//--off	}
//--off
//--off	for (int i(9); i<10; i++)
//--off	{
//--off		binnedData.get(i);
//--off		binnedData.set(value/6.0,(((sqrt(error))/6.0)));
//--off	}
//--off
//--off	errorsheet<<"----------------Info about the last bin-------------"<<endl;
//--off	for (int i(9); i<10; i++)
//--off	{
//--off//		cout<<" Bin "<<i<<" x = "<<binnedData.get(i)->getRealValue("Bplus_Corrected_Mass")<<" Weight="<<binnedData.weight()<<"New Weight Error= "<<binnedData.weightError(RooAbsData::SumW2)<<endl;
//--off
...
//--off	}
//--off
//--off        cout<<"Integral of old "<<binnedData.sum(kTRUE)<<endl;
//--off        cout<<"Integral of new "<<binnedData.sum(kTRUE)<<endl;
...
//--------------------------------------Product of params function and error matrix-------------------------------------------//
	 ...
	 RooRealVar mu_frac1(("mu_frac1"),"frac1mu",frac1.getVal());
	 RooRealVar mu_newexpoconmis(("mu_newexpoconmis"),"newexpoconmismu",newexpocon_low.getVal());
 	 ...
 	 RooRealVar scale_for_misid("scale_for_misid","scale_for_misid",100.0);
         ...
         double oldval04=cov_chi[0][4];
         double oldval14=cov_chi[1][4];
         double oldval24=cov_chi[2][4];
         double oldval34=cov_chi[3][4];
         double oldval44=cov_chi[4][4];
         double oldval43=cov_chi[4][3];
         double oldval42=cov_chi[4][2];
         double oldval41=cov_chi[4][1];
         double oldval40=cov_chi[4][0];

	 TMatrixDSym cov_chi_new(cov_chi);
	 cov_chi_new[0][4]=oldval04*100.0;
	 cov_chi_new[1][4]=oldval14*100.0;
	 cov_chi_new[2][4]=oldval24*100.0;
	 cov_chi_new[3][4]=oldval34*100.0;
	 cov_chi_new[4][4]=oldval44*10000.0;
	 cov_chi_new[4][3]=oldval43*100.0;
	 cov_chi_new[4][2]=oldval42*100.0;         
	 cov_chi_new[4][1]=oldval41*100.0;
	 cov_chi_new[4][0]=oldval40*100.0;         
	 //cov_chi_new[0][2]=0.0;
	 //cov_chi_new[1][2]=0.0;
	 //cov_chi_new[2][1]=0.0;
	 //cov_chi_new[2][0]=0.0;
	 ...
	 cov_chi_new.Print("v");
         ...
         RooMultiVarGaussian mvg("mvg", "mvg",RooArgSet(cbmeanr4,cbsigmar4,frac1,newexpocon_low,misid_scaled),RooArgSet(mu_cbmeanr4,mu_cbsigmar4,mu_frac1,mu_newexpoconmis,mu_sig4),cov_chi_new);
...
//-------------Plot non uniform fit on non-nonuniform staff-------roofit is broken----
	...
	binnedData.plotOn(ibou_nonuni,DataError(RooAbsData::SumW2)); 
        two_ext4.plotOn(ibou_nonuni);
	RooPlot* ibou_nonuni2 = Bplus_Corrected_Mass.frame(Title("Binned histogram Non uniform bin")) ;
	binnedData.plotOn(ibou_nonuni2,DataError(RooAbsData::SumW2));
...
//            hist->GetErrorYlow(i), hist->GetErrorYhigh(i));
   ...
   TLine line2(4000, 3, 7000, 3);
   line2.SetLineColor(2);
   frame10->GetXaxis()->SetTitle("") ; gPad->SetLeftMargin(0.15) ; frame10->SetTitle("") ; frame10->Draw() ; line1.Draw("same"); line2.Draw("same");   
...
{ 
	...
	TFile* f = new TFile((sigdir+"/"+signalfilename+"2016"+PIDcut+"Turbo16.root").c_str());
	TTree* t = (TTree*)f->Get("DecayTree");
...
//          RooRealVar ses_low_2016("ses_2016","Single event sensitivity",ses2016,double(ses2016-(5.0*ses2016err)),double(ses2016+(5.0*ses2016err)));         
          ...
          RooRealVar nexp_low("nexp","n explow",0.1,60000);
