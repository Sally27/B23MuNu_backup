...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal_before_combibdt/estimateforcombibdt_finalPID_Run1/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal_before_combibdt/estimateforcombibdt_finalPID_Run1/workspace_plots/"), 
    fitdir("/vols/lhcb/ss4314/fitsignal_before_combibdt/estimateforcombibdt_finalPID_Run1/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal_before_combibdt/estimateforcombibdt_finalPID_Run1/workspace_fitcls/"),
    workspacedir("/vols/lhcb/ss4314/fitsignal_before_combibdt/estimateforcombibdt_finalPID_Run1/workspace_preparation/"),
    fitresdir("/vols/lhcb/ss4314/fitsignal_before_combibdt/estimateforcombibdt_finalPID_Run1/fit_results"),
    comparedir("/vols/lhcb/ss4314/fitsignal_before_combibdt/estimateforcombibdt_finalPID_Run1/compare_fits"),
    ...
    datadir("/vols/lhcb/ss4314/beforecombibdt/estimateforcombibdt_newTCK_Run1/Run1/bin"),
...
//    ses2016(returnVar("/vols/lhcb/ss4314/SingleEventSensitivity/SesFUMSB_NOTsimultaneous_final_optimisation_GenLevelEff/info/info_SES_2016_probmu35.root", "Info_2016", "sensitivity")),
 //   ses2016err(returnVar("/vols/lhcb/ss4314/SingleEventSensitivity/SesFUMSB_NOTsimultaneous_final_optimisation_GenLevelEff/info/info_SES_2016_probmu35.root", "Info_2016", "sensitivity_err")),
    ...
    numberofpartreco(returnVar("/vols/lhcb/ss4314/compare_mcpartreco_and_mcsignal/normalize_to_jpsiK_beforcombibdt/PR_info/PR_Yield.root", "PR_Yield_no", "numofevents_no")),
    numberofpartreco_error(returnVar("/vols/lhcb/ss4314/compare_mcpartreco_and_mcsignal/normalize_to_jpsiK_beforcombibdt/PR_info/PR_Yield.root", "PR_Yield_no", "numofevents_err_no"))
    {}
