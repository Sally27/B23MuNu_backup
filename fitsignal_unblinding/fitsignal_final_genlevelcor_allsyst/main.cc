...
////        lhcbSally();
	...
	run.plotprettysim_chi2("",ok.c_str(),pid2.c_str(),"fitresults_bkghypo_forCLs_syst_100_final.root","normsigpdf",false);
	run.plotprettysim_chi2("",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final.root","normsigpdf",true);

	run.plotprettysim_chi2_reallynice("",ok.c_str(),pid2.c_str(),"fitresults_bkghypo_forCLs_syst_100_final.root","normsigpdf",false);
	run.plotprettysim_chi2_reallynice("",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final.root","normsigpdf",true);
//	run.plotprettysim_chi2_reallynice("",ok.c_str(),pid2.c_str());
        run.plotpretty_plotnicely_paper_sigsim_drive(false);
        run.plotpretty_plotnicely_paper_sigsim_drive(true);
        run.plotpretty_plotnicely_paper_prsim_drive(false);
        run.plotpretty_plotnicely_paper_prsim_drive(true);
        run.plotpretty_plotnicely_paper_misiddata_drive(false,ok.c_str(),pid2.c_str());
        run.plotpretty_plotnicely_paper_misiddata_drive(true,ok.c_str(),pid2.c_str());
