...
//    RooAbsPdf* pdf_DD_int = ws_int->pdf("normsigpdf_HighFCME");
 ...
 //   RooCategory* cat_int = (RooCategory*)ws_int->cat("sample");
    ...
    RooArgSet constraints=ws_int->argSet("eff_ratio_pr_con,BRpr_con,eff_ratio_run1_err_tot_con,eff_ratio_2016_err_tot_con,jpsik_run1_con,jpsik_2016_con,BRnorm_con"); 

    normpdf_low->getParameters(*mass_int)->Print("v") ;
    ...
    RooFitResult* data_intresult_free = normpdf_low->fitTo(*data_low,RooFit::Extended(true),RooFit::Range("low,high"),ExternalConstraints(constraints),RooFit::Save(true));

    TCanvas* firstfit= new TCanvas("firstfit", "firstfit",800,400);

    RooPlot* frame1 = mass_int->frame(Title("firstfitLow"),Bins(60)) ;
...
//unbl    firstfit->Divide(2) ;
//unbl    RooPlot* frame1 = mass_int->frame(Title("firstfitLowFCME"),Bins(60)) ;
//unbl    data_int->plotOn(frame1,Cut("sample==sample::LowFCME")) ;
//unbl    cout<<"PLOT FINISH 1"<<endl;
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),ProjWData(*cat_int,*data_int),RooFit::Range("low"),RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),ProjWData(*cat_int,*data_int),RooFit::Range("high"),RooFit::NormRange("high"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),Components(("newexpoun_LowFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kRed),RooFit::Range("low"),RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),Components(("misidModel_LowFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kCyan),RooFit::Range("low"), RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),Components(("newpartreco_LowFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kMagenta),RooFit::Range("low"),RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),Components(("newexpoun_LowFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kRed),RooFit::Range("high"),RooFit::NormRange("high"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),Components(("misidModel_LowFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kCyan),RooFit::Range("high"), RooFit::NormRange("high"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),Components(("newpartreco_LowFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kMagenta),RooFit::Range("high"),RooFit::NormRange("high"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),Components(("blah_LowFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kGreen),RooFit::Range("low"), RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame1,Slice(*cat_int,"LowFCME"),Components(("blah_LowFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kGreen),RooFit::Range("high"),RooFit::NormRange("high"));
//unbl
//unbl    cout<<"PLOT FINISH 2"<<endl;
//unbl    RooPlot* frame2 = mass_int->frame(Title("firstfitHighFCME"),Bins(60)) ;
//unbl    data_int->plotOn(frame2,Cut("sample==sample::HighFCME")) ;
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),ProjWData(*cat_int,*data_int),RooFit::Range("low"),RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),ProjWData(*cat_int,*data_int),RooFit::Range("high"),RooFit::NormRange("high"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),Components(("newexpoun_HighFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kRed),RooFit::Range("low"),RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),Components(("misidModel_HighFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kCyan),RooFit::Range("low"), RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),Components(("newpartreco_HighFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kMagenta),RooFit::Range("low"),RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),Components(("newexpoun_HighFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kRed),RooFit::Range("high"),RooFit::NormRange("high"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),Components(("misidModel_HighFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kCyan),RooFit::Range("high"), RooFit::NormRange("high"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),Components(("newpartreco_HighFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kMagenta),RooFit::Range("high"),RooFit::NormRange("high"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),Components(("blah_HighFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kGreen),RooFit::Range("low"), RooFit::NormRange("low"));
//unbl    pdf_int->plotOn(frame2,Slice(*cat_int,"HighFCME"),Components(("blah_HighFCME")),ProjWData(*cat_int,*data_int),LineStyle(kDashed),LineColor(kGreen),RooFit::Range("high"),RooFit::NormRange("high"));

    gPad->SetLeftMargin(0.15) ; frame1->GetYaxis()->SetTitleOffset(1.1) ; frame1->Draw() ;
//    firstfit->cd(2) ; gPad->SetLeftMargin(0.15) ; frame2->GetYaxis()->SetTitleOffset(1.1) ; frame2->Draw() ;
    firstfit->SaveAs((plotdir+"FitResult_NONsimultaneous_injectsig_"+ cleanNameString(d2s(BF_int->getVal()))+".pdf").c_str());
...
//    c_float->cd(2) ; gPad->SetLeftMargin(0.15) ; frame2->GetYaxis()->SetTitleOffset(1.1) ; frame2->Draw() ;
    c_float->SaveAs((plotdir+"FitResult_NONsimultaneous_withfloatingvar_injectsig_"+ cleanNameString(d2s(BF_int->getVal()))+".pdf").c_str());



    RooArgSet* params2 = normpdf_low->getParameters(*mass_int);
    params2->writeToFile((plotdir+"NONSimultaneousFitResults_bkgpdfandsigpdf_with_"+cleanNameString(d2s(BF_int->getVal()))+"_variables_syst_100.txt").c_str());
    ofstream outsig((plotdir+"NONSimultaneousFitResults_bkgpdfandsigpdfwith_"+cleanNameString(d2s(BF_int->getVal()))+"_fullfitinfo_syst_100.txt").c_str());
    saveFitInfo_abspdf(outsig, frame1, 10, normpdf_low,data_intresult_free);

    TFile file3((clsdir+"fitresults_sigandbkghypo_forCLs_syst_100_final.root").c_str(), "RECREATE");
 ...
 //   workspaceFit3.import(*data_high);
    ...
    workspaceFit3.import(*normpdf_low,RecycleConflictNodes());
    ...
    RooFitResult* data_intresult_fixed = normpdf_low->fitTo(*data_low,RooFit::Extended(true),RooFit::Range("low1,high1"),ExternalConstraints(constraints),RooFit::Save(true));

    TCanvas* secondfit= new TCanvas("secondfit", "secondfit",800,400);

    RooPlot* frame3 = mass_int->frame(Title("firstfit"),Bins(60)) ;
    data_low->plotOn(frame3, MarkerSize(0.9), LineColor(kBlack),RooFit::Name("data2"),RooFit::Range("low,high"));
    normpdf_low->plotOn(frame3, Components("newexpoun"), RooFit::Range("low"),RooFit::NormRange("low") ,LineColor(kRed));
    normpdf_low->plotOn(frame3, Components("misidModel"), RooFit::Range("low"),RooFit::NormRange("low") ,LineColor(kCyan));
    normpdf_low->plotOn(frame3, Components("newpartreco"), RooFit::Range("low"),RooFit::NormRange("low"),LineColor(kMagenta));
    normpdf_low->plotOn(frame3, Components("newexpoun"), RooFit::Range("high"),RooFit::NormRange("high") ,LineColor(kRed));
    normpdf_low->plotOn(frame3, Components("misidModel"), RooFit::Range("high"),RooFit::NormRange("high") ,LineColor(kCyan));
    normpdf_low->plotOn(frame3, Components("newpartreco"), RooFit::Range("high"),RooFit::NormRange("high"),LineColor(kMagenta));
    normpdf_low->plotOn(frame3, LineColor(kBlue),RooFit::Range("high"),RooFit::NormRange("high"));
    normpdf_low->plotOn(frame3, LineColor(kBlue),RooFit::Range("low"),RooFit::NormRange("low"));


    gPad->SetLeftMargin(0.15) ; frame3->GetYaxis()->SetTitleOffset(1.1) ; frame3->Draw() ;
    secondfit->SaveAs((plotdir+"FitResult_NONsimultaneous_injectsig_"+ cleanNameString(d2s(BF_int->getVal()))+".pdf").c_str());

    TCanvas* c_float2 = new TCanvas("float","float",800,400) ;
//    c_float2->Divide(2) ;
    normpdf_low->paramOn(frame3, Format("NELU"), Layout(0.5, 0.5, 0.6));
...
//    c_float2->cd(2) ; gPad->SetLeftMargin(0.15) ; frame4->GetYaxis()->SetTitleOffset(1.1) ; frame4->Draw() ;
    c_float2->SaveAs((plotdir+"FitResult_NONsimultaneous_withfloatingvar_injectsig_"+ cleanNameString(d2s(BF_int->getVal()))+".pdf").c_str());


    RooArgSet* params3 = normpdf_low->getParameters(*mass_int);
    params3->writeToFile((plotdir+"NONSimultaneousFitResults_bkgpdf_variables_syst_100.txt").c_str());
    ofstream outbkg((plotdir+"NONSimultaneousFitResults_bkgpdf_fullfitinfo_syst_100.txt").c_str());
    saveFitInfo_abspdf(outbkg, frame3, 10, normpdf_low,data_intresult_fixed);


    delete secondfit;

    TFile file4((clsdir+"fitresults_bkghypo_forCLs_syst_100_final.root").c_str(), "RECREATE");
...
//      workspaceFit2.import(simPdf,RecycleConflictNodes());
	workspaceFit4.import(*normpdf_low,RecycleConflictNodes());
...
//   model_total->plotOn(frame, RooFit::NormRange("low,high"), RooFit::Range("low,high"),RooFit::Components(("misidModel,newpartreco")),RooFit::Name("mis2"),RooFit::FillColor(99), RooFit::LineColor(99), RooFit::DrawOption("F"));
  ...
  if (signalcomp==true)
   ...
   {
           model_total->plotOn(frame,Components(("blah")),LineColor(95),RooFit::FillColor(95),RooFit::Range("low"),RooFit::NormRange("low"),RooFit::Name("signal"),RooFit::DrawOption("F"),VLines());

           model_total->plotOn(frame,Components(("blah")),LineColor(95),RooFit::FillColor(95),RooFit::Range("high"),RooFit::NormRange("high"),RooFit::DrawOption("F"),VLines());
   }
...
//   printLHCb("middle","Other",optText);
   ...
   canvTot.Print((plotdir+type+pidcutRun1+pidcutRun2+"plotB23MuNuFitPretty_chi2_"+nameofpdf+"_with_"+cleanNameString(d2s(BF_int->getVal()))+"reallynice.pdf").c_str());
   canvTot.Print((plotdir+type+pidcutRun1+pidcutRun2+"plotB23MuNuFitPretty_chi2_"+nameofpdf+"_with_"+cleanNameString(d2s(BF_int->getVal()))+"reallynice.root").c_str());

   canv.SetLogy();
   canvTot.cd(1);
   canv.DrawClonePad();
   canvTot.Print((plotdir+type+pidcutRun1+pidcutRun2+"plotB23MuNuFitLogyPretty_chi2_"+nameofpdf+"_with_"+cleanNameString(d2s(BF_int->getVal()))+"reallynice.pdf").c_str());
   canvTot.Print((plotdir+type+pidcutRun1+pidcutRun2+"plotB23MuNuFitLogyPretty_chi2_"+nameofpdf+"_with_"+cleanNameString(d2s(BF_int->getVal()))+"reallynice.root").c_str());
...
//            hist->GetErrorYlow(i), hist->GetErrorYhigh(i));
   ...
   if (signalcomp==true)
   {
    model_total->plotOn(frame,Components(("blah")),LineStyle(kDashed),LineColor(kGreen),RooFit::Range("low,high"),RooFit::NormRange("low,high"),RooFit::Name("signal"));
   }
...
//	 RooGaussian BRpr_con("BRpr_con","BRpr_con",BRpr,BRprval,BRprerr); //stat and syst
	...
	RooPlot* frame1 = Bplus_Corrected_Mass.frame(Bins(60),Title("No Fractional Corrected Mass Error")) ;
        //RooArgSet allsignalcon;

	//RooArgSet allsignalcon("eff_ratio_pr_con,BRpr_con,eff_ratio_run1_err_tot_con,eff_ratio_2016_err_tot_con,jpsik_run1_con,jpsik_2016_con,BRnorm_con"); 
	bool systematics(true);

	if (systematics==true)
	{

		RooArgSet allsignalcon(eff_ratio_pr_con,BRpr_con,eff_ratio_run1_err_tot_con,eff_ratio_2016_err_tot_con,jpsik_run1_con,jpsik_2016_con,BRnorm_con,"syst_sig"); 
		...
		workspaceFit3.import(allsignalcon);
		//	workspaceFit2.import(simPdf,RecycleConflictNodes());
		workspaceFit3.import(normsigpdf_low,RecycleConflictNodes());
		workspaceFit3.Write("", TObject::kOverwrite);
		cout<<"Workspace for fit has been saved:"<<endl;
...
//		workspaceFit2.import(combData);
		...
		workspaceFit2.import(normpdf_low,RecycleConflictNodes());
...
//unbl		workspaceFit2.import(normpdf_low);
//unbl		workspaceFit2.import(allsignalcon);
//unbl		workspaceFit2.import(normsigpdf_low,RecycleConflictNodes());
...
//unbl        TFile file((clsdir+"fitresults_forCLs.root").c_str(), "RECREATE");
//unbl
//unbl	RooWorkspace workspaceFit("workspaceFit", "workspaceFit");
//unbl
//unbl        workspaceFit.import(Bplus_Corrected_Mass);
//unbl	workspaceFit.import(*data_low);
//unbl        //workspaceFit.import(combData);
//unbl        workspaceFit.import(normpdf_low);
//unbl//        workspaceFit.import(*npr_low_con);
//unbl//        workspaceFit.import(ses_low_con);
//unbl//        workspaceFit.import(ses_low_2016_con);
//unbl
//unbl        workspaceFit.import(allsignalcon);
//unbl        workspaceFit.import(normsigpdf_low,RecycleConflictNodes());
//unbl//        workspaceFit.import(allsignalcon,RecycleConflictNodes());
//unbl        //workspaceFit.import(allbkgcon,RecycleConflictNodes());
//unbl	//workspaceFit.writeToFile(workspaceFileName.c_str());
//unbl	workspaceFit.Write("", TObject::kOverwrite);
//unbl	//
//unbl	cout<<"Workspace for fit has been saved:"<<endl;
//unbl	workspaceFit.Print();
//unbl	//
//unbl	//
//unbl	file.Close();
