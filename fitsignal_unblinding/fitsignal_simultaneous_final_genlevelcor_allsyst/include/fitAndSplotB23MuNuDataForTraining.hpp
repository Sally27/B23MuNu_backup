...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst/workspace_plots/"), 
    fitdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst/workspace_fitcls/"),
    workspacedir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst/workspace_preparation/"),
    fitresdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst/fit_results"),
    comparedir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst/compare_fits"),
...
//Sally's addition//
   ...
   void plotprettysim_chi2_reallynice(string type, string pidcutRun1, string pidcutRun2,string nameofclsroot, string nameofpdf);
