...
//	//-----------------------RUN chi2 fit-----------------//
	...
	run.plotprettysim_chi2("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_bkghypo_forCLs_syst_100.root","simPdf",false);
	run.plotprettysim_chi2("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_bkghypo_forCLs_syst_100.root","simPdf",false);
	run.plotprettysim_chi2("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100.root","simPdfsig",true);
	run.plotprettysim_chi2("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100.root","simPdfsig",true);

//        lhcbSally();
	run.plotprettysim_chi2_reallynice("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_bkghypo_forCLs_syst_100.root","simPdf");
	run.plotprettysim_chi2_reallynice("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_bkghypo_forCLs_syst_100.root","simPdf");
