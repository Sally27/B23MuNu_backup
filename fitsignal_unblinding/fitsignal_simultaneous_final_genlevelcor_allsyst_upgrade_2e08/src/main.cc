...
//        run.calculateFOM_chi2("HighFCME",ok.c_str(),pid2.c_str());
	...
	run.plotprettysim_chi2("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final.root","simPdfsig",true);
	run.plotprettysim_chi2("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final.root","simPdfsig",true);
//
////        lhcbSally();
	...
	run.plotprettysim_chi2_reallynice("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final.root","simPdfsig",true);
	run.plotprettysim_chi2_reallynice("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final.root","simPdfsig",true);
