...
//	//-----------------------RUN chi2 fit-----------------//
	...
	run.fitmisidcomponentall_chi2(dir,misidfilenames,weights,species, "HighFCME",ok.c_str(),pid2.c_str());
        ...
        run.calculateFOM_chi2("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__2e_08.root");
        run.calculateFOM_chi2("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__2e_08.root");
...
////        lhcbSally();
	...
	run.plotprettysim_chi2_reallynice("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__2e_08.root","simPdfsig",true);
        ...
        run.simfit_fit_freeBF("fitresults_sigandbkghypo_forCLs_syst_100_final__2e_08.root");
