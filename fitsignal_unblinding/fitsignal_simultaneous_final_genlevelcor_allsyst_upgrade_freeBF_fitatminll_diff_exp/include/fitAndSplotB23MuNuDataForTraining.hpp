...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp/workspace_plots/"), 
    plotdir_free("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp/workspace_plots_freeBF/"), 
    fitdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp/workspace_fitcls/"),
    workspacedir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp/workspace_preparation/"),
    fitresdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp/fit_results"),
    comparedir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp/compare_fits"),
...
//Sally's addition//
  ...
  void simfit_fit_freeBF(string filenameofprefit);
...
//   vector<double> fitmisidcomponent(string type);
   ...
   void calculateFOM_chi2(string type, string PIDcutRun1, string PIDcutRun2, string filename);
