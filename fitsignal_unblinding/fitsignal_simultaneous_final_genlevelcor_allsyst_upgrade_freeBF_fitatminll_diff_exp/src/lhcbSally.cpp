...
////////////////////////////////////////////////////////////////////
	...
	if(optLR=="R"){    
		...
		cout<<"Choosing position"<<endl;
		lhcbName = new TPaveText(lhcbSally->GetPadLeftMargin() + 0.13,
				0.8 - lhcbSally->GetPadTopMargin(),
				lhcbSally->GetPadLeftMargin() + 0.28,
				0.9 - lhcbSally->GetPadTopMargin(),
				"BRNDC");
		cout<<"Choosing position"<<endl;
	}
        else if(optLR=="LLLplusplus"){

		cout<<"Choosing position"<<endl;
		lhcbName = new TPaveText(lhcbSally->GetPadLeftMargin() + 0.15,
				0.77 - lhcbSally->GetPadTopMargin(),
				lhcbSally->GetPadLeftMargin() + 0.37,
		...
		cout<<"Choosing position"<<endl;
                ...
                lhcbName = new TPaveText(lhcbSally->GetPadLeftMargin() + 0.3,
                                0.65 - lhcbSally->GetPadTopMargin(),
		...
		lhcbName = new TPaveText(0.65 - lhcbSally->GetPadRightMargin(),
				0.35,// - lhcbSally->SetPadTopMargin(float(0.05)),
				0.9,// - lhcbSally->GetPadRightMargin(),
		...
		lhcbName = new TPaveText(0.7 - lhcbSally->GetPadRightMargin(),
				0.25,// - lhcbSally->SetPadTopMargin(float(0.05)),
				0.92,// - lhcbSally->GetPadRightMargin(),
				0.35,// - lhcbSally->SetPadTopMargin(float(0.05)),
				"BRNDC");
		cout<<"Choosing position"<<endl;
	}
