...
//	//-----------------------RUN chi2 fit-----------------//
	...
	run.fitmisidcomponentall_chi2(dir,misidfilenames,weights,species, "HighFCME",ok.c_str(),pid2.c_str());
        ...
        run.calculateFOM_chi2("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__1_5e_08.root");
        run.calculateFOM_chi2("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__1_5e_08.root");
        run.calculateFOM_chi2("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_bkghypo_forCLs_syst_100_final_0.root");
        run.calculateFOM_chi2("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_bkghypo_forCLs_syst_100_final_0.root");
	...
	run.plotprettysim_chi2("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__1_5e_08.root","simPdfsig",true);
	run.plotprettysim_chi2("HighFCME",ok.c_str(),pid2.c_str(),"itresults_sigandbkghypo_forCLs_syst_100_final__1_5e_08.root","simPdfsig",true);
//
////        lhcbSally();
	...
	run.plotprettysim_chi2_reallynice("LowFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__1_5e_08.root","simPdfsig",true);
	run.plotprettysim_chi2_reallynice("HighFCME",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__1_5e_08.root","simPdfsig",true);
        run.plotprettysim_chi2_reallynice_both("",ok.c_str(),pid2.c_str(),"fitresults_sigandbkghypo_forCLs_syst_100_final__1_5e_08.root","simPdfsig",true);
        ...
        run.simfit_fit_freeBF("fitresults_sigandbkghypo_forCLs_syst_100_final__1_5e_08.root");

        string freebf("fitresults_sigandbkghypo_forCLs_syst_100_final_freeBF.root");

        run.calculateFOM_chi2("LowFCME",ok.c_str(),pid2.c_str(),freebf);
        run.calculateFOM_chi2("HighFCME",ok.c_str(),pid2.c_str(),freebf);
	run.plotprettysim_chi2("LowFCME",ok.c_str(),pid2.c_str(),freebf,"simPdfsig",true);
