...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp_myProfile/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp_myProfile/workspace_plots/"), 
    fitdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp_myProfile/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp_myProfile/workspace_fitcls/"),
    workspacedir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp_myProfile/workspace_preparation/"),
    fitresdir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp_myProfile/fit_results"),
    comparedir("/vols/lhcb/ss4314/fitsignal_unblinding/fitsignal_simultaneous_final_genlevelcor_allsyst_upgrade_freeBF_fitatminll_diff_exp_myProfile/compare_fits"),
...
//   void simfitseparateandsavesig_chi2fit(string year, string PIDcut); //nonsimultaneous and year based fit
   void simfitseparateandsavesig_chi2fit_100cor_old(); //100 correlation
