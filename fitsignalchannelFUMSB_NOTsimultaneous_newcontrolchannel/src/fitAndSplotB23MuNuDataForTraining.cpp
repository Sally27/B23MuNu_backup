...
void FitAndSplotB23MuNuDataForTraining::plotprettysimrookeys(string type)
{ 
   cout<<"Plotting result of the fit"<<endl;
   TFile fw((clsdir+"Kestfitresults_forCLs.root").c_str());
   ...
   Bplus_Corrected_Mass->setRange("sig",4500,5500);
   ...
   Bplus_Corrected_Mass->setBins(90);
   RooPlot* frame = Bplus_Corrected_Mass->frame(Title(""));
   data->plotOn(frame,RooFit::Name("fitdata"));
//   datanofit->plotOn(frame, MarkerSize(0.9),MarkerColor(kGreen),LineColor(kGreen));
   model_total->plotOn(frame,RooFit::LineColor(kBlue), RooFit::Range("full"), RooFit::NormRange("low,high"), RooFit::LineColor(kBlue) );
   model_total->plotOn(frame,RooFit::LineColor(kBlue), RooFit::Range("full"), RooFit::NormRange("low,high"), RooFit::LineColor(kBlue) );
   frame->Print("V");
   ...
   model_total->plotOn(frame, RooFit::LineColor(kRed),RooFit::Components(("newexpoun")),RooFit::NormRange("low,high"), RooFit::Range("full"), RooFit::Name("combinatorial"));//RooFit::Range("low,high");
   model_total->plotOn(frame, RooFit::LineColor(kCyan),RooFit::Components(("kest1")),RooFit::NormRange("low,high"), RooFit::Range("full"), RooFit::Name("mis2"));
   ...
   ofstream out((plotdir+type+"KeysFitResults.txt").c_str());
   ...
   canvTot.Print((plotdir+type+"KeysplotB23MuNuFitPretty.pdf").c_str());
   canvTot.Print((plotdir+type+"KeysplotB23MuNuFitPretty.root").c_str());

   canv.SetLogy();
   canvTot.cd(1);
   canv.DrawClonePad();
   canvTot.Print((plotdir+type+"KeysplotB23MuNuFitLogyPretty.pdf").c_str());
   canvTot.Print((plotdir+type+"KeysplotB23MuNuFitLogyPretty.root").c_str());
...
//   auto dataHist = (RooHist*) frame->getHist(("fitdata"));
   ...
   model_total->plotOn(frame, RooFit::LineColor(kRed),RooFit::Components(("newexpoun")),RooFit::NormRange("low,high"), RooFit::Range("full"), RooFit::Name("combinatorial"));//RooFit::Range("low,high");
   model_total->plotOn(frame, RooFit::LineColor(kCyan),RooFit::Components(("twocbs")),RooFit::NormRange("low,high"), RooFit::Range("full"), RooFit::Name("mis2"));
   model_total->plotOn(frame, RooFit::LineColor(kMagenta), RooFit::Components(("newpartreco")),RooFit::NormRange("low,high"), RooFit::Range("full"), RooFit::Name("partreco"));
///   datanofit->plotOn(frame, MarkerSize(0.9),MarkerColor(kGreen),LineColor(kGreen),RooFit::Name("signaldata"));
...
{ 
	...
	RooRealVar cbsignalrar(("cbsignalrar"),("cbsignalrar"+type).c_str(),8400,8000,7000) ;
...
void FitAndSplotB23MuNuDataForTraining::prepareWorkspaceNoFitData(string type)
{
	TFile f( (datadir+"/"+nofitdata+"_Probnnmu3.root").c_str());
	TTree* t = (TTree*)f.Get(treename.c_str());
...
vector<double> FitAndSplotB23MuNuDataForTraining::fitmisidcomponentrookeys(string type)
{
	...
	RooKeysPdf kest1("kest1","kest1",Bplus_Corrected_Mass,dpw,RooKeysPdf::NoMirror);
	RooKeysPdf kest2("kest2","kest2",Bplus_Corrected_Mass,dpw,RooKeysPdf::MirrorBoth);
	RooPlot* frame15 = Bplus_Corrected_Mass.frame(Title("Adaptive kernel estimation pdf with and withou mirroring"),Bins(90)) ;
	dpw.plotOn(frame15);
	...
	roo->SaveAs((workspacedir+"FittingMisIDUnBinnedRooKeys_"+type+".pdf").c_str());
...
void FitAndSplotB23MuNuDataForTraining::fitplotrookeys()
{
	  ...
	  ws_low->Print();
          ...
          RooAbsPdf* pdf_misid_low = wsmisid_low->pdf(("kest1"));
	  ...
	  RooRealVar ses_low("ses","Single event sensitivity",7.48e-10,5.0e-10,9.0e-10);
	...
	RooRealVar* Bplus_Corrected_Mass = workspaceData_low->var("Bplus_Corrected_Mass");
	RooDataSet* data_low = (RooDataSet*)workspaceData_low->data("data");

	if(!data_low || !Bplus_Corrected_Mass)
	{
		cerr<<"ERROR: in function FitAndSplotB23MuNuDataForTraining, error downloading stuff from workspace"<<endl;
		return;
	}
 ...
 //       RooDataSet  = normpdf_low.generate(Bplus_Corrected_Mass,2400);

        RooArgSet* params = normpdf_low.getParameters(*Bplus_Corrected_Mass);
        params->writeToFile((plotdir+"KestSimultaneousFitResults.txt").c_str());
	...
	RooPlot* frame1 = Bplus_Corrected_Mass->frame(Bins(90),Title("No Fractional Corrected Mass Error")) ;
	...
	normpdf_low.plotOn(frame1, Components("kest1"), RooFit::Range("low"),RooFit::NormRange("low") ,LineColor(kCyan));
	normpdf_low.plotOn(frame1, Components("newpartreco"), RooFit::Range("low"),RooFit::NormRange("low"),LineColor(kMagenta));
        ...
        normpdf_low.plotOn(frame1, Components("kest1"), RooFit::Range("high"),RooFit::NormRange("high") ,LineColor(kCyan));
        normpdf_low.plotOn(frame1, Components("newpartreco"), RooFit::Range("high"),RooFit::NormRange("high"),LineColor(kMagenta));
        normpdf_low.plotOn(frame1, Components("newexpoun"), RooFit::Range("sig"),RooFit::NormRange("sig") ,LineColor(kRed));
        normpdf_low.plotOn(frame1, Components("kest1"), RooFit::Range("sig"),RooFit::NormRange("sig") ,LineColor(kCyan));
        normpdf_low.plotOn(frame1, Components("newpartreco"), RooFit::Range("sig"),RooFit::NormRange("sig"),LineColor(kMagenta));
        normpdf_low.plotOn(frame1, LineColor(kBlue),RooFit::Range("sig"),RooFit::NormRange("sig"));
	...
	normpdf_low.plotOn(frame1, LineColor(kBlue),RooFit::Range("low"),RooFit::NormRange("low"));
        datanofit->plotOn(frame1, MarkerSize(0.9),MarkerColor(kGreen),LineColor(kGreen));
	...
	c->cd(1) ; gPad->SetLeftMargin(0.15) ; frame1->GetYaxis()->SetTitleOffset(1.4) ; frame1->Draw() ;
        c->SaveAs((plotdir+"KestFitResult_NOFCME.pdf").c_str());

        TFile file((clsdir+"Kestfitresults_forCLs.root").c_str(), "RECREATE");
...
void FitAndSplotB23MuNuDataForTraining::fitplot()
{
	  ...
	  RooRealVar BR("BR","branching fraction",1.0e-8);
	  RooRealVar ses_low("ses","Single event sensitivity",9.36e-10,9.0e-10,1.0e-9);
...
//        }
 ...
 //       RooDataSet  = normpdf_low.generate(Bplus_Corrected_Mass,2400);
	...
	normpdf_low.plotOn(frame1, Components("newpartreco"), RooFit::Range("low"),RooFit::NormRange("low"),LineColor(kMagenta));
        ...
        normpdf_low.plotOn(frame1, Components("newpartreco"), RooFit::Range("high"),RooFit::NormRange("high"),LineColor(kMagenta));
        normpdf_low.plotOn(frame1, Components("newexpoun"), RooFit::Range("sig"),RooFit::NormRange("sig") ,LineColor(kRed));
        normpdf_low.plotOn(frame1, Components("twocbs"), RooFit::Range("sig"),RooFit::NormRange("sig") ,LineColor(kCyan));
        normpdf_low.plotOn(frame1, Components("newpartreco"), RooFit::Range("sig"),RooFit::NormRange("sig"),LineColor(kMagenta));
        normpdf_low.plotOn(frame1, LineColor(kBlue),RooFit::Range("sig"),RooFit::NormRange("sig"));
        normpdf_low.plotOn(frame1, LineColor(kBlue),RooFit::Range("high"),RooFit::NormRange("high"));
	normpdf_low.plotOn(frame1, LineColor(kBlue),RooFit::Range("low"),RooFit::NormRange("low"));
