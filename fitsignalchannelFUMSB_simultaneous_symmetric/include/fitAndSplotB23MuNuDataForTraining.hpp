...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric/workspace_plots/"), 
    workspacedir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric/workspace_preparation/"),
    workspaceFileNameSim("FitB23MuNuworkspace"),
    fitdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric/workspace_fitcls/"),
    tupledir("/vols/lhcb/ss4314/cutonFCME/FUMSB_simultaneous_symmetric"), 
    misiddir("/vols/lhcb/ss4314/addPIDweights/FUMSB_simultaneous_symmetric/finaltuples"),
