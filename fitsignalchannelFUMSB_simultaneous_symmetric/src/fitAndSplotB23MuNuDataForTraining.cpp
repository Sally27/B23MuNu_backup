...
void FitAndSplotB23MuNuDataForTraining::simfitseparateandsavesig()
{
	  ...
	  RooRealVar ses_low("ses_LowFCME","Single event sensitivity",1.7869e-9,1.2e-9,2.0e-9);
          RooRealVar ses_high("ses_HighFCME","Single event sensitivity",2.874e-9,2.5e-9,3.0e-9);
