...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric_nojackweight/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric_nojackweight/workspace_plots/"), 
    workspacedir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric_nojackweight/workspace_preparation/"),
    workspaceFileNameSim("FitB23MuNuworkspace"),
    fitdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric_nojackweight/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/fitsignalchannelFUMSB_simultaneous_symmetric_nojackweight/workspace_fitcls/"),
    tupledir("/vols/lhcb/ss4314/cutonFCME/FUMSB_simultaneous_symmetric"), 
    misiddir("/vols/lhcb/ss4314/addPIDweights/FUMSB_simultaneous_symmetric_nojackweight/finaltuples"),
    tuplename("finaldata_FitCorM"), 
    tuplenamelow("finaldata_LowFCME.root"),
    treename("DecayTree"),
    datadir("/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_simultaneous_symmetric"),
    ...
    typelow("LowFCME"),
    typehigh("HighFCME"),
    sigdir("/vols/lhcb/ss4314/preparesignalweights/preparesignalweights_simultaneous_symmetric/bin/")
    {}
