...
//	cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > 0.0)_All");
        ...
        string justfilename="B23MuNuNewMCNShared_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60andPPUNZIoptBDT_MISIDafter60.root";
...
//       cout<<"Soft MC eff: "<<softmceff<<" Hard MC eff: "<<hardmceff<<" Product: "<<finalmceff <<endl;
      ...
      addmultiplicationofbranches(justfilename, "mu1weight","mu2weight","mu3weight","mcweight");
      
        
       vector<double> mcsigval;
       mcsigval=paramfitsignal(justfilename,"mcweight");
//       return(1);
...
//        tags.push_back("NNmuminuspimore08");
	  ...
	  TTree* treer = gettreemcsig(justfilename,"mcweight");
          RooDataSet dr("dr","dr", RooArgSet(y,pw), Import(*treer), WeightVar("pw"));
...
//                  cout<<"Amount of partreco:"
		  double numberofsigevents=((12.3947)*finalmceff);
