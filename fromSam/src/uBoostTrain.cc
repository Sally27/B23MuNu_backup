...
void uBoostTrain(){
  ...
  TString bdt = "!H:!V:NTrees=100:MaxDepth=4:BoostType=AdaBoost:PruneMethod=NoPruning:SeparationType=GiniIndex:nCuts=-1";
  factory->BookMethod(TMVA::Types::kBDT,"BDT",bdt);
  bdt+=":uBoostFlag=1"; // add flag to use uBoost
  factory->BookMethod(TMVA::Types::kBDT,"UBDT","UBDT_Num=100:"+bdt); // 100 efficiency steps
  //factory->BookMethod(TMVA::Types::kBDT,"UBDT",bdt); // 100 efficiency steps
