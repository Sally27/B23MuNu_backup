...
names=("BuPiMuMuMC2012_MagDown")
end=".root"

iter=""
subdirs=(266)       #(501 502 505)
subjobs=(147)       #(1635 2954 14)
numbers=(0)       #(0 1 2)


#output="/vols/lhcbdisk03/alvarezc/B2Kee_Kmumu/B2Kee_data/BDT_training/kfold5/"
output="/vols/lhcb/ss4314/final_tuples/mc/jpsipi_mc/2012/MC_B2PiMuMu_MagDown.root"
