...
names=("B23MuNuFakeSS_2011")
end=".root"

iter=""
subdirs=(273)       #(501 502 505)
subjobs=(361)       #(1635 2954 14)
numbers=(0)       #(0 1 2)


#output="/vols/lhcbdisk03/alvarezc/B2Kee_Kmumu/B2Kee_data/BDT_training/kfold5/"
output="/vols/lhcb/ss4314/final_tuples/data/misid_data_ss/Run1/Data_B23MuNu_MisidSS_2011.root"
