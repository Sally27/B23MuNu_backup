...
names=("B23MuNuFakeSS_2012")
end=".root"

iter=""
subdirs=(274)       #(501 502 505)
subjobs=(775)       #(1635 2954 14)
numbers=(0)       #(0 1 2)


#output="/vols/lhcbdisk03/alvarezc/B2Kee_Kmumu/B2Kee_data/BDT_training/kfold5/"
output="/vols/lhcb/ss4314/final_tuples/data/misid_data_ss/Run1/Data_B23MuNu_MisidSS_2012.root"
