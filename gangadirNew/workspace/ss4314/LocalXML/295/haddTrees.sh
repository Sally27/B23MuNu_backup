...
names=("LambdaB2JpsipKMC_2016_MagUp")
end=".root"

iter=""
subdirs=(295)       #(501 502 505)
subjobs=(426)       #(1635 2954 14)
numbers=(0)       #(0 1 2)


#output="/vols/lhcbdisk03/alvarezc/B2Kee_Kmumu/B2Kee_data/BDT_training/kfold5/"
output="/vols/lhcb/ss4314/final_tuples/data/lambdab2pkmumu_data/2016/LambdaB2mumupKMC_2016_MagUp.root"
