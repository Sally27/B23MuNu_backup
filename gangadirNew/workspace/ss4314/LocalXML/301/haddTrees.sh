...
names=("BuKstMuMu_2016")
end=".root"

iter=""
subdirs=(301)       #(501 502 505)
subjobs=(1642)       #(1635 2954 14)
numbers=(0)       #(0 1 2)


#output="/vols/lhcbdisk03/alvarezc/B2Kee_Kmumu/B2Kee_data/BDT_training/kfold5/"
output="/vols/lhcb/ss4314/final_tuples/data/B2jpsikst_data/2016/B2JpsiKst_Data_2016_MagDown.root"
