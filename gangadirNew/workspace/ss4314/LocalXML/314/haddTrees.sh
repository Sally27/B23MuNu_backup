...
names=("B2JpsiKstMC_2011_MagDown")
end=".root"

iter=""
subdirs=(314)       #(501 502 505)
subjobs=(185)       #(1635 2954 14)
numbers=(0)       #(0 1 2)


#output="/vols/lhcbdisk03/alvarezc/B2Kee_Kmumu/B2Kee_data/BDT_training/kfold5/"
output="/vols/lhcb/ss4314/final_tuples/mc/B2jpsikst_mc/2011/B2JpsiKstMC_2011_MagDown.root"
