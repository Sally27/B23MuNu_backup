...
names=("Lamb2pkmumuMC_2011_MagUp")
end=".root"

iter=""
subdirs=(315)       #(501 502 505)
subjobs=(41)       #(1635 2954 14)
numbers=(0)       #(0 1 2)


#output="/vols/lhcbdisk03/alvarezc/B2Kee_Kmumu/B2Kee_data/BDT_training/kfold5/"
output="/vols/lhcb/ss4314/final_tuples/mc/lambda2pkmumu_mc/2011/LambdaB2mumupKMC_2011_MagUp.root"
