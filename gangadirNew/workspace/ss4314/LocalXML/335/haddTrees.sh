...
names=("B2mumupiMC_2016_MagDown")
end=".root"

iter=""
subdirs=(335)       #(501 502 505)
subjobs=(420)       #(1635 2954 14)
numbers=(0)       #(0 1 2)


#output="/vols/lhcbdisk03/alvarezc/B2Kee_Kmumu/B2Kee_data/BDT_training/kfold5/"
output="/vols/lhcb/ss4314/final_tuples/mc/mumupi_mc/2016/MC_B2PiMuMu_MagDown.root"
