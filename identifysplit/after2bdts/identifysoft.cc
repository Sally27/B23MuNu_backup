...
string base="_60andPPUNZIoptBDT_MISIDafter60";
...
{
string pathname = "/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi60treesincludePafterCOMBI/";
string filename = *i;
