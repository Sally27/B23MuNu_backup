...
copytree("../Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut.root","DecayTree" , "Run1MC.root", variables);

copytree("../Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut.root","DecayTree" , "2016MC.root", variables);
