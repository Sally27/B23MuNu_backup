...
//  hist2.t->Draw("CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection >>bplusmm2");
//  double nSel2 = hist2.t->GetEntries();
  ...
  DataSample hist1("B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_cut_mu1nShared_mu2nSharedminq2.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  ...
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, -2.0 , 2.0);
  hist1.t->Draw("CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection >> bpluscorrmass");
//  a->Scale(0.800456);
  Int_t nSel1 = hist1.t->GetEntries();
  cout<<nSel1<<endl;
  Double_t myscale;

  DataSample hist2("B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_cut_mu1nShared_mu2nSharedminq2_forbkg.root", "DecayTree");

  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, -2.0 , 2.0);
...
mp3->SetLeftMargin(0.25);
   ...
   hm->SetLineColor(8);
   hm->SetTitle("Check the distribution for CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection");
   hm->SetXTitle("CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection");
...
/*   ha->SetLineColor(8);
   ...
   ha->Draw("same");*/
    ...
    leg->SetBorderSize(0);
    leg->AddEntry(a," qminsq < 960000","l");   // h1 and h2 are histogram pointers
    leg->AddEntry(hm,"qminsq > 960000","l");
...
*/
   ...
   mp3->Update();
   mp3->SaveAs("differentqminsamplescheckbdtoutput.pdf");
