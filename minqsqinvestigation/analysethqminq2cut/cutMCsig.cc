...
string pathname = "";
string filename = "B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_cut_mu1nShared_mu2nShared";
...
string decaytreename = "DecayTree";
string ext = ".root";
string cuttag = "_PUNZIoptBDT_forbkg";
string namecuttree2 = (filename+cuttag).c_str();
string cut2 = "CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection < 0.57";
