...
cout<<"num of mis kaons "<<z+1<<"th it:"<<std::accumulate(jop2iterate.begin(),jop2iterate.end(),0.0)<<endl;
cout<<"num of mis pions "<<z+1<<"th it:"<<std::accumulate(jop1iterate.begin(),jop1iterate.end(),0.0)<<endl;
