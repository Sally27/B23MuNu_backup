...
myfile.open("probnnmu/MISIDProbnnmuminuspi.txt");
myfile0.open("probnnmu/MISIDProbnnmuminuspiEASY.txt");
myfile4.open("probnnmu/MisIDProbnnmuminuspiTradeoff.txt");
myfile2.open("probnnmu/IDMuoneffProbnnmuminuspi.txt");
myfile3.open("probnnmu/IDMuoneffProbnnmuminuspirEASY.txt");
