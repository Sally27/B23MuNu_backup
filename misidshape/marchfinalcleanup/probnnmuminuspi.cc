...
myfile.open("probnnmuminuspi/MISIDProbnnmuminuspi.txt");
myfile0.open("probnnmuminuspi/MISIDProbnnmuminuspiEASY.txt");
myfile4.open("probnnmuminuspi/MisIDProbnnmuminuspiTradeoff.txt");
myfile2.open("probnnmuminuspi/IDMuoneffProbnnmuminuspi.txt");
myfile3.open("probnnmuminuspi/IDMuoneffProbnnmuminuspirEASY.txt");
...
ofstream out;
out.open("SPECIALprobnnmuminuspi.txt");
...
out<<"\\hline"<<endl;
out<<"Cut & total misid &  Eff on Mis ID & Eff on MC (one muon) & Num of Sig evts  \\\\ "<<endl;
...
out<<"\\end{center}"<<endl;
out<<"\\caption{SPECIALprobnnmuminuspi.txt}"<<endl;
out<<"\\end{table}"<<endl;
