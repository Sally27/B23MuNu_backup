...
myfile.open("probnnmuminuspitight/MISIDProbnnmuminuspitight.txt");
myfile0.open("probnnmuminuspitight/MISIDProbnnmuminuspitightEASY.txt");
myfile4.open("probnnmuminuspitight/MisIDProbnnmuminuspitightTradeoff.txt");
myfile2.open("probnnmuminuspitight/IDMuoneffProbnnmuminuspitight.txt");
myfile3.open("probnnmuminuspitight/IDMuoneffProbnnmuminuspirEASYtight.txt");
...
ofstream out;
out.open("SPECIALprobnnmuminuspitight.txt");
...
out<<"\\end{center}"<<endl;
out<<"\\caption{SPECIALprobnnmuminuspitight.txt}"<<endl;
out<<"\\end{table}"<<endl;
