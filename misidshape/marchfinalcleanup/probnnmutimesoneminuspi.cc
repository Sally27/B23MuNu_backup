...
string pionsample="/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi/SSmuonStrSmallDatapreparetuple/B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_PUNZIoptBDT.root";

string kaonsample="/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi/SSmuonStrSmallDatapreparetuple/B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_PUNZIoptBDT.root";
...
myfile.open("probnnmutimsoneminuspi/MISIDProbnnmuminuspitight.txt");
myfile0.open("probnnmutimsoneminuspi/MISIDProbnnmuminuspitightEASY.txt");
myfile4.open("probnnmutimsoneminuspi/MisIDProbnnmuminuspitightTradeoff.txt");
myfile2.open("probnnmutimsoneminuspi/IDMuoneffProbnnmuminuspitight.txt");
myfile3.open("probnnmutimsoneminuspi/IDMuoneffProbnnmuminuspirEASYtight.txt");
...
ofstream out;
out.open("SPECIALprobnnmuoneminuspi.txt");
...
double e;
e=calaveffofasample("/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi/MCSigpreparetuple/B23MuNuNewMCNShared_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_PUNZIoptBDT.root","DecayTree",filename3.c_str(),(cuts3.at(i)).c_str(),"PIDCalib",("newmc"+tags.at(i)+".root").c_str());
...
out<<"\\end{center}"<<endl;
out<<"\\caption{SPECIALprobnnmuoneminuspi.txt}"<<endl;
out<<"\\end{table}"<<endl;
