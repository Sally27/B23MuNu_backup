...
string filename2="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/probnnmutimesoneminuspi/samples/pion/PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root";
...
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1- V2ProbNNpi)) > 0.0)_All");
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.1)_All");
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.2)_All");
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.3)_All");
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.4)_All");
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.5)_All");

string filename="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/probnnmutimesoneminuspi/samples/kaon/PerfHists_K_Strip20_MagDown_P_ETA_nTracks.root";        
...
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1- V2ProbNNpi)) > 0.0)_All");
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.1)_All");
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.2)_All");
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.3)_All");
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.4)_All");
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu*(1-V2ProbNNpi)) > 0.5)_All");
...
myfile.open("importantfiles4/MISIDProbnnmutimesoneminuspi.txt");
myfile0.open("importantfiles4/MISIDProbnnmutimesoneminuspiEASY.txt");
myfile4.open("importantfiles4/MisIDProbnnmutimesoneminuspiTradeoff.txt");
myfile2.open("importantfiles4/IDMuoneffProbnnmutimesoneminuspi.txt");
myfile3.open("importantfiles4/IDMuoneffProbnnmutimesoneminuspiEASY.txt");
...
////ofstream myfile2;
////myfile2.open("IDMuoneffProbnnmu.txt");
////myfile2<<"------------------------------------ID EFF with Probnn cuts in PIDCalib-----------------"<<endl;
////myfile2<<"--------FILENAME------------------------CUTS----------------------EFF OF CUT------------"<<endl;
////for(int i=0;i<9;i++)
////{
////double p;
////p=averageefficiency(filename3, (cuts3.at(i)).c_str(), 18, 4, 4);
////averageeff.push_back(p);
////if(i<3)
////{
////myfile2<<"-----"<<filename3<<"---------"<<cuts3.at(i)<<"------------"<<averageeff.at(i)/averageeff.at(0)<<"---"<<"wrt to basic cut"<<endl;
////}
////if(i>2)
////{
////myfile2<<"-----"<<filename3<<"---------"<<cuts3.at(i)<<"------------"<<averageeff.at(i)/averageeff.at(3)<<"---"<<"wrt to reference cut"<<endl;
////}
////}
////myfile2.close();


//vector<double> averageeff2;
//ofstream myfile3;
//myfile3.open("IDMuoneffProbnnmueasytoREAD.txt");
//myfile3<<"------------------------------------ID EFF with Probnn cuts in PIDCalib-----------------"<<endl;
//myfile3<<"--------FILENAME------------------------CUTS----------------------EFF OF CUT------------"<<endl;
//for(int i=0;i<9;i++)
//{
//double p;
//p=averageefficiency(filename3, (cuts3.at(i)).c_str(), 18, 4, 4);
//averageeff2.push_back(p);
//if(i<3)
//{
//myfile3<<"-----"<<nameofmuonid<<"---------"<<tags.at(i)<<"------------"<<averageeff.at(i)/averageeff.at(0)<<"---"<<"wrt to basic cut"<<endl;
//}
//if(i>2)
//{
//myfile3<<"-----"<<nameofmuonid<<"---------"<<tags.at(i)<<"------------"<<averageeff.at(i)/averageeff.at(3)<<"---"<<"wrt to reference cut"<<endl;
//}
//}
//myfile3.close();
