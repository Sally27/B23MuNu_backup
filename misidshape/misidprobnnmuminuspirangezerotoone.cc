...
myfile.open("importantfiles3/MISIDProbnnmuminuspitighter.txt");
myfile0.open("importantfiles3/MISIDProbnnmuminuspitigherEASY.txt");
myfile4.open("importantfiles3/MisIDProbnnmuminuspitigtherTradeoff.txt");
myfile2.open("importantfiles3/IDMuoneffProbnnmuminuspitigther.txt");
myfile3.open("importantfiles3/IDMuoneffProbnnmuminuspitigtherEASY.txt");
