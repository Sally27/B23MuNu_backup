...
vector<double> eff(string filename, string decaytree, string misidPIDcalib, string misidcuts, string idPIDcalib, string idcuts)
{
...
passedKaon = eff(filename,decaytree, misidPIDcalib, misidcuts, idPIDcalib, idcuts);
...
passedPion = eff(filename2,decaytree2, misidPIDcalib2, misidcuts2, idPIDcalib2, idcuts2);
...
crossmisid(ktopimisidfilename,ktopimisidcuts, p, eta, ntracks);
...
crossmisid(pitokmisidfilename,pitokmisidcuts, p, eta, ntracks);


//eff(filename2,decaytree2, misidPIDcalib2, misidcuts2, idPIDcalib2, idcuts2);
