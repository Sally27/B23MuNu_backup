...
//vector<vector<double> > iterationpion;
//vector<vector<double> > iterationkaon;
//vector<vector<double> > newmisidratepion2;
//vector<vector<double> > newmisidratekaon2;
//ITERATIVE PROCEDURE
//


vector<double> iterationpion;
vector<double> iterationkaon;
vector<double> newmisidratepion2;
vector<double> newmisidratekaon2;
...
iterationkaon.push_back(((numberofkaons[i] - (mypitokmisid[i]*newitpion[i]))/kaonideff[i]));
cout<<"iterationkaon: "<< iterationkaon<<endl;
}
...
iterationpion.push_back(((numberofpions[i] - (myktopimisid[i]*newitkaon[i]))/pionideff[i]));
cout<<"iterationpion: "<< iterationpion<<endl;
}

for (int i=0; i<288; i++)
{
cout<<"new mis id rate pion"<<endl;
cout<<iterationpion[i]<<endl;
cout<<misidpiontomuon[i]<<endl;

cout<<(iterationpion[i]*misidpiontomuon[i])<<endl;
newmisidratepion2.push_back(double(iterationpion[i])*double(misidpiontomuon[i]));
cout<<"newmisidratepion: "<<newmisidratepion2<<endl;
}
...
{
cout<<"new mis id rate kaon"<<endl;
cout<<iterationkaon[i]<<endl;
cout<<misidkaontomuon[i]<<endl;

cout<<(iterationkaon[i]*misidkaontomuon[i])<<endl;
newmisidratekaon2.push_back(iterationkaon[i]*misidkaontomuon[i]);
cout<<"newmisidratekaon: "<<newmisidratekaon2<<endl;
}
...
for (int i=0; i<288; i++)
{
if (newmisidratekaon2[i]>-1000){

addkaons2+=newmisidratekaon2[i];
cout<<"my kaon cuties:"<<addkaons2<<"newmisidratekaon:"<<newmisidratekaon2[i]<<endl;;
}
}

for (int i=0; i<288; i++)
{
if (newmisidratepion2[i]>-1000){
addpions2+=newmisidratepion2[i];
cout<<"my pion cuties:"<<addpions2<<"newmisidratepion:"<<newmisidratepion2[i]<<endl;
}
}

cout<<"This is number of kaons:"<<addkaons2<<endl;
cout<<"This is number of pions:"<<addpions2<<endl;
totalmisidrate.push_back(addkaons2+addpions2);
