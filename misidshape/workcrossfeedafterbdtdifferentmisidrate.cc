...
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 3.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 4.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 5.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
cuts2.push_back("Pi_(IsMuon==1.0) && (DLLmu > 10.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");

string filename="/vols/lhcbdisk05/ss4314/misidstudies/checkkaonmisid/samplewithkaonpidcuts/dllmutight/PerfHists_K_Strip20_MagDown_P_ETA_nTracks.root";        cuts.push_back("K_(IsMuon==1.0)_All");
...
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 3.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 4.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 5.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
cuts.push_back("K_(IsMuon==1.0) && (DLLmu > 10.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
