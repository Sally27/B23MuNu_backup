...
//-------------------------------------------PID Calib ID histograms and cuts---------------------------------------//
        ...
        string idPIDcalib =("/vols/lhcbdisk05/ss4314/PIDCalibEfficiencies/ideff/kaon/PerfHists_K_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string idcuts ="K_IsMuon==0.0 && InMuonAcc==1.0 && DLLK > 0.0 && ((DLLp - DLLK) < 5.0)_All";
        string idPIDcalib2 = ("/vols/lhcbdisk05/ss4314/PIDCalibEfficiencies/ideff/pion/PerfHists_Pi_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string idcuts2 ="Pi_IsMuon==0.0 && InMuonAcc==1.0 && DLLK < 0.0 && DLLp < 5.0_All";


//------------------------------------------Crossfeed Hitograms and Cuts--------------------------------------------//
        string ktopimisidfilename=("/vols/lhcbdisk05/ss4314/PIDCalibEfficiencies/crossfeedeff/kaon/PerfHists_K_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string ktopimisidcuts="K_IsMuon==0.0 && InMuonAcc==1.0 && DLLK < 0.0 && DLLp < 5.0_All";

        string pitokmisidfilename=("/vols/lhcbdisk05/ss4314/PIDCalibEfficiencies/crossfeedeff/pion/PerfHists_Pi_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
...
//-----------------------------------------Muon Sample and Muon PIDCalib Sample-----------------------------------------//
	...
	string pidmuonsample=("/vols/lhcbdisk05/ss4314/PIDCalibEfficiencies/ideff/muon/PerfHists_Mu_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
...
//------------------------------------ PION MIS ID PID calib sample and cuts-----------------------------------------------------//
	...
	string filename2=("/vols/lhcbdisk05/ss4314/PIDCalibEfficiencies/misideff/pion/PerfHists_Pi_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
...
//------------------------------------ KAON MIS ID PID calib sample and cuts-----------------------------------------------------//
	...
	string filename=("/vols/lhcbdisk05/ss4314/PIDCalibEfficiencies/misideff/kaon/PerfHists_K_"+stripping+"_"+polarity+"_P_ETA.root").c_str();        
...
//------------------------------------ MUON ID PID calib sample and cuts-----------------------------------------------------//
	...
	string filename3=("/vols/lhcbdisk05/ss4314/PIDCalibEfficiencies/misideff/muon/PerfHists_Mu_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
...
//         return(1);
 	...
 	{
 		float p;
 		p=totmisidnobinofcorrmimp(kaonsample,pionsample,"kaon","pion",filename, (cuts.at(i)).c_str(), filename2, (cuts2.at(i)).c_str(), idPIDcalib, idcuts,idPIDcalib2, idcuts2, ktopimisidfilename, ktopimisidcuts, pitokmisidfilename, pitokmisidcuts ,(tags.at(i)).c_str());
 		eff.push_back(p);
