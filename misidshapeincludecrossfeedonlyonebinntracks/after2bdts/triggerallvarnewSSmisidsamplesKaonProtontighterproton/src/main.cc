...
int main(int argc, char *argv[]){
	...
	//         gROOT->ProcessLine(".x lhcbSally.C");
	 ...
	 //	string kaonsample="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_PUNZIoptBDT.root";

	 //	string protonsample="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_PUNZIoptBDT.root";
...
//------------------------------------------Crossfeed Hitograms and Cuts--------------------------------------------//
        string ktopimisidfilename=("/vols/lhcb/ss4314/PIDCalibEfficiencies/crossfeedeff/protontokaontighter/PerfHists_P_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string ktopimisidcuts="P_IsMuon==0.0 && InMuonAcc==1.0 && DLLK > 0.0 && ((DLLp - DLLK) < 5.0)_All";

        string pitokmisidfilename=("/vols/lhcb/ss4314/PIDCalibEfficiencies/crossfeedeff/protontokaontighter/PerfHists_K_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string pitokmisidcuts="K_IsMuon==0.0 && InMuonAcc==1.0 && DLLp > 5.0 && ((DLLp - DLLK) > 5.0)_All";
