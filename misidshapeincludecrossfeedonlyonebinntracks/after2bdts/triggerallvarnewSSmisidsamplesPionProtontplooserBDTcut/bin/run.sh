...
cp /vols/lhcb/ss4314/misidsplitting/MisidBackTonomu1mu3ETAlesstightBDTcut/bin/B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasicStrip* .
