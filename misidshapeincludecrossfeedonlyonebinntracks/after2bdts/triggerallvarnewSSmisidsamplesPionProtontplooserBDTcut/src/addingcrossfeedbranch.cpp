...
//	string pitokmisidcuts="Pi_IsMuon==0.0 && DLLK > 0.0 && ((DLLp - DLLK) < 5.0)_All";
	...
	while ((abs(overallvector.at(z+2)-overallvector.at(z+1))>(0.001*(overallvector.at(z+1)))))
	{
		...
		vector<float> weightfinalpion;     
                ...
                cout<<"Check value abs(overallvector.at(z+2)-overallvector.at(z+1)): "<<abs(overallvector.at(z+2)-overallvector.at(z+1))<<endl;
                cout<<"Check value (0.001*(overallvector.at(z+1))"<<(0.001*(overallvector.at(z+1)))<<endl;
                cout<<"Check value z+2:"<< z+2<<endl;
                cout<<"Filename: "<<("modifiedandcut"+tags+stripping+polarity+filename).c_str()<<endl; 

		if((abs(overallvector.at(z+2)-overallvector.at(z+1))<(0.001*(overallvector.at(z+1)))) || (abs(overallvector.at(z+2)-overallvector.at(z+1)) < 0.015)  )
		{
