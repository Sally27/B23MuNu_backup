...
int main(int argc, char *argv[]){
	...
	string kaonsample=argv[2];
        ...
        string idPIDcalib ="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/nontrackcalculation/idkaon/PerfHists_K_Strip20_MagDown_P_ETA.root";
        string idcuts ="K_IsMuon==0.0 && DLLK > 0.0 && ((DLLp - DLLK) < 5.0)_All";
        string idPIDcalib2 ="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/nontrackcalculation/idpion/PerfHists_Pi_Strip20_MagDown_P_ETA.root";
	...
	string pidmuonsample="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/nontrackcalculation/basiccutforallthree/combinethetwo/muon/PerfHists_Mu_Strip20_MagDown_P_ETA.root";

	string maintag="allbasiccutscombined";
	...
	string filename2="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/nontrackcalculation/basiccutforallthree/combinethetwo/pion/PerfHists_Pi_Strip20_MagDown_P_ETA.root";
	...
	string filename="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/nontrackcalculation/basiccutforallthree/combinethetwo/kaon/PerfHists_K_Strip20_MagDown_P_ETA.root";        
	...
	{
		float p;
		p=totmisidnobinofcorrmimp(kaonsample,pionsample,"kaon","pion",filename, (cuts.at(i)).c_str(), filename2, (cuts2.at(i)).c_str(), idPIDcalib, idcuts,idPIDcalib2, idcuts2, (tags.at(i)).c_str());
		eff.push_back(p);
