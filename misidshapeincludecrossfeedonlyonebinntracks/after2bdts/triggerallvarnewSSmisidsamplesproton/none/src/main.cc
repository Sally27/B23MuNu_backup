...
//------------------------------------------Crossfeed Hitograms and Cuts--------------------------------------------//
        string ktopimisidfilename=("/vols/lhcb/ss4314/PIDCalibEfficiencies/crossfeedeff/protontopion/PerfHists_P_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string ktopimisidcuts="P_IsMuon==0.0 && InMuonAcc==1.0 && DLLK < 0.0 && DLLp < 5.0_All";

        string pitokmisidfilename=("/vols/lhcb/ss4314/PIDCalibEfficiencies/crossfeedeff/protontopion/PerfHists_Pi_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string pitokmisidcuts="Pi_IsMuon==0.0 && InMuonAcc==1.0 && DLLp > 0.0 && ((DLLp - DLLK) > 0.0)_All";
