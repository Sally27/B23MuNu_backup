...
int main(int argc, char *argv[]){
	...
	//         gROOT->ProcessLine(".x lhcbSally.C");
	 ...
	 //	string kaonsample="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_PUNZIoptBDT.root";

	 //	string protonsample="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_PUNZIoptBDT.root";

//--------------------------------------------TwO Species Sample ---------------------------------------------------//

	string kaonsample=argv[1];
	string protonsample=argv[2];
        string polarity=argv[3]; 
        string stripping=argv[4];
//-------------------------------------------PID Calib ID histograms and cuts---------------------------------------//

        string idPIDcalib =("/vols/lhcb/ss4314/PIDCalibEfficiencies/ideff/proton/PerfHists_P_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string idcuts ="P_IsMuon==0.0 && InMuonAcc==1.0 && DLLp > 0.0 && ((DLLp - DLLK) > 0.0)_All";
        string idPIDcalib2 = ("/vols/lhcb/ss4314/PIDCalibEfficiencies/ideff/kaon/PerfHists_K_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string idcuts2 ="K_IsMuon==0.0 && InMuonAcc==1.0 && DLLK > 0.0 && ((DLLp - DLLK) < 5.0)_All";


//------------------------------------------Crossfeed Hitograms and Cuts--------------------------------------------//
        string ktopimisidfilename=("/vols/lhcb/ss4314/PIDCalibEfficiencies/crossfeedeff/protontokaon/PerfHists_P_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string ktopimisidcuts="P_IsMuon==0.0 && InMuonAcc==1.0 && DLLK > 0.0 && ((DLLp - DLLK) < 5.0)_All";

        string pitokmisidfilename=("/vols/lhcb/ss4314/PIDCalibEfficiencies/crossfeedeff/protontokaon/PerfHists_K_"+stripping+"_"+polarity+"_P_ETA.root").c_str();
        string pitokmisidcuts="K_IsMuon==0.0 && InMuonAcc==1.0 && DLLp > 0.0 && ((DLLp - DLLK) > 0.0)_All";



//-----------------------------------------Muon Sample and Muon PIDCalib Sample-----------------------------------------//
	string mcmuonsample="/vols/lhcb/ss4314/cutonBDTs/allvartriggernoassmisidaftercombi/B23MuNuMCallvar_MCtruth_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root";
...
//------------------------------------ KAON MIS ID PID calib sample and cuts-----------------------------------------------------//
	...
	string filename2=("/vols/lhcb/ss4314/PIDCalibEfficiencies/misideff/kaon/PerfHists_K_"+stripping+"_"+polarity+"_P_ETA.root").c_str();


	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.5) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 1.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 1.5) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 2.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.5) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 1.0) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 1.5) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 2.0) && (nShared==0)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > -0.6)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > -0.5)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > -0.4)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All");
	cuts2.push_back("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All");



//------------------------------------ PROTON MIS ID PID calib sample and cuts-----------------------------------------------------//


	string filename=("/vols/lhcb/ss4314/PIDCalibEfficiencies/misideff/proton/PerfHists_P_"+stripping+"_"+polarity+"_P_ETA.root").c_str();        

	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.5) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 1.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 1.5) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 2.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.5) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 1.0) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 1.5) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 2.0) && (nShared==0)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > -0.6)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > -0.5)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > -0.4)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All");
	cuts.push_back("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All");
...
//         return(1);
 	...
 	myfile<<"-------------------------MISID with Probnn cuts on both PROTON and KAON----------------------"<<endl;
 	myfile<<"--------TOTAL MISID------------------------CUTS----------------------EFF OF CUT------------"<<endl;
 
 	myfile0<<"-------------------------MISID with Probnn cuts on both PROTON and KAON----------------------"<<endl;
 	myfile0<<"--------TOTAL MISID------------------------CUTS----------------------EFF OF CUT------------"<<endl;
 
 
 	myfile4<<"-------------------------Trade off  - Probnn cuts PROTON, KAON, MUON----------------------"<<endl;
 	...
 	{
 		float p;
 		p=totmisidnobinofcorrmimp(protonsample,kaonsample,"proton","kaon",filename, (cuts.at(i)).c_str(), filename2, (cuts2.at(i)).c_str(), idPIDcalib, idcuts,idPIDcalib2, idcuts2, ktopimisidfilename, ktopimisidcuts, pitokmisidfilename, pitokmisidcuts ,(tags.at(i)).c_str(), stripping, polarity);
 		eff.push_back(p);
