...
int main(int argc, char *argv[]){
	...
	//         gROOT->ProcessLine(".x lhcbSally.C");
	 ...
	 //	string kaonsample="B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_PUNZIoptBDT.root";
        ...
        string sample="/vols/lhcb/ss4314/addPIDweights/FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/finaltuples2016/modifiedandcutprobmu3Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_PionPID_CombBasic_AntiBDT_FitCorM.root";

        readvalue(sample, "DecayTree","misidPIDcalib");


        string sample2="Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_PionPID_CombBasic_AntiBDT_FitCorM_Strip26MagDown.root";

        cout<<"New sample "<<sample2<<endl;
        readvalue(sample2, "DecayTree","mu3_ETA");
}
