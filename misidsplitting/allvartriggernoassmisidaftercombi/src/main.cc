...
int main(int argc, char *argv[]){
	...
	string pathname = "/vols/lhcb/ss4314/cutonBDTs/allvartriggernoassmisidaftercombi/";
...
//   TTree* t2 = t->CloneTree(0);
	...
	string filename4="B23MuNuFakeSS_mu3isNotMuon_mu3inMuonAcc_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic";
