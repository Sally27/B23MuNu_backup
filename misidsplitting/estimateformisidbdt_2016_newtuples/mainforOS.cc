...
int main(int argc, char *argv[]){
	...
	string filename1="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_KaonPID_CombBasic_MisidBasic";
	string filename2="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_PionPID_CombBasic_MisidBasic";
//   TTree* t2 = t->CloneTree(0);
        string filename3="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_CombBasic_MisidBasic";
	string filename4="B23MuNuFakeOStotal_mu2isNotMuon_mu2inMuonAcc_trigger_mu1nShared_mu3nShared_qmincut_ProtonPID_CombBasic_MisidBasic";
//	string filename4="B23MuNuMCallvar_MCtruth_trigger_mu1nShared_mu3nShared_mu3nShared_qmincut_CombBasic";
//	string filename5="Data2012and2011_corrm_trigger_mu1nShared_mu3nShared_mu3nShared_qmincut_CombBasic";
//	string filename6="B23Pimu_MCtruth_trigger_mu3nShared_qmincut_CombBasic";
