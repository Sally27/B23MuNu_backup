...
string filename="sample28feb2016/PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root"; 
string th3name1 ="Pi_(IsMuon==1.0)_All";
string th3name2 ="Pi_(IsMuon==1.0) && (DLLmu > 0.0)_All";
string th3name3 ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All";
string th3name4 ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string tag="firstcut";
...
mg->SetTitle("PION Mis id rate as a function of momentum pt");
mg->Add(gr);
mg->Add(gr2);
mg->Add(gr3);
mg->Add(gr4);
...
//leg->AddEntry(h2n,"Dllmu> 0.0 and Dllmu - DllK >0 and IsMuon and InMuonAcc","p");
//leg->Draw("same");
c1->SaveAs("pionmisidrateoriginal.pdf");
return;
}
