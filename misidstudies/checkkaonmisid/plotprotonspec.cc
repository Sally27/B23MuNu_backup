...
string filename="sample28feb2016/PerfHists_P_Strip20_MagDown_P_ETA_nTracks.root"; 
string th3name1 ="P_(IsMuon==1.0)_All";
string th3name2 ="P_(IsMuon==1.0) && (DLLmu > 0.0)_All";
string th3name3 ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All";
string th3name4 ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string tag="firstcut";
