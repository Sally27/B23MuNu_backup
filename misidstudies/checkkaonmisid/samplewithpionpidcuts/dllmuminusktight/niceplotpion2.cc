...
string filename="/vols/lhcbdisk05/ss4314/misidstudies/checkkaonmisid/samplewithpionpidcuts/dllmuminusktight/PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root"; 
...
string th3namefifth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 1.0) && (nShared==0)_All";
string th3namesixth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 2.0) && (nShared==0)_All";
string th3nameseventh ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 3.0) && (nShared==0)_All";
string th3nameeighth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 4.0) && (nShared==0)_All";
string th3namenineth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 5.0) && (nShared==0)_All";
string th3nametenth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 10.0) && (nShared==0)_All";
...
TPaveText *pt = new TPaveText(.55,.1,.85,.2,"brNDC");
