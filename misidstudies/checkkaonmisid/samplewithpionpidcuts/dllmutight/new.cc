...
string filename="/vols/lhcbdisk05/ss4314/misidstudies/checkkaonmisid/samplewithpionpidcuts/dllmutight/PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root"; 
...
string th3namefifth ="Pi_(IsMuon==1.0) && (DLLmu > 1.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3namesixth ="Pi_(IsMuon==1.0) && (DLLmu > 2.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3nameseventh ="Pi_(IsMuon==1.0) && (DLLmu > 3.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3nameeighth ="Pi_(IsMuon==1.0) && (DLLmu > 4.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3namenineth ="Pi_(IsMuon==1.0) && (DLLmu > 5.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3nametenth ="Pi_(IsMuon==1.0) && (DLLmu > 10.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
...
mg->SetTitle("PION Misid as f(pt) in bin of ETA:2.375-3.25, nTracks: 50-200");
...
vector<string> cuts2;
cuts2.push_back("mu3_PIDmu>0");
cuts2.push_back("mu3_PIDmu>1");
cuts2.push_back("mu3_PIDmu>2");
cuts2.push_back("mu3_PIDmu>3");
cuts2.push_back("mu3_PIDmu>4");
cuts2.push_back("mu3_PIDmu>5");
cuts2.push_back("mu3_PIDmu>10");
...
c1->SaveAs("pionmisidrateoriginal2.pdf");
return;
}
