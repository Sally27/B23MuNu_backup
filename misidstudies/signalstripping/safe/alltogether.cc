...
int Jpsi(string filename, string decaytreename)
{
...
//veto J/psi
  ...
  TFile *filefort2 = new TFile((filename+"_Jpsi.root").c_str(), "RECREATE");
  TTree *t2 = t->CloneTree(0);
  int count, count2;
...
string pathname = "/vols/lhcbdisk05/ss4314/tuples/SmallDataSampleSignalStripping/";
string filename = "B23MuNuSmallDataSampleSignal";
string decaytreename = "B_Tuple2/DecayTree";
string ext = ".root";

//double cutval = 6000.0;
//string cutvar = "Bplus_Corrected_Mass";
//double eff;
...
//{
//cout << output.at(n)<<endl;
//}
//cout<<"Done"<<endl;
//
////THIS needed for a cut if equal signs//
//string newfilename = output.at(0);
//string newdecaytreename = "DecayTree";
//
//string cutvar2 = "mu1_nShared";
//double cutval2 = 0.0;
//
//vector<string> output2;
//cout<<newfilename<<ext<<newdecaytreename<<cutvar2<<cutval2<<endl;
//output2 = cuttuplehere(newfilename, newdecaytreename, ext, cutvar2, cutval2);
//for (unsigned  n = 0; n<output2.size(); n++)
//{
//cout << output2.at(n)<<endl;
//}
//cout<<"Done"<<endl;
//
//string newfilename = output2.at(0);
//string newdecaytreename = "DecayTree";
//
//string cutvar2 = "mu2_nShared";
//double cutval2 = 0.0;
//
//vector<string> output2;
//cout<<newfilename<<ext<<newdecaytreename<<cutvar2<<cutval2<<endl;
...
//string cuts = "mu3_nShared==0.0";
//string nametree = "B23MuNuSmallDataSampleSignal_cut_Bplus_Corrected_Mass_cut_mu1_nShared.root";
//string namecuttree = "newtree.root";
...
string decaytreename = "B_Tuple2/DecayTree";
string ext = ".root";
string cuttag = "_mu1nShared";
string namecuttree2 = (filename+"_cut"+cuttag).c_str();
string cut2 = "mu1_nShared == 0.0";
...
string decaytreename = "DecayTree";
string ext = ".root";
string cuttag = "_mu2nShared";
string namecuttree2 = (filename+cuttag).c_str();
cut2 = "mu2_nShared == 0.0";
...
string namecuttree2 = (filename+cuttag).c_str();
cut2 = "mu3_nShared == 0.0";

cutTree((filename+ext).c_str(), decaytreename, (namecuttree2+ext).c_str(), cut2);


Jpsi((namecuttree2).c_str(), decaytreename);
//me+ext).c_str(), decaytreename, (namecuttree2+ext).c_str(), cut2);
//s->Close();

//string cuts = "mu3_nShared==0.0";
//string nametree = output2.at(0);
//string namecuttree = "newtree.root";
//cutTree(string nametree, string namecuttree, string cuts);
