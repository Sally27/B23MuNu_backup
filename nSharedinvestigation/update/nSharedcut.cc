...
vector<int> clone3(string pathname, string filename, string decaytreename, string array1)
{
...
//  t->SetBranchAddress(var3.c_str(), &cuttingvar3); 
  ...
  TFile *filefort2 = new TFile((var1+filename).c_str(), "RECREATE");
  TTree *t2 = t->CloneTree(0);
  int count, count2; 
...
//        cout<<count2<<endl;
 ...
 // t2->Print();
  ...
  numbers.push_back(count2);
  cout<<"Overall NumOfEntries: "<<numbers[0]<<endl;
  cout<<"For File: "<<filename <<" NumOfEvents passing cut: "<<var1<<"  is "<<numbers[1]<<" so eff of this: "<<(double(numbers[1])/double(numbers[0]))<<endl;
...
void main()
{
string pathname34 = "/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/MCSigpreparetuple/";
string filename34 = "B23MuNuNewMCNShared_MCtruth.root";
string decaytreename34 = "DecayTree";
...
string pathname3 = "/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/Combinatorialpreparetuple/";
string filename3 = "B23MuNuSignal2012and2011data_corrm.root";
...
string pathname5 = "/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/SSmuonStrSmallDatapreparetuple/";
string filename5 = "B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc.root";
