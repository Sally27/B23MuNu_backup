...
void addcostheta(string filename, string decaytreename, string newfilename)
{
	...
	//
	//              //veto J/psi
	t->SetBranchAddress("muplus_TRUEP_X", &mu3_PX);
	t->SetBranchAddress("muplus_TRUEP_Y", &mu3_PY);
	t->SetBranchAddress("muplus_TRUEP_Z", &mu3_PZ);
	t->SetBranchAddress("muplus_TRUEP_E", &mu3_PE);

	t->SetBranchAddress("eplus_TRUEP_X", &mu1_PX);
	t->SetBranchAddress("euplus_TRUEP_Y", &mu1_PY);
	t->SetBranchAddress("eplus_TRUEP_Z", &mu1_PZ);
	t->SetBranchAddress("eplus_TRUEP_E", &mu1_PE);

	t->SetBranchAddress("eminus_TRUEP_X", &mu2_PX);
	t->SetBranchAddress("eminus_TRUEP_Y", &mu2_PY);
	t->SetBranchAddress("eminus_TRUEP_Z", &mu2_PZ);
	t->SetBranchAddress("eminus_TRUEP_E", &mu2_PE);
...
void addqsqinf(string filename, string decaytreename, string newfilename)
{
	...
	t->SetBranchAddress("eplus_TRUEP_X", &mu1_PX);
	t->SetBranchAddress("eplus_TRUEP_Y", &mu1_PY);
	t->SetBranchAddress("eplus_TRUEP_Z", &mu1_PZ);
	t->SetBranchAddress("eplus_TRUEP_E", &mu1_PE);
