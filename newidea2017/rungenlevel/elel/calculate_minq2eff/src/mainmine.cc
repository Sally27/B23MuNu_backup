...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/newidea2017/rungenlevel/elel/";
	string filename = "minemodel_2012_PYTHIA8";
...
//        addcostheta(filename2, "DecayTree", filename2);  
      ...
      vals.push_back("(eplus_eta>1.596 && eplus_eta<5.298) && (eminus_eta>1.596 && eminus_eta<5.298) && (muplus_eta>1.596 && muplus_eta<5.298)"); 
