...
int main()
{
	...
	string filecombi="/vols/lhcb/ss4314/final_tuples_analyser/data/sig_data/Run1/FullUpperMassSideBand/bin/Data_B23MuNu_Run1_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
        ...
        plotvariablebeforeq2("Bplus_pmu_ISOLATION_BDT1_weights", -2.5, 5, "Isolation Variable - BDT Output",filemcsig,filepartreco,filemisid,filecombi, year);
	...
	plotvariablebeforeq2("Bplus_pmu_ISOLATION_BDT1_weights", -2.5, 5, "Isolation Variable - BDT Output",filemcsig_2016,filepartreco_2016,filemisid_2016,filecombi_2016, year2);
...
//	plotvariable_partrecostudy("Bplus_Corrected_Mass", 2000, 10000, "Corrected #mu^{+} #mu^{-} #mu^{+} mass [MeV/c^{2}] ", filemcsig,filepartreco ,year, 0.31677);
...
//	plotvariable_partrecostudy("Bplus_Corrected_Mass", 2000, 10000, "Corrected #mu^{+} #mu^{-} #mu^{+} mass [MeV/c^{2}] ", mcaftermis,partrecoaftermis,year, 0.077);
	...
	plotvariable_partrecostudy_nice("Bplus_Corrected_Mass", 2000, 10000, "Corrected #mu^{+} #mu^{-} #mu^{+} mass [MeV/c^{2}] ", mcaftermis,partrecoaftermis,year, 0.102);
