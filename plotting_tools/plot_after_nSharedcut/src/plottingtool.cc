...
int main()
{
	...
	string filemcsig="/vols/lhcb/ss4314/final_tuples_analyser/mc/sig_mc/2012/bin/Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi.root";

	string filepartreco="/vols/lhcb/ss4314/final_tuples_analyser/mc/partreco_mc/2012/bin/MC_PartReco_MCtruth_trigger_Jpsi.root";

	string filemisid="/vols/lhcb/ss4314/final_tuples_analyser/data/misid_data_ss/Run1/bin/Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared.root";

	string filecombi="/vols/lhcb/ss4314/final_tuples_analyser/data/sig_data/Run1/FullUpperMassSideBand/bin/Data_B23MuNu_Run1_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared.root";


//        plotvariablebeforeq2_line("minq2", 10000, 10000000, "minq^{2} [MeV/c^{2}]^{2}",filemcsig,filepartreco,filemisid,filecombi);
//        plotvariablebeforeq2("maxq2", 100000, 35000000, "maxq^{2} [MeV/c^{2}]^{2}",filemcsig,filepartreco,filemisid,filecombi);


        plotvariablebeforeq2_line("sqrt(minq2)", sqrt(10000), sqrt(10000000), "minq [MeV/c^{2}]",filemcsig,filepartreco,filemisid,filecombi);
        plotvariablebeforeq2("sqrt(maxq2)", sqrt(100000), sqrt(180000000), "maxq [MeV/c^{2}]",filemcsig,filepartreco,filemisid,filecombi);
