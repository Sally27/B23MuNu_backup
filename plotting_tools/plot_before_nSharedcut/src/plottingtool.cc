...
//	plotvariablefourdisnoscale("JPSIKDATA",plot1, file555, file666, file777, file4, tag555, tag666, tag777, tag4, "nMuonTracks", 1, 70,"nMuonTracks","nMuonTracks","0");
	...
	plotvariablefourdisnoscale("JPSIKDATA",plot1, file555, file666, file777, file4, tag555, tag666, tag777, tag4, "mu1_nShared","mu1_MuonNShared",0, 6,"#mu^{+}_{[J/#psi]} #font[80]{nShared}","mu1_nShared","0",legendTitle2,true);

	plotvariablefourdisnoscale("JPSIKDATA",plot1, file555, file666, file777, file4, tag555, tag666, tag777, tag4, "mu2_nShared","mu2_MuonNShared",0, 6,"#mu^{-}_{[J/#psi]} #font[80]{nShared}","mu2_nShared","0",legendTitle2,true);

	plotvariablefourdisnoscale("JPSIKDATA",plot1, file555, file666, file777, file4, tag555, tag666, tag777, tag4, "mu3_nShared","mu3_MuonNShared",0, 6,"mu3_nShared","mu3_nShared","0",legendTitle2,true);
...
//	plotvariablefourdisnoscale("JPSIKMC",plot1, file5555, file6666, file7777, file4, tag5555, tag6666, tag7777, tag4, "nMuonTracks", 1, 70,"nMuonTracks","nMuonTracks","0");
	...
	plotvariablefourdisnoscale("JPSIKMC",plot1, file5555, file6666, file7777, file4, tag5555, tag6666, tag7777, tag4, "mu1_nShared","mu1_MuonNShared",0, 6,"#mu^{+}_{[J/#psi]} #font[80]{nShared}","mu1_nShared","0",legendTitle,true);

	plotvariablefourdisnoscale("JPSIKMC",plot1, file5555, file6666, file7777, file4, tag5555, tag6666, tag7777, tag4, "mu2_nShared","mu2_MuonNShared",0, 6,"#mu^{-}_{[J/#psi]} #font[80]{nShared}","mu2_nShared","0",legendTitle,true);

	plotvariablefourdisnoscale("JPSIKMC",plot1, file5555, file6666, file7777, file4, tag5555, tag6666, tag7777, tag4, "mu3_nShared","mu3_MuonNShared",0, 6,"mu3_nShared","mu3_nShared","0",legendTitle,true);
