...
int main()
{
	...
	using namespace std;
        ...
        string year="2012";
        string legtext="B^{+} -> #pi^{+} #mu^{-} #mu^{+}  MC";
   //     string legtext="blah";

	string filepartreco="/vols/lhcb/ss4314/final_tuples_analyser_PO_AND_UE/mc/pimumu_mc/2012_applyfurthercuts/bin/MC_B2PiMuMu_L0MuonDecisionTOS_trigger_Jpsi_CombBasic.root";
        string filepartreco2="/vols/lhcb/ss4314/final_tuples_analyser_PO_AND_UE/mc/pimumu_mc/2012_applyfurthercuts/bin/MC_B2PiMuMu_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic.root"; 
        string filepartreco3="/vols/lhcb/ss4314/final_tuples_analyser_PO_AND_UE/mc/pimumu_mc/2012_applyfurthercuts/bin/MC_B2PiMuMu_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM.root"; 
        plotvariable_one("Bplus_Corrected_Mass", 2000, 10000, "Corrected #mu^{+} #mu^{-} #mu^{+} mass [MeV/c^{2}]", filepartreco, "2012", 1.0, "combiapp",legtext.c_str());
        plotvariable_one("Bplus_Corrected_Mass", 2000, 10000, "Corrected #mu^{+} #mu^{-} #mu^{+} mass [MeV/c^{2}]", filepartreco2, "2012", 1.0,"combiappmisidapp",legtext.c_str());
        plotvariable_one("Bplus_Corrected_Mass", 2000, 10000, "Corrected #mu^{+} #mu^{-} #mu^{+} mass [MeV/c^{2}]", filepartreco3, "2012", 1.0, "combiappmisidappfitrange",legtext.c_str());
