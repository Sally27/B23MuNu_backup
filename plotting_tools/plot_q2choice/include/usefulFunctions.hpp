...
double getCorrelationCoefficient_Sally(TTree*& t, string var1name, string var2name, string cuts, string var1nice, string var2nice,bool draw = false, string plotname = "");
double getCorrelationCoefficient_Sally(string filename, string var1name, string var2name, string cuts, string var1nice, string var2nice,bool draw = false, string plotname = "");

double getCorrelationCoefficient_Sally_Jpsi(TTree*& t, string var1name, string var2name, string cuts, string var1nice, string var2nice,bool draw = false, string plotname = "");
double getCorrelationCoefficient_Sally_Jpsi(string filename, string var1name, string var2name, string cuts, string var1nice, string var2nice,bool draw = false, string plotname = "");
