...
double getCorrelationCoefficient_Sally_Jpsi(TTree*& t, string var1name, string var2name, string cuts, string var1name_nice, string var2name_nice, bool draw, string plotname)
{
   ...
   {
      if(draw) th2f.SetBins(nbins, -1e5, 1e5, nbins, var2min, var2max);
      if(draw) th2f.SetCanExtend(TH1::kXaxis);
      cuts += (" && " + var2name + " > " + d2s(var2min) + " && " + var2name + " < " + d2s(var2max));
   }
   if(isSeparable1 && !isSeparable2)
   {
      if(draw) th2f.SetBins(nbins, var1min, var1max, nbins, -1e5, 1e5);
      if(draw) th2f.SetCanExtend(TH1::kYaxis);
      cuts += (" && " + var1name + " > " + d2s(var1min) + " && " + var1name + " < " + d2s(var1max));
   }
   if(isSeparable1 && isSeparable2)
   {
      if(draw) th2f.SetBins(nbins, var1min, var1max, nbins, var2min, var2max);
      cuts += (" && " + var2name + " > " + d2s(var2min) + " && " + var2name + " < " + d2s(var2max));
      cuts += (" && " + var1name + " > " + d2s(var1min) + " && " + var1name + " < " + d2s(var1max));
   }
   ...
   if(draw) 
   {
      TCanvas canv("canv2", "canv2", 800, 600);
      th2f.GetXaxis()->SetTitle(var1name_nice.c_str());
      th2f.GetYaxis()->SetTitle(var2name_nice.c_str());
      th2f.GetYaxis()->SetTitleOffset(1.1);
...
//      gStyle->SetContour(100);
      ...
      TLine* myline0=new TLine(980, 0.0,980,var2max);
      myline0->SetLineColor(kRed);
      myline0->SetLineWidth(2);
      myline0->Draw("same");

      TLine* myline=new TLine(2946, 0.0,2946,var2max);
      myline->SetLineColor(kGreen);
      myline->SetLineWidth(2);
      myline->Draw("same");

      TLine* myline2=new TLine(3176, 0.0,3176,var2max);
      myline2->SetLineColor(kGreen);
      myline2->SetLineWidth(2);
      myline2->Draw("same");

      TLine* myline3=new TLine(0.0, 2946,var1max,2946);
      myline3->SetLineColor(kGreen);
      myline3->SetLineWidth(2);
      myline3->Draw("same");

      TLine* myline4=new TLine(0.0, 3176,var1max,3176);
      myline4->SetLineColor(kGreen);
      myline4->SetLineWidth(2);
      myline4->Draw("same");


      TLine* myline5=new TLine(3586, 0.0,3586,var2max);
      myline5->SetLineColor(kBlue);
      myline5->SetLineWidth(2);
      myline5->Draw("same");

      TLine* myline6=new TLine(3766, 0.0,3766,var2max);
      myline6->SetLineColor(kBlue);
      myline6->SetLineWidth(2);
      myline6->Draw("same");

      TLine* myline7=new TLine(0.0, 3586,var1max,3586);
      myline7->SetLineColor(kBlue);
      myline7->SetLineWidth(2);
      myline7->Draw("same");

      TLine* myline8=new TLine(0.0, 3766,var1max,3766);
      myline8->SetLineColor(kBlue);
      myline8->SetLineWidth(2);
      myline8->Draw("same");
...
double getCorrelationCoefficient_Sally(TTree*& t, string var1name, string var2name, string cuts, string var1name_nice, string var2name_nice, bool draw, string plotname)
{
   TH2F th2f("th2f", "th2f", 50,-1e5,1e5,50,-1e5,1e5);
...
//      gStyle->SetContour(100);
      ...
      TLine* myline=new TLine(980, 0.0,980,var2max);
...
double getCorrelationCoefficient_Sally_Jpsi(string filename, string var1name, string var2name, string cuts, string var1name_nice, string var2name_nice ,bool draw,string dirname)
{
	double ret;
	TFile f(filename.c_str());
	TTree* t = (TTree*)f.Get("DecayTree");
	ret = getCorrelationCoefficient_Sally_Jpsi(t, var1name, var2name, cuts,var1name_nice, var2name_nice ,draw, dirname);
	f.Close();
	return ret;
}
double getCorrelationCoefficient_Sally(string filename, string var1name, string var2name, string cuts, string var1name_nice, string var2name_nice ,bool draw,string dirname)
{
	double ret;
	TFile f(filename.c_str());
	TTree* t = (TTree*)f.Get("DecayTree");
	ret = getCorrelationCoefficient_Sally(t, var1name, var2name, cuts,var1name_nice, var2name_nice ,draw, dirname);
	f.Close();
	return ret;
}
