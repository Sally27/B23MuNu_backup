...
void plotkeyplot(string filename, string year)
{
	...
	t->SetBranchAddress("resolution", &resolution);
	t->SetBranchAddress("Bplus_corMassERR", &error);

	TH2D eff("eff", "eff", 10,0.0,1000.0,10, 0 , 1000.0);

	for(int n=0; n<t->GetEntries(); ++n)
	{
		t->GetEntry(n);
		eff.Fill(error,resolution);
	}

	TCanvas canv5("canv5", "canv5", 800, 800);
        eff.Draw("COLZ");
        canv5.SaveAs(("trial_TH2_"+year+".pdf").c_str());


	TCanvas canv6("canv6", "canv6", 800, 600);
	TProfile *profile = eff.ProfileX();
	profile->GetYaxis()->SetTitle("RMS of M_{B_{corr}} ");
	profile->GetXaxis()->SetTitle("#delta");
        profile->Draw();
	canv6.SaveAs(("trial"+year+".pdf").c_str());


        TH1D again("again", "again", 10, 0 , 1000.0);
	...
	//	again.SetBinContent(0)
                if ((error>(j*100))&&(error<((j+1)*100)))
                {
        //        SetBinContent
	        again.Fill(resolution);
                }
        }

	TCanvas canv7("canv7", "canv7", 800, 600);
        again.Draw("e1");
	canv7.SaveAs(("trial_again_"+year+"_new.pdf").c_str());
...
void addresolution(string filename, string newfilename){
	...
	t->SetBranchAddress("true_crosscheck", &truecorrm);
	t->SetBranchAddress("reco_crosscheck", &recocorrm);
	...
	newtree->Branch("resolution",&resolution,"resolution/D");
	for(int n=0; n<t->GetEntries(); ++n)
	{
		t->GetEntry(n);


		resolution = recocorrm-truecorrm;
		newtree->Fill();
	}
...
void addmissingpt_true(string filename, string newfilename){
       ...
       TFile* f = new TFile(filename.c_str());
        ...
        t->SetBranchAddress("Bplus_TRUEORIGINVERTEX_X", &BPV_X);
        t->SetBranchAddress("Bplus_TRUEORIGINVERTEX_Y", &BPV_Y);
        t->SetBranchAddress("Bplus_TRUEORIGINVERTEX_Z", &BPV_Z);
        t->SetBranchAddress("Bplus_TRUEENDVERTEX_X", &BSV_X);
        t->SetBranchAddress("Bplus_TRUEENDVERTEX_Y", &BSV_Y);
        t->SetBranchAddress("Bplus_TRUEENDVERTEX_Z", &BSV_Z);
        t->SetBranchAddress("Bplus_TRUEP_X", &Bplus_PX);
        t->SetBranchAddress("Bplus_TRUEP_Y", &Bplus_PY);
        t->SetBranchAddress("Bplus_TRUEP_Z", &Bplus_PZ);
        t->SetBranchAddress("Bplus_TRUEP_E", &Bplus_PE);
        ...
        newtree->Branch("true_missingPT",&missingPT,"missingPT/D");
        newtree->Branch("true_crosscheck",&crosscheck,"crosscheck/D");
...
void addmissingpt(string filename, string newfilename){
        ...
        t->SetBranchAddress("Bplus_MuMuMu_PV_X", &BPV_X);
        t->SetBranchAddress("Bplus_MuMuMu_PV_Y", &BPV_Y);
        t->SetBranchAddress("Bplus_MuMuMu_PV_Z", &BPV_Z);
        t->SetBranchAddress("Bplus_MuMuMu_SV_X", &BSV_X);
        t->SetBranchAddress("Bplus_MuMuMu_SV_Y", &BSV_Y);
        t->SetBranchAddress("Bplus_MuMuMu_SV_Z", &BSV_Z);
        ...
        newtree->Branch("reco_missingPT",&missingPT,"missingPT/D");
        newtree->Branch("reco_crosscheck",&crosscheck,"crosscheck/D");
...
//    int left(0);
    ...
    {
    Double_t xl1=.60, yl1=0.68, xl2=xl1+.25, yl2=yl1+.25;
    ...
    {
    Double_t xl1=.25, yl1=0.68, xl2=xl1+.25, yl2=yl1+.25;
