...
int main()
{
	...
	string file_norm="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut.root";
        ...
        addmissingpt(file_sig, "Signal2012.root");
        addmissingpt(file_norm, "Signal2016.root");

        addmissingpt_true("Signal2012.root", "Signal2012_2.root");
        addmissingpt_true("Signal2016.root", "Signal2016_2.root");

        addresolution("Signal2012_2.root", "Signal2012_3.root");
        addresolution("Signal2016_2.root", "Signal2016_3.root");

	string plot1="BEFOREBDT";

        string file1="Signal2012_3.root";

        string file2="Signal2016_3.root";


//       plotvariabletwodisnoscale("RMS",plot1, file1, file2,  tag1, tag2,  "reco_missingPT", "reco_missingPT",0 , 5000,"reco_missingPT","reco_missingPT","0",legendTitle2);
//       plotvariabletwodisnoscale("RMS",plot1, file1, file2,  tag1, tag2,  "true_missingPT", "true_missingPT",0 , 5000,"true_missingPT","true_missingPT","0",legendTitle2);
//       plotvariabletwodisnoscale("RMS",plot1, file1, file2,  tag1, tag2,  "reco_crosscheck", "reco_crosscheck",2500 , 10000,"reco_crosscheck","reco_crosscheck","0",legendTitle2);
//       plotvariabletwodisnoscale("RMS",plot1, file1, file2,  tag1, tag2,  "true_crosscheck", "true_crosscheck",2500 , 10000,"true_crosscheck","true_crosscheck","0",legendTitle2);
//       plotvariabletwodisnoscale("RMS",plot1, file1, file2,  tag1, tag2,  "Bplus_Corrected_Mass", "Bplus_Corrected_Mass",2500 , 10000,"Bplus_Corrected_Mass","Bplus_Corrected_Mass","0",legendTitle2);
//       plotvariabletwodisnoscale("RMS",plot1, file1, file2,  tag1, tag2,  "resolution", "resolution",0 , 1000,"resolution","resolution","0",legendTitle2);


       plotkeyplot("Signal2012_3.root", "2012");
       plotkeyplot("Signal2016_3.root", "2016");
