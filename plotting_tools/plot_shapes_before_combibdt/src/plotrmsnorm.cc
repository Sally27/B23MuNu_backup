...
int main()
{
	...
	lhcbSally();
        ...
        string legendTitle2="B^{+} #rightarrow J/\#psi K^{+}  MC";
	string tag1="Stripping 21";
	string tag2="Stripping 26";

//	string file_sig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_onlyRun1/Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut.root";
//	string file_norm="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut.root";
        string file_sig="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_onlyRun1/MC_B2JpsiK_2012MCTruth__misidstrippingfull_trigger.root";
        string file_norm="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/B2JpsiKMC2016_MCtruth_misidstrippingfull_trigger.root";

        addmissingpt(file_sig, "Normalisation2012.root");
        addmissingpt(file_norm, "Normalisation2016.root");

        addmissingpt_true("Normalisation2012.root", "Normalisation2012_2.root");
        addmissingpt_true("Normalisation2016.root", "Normalisation2016_2.root");

        addresolution("Normalisation2012_2.root", "Normalisation2012_3.root");
        addresolution("Normalisation2016_2.root", "Normalisation2016_3.root");

	string plot1="BEFOREBDT";

        string file1="Normalisation2012_3.root";

        string file2="Normalisation2016_3.root";


       plotvariabletwodisnoscale("RMSNORM",plot1, file1, file2,  tag1, tag2,  "reco_missingPT", "reco_missingPT",0 , 5000,"reco_missingPT","reco_missingPT","0",legendTitle2);
       plotvariabletwodisnoscale("RMSNORM",plot1, file1, file2,  tag1, tag2,  "true_missingPT", "true_missingPT",0 , 5000,"true_missingPT","true_missingPT","0",legendTitle2);
       plotvariabletwodisnoscale("RMSNORM",plot1, file1, file2,  tag1, tag2,  "reco_crosscheck", "reco_crosscheck",2500 , 10000,"reco_crosscheck","reco_crosscheck","0",legendTitle2);
       plotvariabletwodisnoscale("RMSNORM",plot1, file1, file2,  tag1, tag2,  "true_crosscheck", "true_crosscheck",2500 , 10000,"true_crosscheck","true_crosscheck","0",legendTitle2);
       plotvariabletwodisnoscale("RMSNORM",plot1, file1, file2,  tag1, tag2,  "Bplus_Corrected_Mass", "Bplus_Corrected_Mass",2500 , 10000,"Bplus_Corrected_Mass","Bplus_Corrected_Mass","0",legendTitle2);
       plotvariabletwodisnoscale("RMSNORM",plot1, file1, file2,  tag1, tag2,  "resolution", "resolution",0 , 1000,"resolution","resolution","0",legendTitle2);


       plotkeyplot("Normalisation2012_3.root", "2012_Norm");
       plotkeyplot("Normalisation2016_3.root", "2016_Norm");
