...
int main()
{
	...
	string file5="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_onlyRun1/MC_B2JpsiK_2012MCTruth__misidstrippingfull_trigger.root";
        ...
        string legendTitle4="B^{+} #rightarrow J/#psi K^{+} Data";
        string tag5="Stripping 21";
        string tag6="Stripping 26";

        string file7="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATACombiRun1_onlyRun1/Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID.root";
        string file8="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared.root";

        string tag7="Stripping 21";
        string tag8="Stripping 26";

       plotvariablefourdisnoscale("NORMALISATION_ISOLATION",plot1, file5, file6,file7,file8,  tag5, tag6,tag7,tag8,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 3,"Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights","0",legendTitle3,legendTitle4);


       plotvariablefourdisnoscale("NORMALISATION_ISOLATION_NICE",plot1, file5, file6,file7,file8,tag5, tag6,tag7,tag8,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 3,"Isolation Variable","Bplus_pmu_ISOLATION_BDT1_weights","0",legendTitle3,legendTitle4);

        plotvariabletwodisnoscale("NORMALISATION_ISOLATION_NICE_RUN1",plot1, file5, file7,  legendTitle3, legendTitle4,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 3,"Isolation Variable","Bplus_pmu_ISOLATION_BDT1_weights","0",tag5);

        plotvariabletwodisnoscale("NORMALISATION_ISOLATION_NICE_2016",plot1, file6, file8,  legendTitle3, legendTitle4,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 3,"Isolation Variable","Bplus_pmu_ISOLATION_BDT1_weights","0",tag6);
//       plotvariablefourdisnoscale("NORMALISATION_ISOLATION_NICE_RUN1",plot1, file5, file5,file7,file7,tag5, tag5,tag7,tag7,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 3,"Isolation Variable","Bplus_pmu_ISOLATION_BDT1_weights","0",legendTitle3,legendTitle4);

//       plotvariablefourdisnoscale("NORMALISATION_ISOLATION_NICE_2016",plot1, file6, file6,file8,file8,tag6, tag6,tag8,tag8,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 3,"Isolation Variable","Bplus_pmu_ISOLATION_BDT1_weights","0",legendTitle3,legendTitle4);
