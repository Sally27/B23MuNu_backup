...
//    int left(0);
    ...
    {
    Double_t xl1=.6, yl1=0.68, xl2=xl1+.25, yl2=yl1+.25;
...
//    int left(0);
    ...
    Double_t xl1=.4, yl1=0.6, xl2=xl1+.3, yl2=yl1+.3;
    if (legend=="1")
    {
    ...
    {
    Double_t xl1=.4, yl1=0.6, xl2=xl1+.35, yl2=yl1+.25;
    ...
    {
    Double_t xl1=.25, yl1=0.6, xl2=xl1+.35, yl2=yl1+.25;
