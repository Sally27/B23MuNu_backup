...
int main()
{
	...
	string file1="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATAMisidRun1_onlyRun1/Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic.root";
	string file2="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATAMisid2016_only2016/Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic.root";
...
//        string tag4=legendTitle2;
       ...
       plotvariabletwodisnoscale("MCSIG",plot1, file1, file2,  "MisidBDT Run1", "MisidBDT 2016",  "MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","MCSig2016_288888335_vs_DATAMisid2016NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection" ,-1.1, 1.1,"MisidBDT","MisidBDT","2",legendTitle2);
       ...
       string file11="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATAMisidRun1_onlyRun1/Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root";
       string file22="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATAMisid2016_only2016/Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_CombBasic.root";


        string legendTitlemis="Misid Data";
        string tag3="Stripping 21 + 21r1";
        string tag4="Stripping 26";

       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "Bplus_P", "Bplus_P",0, 300000,"B P","B_P","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "Bplus_PT","Bplus_PT" ,0, 150000,"B PT","B_PT","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu1_PT","mu1_PT" ,0, 50000,"mu1 PT","mu1_PT","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu2_PT","mu2_PT" ,0, 50000,"mu2 PT","mu2_PT","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu3_PT","mu3_PT" ,0, 50000,"mu3 PT","mu3_PT","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu1_P","mu1_P" ,0, 150000,"mu1 P","mu1_P","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu2_P","mu2_P" ,0, 150000,"mu2 P","mu2_P","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu3_P","mu3_P" ,0, 150000,"mu3 P","mu3_P","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu1_MINIPCHI2","mu1_MINIPCHI2" ,0, 20000,"mu1_MINIPCHI2","mu1_MINIPCHI2","1",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu2_MINIPCHI2","mu2_MINIPCHI2" ,0, 20000,"mu2_MINIPCHI2","mu2_MINIPCHI2","1", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "mu3_MINIPCHI2","mu3_MINIPCHI2" ,0, 20000,"mu3_MINIPCHI2","mu3_MINIPCHI2","1",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "Bplus_TAU","Bplus_TAU" ,0, 0.1,"Bplus_TAU","Bplus_TAU","1",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "Bplus_DIRA_OWNPV","Bplus_DIRA_OWNPV" ,0.998, 1,"Bplus_DIRA_OWNPV","Bplus_DIRA_OWNPV","1",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  tag3, tag4,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 5,"Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSS",plot1, file11, file22,  "MisidBDT Run1", "MisidBDT 2016",  "MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","MCSig2016_288888335_vs_DATAMisid2016NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection" ,-1.1, 1.1,"MisidBDT","MisidBDT","2",legendTitlemis);

       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "Bplus_P", "Bplus_P",0, 300000,"B^{+} p [MeV/c]","B_P","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "Bplus_PT","Bplus_PT" ,0, 50000,"B^{+} p_{T} [MeV/c]","B_PT","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu1_PT","mu1_PT" ,0, 30000,"#mu^{1} p_{T} [MeV/c]","mu1_PT","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu2_PT","mu2_PT" ,0, 30000,"#mu^{2} p_{T} [MeV/c]","mu2_PT","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu3_PT","mu3_PT" ,0, 30000,"#mu^{3} p_{T} [MeV/c]","mu3_PT","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu1_P","mu1_P" ,0, 100000,"#mu^{1} p [MeV/c]","mu1_P","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu2_P","mu2_P" ,0, 100000,"#mu^{2} p [MeV/c]","mu2_P","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu3_P","mu3_P" ,0, 100000,"#mu^{3} p [MeV/c]","mu3_P","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu1_MINIPCHI2","mu1_MINIPCHI2" ,0, 2000,"#mu^{1} minIP#chi^{2}","mu1_MINIPCHI2","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu2_MINIPCHI2","mu2_MINIPCHI2" ,0, 2000,"#mu^{2} minIP#chi^{2}","mu2_MINIPCHI2","0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "mu3_MINIPCHI2","mu3_MINIPCHI2" ,0, 2000,"#mu^{3} minIP#chi^{2}","mu3_MINIPCHI2","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "Bplus_TAU","Bplus_TAU" ,0, 0.06,"B^{+} lifetime [ns]","Bplus_TAU","1",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "Bplus_DIRA_OWNPV","Bplus_DIRA_OWNPV" ,0.9989, 1,"cos({#theta_{B^{+}}}) [mrad]","Bplus_DIRA_OWNPV","1",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 3,"Isolation Variable","Bplus_pmu_ISOLATION_BDT1_weights","0",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22, "MisidBDT Run1", "MisidBDT 2016",  "MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","MCSig2016_288888335_vs_DATAMisid2016NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection" ,-3.1, 1.1,"MisidBDT","MisidBDT","2",legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "Bplus_ENDVERTEX_CHI2","Bplus_ENDVERTEX_CHI2", 0, 10, "B^{+} vertex #chi^{2}/ndof","Bplus_ENDVERTEX_CHI2", "0", legendTitlemis);
       plotvariabletwodisnoscale("MISIDSSNICE",plot1, file11,file22,tag3,tag4,  "Bplus_FD_CHI2","Bplus_FD_CHI2", 50, 4000, "B^{+} FD #chi^{2}","Bplus_FD_CHI2", "0", legendTitlemis);





//       string tag3="Misid Run1";
//       string tag4="Misid 2016";

//       string legendTitle2,legendTitlemis="B^{+} #rightarrow #mu^{+} #mu^{-} #mu^{+} #nu_{#mu} MC #newline Misid Data";
       ...
       plotvariablefourdisnoscale("MIX",plot1, file1, file2,file11,file22,  tag1, tag2,tag3,tag4,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 2,"Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights","0",legendTitle2,legendTitlemis);
       plotvariablefourdisnoscale("MIX",plot1, file1, file2,file11,file22, "MisidBDT Run1", "MisidBDT 2016", "MisidBDT Run1", "MisidBDT 2016","MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","MCSig2016_288888335_vs_DATAMisid2016NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection" ,-3.1, 1.1,"MisidBDT","MisidBDT","2",legendTitle2,legendTitlemis);
