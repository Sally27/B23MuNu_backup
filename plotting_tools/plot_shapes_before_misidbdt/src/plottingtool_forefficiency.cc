...
int main()
{
	...
	string file5="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATAMisidRun1_onlyRun1/MC_B2JpsiK_2012MCTruth__misidstrippingfull_trigger_CombBasic.root";
...
//        string tag4=legendTitle2;
       ...
       string file3="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATAMisidRun1_onlyRun1/Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root";
       string file4="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATAMisid2016_only2016/Bu23MuNuData2016_SSmisid_mu3isNotMuon_mu3InAccMuonAcc_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_qmincut_CombBasic.root";
       string file6="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATAMisid2016_only2016/B2JpsiKMC2016_MCtruth_misidstrippingfull_trigger_CombBasic.root";
...
//       string legendTitle2,legendTitlemis,legendTitle3="B^{+} #rightarrow #mu^{+} #mu^{-} #mu^{+} #nu_{#mu} MC #newline Misid Data";
       ...
       plotvariablesixdisnoscale("FOREFF",plot1, file1, file2,file3,file4,file5,file6,  tag1, tag2,tag3,tag4,tag5,tag6,  "mu1_MINIPCHI2","mu1_MINIPCHI2" ,0, 5000,"mu1_MINIPCHI2","mu1_MINIPCHI2","0",legendTitle2,legendTitlemis,legendTitle3);
       plotvariablesixdisnoscale("FOREFF",plot1, file1, file2,file3,file4,file5,file6,  tag1, tag2,tag3,tag4,tag5,tag6,  "mu2_MINIPCHI2","mu2_MINIPCHI2" ,0, 5000,"mu2_MINIPCHI2","mu2_MINIPCHI2","0", legendTitle2,legendTitlemis,legendTitle3);
       plotvariablesixdisnoscale("FOREFF",plot1, file1, file2,file3,file4,file5,file6,  tag1, tag2,tag3,tag4,tag5,tag6,  "mu3_MINIPCHI2","mu3_MINIPCHI2" ,0, 5000,"mu3_MINIPCHI2","mu3_MINIPCHI2","0",legendTitle2,legendTitlemis,legendTitle3);
       ...
       plotvariablesixdisnoscale("FOREFF",plot1, file1, file2,file3,file4,file5,file6,  tag1, tag2,tag3,tag4,tag5,tag6,  "Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights" ,-2.1, 2,"Bplus_pmu_ISOLATION_BDT1_weights","Bplus_pmu_ISOLATION_BDT1_weights","0",legendTitle2,legendTitlemis,legendTitle3);

       plotvariablesixdisnoscale("FOREFF",plot1, file1, file2,file3,file4,file5,file6,  tag1, tag2,tag3,tag4,tag5,tag6,  "Bplus_ENDVERTEX_CHI2","Bplus_ENDVERTEX_CHI2" ,0, 10,"Bplus_ENDVERTEX_CHI2","Bplus_ENDVERTEX_CHI2","0",legendTitle2,legendTitlemis,legendTitle3);

       plotvariablesixdisnoscale("FOREFF",plot1, file1, file2,file3,file4,file5,file6, "MisidBDT Run1", "MisidBDT 2016", "MisidBDT Run1", "MisidBDT 2016","MisidBDT Run1", "MisidBDT 2016","MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection","MCSig2016_288888335_vs_DATAMisid2016NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection" ,-3.1, 1.1,"MisidBDT","MisidBDT","2",legendTitle2,legendTitlemis,legendTitle3);
       ...
       plotvariablesixdisnoscale("NICEFOREFF",plot1, file1, file2,file3,file4,file5,file6,tag1, tag2,tag3,tag4,tag5,tag6,  "mu1_MINIPCHI2","mu1_MINIPCHI2" ,0, 10000,"#mu^{1} minIP#chi^{2}","mu1_MINIPCHI2","0",legendTitle2,legendTitlemis,legendTitle3);
       plotvariablesixdisnoscale("NICEFOREFF",plot1, file1, file2,file3,file4,file5,file6,tag1, tag2,tag3,tag4,tag5,tag6,  "mu2_MINIPCHI2","mu2_MINIPCHI2" ,0, 10000,"#mu^{2} minIP#chi^{2}","mu2_MINIPCHI2","0", legendTitle2,legendTitlemis,legendTitle3);
       plotvariablesixdisnoscale("NICEFOREFF",plot1, file1, file2,file3,file4,file5,file6,tag1, tag2,tag3,tag4,tag5,tag6,  "mu3_MINIPCHI2","mu3_MINIPCHI2" ,0, 10000,"#mu^{3}/K minIP#chi^{2}","mu3_MINIPCHI2","0",legendTitle2,legendTitlemis,legendTitle3);
...
//	string file5="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsMisidFUMSB_add2016_newPID/B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut.root";
//
//	string file6="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsMisidFUMSB_add2016_newPID/B23MuNuFakeSS_2015_DV41r2_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut.root";
//
//	string file7="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsMisidFUMSB_add2016_newPID/B23MuNuFakeSS_2016_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut.root";
//
...
//
//
//	string file55="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsMisidFUMSB_add2016_newPID/Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
//
//	string file66="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsMisidFUMSB_add2016_newPID/B23MuNuData2015_DV41r2_corrmFUSMB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
//
//	string file77="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCnonsharedvsMisidFUMSB_add2016_newPID/B23MuNuData2016_corrmFUSMB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
//
//
//	//string plot1="BEFOREBDT";
//
