...
int main()
{
	...
	string file1="/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic_MisidBasic.root";
//	string file2="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut.root";
	string file11="/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/MC_B2JpsiK_2012MCTruth__misidstrippingfull_trigger_CombBasic_MisidBasic.root";

	string file2="/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic_MisidBasic.root";
...
//      string file11="/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root";
//       string file22="/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/Bu23MuNuData2016_corrmFUSMB_trigger_Jpsi_mu1isMuonTight_mu2isMuonTight_mu3isMuonTight_mu1MuonNShared_mu2MuonNShared_mu3MuonNShared_qmincut.root";
       ...
       string file22="/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/B2JpsiKMC2016_MCtruth_misidstrippingfull_trigger_CombBasic_MisidBasic.root";
       string legendTitlemis="B^{+} #rightarrow J/#psi K^{+} MC";

 //       string legendTitlemis="Combinatorial Data";
        string tag3="Stripping 21";
        string tag4="Stripping 26";



       plotvariablefourdisnoscalelogy("MIX",plot1, file1, file2,file11,file22,  tag1, tag2,tag3,tag4,  "Bplus_Corrected_Mass", "Bplus_Corrected_Mass",0, 10000,"Bplus_Corrected_Mass","Bplus_Corrected_Mass","1",legendTitle2,legendTitlemis);
       plotvariablefourdisnoscalelogy("MIX",plot1, file1, file2,file11,file22,  tag1, tag2,tag3,tag4,  "Bplus_MM", "Bplus_MM",0, 10000,"B Mass","B_MM","0",legendTitle2,legendTitlemis);

       plotvariablefourdisnoscalelogy("MIX",plot1, file1, file2,file11,file22,  tag1, tag2,tag3,tag4,  "Bplus_corMassERR", "Bplus_corMassERR",0, 1000,"Error on corrected mass","B_error","0",legendTitle2,legendTitlemis);


       plotvariablefourdisnoscale("MIX",plot1, file1, file2,file11,file22,  tag1, tag2,tag3,tag4,  "Bplus_Corrected_Mass", "Bplus_Corrected_Mass",0, 10000,"Bplus_Corrected_Mass","Bplus_Corrected_Mass","1",legendTitle2,legendTitlemis);
       plotvariablefourdisnoscale("MIX",plot1, file1, file2,file11,file22,  tag1, tag2,tag3,tag4,  "Bplus_MM", "Bplus_MM",0, 10000,"B Mass","B_MM","0",legendTitle2,legendTitlemis);

       plotvariablefourdisnoscale("MIX",plot1, file1, file2,file11,file22,  tag1, tag2,tag3,tag4,  "Bplus_corMassERR", "Bplus_corMassERR",0, 1000,"Error on corrected mass","B_error","0",legendTitle2,legendTitlemis);
