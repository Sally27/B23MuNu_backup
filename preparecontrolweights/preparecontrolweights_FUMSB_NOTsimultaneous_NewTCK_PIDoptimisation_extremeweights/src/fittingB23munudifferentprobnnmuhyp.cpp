...
ValError calaveffofasamplekaon(string filename, string weightfile, string wfilecuts, string weightfileup, string wfilecutsup ,string muon, string eta, string name, string newfilename) {
