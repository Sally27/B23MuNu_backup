...
//        string pathname = "/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/bin/";
//	string pathname2 = "/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/bin/";
...
//	PIDcut.push_back("probnnmupi06");
	...
	for (int g(0); g<PIDcut.size(); g++)
	{
		...
		tuples.push_back(("JpsiKMC2012"+PIDcut.at(g)).c_str());
	...
	for (int g(0); g<PIDcut2016.size(); g++)
	{
		...
		tuples2.push_back(("JpsiKMC2016"+PIDcut2016.at(g)).c_str());
