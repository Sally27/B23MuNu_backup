...
./main Strip21 MagUp /vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_newcontrolchannel/bin/JpsiKMCDetachedLine_2012_misidstrippingfull_trigger_CombBasic_MisidBasic_FitCorM.root JpsiKMCDetachedLine_2012_misidstrippingfull_trigger_CombBasic_MisidBasic_FitCorM.root
