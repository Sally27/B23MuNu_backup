	...
	if(l==0.0)
	{
		...
		for(int h(14); h<15; h++)
		{
			...
			int indexofcut=h;
                        ...
                        string kaoneffpath =("/vols/lhcb/ss4314/PIDCalibEfficienciesID_for_JpsiKst/2012/id/kaon/PerfHists_K_"+stripping+"_MagDown_P_ETA.root").c_str(); 
                        string kaoneffpathup =("/vols/lhcb/ss4314/PIDCalibEfficienciesID_for_JpsiKst/2012/id/kaon/PerfHists_K_"+stripping+"_MagUp_P_ETA.root").c_str();
                        string kaonidcut ="K_DLLK > 0.0 && IsMuon==0.0 && (DLLK-DLLp) > 0.0_All"; 

                        //---------------GET MC EFFICIENCIES FROM PIDCALIB-------??
                        string muonideffpath=("/vols/lhcb/ss4314/PIDCalibEfficienciesID_for_JpsiKst/2012/id/muon/PerfHists_Mu_"+stripping+"_MagDown_P_ETA.root").c_str();
                        string muonideffpathup=("/vols/lhcb/ss4314/PIDCalibEfficienciesID_for_JpsiKst/2012/id/muon/PerfHists_Mu_"+stripping+"_MagUp_P_ETA.root").c_str();
                        string muonidcut="Mu_(V2ProbNNmu > 0.5)_All";
