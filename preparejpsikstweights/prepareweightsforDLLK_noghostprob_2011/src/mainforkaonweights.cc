	...
	if(l==0.0)
	{
		...
		for(int h(14); h<15; h++)
		{
			...
			int indexofcut=h;
                        ...
                        string kaoneffpath =("/vols/lhcb/ss4314/PIDCalibEfficienciesID_for_JpsiKst/2011/id/kaon/PerfHists_K_"+stripping+"_MagDown_P_ETA.root").c_str(); 
                        string kaoneffpathup =("/vols/lhcb/ss4314/PIDCalibEfficienciesID_for_JpsiKst/2011/id/kaon/PerfHists_K_"+stripping+"_MagUp_P_ETA.root").c_str();
