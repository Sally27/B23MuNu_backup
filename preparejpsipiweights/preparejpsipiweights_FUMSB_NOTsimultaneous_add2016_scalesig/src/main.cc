	...
	//	canvshifttotal->Divide(4,4);
		...
		for(int h(14); h<15; h++)
		{
			...
			int indexofcut=h;
                        ...
                        string kaoneffpath =("/vols/lhcb/ss4314/PIDCalibEfficiencies/2015/ideff/pion/PerfHists_Pi_"+stripping+"_MagDown_P_ETA.root").c_str(); 
                        string kaoneffpathup =("/vols/lhcb/ss4314/PIDCalibEfficiencies/2015/ideff/pion/PerfHists_Pi_"+stripping+"_MagUp_P_ETA.root").c_str();
