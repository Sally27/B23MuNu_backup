...
int main(){
	...
	vector<string> PIDcut2016;
        ...
        string pathname = "/vols/lhcb/ss4314/preparejpsipiweights/preparejpsipiweights_FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights/tuples_nonsim/";
	string pathname2 = "/vols/lhcb/ss4314/preparejpsipiweights/preparejpsipiweights_FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights/tuples_nonsim/";
...
//	PIDcut.push_back("probnnmupi06");
	...
	for (int g(0); g<PIDcut.size(); g++)
	{
		...
		tuples.push_back(("JpsiPiMC2012"+PIDcut.at(g)).c_str());
