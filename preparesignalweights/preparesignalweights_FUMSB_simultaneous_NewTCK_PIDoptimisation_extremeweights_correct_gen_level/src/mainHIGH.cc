...
int main(){
	...
	vector<string> PIDcut2016;
        ...
        string pathname = "/vols/lhcb/ss4314/preparesignalweights/preparesignalweights_FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level/tuples_nonsim/";
...
//	PIDcut.push_back("probnnmupi06");
	...
	for (int g(0); g<PIDcut.size(); g++)
	{
		...
		tuples.push_back(("B23MuNuMC2012"+PIDcut.at(g)+"Strip21").c_str());
	...
	for (int g(0); g<PIDcut2016.size(); g++)
	{
		...
		tuples2.push_back(("B23MuNuMC2016"+PIDcut2016.at(g)+"Turbo16").c_str());
