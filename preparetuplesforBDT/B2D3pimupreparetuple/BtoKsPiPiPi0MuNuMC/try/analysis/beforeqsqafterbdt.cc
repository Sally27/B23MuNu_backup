...
*/
  ...
  DataSample hist1("../B2D3piD0inclusiverightMCrightIsolationvetoJpsiBDTcut.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  /*Double_t nSel1, nGen1, nSel2, nGen2, nSel3, nGen3, nSel4, nGen4;*/
  ...
  DataSample hist2("/vols/lhcbdisk05/ss4314/MCSigpreparetuple/try/B23MuNuNewMCsamplevetoJpsiBDTcut.root", "DecayTree");

  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, 2500, 10000);
  double nSel2 = hist2.t->GetEntries();
//  double myscale = 194952.0;
  myscale = ((double(nSel1)/double(nSel2))*0.6598);
...
//   a->SetYTitle("NCandidatesSel/NCandidatesGen");
   a->SetTitle("Bplus_Corrected_Mass");
...
*/
   ...
   mp3->Update();
   mp3->SaveAs("B2D3pimunuMCinclusiveD0rightMCrightISOscalingbeforeqsqafterbdtcut.pdf");
