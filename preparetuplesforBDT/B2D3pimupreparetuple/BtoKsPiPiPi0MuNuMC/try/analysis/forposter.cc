...
*/
  ...
  DataSample hist1("../B2D3piD0inclusiverightMCrightIsolationvetoJpsi.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  /*Double_t nSel1, nGen1, nSel2, nGen2, nSel3, nGen3, nSel4, nGen4;*/
...
//  printLHCb("L","Prelim","");
  ...
  DataSample hist2("/vols/lhcbdisk05/ss4314/preparetuplesforBDT/MCSigpreparetuple/tuplewithnSharedrefinedscript/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut.root", "DecayTree");
...
//   hm->SetTitle("Bplus_Corrected_Mass NOT TO SCALE");
   hm->SetXTitle("Corrected #mu^{+}#mu^{-}#mu^{+}[MeV/c^{2}]");
...
//    leg->SetTextSize(0.02);
    leg->SetBorderSize(0);
    leg->AddEntry(hm,"LHCb #mu^{+} #mu^{-} #mu^{+} #nu_{#mu} simulation","l");
    leg->AddEntry(a,"LHCb D^{0} (K^{+} #pi^{-} #mu^{+} #mu^{-}) #mu^{+} #nu_{#mu} simulation","l");   // h1 and h2 are histogram pointers
    leg->AddEntry(la,"LHCb Combinatorial Data","l");
