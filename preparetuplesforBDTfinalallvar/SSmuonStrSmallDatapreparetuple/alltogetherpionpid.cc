...
string pathname = "/vols/lhcbdisk05/ss4314/tuples/SSmuonStrSmallData/";
...
double minq2;
minq2=cutTree((filename+ext).c_str(), decaytreename, (namecuttree2+ext).c_str(), cut2);

//string filename = namecuttree2;
//string decaytreename = "DecayTree";
//string ext = ".root";
//string cuttag = "_KaonPID";
//string namecuttree2 = (filename+cuttag).c_str();
//cut2 = "(mu3_PIDK > 0) && (mu3_PIDp - mu3_PIDK < 5)";
...
string decaytreename = "DecayTree";
string ext = ".root";
string cuttag = "_PionPID";
string namecuttree2 = (filename+cuttag).c_str();
string cut2 = "(mu3_PIDK < 0) && (mu3_PIDp < 5)";


double iden;
iden=cutTree((filename+ext).c_str(), decaytreename, (namecuttree2+ext).c_str(), cut2);
