...
//   TTree* t = (TTree*)f.Get(decaytreename.c_str());
   ...
   {
	   t->GetEntry(i);
           if (TCK ==17170594 && MuonPT > 56)
           {
           t2->Fill();
           count2++;
           }
           
           else if (TCK ==17170595 && MuonPT > 48)
           {
           t2->Fill();
           count2++;
           }

           else if (TCK ==17170598 && MuonPT > 36)
           {
           t2->Fill();
           count2++;
           }

           else if (TCK ==17170599 && MuonPT > 30)
           {
           t2->Fill();
           count2++;
           }

           else if (TCK ==17236129 && MuonPT > 38)
           {
           t2->Fill();
           count2++;
           }

           else if (TCK ==17301666 && MuonPT > 56)
           {
           t2->Fill();
           count2++;
           }

           else if (TCK ==18088104 && MuonPT > 56)
           {
           t2->Fill();
           count2++;
           }
