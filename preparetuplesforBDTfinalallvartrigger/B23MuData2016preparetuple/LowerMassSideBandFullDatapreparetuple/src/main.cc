...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        string pathname = "/vols/lhcb/ss4314/tuplesallvar/Data2016/";
        string filename = "B23MuNuData2016";
	...
	addKFoldandW(filename2, "DecayTree", filename2);
        ...
        string filename3=(filenameclean+"_corrmLSDfull").c_str();
        ...
        string filename4=(filenameclean+"_corrmLSDfull_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS").c_str();
