...
int main(){
	...
	out<<"\\hline"<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/tuplesallvar/JpsiKdataDetachedLine/2011/";
	string filename = "B2JpsiKDetachedData_2011";
...
//	vals.push_back("minq2 < 960400");
	...
	string filename3="B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc";
	...
	string filename4="B2JpsiKDetachedData_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS";
