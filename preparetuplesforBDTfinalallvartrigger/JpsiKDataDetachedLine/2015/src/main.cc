...
int main(){
	...
	out<<"\\hline"<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/tuplesallvar/JpsiKdataDetachedLine/2015/";
	string filename = "B2JpsiKDataDetached2015_v42r1";
	...
	string filename3="B2JpsiKDataDetached2015_v42r1_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc";
	...
	string filename4="B2JpsiKDataDetached2015_v42r1_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS";
