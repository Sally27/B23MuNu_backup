...
int main(){
	...
	out<<"\\hline"<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/tuplesallvar/JpsiKdataDetachedLine/2016/";
	string filename = "B2JpsiK2016";
	...
	string filename3="B2JpsiK2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc";
	...
	string filename4="B2JpsiK2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS";
