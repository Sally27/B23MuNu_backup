...
int main(){
	...
	out<<"or strip and reco & 0.291137 & 1223359(4201997) & TBD  \\\\ "<<endl;
...
//	string filename2 = (filename+cuttag).c_str();
 //       string filenameclean = filename;
        ...
        string pathname = "/vols/lhcb/ss4314/tuplesallvar/JpsiKMCDetachedLine/2016/";
        string filename = "B2JpsiKMC2016Detached";
        string decaytreename = "B2JpsiK_Tuple/DecayTree";
        string ext = ".root";
        string cuttag = "";
        string filename2 = (filename+cuttag).c_str();
