...
int main(){
	...
	out<<"or strip and reco & 0.23207 \\\\ "<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/tuplesallvar/JpsiKdata/";
	string filename = "BuKMuMuMerged";
...
//	vals.push_back("minq2 < 960400");
	...
	string filename3="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc";
	...
	string filename4="BuKMuMuMerged_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS";
