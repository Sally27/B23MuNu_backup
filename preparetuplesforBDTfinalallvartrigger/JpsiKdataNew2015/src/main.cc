...
int main(){
	...
	out<<"or strip and reco & 0.23207 \\\\ "<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/tuplesallvar/JpsiKdata2015/";
	string filename = "JpsiKData_2015";
...
//	varia.push_back("qmincut");
	...
	vals.push_back("(Bplus_L0MuonDecision_TOS==1.0) && (Bplus_Hlt1TrackMuonDecision_TOS==1.0) && ((Bplus_Hlt2Topo2BodyDecision_TOS==1.0) || (Bplus_Hlt2Topo3BodyDecision_TOS==1.0) || (Bplus_Hlt2DiMuonDetachedDecision_TOS==1.0) || (Bplus_Hlt2DiMuonDetachedHeavyDecision_TOS==1.0))");
...
//	vals.push_back("minq2 < 960400");
	...
	vals.push_back("(Bplus_Hlt2Topo2BodyDecision_TOS==1.0) || (Bplus_Hlt2Topo3BodyDecision_TOS==1.0) || (Bplus_Hlt2DiMuonDetachedDecision_TOS==1.0) || (Bplus_Hlt2DiMuonDetachedHeavyDecision_TOS==1.0)");

	varia.push_back("L0MuonDecisionTOS");
	varia.push_back("Hlt1TrackMuonDecisionTOS");
	varia.push_back("Hlt2orofDecisions");

	string filename3="JpsiKData_2015_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc";
	...
	vals.push_back("Bplus_Hlt2Topo2BodyDecision_TOS==1.0");
        vals.push_back("Bplus_Hlt2Topo3BodyDecision_TOS==1.0");
        vals.push_back("Bplus_Hlt2DiMuonDetachedDecision_TOS==1.0");
        vals.push_back("Bplus_Hlt2DiMuonDetachedHeavyDecision_TOS==1.0");

	varia.push_back("Hlt2Topo2BodyDecision");
        varia.push_back("Hlt2Topo3BodyDecision");
        varia.push_back("Hlt2DiMuonDetachedDecision");
        varia.push_back("Hlt2DiMuonDetachedHeavyDecision");
        

	string filename4="JpsiKData_2015_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS";
	...
	//	filename3=(filename3+"_"+varia.at(i)).c_str();
        ...
        {
        double eff;
        eff=cutTree("JpsiKData_2015_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut.root", "DecayTree", "JpsiKData_2015_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID.root", "(mu3_PIDK > 0) && (mu3_PIDp - mu3_PIDK < 5)");
        out<<"(mu3_PIDK > 0) && (mu3_PIDp - mu3_PIDK < 5) & "<<eff<<" \\\\ "<<endl;
        addKFoldandW("JpsiKData_2015_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID", "DecayTree", "JpsiKData_2015_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_qmincut_KaonPID");
        }
	...
	//        string cutspec = "(Bplus_L0MuonDecision_TOS==1.0) && (Bplus_Hlt1TrackMuonDecision_TOS==1.0) && ((Bplus_Hlt2Topo2BodyDecision_TOS==1.0) || (Bplus_Hlt2Topo3BodyDecision_TOS==1.0) || (Bplus_Hlt2DiMuonDetachedDecision_TOS==1.0) || (Bplus_Hlt2DiMuonDetachedHeavyDecision_TOS==1.0))";
	//
	//        double triggereff;
