...
int main(){
	...
	out<<"or strip and reco & 0.23207 \\\\ "<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/tuplesallvar/JpsiKmc2011strip20r1/";
	string filename = "BuKMuMuMC2011total";
	...
	string filename4=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS").c_str();
