...
void addcostheta(string filename, string decaytreename, string newfilename)
{
	...
	//
	//              //veto J/psi
	t->SetBranchAddress("K_PX", &mu3_PX);
	t->SetBranchAddress("K_PY", &mu3_PY);
	t->SetBranchAddress("K_PZ", &mu3_PZ);
	t->SetBranchAddress("K_PE", &mu3_PE);
...
//	Double_t mu3_isMuon;
	...
	Int_t mu1_MC_MOTHER_ID, mu2_MC_MOTHER_ID, K_MC_MOTHER_ID, Pi_MC_MOTHER_ID, mu1_MC_GD_MOTHER_ID, mu2_MC_GD_MOTHER_ID, K_MC_GD_MOTHER_ID, Pi_MC_GD_MOTHER_ID;
	Int_t Bplus_BKGCAT;
        Int_t mu1_TRUEID, mu2_TRUEID, K_TRUEID, Pi_TRUEID;

	t->SetBranchAddress("B0_BKGCAT", &Bplus_BKGCAT);


	t->SetBranchAddress("mu1_MC_MOTHER_ID", &mu1_MC_MOTHER_ID);
	t->SetBranchAddress("mu2_MC_MOTHER_ID", &mu2_MC_MOTHER_ID);
	t->SetBranchAddress("K_MC_MOTHER_ID", &K_MC_MOTHER_ID);
        t->SetBranchAddress("Pi_MC_MOTHER_ID", &Pi_MC_MOTHER_ID);
	t->SetBranchAddress("mu1_MC_GD_MOTHER_ID", &mu1_MC_GD_MOTHER_ID);
	t->SetBranchAddress("mu2_MC_GD_MOTHER_ID", &mu2_MC_GD_MOTHER_ID);
	t->SetBranchAddress("K_MC_GD_MOTHER_ID", &K_MC_GD_MOTHER_ID);
        t->SetBranchAddress("Pi_MC_GD_MOTHER_ID", &Pi_MC_GD_MOTHER_ID);

	t->SetBranchAddress("mu1_TRUEID", &mu1_TRUEID);
	t->SetBranchAddress("mu2_TRUEID", &mu2_TRUEID);
	t->SetBranchAddress("K_TRUEID", &K_TRUEID);
        t->SetBranchAddress("Pi_TRUEID", &Pi_TRUEID);
	...
	for(int i(0); i<t->GetEntries(); ++i)
	{
		...
		if (Bplus_BKGCAT<60)// ||Bplus_BKGCAT==50)
		{
			count++;

			if ((abs(mu1_TRUEID)==13) && (abs(mu2_TRUEID)==13) && (abs(K_TRUEID)==211) && (abs(Pi_TRUEID)==321) && mu1_MC_MOTHER_ID==443 && mu2_MC_MOTHER_ID==443 && abs(K_MC_MOTHER_ID)==313 && abs(Pi_MC_MOTHER_ID)==313 && abs(mu1_MC_GD_MOTHER_ID)==511 && abs(mu2_MC_GD_MOTHER_ID)==511 && abs(K_MC_GD_MOTHER_ID)==511 && abs(Pi_MC_GD_MOTHER_ID)==511)
                        {			
				count2++;
				t2->Fill();
//				//              cout<<"Executing"<<endl;
...
//  t->SetBranchAddress("K_isMuon", &mu3_isMuon);
  
//  t->SetBranchAddress("mu1_inMuon", &mu1_inMuon);
//  t->SetBranchAddress("mu2_inMuon", &mu2_inMuon);
//  t->SetBranchAddress("K_inMuon", &mu3_inMuon);

//  t->SetBranchAddress("mu1_inMuon", &mu1_inMuon);
//  t->SetBranchAddress("mu2_inMuon", &mu2_inMuon);
//  t->SetBranchAddress("K_MINIPCHI2", &mu3_MINIPCHI2);
//  t->SetBranchAddress("K_PIDmu", &mu3_PIDmu);
//  t->SetBranchAddress("K_PIDK", &mu3_PIDK);
//  t->SetBranchAddress("K_PIDp", &mu3_PIDp);
//  t->SetBranchAddress("K_ghost", &mu3_ghost);
//  t->SetBranchAddress("K_TRACK_CHI2", &mu3_TRACK_CHI2);
...
//  Double_t mu1mu2, mu2mu3, mu1mu3;
 ...
 //  t1->Branch("mu1mu3Massfinal",&mu1mu3,"mu1mu3/D");
   ...
   //t1->Branch("Konly",&onlymu3,"onlymu3/D");
   count=0;
   count2=0;
...
void addqsqinf(string filename, string decaytreename, string newfilename)
{
	...
	Int_t identify;
	Double_t invmu1mu2,invmu2mu3,invmu1mu3,invmu1mu2mu3, invmu1mu2K;
	...
	t2->Branch("invmu2andmu3",&invmu2mu3,"invmu2mu3/D");
	t2->Branch("invmu1andmu3",&invmu1mu3,"invmu1mu3/D");
        t2->Branch("invmu1mu2mu3",&invmu1mu2mu3,"invmu1mu2mu3/D");
        t2->Branch("invmu1mu2K",&invmu1mu2K,"invmu1mu2K/D");
