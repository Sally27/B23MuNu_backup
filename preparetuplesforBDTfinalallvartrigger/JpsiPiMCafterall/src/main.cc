...
int main(){
	...
	out<<"or strip and reco & 0.31575 & 2539870(8043820) & TBD  \\\\ "<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_add2016/bin/";
	string filename = "BuPiMuMuMC_misidstrippingfull_trigger_CombBasic_MisidBasic_FitCorM";
