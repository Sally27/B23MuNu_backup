...
int main(){
	...
	out<<"or strip and reco & 0.31575 & 2539870(8043820) & TBD  \\\\ "<<endl;
        ...
        if (p==0)
        {
	string pathname = "/vols/lhcb/ss4314/cutonFCME/FUMSB_simultaneous_NewTCK/bin/";
	string filename = "MC_2012_B2PiMuMu_misidstrippingfull_trigger_CombBasic_MisidBasic_FitCorM_HighFCME";
