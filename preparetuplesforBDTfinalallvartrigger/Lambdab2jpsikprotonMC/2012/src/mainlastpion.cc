...
int main(){
	...
	out<<"or strip and reco & 0.144209 & 1277956(8861780) & TBD  \\\\ "<<endl;
        ...
        string pathname = "/vols/lhcb/ss4314/tuplesallvar/Lambdab2jpsikproton/2012/";
        string filename = "Lambdab2jpsikpMC2012";
...
//        vals.push_back("(K_ProbNNk*(1-K_ProbNNp))>0.05");
        vals.push_back("((Pi_ProbNNpi)*(1-Pi_ProbNNk)*(1-Pi_ProbNNp))>0.1");
