...
//	varia.push_back("PT");
	...
	varia.push_back("Pighost");
        ...
        varia.push_back("PipidK");
        varia.push_back("Pipidp");
        varia.push_back("PipidisMuon");
...
//	varia.push_back("mu1PIDmmu2PIDK");
	...
	vals.push_back("K_PIDK > 0");
	vals.push_back("K_PIDK - K_PIDp > 0");
        vals.push_back("K_isMuon==0.0");
