...
double calculateL0effMC(string nametree, string decaytreename, string newfilename)
{
   ...
   double TCK1= cutTree((nametree+ext).c_str(), decaytreename, "not.root", "L0Data_Muon1_Pt>56");
   double TCK2= cutTree((nametree+ext).c_str(), decaytreename, "not.root", "L0Data_Muon1_Pt>48");
   double TCK3= cutTree((nametree+ext).c_str(), decaytreename, "not.root", "L0Data_Muon1_Pt>36");
   double TCK4= cutTree((nametree+ext).c_str(), decaytreename, "not.root", "L0Data_Muon1_Pt>30");
   double TCK5= cutTree((nametree+ext).c_str(), decaytreename, "not.root", "L0Data_Muon1_Pt>38");
   double TCK6= cutTree((nametree+ext).c_str(), decaytreename, "not.root", "L0Data_Muon1_Pt>56");
   double TCK7= cutTree((nametree+ext).c_str(), decaytreename, "not.root", "L0Data_Muon1_Pt>56");

   double TCKpropdata1= 0.294293;
   double TCKpropdata2= 0.210096;
   double TCKpropdata3= 0.000184376;
   double TCKpropdata4= 0.00389438;
   double TCKpropdata5= 0.0222398;
   double TCKpropdata6= 0.208259;
   double TCKpropdata7= 0.261033;

   double cont1= TCK1*TCKpropdata1;
   double cont2= TCK2*TCKpropdata2;
   double cont3= TCK3*TCKpropdata3;
   double cont4= TCK4*TCKpropdata4;
   double cont5= TCK5*TCKpropdata5;
   double cont6= TCK6*TCKpropdata6;
   double cont7= TCK7*TCKpropdata7;

   double totcont = cont1 + cont2 + cont3 + cont4 + cont5 + cont6 + cont7;
