...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/tuplesallvar/B23MuNuMC2016/";
	string filename = "B23MuNuMC2016";
	...
	string filename2 = (filename+cuttag).c_str();
        ...
        out << "$\\epsilon_{reco}$ &" << effrecostrip2 << " & "<<"(149879)1107715 " << " & "<< (sqrt(double(149879)*(1.0-((double(1107715)/double(1107715))))))*(1/double(1107715)) <<" \\\\ "<<endl;
