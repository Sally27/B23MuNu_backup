...
int main(){
	...
	out<<"\\begin{document}"<<endl;
        ...
        string pathname = "/vols/lhcb/ss4314/tuplesallvar/SSMisidRestripping2015/";
        string filename = "B23MuNuFakeSS_2015_DV41r2";
	...
	string filename3=(filenameclean+"_mu3isNotMuon_mu3inMuonAcc").c_str();
	...
	string filename4=(filenameclean+"_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTOS_Hlt1TrackMuonDecisionTOS").c_str();        
