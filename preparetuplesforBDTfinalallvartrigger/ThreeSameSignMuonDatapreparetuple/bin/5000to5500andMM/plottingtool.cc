...
string file7="/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/ThreeSameSignMuonDatapreparetuple/bin/5000to5500andMM/B23SameSignMuonTotal_investigate50005500andMM.root";
...
plotonevariable(file7, "Bplus_Corrected_Mass", 5000, 5500, 100);
plotonevariable(file7, "invmu1andmu2", 200 , 290, 100);
plotonevariable(file7, "invmu1andmu3", 200 , 290, 100);
plotonevariable(file7, "invmu2andmu3", 200 , 290, 100);
...
plotonevariable(file7, "mu1_PT", 1800 , 8000, 100);
plotonevariable(file7, "mu2_PT", 1800 , 8000, 100);
plotonevariable(file7, "mu1_MuMuMu_MCORRFULLERR", 0 , 2000, 100);

plotstackimprovedexclude(30,"30NormalizednocutsOVERVIEWexcludeallothers",plot1, file7, file7, file7, file7, tag1, tag2, tag3, tag4, "Bplus_Corrected_Mass", 5000, 5500,"Bplus_Corrected_Mass","Bplus_Corrected_Mass");

plotstackimprovedexclude2(30,"30NormalizednSharedOVERVIEWexcludeallothers2",plot1, file7, file7, file7, file7, tag1, tag2, tag3, tag4, "Bplus_Corrected_Mass", 5000, 5500,"Bplus_Corrected_Mass","Bplus_Corrected_Mass");
