...
string file7="/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/ThreeSameSignMuonDatapreparetuple/bin/ALLCORMandtigterMM/B23SameSignMuonTotal_investigateALLCORMandtigterMM.root";
...
plotstackimprovedexclude(30,"30NormalizednocutsOVERVIEWexcludeallothers",plot1, file7, file7, file7, file7, tag1, tag2, tag3, tag4, "Bplus_Corrected_Mass", 2500, 10000,"Bplus_Corrected_Mass","Bplus_Corrected_Mass");

plotstackimprovedexclude2(30,"30NormalizednSharedOVERVIEWexcludeallothers2",plot1, file7, file7, file7, file7, tag1, tag2, tag3, tag4, "Bplus_Corrected_Mass", 2500, 10000,"Bplus_Corrected_Mass","Bplus_Corrected_Mass");
