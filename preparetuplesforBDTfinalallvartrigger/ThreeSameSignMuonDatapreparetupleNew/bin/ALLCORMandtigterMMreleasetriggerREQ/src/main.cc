...
string file6="/vols/lhcb/ss4314/preparetuplesforBDTfinalallvartrigger/ThreeSameSignMuonDatapreparetuple/bin/ALLCORMandtigterMMreleasetriggerREQ/B23SameSignMuonTotal.root";
...
plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "Bplus_Corrected_Mass", 0, 10000, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "missingPT", 0, 5000, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "Bplus_MM", 0, 5000, 100);
return(1);
...
plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "nDownstreamTracks", 0, 80, 100);
plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "nUpstreamTracks", 0, 80, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "nMuonTracks", 0, 80, 100);

return(1);

plotposition2("B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root","Bplus_Corrected_Mass > 0","mu1_PX/mu1_P" , "mu1_PY/mu1_P");

plotposition2("B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root","Bplus_Corrected_Mass > 0","mu1_PX/mu1_P" , "mu1_PZ/mu1_P");

plotposition2("B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root","Bplus_Corrected_Mass > 0","mu1_PY/mu1_P" , "mu1_PZ/mu1_P");
...
//plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "Bplus_PT", 0, 10000, 100);

//plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "missingPT", 0, 10000, 100);
//plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "Bplus_P", 0, 100000, 100);

//plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "Bplus_ETA", 0, 7, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "mu1_PT", 0, 10000, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "mu2_PT", 0, 10000, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "mu3_PT", 0, 10000, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "Bplus_P_Perp", 0, 10000, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "Bplus_P_Parallel", 0, 100000, 100);

plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "Bplus_Z_travelled", 0, 250, 100);


//plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "mu1_ETA", 0, 7, 100);

//plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "mu2_ETA", 0, 7, 100);

//plotonevariable3folders("B23SameSignMuonTotal.root", "B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root" ,"B23SameSignMuonTotal_investigateALLCORMandOPtigterMMreleasetriggerREQ.root" , "mu3_ETA", 0, 7, 100);
