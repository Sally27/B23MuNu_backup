...
int plotposition2(string filename, string cuts, string var1name, string var2name){
   ...
   TH2D th2f("th2f", "th2f", 50,0,1,50,0,1);
   ...
   for(int i(0); i<t->GetEntries(); ++i)
   {
      ...
      th2f.Draw("CONTZ");
      //canv.Print( (filename+cleanNameString(var1name+"_vs_"+var2name)+".pdf").c_str());
      canv.Print(( "2D"+cleanNameString(var1name)+"_vs_"+cleanNameString(var2name)+".pdf").c_str());
...
//   Double_t xl1=.7; Double_t yl1=0.7; Double_t xl2=xl1+.2; Double_t yl2=yl1+.2;   
...
//plotposition3D("B23SameSign2012DownTrackers_investigateALLCORMandOPtigterMMreleasetriggerREQ.root","Bplus_Corrected_Mass > 0","mu1_MuMuMu_PV_X" ,"mu1_MuMuMu_PV_Y" ,"mu1_MuMuMu_PV_Z");

//plotposition3D("B23SameSign2012DownTrackers_investigateALLCORMandOPtigterMMreleasetriggerREQ.root","Bplus_Corrected_Mass > 0","mu1_MuMuMu_SV_X" ,"mu1_MuMuMu_SV_Y" ,"mu1_MuMuMu_SV_Z");
...
//plotposition2("B23SameSignMuonTotal_investigateALLCORMandtigterMMreleasetriggerREQ.root","Bplus_Corrected_Mass > 0","mu1_PX/P" , "mu2_PY/P");
