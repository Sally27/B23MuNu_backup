...
void plotvariablebeforeq2(string k, double low, double high, string xaxis)
{
  ...
  int nbins=100;
//  printLHCb("L","Prelim","");
  DataSample hist3("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/MCSigpreparetuple/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared.root", "DecayTree");
  ...
  DataSample hist1("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/B2D3pimupreparetuple/B2D3pimufinal_MCtruth_cut_mu3nShared.root", "DecayTree");
  double nSel1 = hist1.t->GetEntries();
  double scale;
  scale = nSel3/nSel1;
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", nbins, low, high);
//  a->Scale(scale);
  ...
  DataSample hist2("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/SSmuonStrSmallDatapreparetuple/B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_cut_mu1nShared_mu2nShared.root", "DecayTree");
  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", nbins, low, high);
  double nSel2 = hist2.t->GetEntries();
  double scale2;
  scale2=nSel3/nSel2;
  ...
  DataSample hist4("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/Combinatorialpreparetuple/B23MuNuSignal2012and2011data_corrm_mu1nShared_mu2nShared_mu3nShared.root", "DecayTree");
  TH1F* ho = new TH1F("bplusmm2", "bplusmm2", nbins, low, high);
  double nSel4 = hist4.t->GetEntries();
  double scale3;
  scale3=nSel3/nSel4;
...
//  a->Scale(scale);
  ...
  DataSample hist4("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/Combinatorialpreparetuple/B23MuNuSignal2012and2011data_corrm_mu1nShared_mu2nShared_mu3nShared_qmin.root", "DecayTree");
  TH1F* ho = new TH1F("bplusmm2", "bplusmm2", nbins, low, high);
  double nSel4 = hist4.t->GetEntries();
  double scale3;
  scale3=nSel3/nSel4;
...
//plotvariableafterq2("minq2", 0.0, 10000000.0, "min q^{2} [MeV/c^{2}]^{2}");
//plotvariableafterq2("maxq2", 0.0, 35000000.0, "max q^{2} [MeV/c^{2}]^{2}");



plotvariablebeforeq2("minq2", 0.0, 20000000.0, "min q^{2} [MeV/c^{2}]^{2}");
plotvariablebeforeq2("maxq2", 0.0, 40000000.0, "max q^{2} [MeV/c^{2}]^{2}");
