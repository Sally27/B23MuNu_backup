...
TLatex *latex = new TLatex(grfirst->GetX()[0], grfirst->GetY()[0], "(V1ProbNNmu > 0.0)");
latex->SetTextSize(0.02);

TLatex *latex1 = new TLatex(grfirst->GetX()[1], grfirst->GetY()[1], "(V1ProbNNmu > 0.2)");
latex1->SetTextSize(0.02);

TLatex *latex2 = new TLatex(grfirst->GetX()[2], grfirst->GetY()[2], "(V1ProbNNmu > 0.25)");
latex2->SetTextSize(0.02);

TLatex *latex3 = new TLatex(grfirst->GetX()[3], grfirst->GetY()[3], "(V1ProbNNmu > 0.3)");
latex3->SetTextSize(0.02);

TLatex *latex4 = new TLatex(grfirst->GetX()[4], grfirst->GetY()[4], "(V1ProbNNmu > 0.35)");
...
//TLatex *blatex = new TLatex(grsecond->GetX()[0], grsecond->GetY()[0], "(V1ProbNNmu > 0.0)");
//blatex->SetTextSize(0.02);
//blatex->SetTextColor(i+1);
//
//TLatex *blatex1 = new TLatex(grsecond->GetX()[1], grsecond->GetY()[1], "(V1ProbNNmu > 0.2)");
//blatex1->SetTextSize(0.02);
//blatex1->SetTextColor(i+1);
//
//TLatex *blatex2 = new TLatex(grsecond->GetX()[2], grsecond->GetY()[2], "(V1ProbNNmu > 0.25)");
//
//blatex2->SetTextSize(0.02);
//blatex2->SetTextColor(i+1);
//
//TLatex *blatex3 = new TLatex(grsecond->GetX()[3], grsecond->GetY()[3], "(V1ProbNNmu > 0.3)");
//blatex3->SetTextSize(0.02);
//blatex3->SetTextColor(i+1);
//
//TLatex *blatex4 = new TLatex(grsecond->GetX()[4], grsecond->GetY()[4], "(V1ProbNNmu > 0.35)");
...
double* firstmisideffi2 = &firstcut2[15];
double* firstmisideffi = &firstcut[15];
...
double* firstmisideffi2 = &firstcut2[25];
double* firstmisideffi = &firstcut[25];
...
double* firstmisideffi2 = &firstcut2[35];
double* firstmisideffi = &firstcut[35];
...
c1->BuildLegend();
c1->SaveAs("performancerateforana2015.pdf");
return;
