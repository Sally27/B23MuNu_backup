...
string ifilename="/vols/lhcb/ss4314/PIDCalibEfficiencies/misideff/pion/PerfHists_Pi_Strip21_MagDown_P_ETA.root";
string ith3namefirst ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string ith3namesecond ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
string ith3namethird ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All";
string ith3namefourth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All";
string ith3namefifth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All";
...
string ifilename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/ideff/muon/PerfHists_Mu_Strip21_MagDown_P_ETA.root";
string ith3namefirst2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string ith3namesecond2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
string ith3namethird2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All";
string ith3namefourth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All";
string ith3namefifth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All";
...
TLatex *platex1 = new TLatex(grthird->GetX()[2], grthird->GetY()[2], "(V2ProbNNmu > 0.25)");
platex1->SetTextSize(0.02);
platex1->SetTextColor(i);

TLatex *platex2 = new TLatex(grthird->GetX()[3], grthird->GetY()[3], "(V2ProbNNmu > 0.3)");
platex2->SetTextSize(0.02);
platex2->SetTextColor(i);

TLatex *platex3 = new TLatex(grthird->GetX()[4], grthird->GetY()[4], "(V2ProbNNmu > 0.35)");
platex3->SetTextSize(0.02);
platex3->SetTextColor(i);

TLatex *platex4 = new TLatex(grthird->GetX()[0], grthird->GetY()[0], "(V2ProbNNmu > 0.0)");
...
TLatex *ulatex = new TLatex(grfourth->GetX()[1], grfourth->GetY()[1], "(V2ProbNNmu > 0.2)");
ulatex->SetTextSize(0.02);
ulatex->SetTextColor(i+1);

TLatex *ulatex1 = new TLatex(grfourth->GetX()[2], grfourth->GetY()[2], "(V2ProbNNmu > 0.25)");
ulatex1->SetTextSize(0.02);
ulatex1->SetTextColor(i+1);

TLatex *ulatex2 = new TLatex(grfourth->GetX()[3], grfourth->GetY()[3], "(V2ProbNNmu > 0.3)");
ulatex2->SetTextSize(0.02);
ulatex2->SetTextColor(i+1);

TLatex *ulatex3 = new TLatex(grfourth->GetX()[4], grfourth->GetY()[4], "(V2ProbNNmu > 0.35)");
ulatex3->SetTextSize(0.02);
ulatex3->SetTextColor(i+1);

TLatex *ulatex4 = new TLatex(grfourth->GetX()[0], grfourth->GetY()[0], "(V2ProbNNmu > 0.0)");
...
c1->BuildLegend();
c1->SaveAs("comparedirectly2016.pdf");
return;
