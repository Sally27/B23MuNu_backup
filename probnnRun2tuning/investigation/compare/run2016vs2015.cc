...
double misid(string filename, string th3name, int binofmomentum)
{
  ...
  PArr[10]=70000.0;
  PArr[11]=100000.0;
//B(3000 : 6000 : 8000 : 10000 : 12000 : 14500 : 17500 : 21500 : 27000 : 32000 : 40000 : 60000 : 70000 : 100000)
...
string filename="/vols/lhcb/ss4314/PIDCalibEfficiencies/2015/misideff/pion/PerfHists_Pi_Strip26_MagDown_P_ETA.root"; 
string th3namefirst ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3namesecond ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.2)_All";
string th3namethird ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.25)_All";
string th3namefourth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.3)_All";
string th3namefifth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.35)_All";
...
string filename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/2015/ideff/muon/PerfHists_Mu_Strip26_MagDown_P_ETA.root";
string th3namefirst2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3namesecond2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.2)_All";
string th3namethird2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.25)_All";
string th3namefourth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.3)_All";
string th3namefifth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.35)_All";
...
string ifilename="/vols/lhcb/ss4314/PIDCalibEfficiencies/2015/misideff/pion/PerfHists_Pi_Strip23_MCTuneV1_MagDown_P_ETA.root";
string ith3namefirst ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string ith3namesecond ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.2)_All";
string ith3namethird ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.25)_All";
string ith3namefourth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.3)_All";
string ith3namefifth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.35)_All";
...
string ifilename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/2015/ideff/muon/PerfHists_Mu_Strip23_MCTuneV1_MagDown_P_ETA.root";
string ith3namefirst2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string ith3namesecond2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.2)_All";
string ith3namethird2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.25)_All";
string ith3namefourth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.3)_All";
string ith3namefifth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V1ProbNNmu > 0.35)_All";
...
TLatex *latex = new TLatex(grfirst->GetX()[1], grfirst->GetY()[1], "(V1ProbNNmu > 0.2)");
latex->SetTextSize(0.02);

TLatex *latex1 = new TLatex(grfirst->GetX()[2], grfirst->GetY()[2], "(V1ProbNNmu > 0.25)");
latex1->SetTextSize(0.02);

TLatex *latex2 = new TLatex(grfirst->GetX()[3], grfirst->GetY()[3], "(V1ProbNNmu > 0.3)");
latex2->SetTextSize(0.02);

TLatex *latex3 = new TLatex(grfirst->GetX()[4], grfirst->GetY()[4], "(V1ProbNNmu > 0.35)");
...
double* firstmisideffi2 = &firstcut2[5];
double* firstmisideffi = &firstcut[5];
...
TLatex *blatex = new TLatex(grsecond->GetX()[1], grsecond->GetY()[1], "(V1ProbNNmu > 0.2)");
blatex->SetTextSize(0.02);
blatex->SetTextColor(i+1);

TLatex *blatex1 = new TLatex(grsecond->GetX()[2], grsecond->GetY()[2], "(V1ProbNNmu > 0.25)");
blatex1->SetTextSize(0.02);
blatex1->SetTextColor(i+1);

TLatex *blatex2 = new TLatex(grsecond->GetX()[3], grsecond->GetY()[3], "(V1ProbNNmu > 0.3)");

blatex2->SetTextSize(0.02);
blatex2->SetTextColor(i+1);

TLatex *blatex3 = new TLatex(grsecond->GetX()[4], grsecond->GetY()[4], "(V1ProbNNmu > 0.35)");
blatex3->SetTextSize(0.02);
blatex3->SetTextColor(i+1);

TLatex *blatex4 = new TLatex(grsecond->GetX()[0], grsecond->GetY()[0], "(V1ProbNNmu > 0.0)");
...
TGraph *grthird =  new TGraph(5,ifirstmisideffi2,ifirstmisideffi);
...
TLatex *platex = new TLatex(grthird->GetX()[1], grthird->GetY()[1], "(V2ProbNNmu > 0.2)");
platex->SetTextSize(0.02);
platex->SetTextColor(i);

TLatex *platex1 = new TLatex(grthird->GetX()[2], grthird->GetY()[2], "(V1ProbNNmu_2015 > 0.25)");
platex1->SetTextSize(0.02);
platex1->SetTextColor(i);

TLatex *platex2 = new TLatex(grthird->GetX()[3], grthird->GetY()[3], "(V1ProbNNmu_2015 > 0.3)");
platex2->SetTextSize(0.02);
platex2->SetTextColor(i);

TLatex *platex3 = new TLatex(grthird->GetX()[4], grthird->GetY()[4], "(V1ProbNNmu_2015 > 0.35)");
platex3->SetTextSize(0.02);
platex3->SetTextColor(i);

TLatex *platex4 = new TLatex(grthird->GetX()[0], grthird->GetY()[0], "(V1ProbNNmu_2015 > 0.0)");
...
double* ifirstmisideffi2 = &ifirstcut2[5];
double* ifirstmisideffi = &ifirstcut[5];
TGraph *grfourth =  new TGraph(5,ifirstmisideffi2,ifirstmisideffi);
...
TLatex *ulatex = new TLatex(grfourth->GetX()[1], grfourth->GetY()[1], "(V1ProbNNmu_2015 > 0.2)");
ulatex->SetTextSize(0.02);
ulatex->SetTextColor(i+1);

TLatex *ulatex1 = new TLatex(grfourth->GetX()[2], grfourth->GetY()[2], "(V1ProbNNmu_2015 > 0.25)");
ulatex1->SetTextSize(0.02);
ulatex1->SetTextColor(i+1);

TLatex *ulatex2 = new TLatex(grfourth->GetX()[3], grfourth->GetY()[3], "(V1ProbNNmu_2015 > 0.3)");
ulatex2->SetTextSize(0.02);
ulatex2->SetTextColor(i+1);

TLatex *ulatex3 = new TLatex(grfourth->GetX()[4], grfourth->GetY()[4], "(V1ProbNNmu_2015 > 0.35)");
ulatex3->SetTextSize(0.02);
ulatex3->SetTextColor(i+1);

TLatex *ulatex4 = new TLatex(grfourth->GetX()[0], grfourth->GetY()[0], "(V1ProbNNmu_2015 > 0.0)");
...
c1->BuildLegend();
c1->SaveAs("comparedirectly2015and2016bin2to4.pdf");
return;
