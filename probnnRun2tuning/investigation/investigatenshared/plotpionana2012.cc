...
//      for (int k=1; k<(ntracks+1); k++) {
   ...
   cout<<" Efficiency: " << effi[z] << " in a bin i , j , k:" << i << " " << j << " "<< " "<< endl;
   myaverage+=effi[z];
   z++;
//   } 
  }
...
string filename="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2/misideff/pion/PerfHists_Pi_Strip21_MagDown_P_ETA.root"; 
string th3namefirst ="Pi_(IsMuon==1.0) && (DLLmu > 0.0)_All";
...
string th3namefourth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
string th3namefifth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All";
string th3namesixth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All";
string th3nameseventh ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All";




string filename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2/ideff/muon/PerfHists_Mu_Strip21_MagDown_P_ETA.root";
string th3namefirst2 ="Mu_(DLLmu > 0.0)_All";
string th3namesecond2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All";
string th3namethird2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3namefourth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
string th3namefifth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All";
string th3namesixth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All";
string th3nameseventh2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All";
...
const Int_t n = 7; //number of cuts
...
TLatex *latex = new TLatex(grfirst->GetX()[0], grfirst->GetY()[0], "(DLLmu > 0.0)");
latex->SetTextSize(0.02);

TLatex *latex1 = new TLatex(grfirst->GetX()[1], grfirst->GetY()[1], "(DLLmu - K) > 0.0)");
latex1->SetTextSize(0.02);

TLatex *latex2 = new TLatex(grfirst->GetX()[2], grfirst->GetY()[2], "nShared == 0.0)");
latex2->SetTextSize(0.02);

TLatex *latex4 = new TLatex(grfirst->GetX()[3], grfirst->GetY()[3], "(V2ProbNNmu > 0.2)");
latex4->SetTextSize(0.02);

TLatex *latex5 = new TLatex(grfirst->GetX()[4], grfirst->GetY()[4], "(V2ProbNNmu > 0.25)");
latex5->SetTextSize(0.02);

TLatex *latex6 = new TLatex(grfirst->GetX()[5], grfirst->GetY()[5], "(V2ProbNNmu > 0.3)");
latex6->SetTextSize(0.02);

TLatex *latex7 = new TLatex(grfirst->GetX()[6], grfirst->GetY()[6], "(V2ProbNNmu > 0.35)");
...
grfirst->GetListOfFunctions()->Add(latex7);
...
//TLatex *blatex = new TLatex(grsecond->GetX()[0], grsecond->GetY()[0], "(V2ProbNNmu > 0.0)");
//blatex->SetTextSize(0.02);
//blatex->SetTextColor(i+1);
//
//TLatex *blatex1 = new TLatex(grsecond->GetX()[1], grsecond->GetY()[1], "(V2ProbNNmu > 0.2)");
//blatex1->SetTextSize(0.02);
//blatex1->SetTextColor(i+1);
//
//TLatex *blatex2 = new TLatex(grsecond->GetX()[2], grsecond->GetY()[2], "(V2ProbNNmu > 0.25)");
//
//blatex2->SetTextSize(0.02);
//blatex2->SetTextColor(i+1);
//
//TLatex *blatex3 = new TLatex(grsecond->GetX()[3], grsecond->GetY()[3], "(V2ProbNNmu > 0.3)");
//blatex3->SetTextSize(0.02);
//blatex3->SetTextColor(i+1);
//
//TLatex *blatex4 = new TLatex(grsecond->GetX()[4], grsecond->GetY()[4], "(V2ProbNNmu > 0.35)");
...
TGraph *grsecond =  new TGraph(n,firstmisideffi2,firstmisideffi);
grsecond->SetTitle(("P bin: "+(d2s(mymombin.at(i+0)))+" to "+(d2s(mymombin.at(i+1)))).c_str());
grsecond->SetMarkerColor(i+1);
grsecond->SetLineColor(i+1);
grsecond->SetMarkerStyle(i+27);
grsecond->SetFillStyle(0);
mg->Add(grsecond);
...
double* firstmisideffi2 = &firstcut2[2*n];
double* firstmisideffi = &firstcut[2*n];
...
grthird->SetMarkerStyle(i+28);
grthird->SetFillStyle(0);
mg->Add(grthird);


double* firstmisideffi2 = &firstcut2[3*n];
double* firstmisideffi = &firstcut[3*n];
...
double* firstmisideffi2 = &firstcut2[4*n];
double* firstmisideffi = &firstcut[4*n];
...
double* firstmisideffi2 = &firstcut2[5*n];
double* firstmisideffi = &firstcut[5*n];
...
double* firstmisideffi2 = &firstcut2[6*n];
double* firstmisideffi = &firstcut[6*n];
...
double* firstmisideffi2 = &firstcut2[7*n];
double* firstmisideffi = &firstcut[7*n];
...
double* firstmisideffi2 = &firstcut2[8*n];
double* firstmisideffi = &firstcut[8*n];
...
c1->BuildLegend();
c1->SaveAs("performancerateforana2012.pdf");
return;
