...
string ifilename="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2/misideff/pion/PerfHists_Pi_Strip21_MagDown_P_ETA.root";

string ith3namefirst ="Pi_(IsMuon==1.0) && (DLLmu > 0.0)_All";
...
string ifilename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2/ideff/muon/PerfHists_Mu_Strip21_MagDown_P_ETA.root";
string ith3namefirst2 ="Mu_(DLLmu > 0.0)_All";
...
grfirst->SetTitle("Second bin in P");
...
grthird->SetTitle("Second bin in P");
grthird->SetMarkerColor(i);
grthird->SetLineColor(i);
grthird->SetMarkerStyle(i+19);
grthird->SetFillStyle(0);
TLatex *platex = new TLatex(grthird->GetX()[1], grthird->GetY()[1], "(DLLmu -K) > 0");
...
c1->BuildLegend();
c1->SaveAs("comparedirectly2015bin1to3.pdf");
return;
