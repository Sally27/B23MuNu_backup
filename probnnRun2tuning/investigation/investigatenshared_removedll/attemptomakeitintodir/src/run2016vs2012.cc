...
grsecond->GetYaxis()->SetNdivisions(50510);
...
c1->Print("comparedirectly2012vs2016_2.pdf(");
mg->Draw("alp");
gPad->SetLeftMargin(0.15);

mg->GetYaxis()->SetRange(0.010,0.050);
mg->GetYaxis()->SetLimits(0.010,0.050);
...
c1->SaveAs("comparedirectly2012vs2016.root");
c1->SaveAs("comparedirectly2012vs2016.ps");
