...
//  vector<double> xbin=binx();
//  vector<double> ybin=biny();
//  double* PArr=&xbin[0];
...
//  TH2D* h1 = new TH2D("bplusmm2", "bplusmm2", XBINS, PArr, YBINS, EtaArr);
 // hs->Add(h1,"nostack");
...
//  TH2D* h2 = new TH2D("bpluscorrmass", "bplusmm", XBINS, PArr, YBINS, EtaArr);
...
//   hs->Draw();
   ...
   double zl2(0.6);
    ...
    mp3->Print(("plotvariable2Dnostack_2files_10bins_"+variable+scale+"_"+k+"_"+k2+".pdf").c_str());
    mp3->SaveAs(("plotvariable2Dnostack_2files_10bins_"+variable+scale+"_"+k+"_"+k2+".root").c_str());
...
//  t2->Draw((k+":"+k2+">>bpluscorrmass").c_str());
  ...
  gStyle->SetOptStat(0);
   ...
   h1->SetLineColor(kGreen);
   h1->SetTitle((nameforplot+" Misid distribution for "+scale).c_str());
   h1->SetXTitle(xaxis.c_str());
   h1->SetYTitle(k2.c_str());
   h1->SetZTitle("Entries/Arbitrary Scale");
   h1->GetYaxis()->SetTitleOffset(1.4);
...
//   hs->Draw();
   ...
   double zl2(0.6);
    ...
    mp3->Print(("plotvariable2Dnostack_2files_"+nameforplot+variable+scale+"_"+k+"_"+k2+".pdf").c_str());
    mp3->SaveAs(("plotvariable2Dnostack_2files_"+nameforplot+variable+scale+"_"+k+"_"+k2+".root").c_str());
