...
string filename="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2_removedll/ideff/muon/PerfHists_Mu_Strip26_MagDown_P_ETA.root";
string th3namefirst ="Mu_(nShared==0)_All";
string th3namesecond ="Mu_(nShared==0) && (V1ProbNNmu > 0.2)_All";
string th3namethird ="Mu_(nShared==0) && (V1ProbNNmu > 0.25)_All";
string th3namefourth ="Mu_(nShared==0) && (V1ProbNNmu > 0.3)_All";
string th3namefifth ="Mu_(nShared==0) && (V1ProbNNmu > 0.35)_All";
...
c1->BuildLegend();
c1->SaveAs("muonidrate2016asfofp.pdf");
return;
}
