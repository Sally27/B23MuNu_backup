...
//      for (int k=2; k<3; k++) {
   ...
   plotvary[y] = hname->GetBinContent(i,j);
   mymisid = hname->GetBinContent(i,j);
   myeff.push_back(mymisid);
   cout<<" Efficiency: " << plotvary[y] << " in a bin i , j , k:" << i << " " << j<< " "<< endl;
...
//string filename="/vols/lhcb/ss4314/tightPIDinvestigation/probnnmu/samples/muon/PerfHists_Mu_Strip20_MagDown_P_ETA_nTracks.root"; 
...
//string th3namefifth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.0)_All";
//string th3namesixth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
//string th3nameseventh ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.4)_All";
//string th3nameeighth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.6)_All";
//string th3namenineth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.8)_All";
...
string filename="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2_removedll/ideff/muon/PerfHists_Mu_Strip21_MagDown_P_ETA.root";
string th3namefirst ="Mu_(nShared==0)_All";
string th3namesecond ="Mu_(nShared==0) && (V2ProbNNmu > 0.2)_All";
string th3namethird ="Mu_(nShared==0) && (V2ProbNNmu > 0.25)_All";
string th3namefourth ="Mu_(nShared==0) && (V2ProbNNmu > 0.3)_All";
string th3namefifth ="Mu_(nShared==0) && (V2ProbNNmu > 0.35)_All";
...
mg->SetTitle("Muon id rate as a function of momentum");
...
mg->GetYaxis()->SetTitle("Id eff");

c1->BuildLegend();
c1->SaveAs("muonidrate2012asfofp.pdf");
return;
}
