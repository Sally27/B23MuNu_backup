...
double misid(string filename, string th3name, int binofmomentum)
{
  ...
  cout<<"cut is "<<th3name.c_str()<<endl;
...
string filename="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2_removedll/misideff/pion/PerfHists_Pi_Strip21_MagDown_P_ETA.root"; 
string th3namefirst ="Pi_(IsMuon==1.0) &&  (nShared==0)_All";
string th3namesecond ="Pi_(IsMuon==1.0) &&  (nShared==0) && (V2ProbNNmu > 0.2)_All";
string th3namethird="Pi_(IsMuon==1.0) &&  (nShared==0) && (V2ProbNNmu > 0.25)_All";
string th3namefourth ="Pi_(IsMuon==1.0) &&  (nShared==0) && (V2ProbNNmu > 0.3)_All";
string th3namefifth ="Pi_(IsMuon==1.0) &&  (nShared==0) && (V2ProbNNmu > 0.35)_All";




string filename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2_removedll/ideff/muon/PerfHists_Mu_Strip21_MagDown_P_ETA.root";
string th3namefirst2 ="Mu_(nShared==0)_All";
string th3namesecond2 ="Mu_(nShared==0) && (V2ProbNNmu > 0.2)_All";
string th3namethird2 ="Mu_(nShared==0) && (V2ProbNNmu > 0.25)_All";
string th3namefourth2 ="Mu_(nShared==0) && (V2ProbNNmu > 0.3)_All";
string th3namefifth2 ="Mu_(nShared==0) && (V2ProbNNmu > 0.35)_All";
...
string ith3namesecond ="Pi_(IsMuon==1.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
string ith3namethird ="Pi_(IsMuon==1.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All";
string ith3namefourth ="Pi_(IsMuon==1.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All";
string ith3namefifth ="Pi_(IsMuon==1.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All";
...
string ith3namesecond2 ="Mu_(nShared==0) && (V2ProbNNmu > 0.2)_All";
string ith3namethird2 ="Mu_(nShared==0) && (V2ProbNNmu > 0.25)_All";
string ith3namefourth2 ="Mu_(nShared==0) && (V2ProbNNmu > 0.3)_All";
string ith3namefifth2 ="Mu_(nShared==0) && (V2ProbNNmu > 0.35)_All";



string tag="";

const Int_t n = 5; //number of cuts
...
TLatex *latex = new TLatex(grfirst->GetX()[0], grfirst->GetY()[0], "(nShared==0)");
...
TLatex *latex4 = new TLatex(grfirst->GetX()[1], grfirst->GetY()[1], "(V2ProbNNmu > 0.2)");
latex4->SetTextSize(0.02);

TLatex *latex5 = new TLatex(grfirst->GetX()[2], grfirst->GetY()[2], "(V2ProbNNmu > 0.25)");
latex5->SetTextSize(0.02);

TLatex *latex6 = new TLatex(grfirst->GetX()[3], grfirst->GetY()[3], "(V2ProbNNmu > 0.3)");
latex6->SetTextSize(0.02);

TLatex *latex7 = new TLatex(grfirst->GetX()[4], grfirst->GetY()[4], "(V2ProbNNmu > 0.35)");
