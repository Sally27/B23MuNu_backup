...
string filename="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2_removedll/misideff/pion/PerfHists_Pi_Strip26_MagDown_P_ETA.root"; 
string th3namefirst ="Pi_(IsMuon==1.0) &&  (nShared==0)_All";
string th3namesecond ="Pi_(IsMuon==1.0) &&  (nShared==0) && (V1ProbNNmu > 0.2)_All";
string th3namethird="Pi_(IsMuon==1.0) &&  (nShared==0) && (V1ProbNNmu > 0.25)_All";
string th3namefourth ="Pi_(IsMuon==1.0) &&  (nShared==0) && (V1ProbNNmu > 0.3)_All";
string th3namefifth ="Pi_(IsMuon==1.0) &&  (nShared==0) && (V1ProbNNmu > 0.35)_All";
...
string th3namesecond2 ="Mu_(nShared==0) && (V1ProbNNmu > 0.2)_All";
string th3namethird2 ="Mu_(nShared==0) && (V1ProbNNmu > 0.25)_All";
string th3namefourth2 ="Mu_(nShared==0) && (V1ProbNNmu > 0.3)_All";
string th3namefifth2 ="Mu_(nShared==0) && (V1ProbNNmu > 0.35)_All";


string ifilename="/vols/lhcb/ss4314/PIDCalibEfficiencies/misideff/pion/PerfHists_Pi_Strip26_MagDown_P_ETA.root";
string ith3namefirst ="Pi_(IsMuon==1.0) && (nShared==0)_All";
string ith3namesecond ="Pi_(IsMuon==1.0) && (nShared==0) && (V1ProbNNmu > 0.2)_All";
string ith3namethird ="Pi_(IsMuon==1.0) && (nShared==0) && (V1ProbNNmu > 0.25)_All";
string ith3namefourth ="Pi_(IsMuon==1.0) && (nShared==0) && (V1ProbNNmu > 0.3)_All";
string ith3namefifth ="Pi_(IsMuon==1.0) && (nShared==0) && (V1ProbNNmu > 0.35)_All";



string ifilename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/ideff/muon/PerfHists_Mu_Strip26_MagDown_P_ETA.root";
string ith3namefirst2 ="Mu_(nShared==0)_All";
string ith3namesecond2 ="Mu_(nShared==0) && (V1ProbNNmu > 0.2)_All";
string ith3namethird2 ="Mu_(nShared==0) && (V1ProbNNmu > 0.25)_All";
string ith3namefourth2 ="Mu_(nShared==0) && (V1ProbNNmu > 0.3)_All";
string ith3namefifth2 ="Mu_(nShared==0) && (V1ProbNNmu > 0.35)_All";
...
TLatex *latex4 = new TLatex(grfirst->GetX()[1], grfirst->GetY()[1], "(V1ProbNNmu > 0.2)");
latex4->SetTextSize(0.02);

TLatex *latex5 = new TLatex(grfirst->GetX()[2], grfirst->GetY()[2], "(V1ProbNNmu > 0.25)");
latex5->SetTextSize(0.02);

TLatex *latex6 = new TLatex(grfirst->GetX()[3], grfirst->GetY()[3], "(V1ProbNNmu > 0.3)");
latex6->SetTextSize(0.02);

TLatex *latex7 = new TLatex(grfirst->GetX()[4], grfirst->GetY()[4], "(V1ProbNNmu > 0.35)");
