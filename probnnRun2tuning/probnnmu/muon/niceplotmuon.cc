...
string filename="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/V3tuning/probnnmu/muon/PerfHists_Mu_Strip20_MagDown_P_ETA_nTracks.root"; 
...
string th3namefifth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V3ProbNNmu > 0.0)_All";
string th3namesixth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V3ProbNNmu > 0.8)_All";
string th3nameseventh ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V3ProbNNmu > 0.9)_All";
string th3nameeighth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V3ProbNNmu > 0.93)_All";
string th3namenineth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V3ProbNNmu > 0.95)_All";
string th3nametenth ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V3ProbNNmu > 0.97)_All";
...
mg->SetTitle("Muon Mis id rate as a function of momentum pt");
...
c1->BuildLegend();
c1->SaveAs("muonmisidrateoriginal2.pdf");
return;
}
