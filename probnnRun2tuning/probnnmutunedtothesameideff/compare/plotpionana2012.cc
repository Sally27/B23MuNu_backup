...
string filename="/vols/lhcb/ss4314/PIDCalibEfficiencies/misideff/pion/PerfHists_Pi_Strip21r1_MagDown_P_ETA.root"; 
string th3namefirst ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3namesecond ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
string th3namethird ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All";
string th3namefourth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All";
string th3namefifth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All";




string filename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/ideff/muon/PerfHists_Mu_Strip21r1_MagDown_P_ETA.root";
string th3namefirst2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3namesecond2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
string th3namethird2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All";
string th3namefourth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All";
string th3namefifth2 ="Mu_(DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All";


string ifilename="/vols/lhcb/ss4314/PIDCalibEfficiencies/misideff/pion/PerfHists_Pi_Strip21r1_MagDown_P_ETA.root";
...
string ifilename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/ideff/muon/PerfHists_Mu_Strip21r1_MagDown_P_ETA.root";
...
TLatex *latex = new TLatex(grfirst->GetX()[0], grfirst->GetY()[0], "(V2ProbNNmu > 0.0)");
latex->SetTextSize(0.02);

TLatex *latex1 = new TLatex(grfirst->GetX()[1], grfirst->GetY()[1], "(V2ProbNNmu > 0.2)");
latex1->SetTextSize(0.02);

TLatex *latex2 = new TLatex(grfirst->GetX()[2], grfirst->GetY()[2], "(V2ProbNNmu > 0.25)");
latex2->SetTextSize(0.02);

TLatex *latex3 = new TLatex(grfirst->GetX()[3], grfirst->GetY()[3], "(V2ProbNNmu > 0.3)");
latex3->SetTextSize(0.02);

TLatex *latex4 = new TLatex(grfirst->GetX()[4], grfirst->GetY()[4], "(V2ProbNNmu > 0.35)");
...
c1->BuildLegend();
c1->SaveAs("performancerateforana2011.pdf");
return;
