...
void plotvariable2D(string scale,string nameforplot, string file1, string file2, string file3, string tag1, string tag2, string tag3, string k, string k2,double low, double high, string xaxis, string variable)
{
...
//   hs->Draw();
 ...
 //  mp3->Update();
    mp3->SaveAs(("plotvariable2D"+variable+scale+"_"+k+"_"+k2+".pdf").c_str());
