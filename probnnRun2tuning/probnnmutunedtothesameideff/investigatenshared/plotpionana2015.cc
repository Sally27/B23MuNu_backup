...
string filename="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2/misideff/pion/PerfHists_Pi_Strip23_MCTuneV1_MagDown_P_ETA.root"; 
...
string filename2="/vols/lhcb/ss4314/PIDCalibEfficiencies/investigateRun2/ideff/muon/PerfHists_Mu_Strip23_MCTuneV1_MagDown_P_ETA.root";
...
TLatex *latex4 = new TLatex(grfirst->GetX()[3], grfirst->GetY()[3], "(V1ProbNNmu > 0.2)");
latex4->SetTextSize(0.02);

TLatex *latex5 = new TLatex(grfirst->GetX()[4], grfirst->GetY()[4], "(V1ProbNNmu > 0.25)");
latex5->SetTextSize(0.02);

TLatex *latex6 = new TLatex(grfirst->GetX()[5], grfirst->GetY()[5], "(V1ProbNNmu > 0.3)");
latex6->SetTextSize(0.02);

TLatex *latex7 = new TLatex(grfirst->GetX()[6], grfirst->GetY()[6], "(V1ProbNNmu > 0.35)");
