...
grfirst->SetTitle("Third bin in P");
...
grsecond->SetTitle("Fourth bin in P");
...
grthird->SetTitle("Third bin in P");
...
grfourth->SetTitle("Fourth bin in P");
...
c1->BuildLegend();
c1->SaveAs("comparedirectly2015bin2to4.pdf");
return;
