...
void invmassmuplus0muminus()
{
  ...
  TTree* j = (TTree*)k->Get("MCDecayTreeTuple/MCDecayTree");
   ...
   j->SetBranchAddress("muplus0_TRUEP_X", &muplus0_TRUEP_X);
   j->SetBranchAddress("muplus0_TRUEP_Y", &muplus0_TRUEP_Y);
   j->SetBranchAddress("muplus0_TRUEP_Z", &muplus0_TRUEP_Z);
   ...
   j->SetBranchAddress("muplus0_TRUEP_E", &muplus0_TRUEP_E);
   ...
   TBranch *bpt2 = j->Branch("mplus0andmminusinvmass",&newcalc2,"newcalc2/D");
