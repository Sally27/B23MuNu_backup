...
void mu1andnu()
{
  ...
  graph1->SetTitle("comparison of qsq of mu1 nu and mu3 nu at selection");
  graph1->Draw();
  ...
  leg->AddEntry(graph1,"mu1 and mu","l");   // h1 and h2 are histogram pointers
  leg->AddEntry(graph2,"mu3 and mu","l");
  leg->Draw();
