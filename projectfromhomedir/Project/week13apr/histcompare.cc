...
void hist()
{
  DataSample hist1("/home/hep/ss4314/cmtuser/Gauss_v45r9/ParticleGun/tupletauchangedtoe_10andmaxwidth2p085andmass3.root", "/KstarMass");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  ...
  TH1F* a = new TH1F("KstarMassfinal", "KstarMassfinal", 100, -10 , 10000);
  hist1.t->Draw("KstarMassfinal >> KstarMassfinal");
...
*/
   ...
   a->SetTitle("B+ Corrected Mass - run13039{1,2,3,4,5,6}");
...
/*   ha->SetLineColor(8);
   ...
   ha->Draw("same");*/
    ...
    leg->AddEntry(a,"B corr mass background entries","l");   // h1 and h2 are histogram pointers
/*    leg->AddEntry(hm,"B corr mass signal","l");*/
