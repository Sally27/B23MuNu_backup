...
void invmass()
{
  ...
  TFile* f = new TFile("/home/hep/ss4314/Project/week23mar/finalbackground.root");
  TTree* t = (TTree*)f->Get("B_Tuple2/DecayTree");

  TFile *f1 = new TFile("invmassbackground.root","RECREATE");
