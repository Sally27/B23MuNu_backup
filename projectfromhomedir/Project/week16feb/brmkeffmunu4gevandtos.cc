...
void invmass()
{
  ...
  TFile *f1 = new TFile("myfilep1tosandmunu.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
 ...
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   TBranch *bpt = t1->Branch("m1andm2whereinvmunumore4gevandtos",&invmassmu1mu2,"invmassmu1mu2/D");
   count=0;
   count2=0;
...
void invmassmuplus0muplus()
{
  ...
  TFile *f01 = new TFile("myfilep2tosandmunu.root","RECREATE");
