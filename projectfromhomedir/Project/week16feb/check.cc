...
void invmass()
{
  ...
  TFile *f1 = new TFile("myfilep1redoagaintry.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
 ...
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   TBranch *bpt = t1->Branch("m1andm2",&invmassmu1mu2,"invmassmu1mu2/D");
   count=0;
   count2=0;
      ...
      if (mu2_TRUEID==13&&mu3_TRUEID==4294967283&&mu1_TRUEID==4294967283&&Bplus_TRUEID==521)
         {
	      ...
	      /*cout<<trial<<endl;*/
      	      ...
      	      mu1mu2[0] = mu1_TRUEP_X+mu3_TRUEP_X;
              mu1mu2[1] = mu1_TRUEP_Y+mu3_TRUEP_Y;
              mu1mu2[2] = mu1_TRUEP_Z+mu3_TRUEP_Z;
              mu1mu2[3] = mu1_TRUEP_E+mu3_TRUEP_E;
...
void invmassmuplus0muplus()
{
  ...
  TFile *f01 = new TFile("myfilep2egainry.root","RECREATE");
  TTree *t01 = new TTree("pt2","");
   ...
   TBranch *bpt2 = t01->Branch("mplusandmminusinvmass",&muplusmuminusinvmass,"muplusmuminusinvmass/D");
    ...
    for(int i(0); i<l->GetEntries(); ++i)
   {
      ...
      muplusmuminus[0] = muplus_TRUEP_X+muplus0_TRUEP_X;
      muplusmuminus[1] = muplus_TRUEP_Y+muplus0_TRUEP_Y;
      muplusmuminus[2] = muplus_TRUEP_Z+muplus0_TRUEP_Z;
      muplusmuminus[3] = muplus_TRUEP_E+muplus0_TRUEP_E;
