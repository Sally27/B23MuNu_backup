...
void eff()
{
	...
	gStyle->SetOptStat(0);	
  DataSample B23MuNu_gen("redoagain2.root", "t01");
  DataSample myfile("redoagain1.root","t1");
...
// here hg has data ini it
   ...
   TH1F* hm = new TH1F("m3m2invmass_sel", "m3m2invmass_sel", 50, -10 , 5000000);
   hm->Sumw2();
   myfile2.t->Draw("m3andm2att2invmass>>m3m2invmass_sel");
   double nSel = myfile2.t->GetEntries();
// here hm has data ini it
   TH1F* hg = new TH1F("m3m2invmass_gen", "m3m2invmass_gen", 50, -10 , 5000000);
   hg->Sumw2();
...
// here hg has data ini it
  ...
  //t->SetBranchAddress("mplusandmminusinvmass", &mplusandmminusinvmass);
   ...
   TH1F* am = new TH1F("m1m3invmass_sel", "m1m3invmass_sel", 50, -10 , 5000000);
   am->Sumw2();
   myfile3.t->Draw("m3andm1att2invmass>>m1m3invmass_sel");
   double nSel = myfile3.t->GetEntries();
// here hm has data ini it
   TH1F* ag = new TH1F("m1m3invmass_gen", "m1m3invmass_gen", 50, -10 , 5000000);
   ag->Sumw2();
   B23MuNu_gen3.t->Draw("mplusandmplus0invmass>>m1m3invmass_gen");
// here hg has data ini it
