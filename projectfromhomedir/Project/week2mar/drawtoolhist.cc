...
void hist()
{
  DataSample hist1("/home/hep/ss4314/Project/week22feb/Bcorrmassplot.root", "t1");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  ...
  DataSample hist2("/home/hep/ss4314/Project/week22feb/Bcorrmassplot2.root", "t2");
  ...
  double nSel3 = hist3.t->GetEntries();
   ...
   a->SetLineColor(2);
   a->SetTitle("B plus corrected mass");
   ...
   ha->Draw("same");
    ...
    leg->AddEntry(a,"B corr mass","l");   // h1 and h2 are histogram pointers
    leg->AddEntry(hm,"B corr mass with q^2(mu nu) > 4000  GeV","l");
