...
// here hg has data ini it
   ...
   c->Divide(a,b,1.0/nSel1, 1.0/nGen1);
   


   DataSample B23MuNu_gen2("/home/hep/ss4314/Project/week22feb/redoagain2_2gev.root", "pt2");
...
// here hm has data ini it
   ...
   hg->Sumw2();
   B23MuNu_gen2.t->Draw("mplusandmminusmunu2gev>>mplusmminusinvmassmunusel_gen");
// here hg has data ini it
   double nGen2 = B23MuNu_gen2.t->GetEntries();

   TH1F* heff = new TH1F("eff", "eff", 100, -10 , 30000000);
   heff->Divide(hm,hg,1.0/nSel2, 1.0/nGen2);
...
// here hg has data ini it
   ...
   ha->Divide(am,ag,1.0/nSel3, 1.0/nGen3);

   DataSample B23MuNu_gen4("/home/hep/ss4314/Project/week22feb/redoagain22_2.root", "pt2");
...
// here hm has data ini it
   ...
   ai->Sumw2();
   B23MuNu_gen4.t->Draw("mplusandmminusinvmass2gevandtos>>mplusandmminusinvmasstosandmunu_gen");
// here hg has data ini it
   double nGen4 = B23MuNu_gen4.t->GetEntries();

   TH1F* aj = new TH1F("eff", "eff", 50, -10 , 30000000);
   aj->Divide(af,ai,1.0/nSel4, 1.0/nGen4);
