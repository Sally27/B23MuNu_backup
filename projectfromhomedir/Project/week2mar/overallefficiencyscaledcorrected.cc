...
void eff()
{
  ...
  DataSample B23MuNu_gen("/home/hep/ss4314/Project/week22feb/redoagain2.root", "pt2");
...
// here hg has data ini it
   ...
   DataSample B23MuNu_gen2("/home/hep/ss4314/Project/week22feb/redoagain2.root", "pt2");
   DataSample myfile2("/home/hep/ss4314/Project/week22feb/redoagain1_2gev.root","pt1");
...
// here hg has data ini it
   ...
   DataSample B23MuNu_gen3("/home/hep/ss4314/Project/week22feb/redoagain2tosonly.root", "pt2");
   DataSample myfile3("/home/hep/ss4314/Project/week22feb/redoagain1tosonly.root","pt1");
...
// here hg has data ini it
   ...
   DataSample B23MuNu_gen4("/home/hep/ss4314/Project/week22feb/redoagain2.root", "pt2");
   DataSample myfile4("/home/hep/ss4314/Project/week22feb/redoagain11_1.root","pt1");
...
// here hg has data ini it
   ...
   heff->SetLineColor(2);
   heff->SetTitle("Efficiency of #mu_{1} and #mu_{2} with q^{2}(#mu_{3 },#nu)>4000 GeV and/or TOS scaled");
   ...
   aj->SetLineColor(5);
   aj->SetTitle("Efficiency of #mu_{1} and #mu_{2} with q^{2}(#mu_{3},#nu)>4000 GeV with TOS");
   ...
   ha->Draw("same");
    ...
    Double_t xl1=.35, yl1=0.55, xl2=xl1+.63, yl2=yl1+.125;
    TLegend *leg = new TLegend(xl1,yl1,xl2,yl2);
    leg->SetTextSize(0.025);
    leg->AddEntry(c,"#mu_{1} and #mu_{2}","l");   // h1 and h2 are histogram pointers
    leg->AddEntry(heff,"#mu_{1} and #mu_{2} after q^{2}(#mu_{3}, #nu)>4000 GeV","l");
    leg->AddEntry(ha,"#mu_{1} and #mu_{2} after tos cut only","l");
    leg->AddEntry(aj,"#mu_{1} and #mu_{2} after tos and after q^{2}(#mu_{3}, #nu)>4000 GeV","l");
    leg->Draw("same");

   
   mp3->Update();
   mp3->SaveAs("efficiencycutscorrectedoverallforpres.pdf");
