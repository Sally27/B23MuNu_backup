...
int  main()
{
	...
	if (l==2){
		...
		cout<< "I am here: "<<endl;
                ...
                myfile2.open("STATISTICSprobnnmuminuspi.txt");
                myfile2<<"------------------------------------ID EFF with Probnn cuts in PIDCalib-----------------"<<endl;
...
//                o = cutTree("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/MCSigpreparetuple/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root", "DecayTree", ("B23MuNuMC"+tags.at(i)+".root").c_str(), (cute.at(i)).c_str());
                double eff;
                eff = calaveffofasample("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/MCSigpreparetuple/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root","DecayTree","/vols/lhcbdisk05/ss4314/tightPIDinvestigation/probnnmuandpi/samples/rangeminusonetozero/muon/PerfHists_Mu_Strip20_MagDown_P_ETA_nTracks.root",(cuts3.at(i)).c_str(),"PIDCalib",("newmc"+tags.at(i)+".root").c_str());
                ...
                if (i>3)
                {
	        myfile2<<"----"<<(cuts3.at(i)).c_str()<<"------"<<(tags.at(i)).c_str()<<"----"<<efficiencies.at(i)/efficiencies.at(3)<<"---wrt to reference cut"<<endl;
                }
