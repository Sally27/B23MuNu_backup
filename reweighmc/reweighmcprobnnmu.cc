...
//                o = cutTree("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/MCSigpreparetuple/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root", "DecayTree", ("B23MuNuMC"+tags.at(i)+".root").c_str(), (cute.at(i)).c_str());
                double eff;
                eff = calaveffofasample("/vols/lhcbdisk05/ss4314/preparetuplesforBDTincludeJpsi/MCSigpreparetuple/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root","DecayTree","/vols/lhcbdisk05/ss4314/tightPIDinvestigation/probnnmu/samples/muon/PerfHists_Mu_Strip20_MagDown_P_ETA_nTracks.root",(cuts3.at(i)).c_str(),"PIDCalib",("newmc"+tags.at(i)+".root").c_str());
