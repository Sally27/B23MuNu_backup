...
int main()
{
	...
	string extracut="";
	char* strarray[] = {"MCnonsharedvsMisidFUMSBNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection"};
	...
	string bdtvar = "MCSig2012_vs_DATAMisidRun1NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
        string pathnamesally="/vols/lhcb/ss4314/rocurves/third_attemp_newTCKapproach/MCSig2012_vs_DATAMisidRun1_onlyRun1/";
...
//      plotRocCurvesSallyCompare(pathnamesally, condition ,fsig, fbkg ,bdtvar, "_Misid_TrainedonRun1_", extracuts, tr, nsigexp, nbkgexp, namemything1, mincut, maxcut, weightBranchSig, weightBranchBkg);
...
//       plotRocCurvesSallyCompare(pathnamesally2, condition ,fsig2, fbkg2 ,bdtvarmis, "_Misid_TrainedonRun1_", extracuts, tr, nsigexp, nbkgexp, namemything1, mincut, maxcut, weightBranchSig, weightBranchBkg);
       ...
       string pathnamesally3="/vols/lhcb/ss4314/rocurves/third_attemp_newTCKapproach/MCSig2016_288888335_vs_DATAMisid2016_only2016/";

       vector<string> paths;
       paths.push_back(pathnamesally);
       paths.push_back(pathnamesally3);

       string bdtvar2016="MCSig2016_288888335_vs_DATAMisid2016NTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
       vector<string> vars;
...
//       plotRocCurvesSallyCompareDiffTraining(paths, condi3 ,fsig3, fbkg3 ,vars, "_Misid_CompareTrainSeparately_", extracuts, tr, nsigexp, nbkgexp, namemything1, mincut, maxcut, weightBranchSig, weightBranchBkg);
       
//       plotRocCurvesSallyCompareDiffTrainingOneMinusBkgRej(paths, condi3 ,fsig3, fbkg3 ,vars, "_Misid_CompareTrainSeparately_", extracuts, tr, nsigexp, nbkgexp, namemything1, mincut, maxcut, weightBranchSig, weightBranchBkg);



       //-----------Compare performances trained on both datasets------------//
       string pathnamesally4="/vols/lhcb/ss4314/rocurves/third_attemp_newTCKapproach/MCSig_vs_MisidData_BOTHRun1andRun2_newTCK/";
       ...
       string bdtvarrun1and2016="MCSig_vs_MisidData_BOTHRun1andRun2_newTCKNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection";
       vector<string> vars4;
       ...
       vector<string> fsig4;
       fsig4.push_back("Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic.root");
       fsig4.push_back("Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic.root");
       fsig4.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic.root");
       fsig4.push_back("Bu23MuNuMC2016_MCtruth_L0MuonDecisionTOS_288888335_Hlt1TrackMuonDecision_trigger_Jpsi_qmincut_CombBasic.root");
       vector<string> fbkg4;
       fbkg4.push_back("Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root");
       fbkg4.push_back("Data_B23MuNu_MisidSS_Run1_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_CombBasic.root");
