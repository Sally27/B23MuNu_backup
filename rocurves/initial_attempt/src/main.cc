...
int main()
{
	...
	string outputfilename="roccurves/initial_attempt.pdf";
	bool fa=false;
	string weight="";
...
//	plotRocCurvesPunzi(fsigname, fbkgname, bdtvars, outputfilename, extracuts, tr, nsigexp, nbkgexp, namemything1, mincut, maxcut);
        ...
        string pathnamesally="/vols/lhcb/ss4314/roccurves/initial_attempt/MCnonsharedvsCombiFUMSB_add2016_newPID/";
      ...
      plotRocCurvesSallyCompare(pathnamesally, condition ,fsig, fbkg ,bdtvar, "_Combi_TrainedonRun1_", extracuts, tr, nsigexp, nbkgexp, namemything1, mincut, maxcut, weightBranchSig, weightBranchBkg);
       ...
       string pathnamesally2="/vols/lhcb/ss4314/roccurves/initial_attempt/MCnonsharedvsMisidFUMSB_add2016_newPID/";
       ...
       string pathnamesally3="/vols/lhcb/ss4314/roccurves/initial_attempt/MCSigvsCombi2016/";
       ...
       string pathnamesally4="/vols/lhcb/ss4314/roccurves/initial_attempt/MCsigvsCombiTrainonBothRun1and2016/";
