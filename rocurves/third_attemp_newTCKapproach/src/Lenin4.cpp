...
//   double maxCut(1.0);
   ...
   TH1F* frame;
   frame = cROC.DrawFrame(0,0.9,1,1);
   frame->GetXaxis()->SetTitle("Signal Efficiency");
   frame->GetYaxis()->SetTitle("Background Rejection");
   ...
   TLine* myline=new TLine(0.44, 0.9,0.44,1.0);
   myline->SetLineColor(9);
   TLine* myline2=new TLine(0.36, 0.9,0.36,1.0);
   myline2->SetLineColor(9);
   myline->SetLineWidth(5);
   myline->Draw("same");
   myline2->SetLineWidth(5);
   myline2->Draw("same");
...
//   double maxCut(1.0);
   ...
   frame->GetXaxis()->SetRangeUser(0.0,0.6);
