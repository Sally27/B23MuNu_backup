...
//  break;
  ...
  RooRealVar cbsigmar1("cbsigmar1","cbsigmar",100.0,5000.0);//,0.1,50) ;
  RooRealVar nr1("nr1","",0.0,10.0);
  ...
  RooRealVar cbsigmar2("cbsigmar2","cbsigmar",100.0,5000.0);//,0.1,50) ;
  RooRealVar nr2("nr2","",0.0,10.0);
