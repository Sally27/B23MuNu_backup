...
//  histcomb.plotOn(frame5) ; 
  ...
  // Plot all components
  sume.plotOn( finalfitframe, Components(expoun), RooFit::Range("fitting"), LineColor(kGreen));
  sume.plotOn( finalfitframe, Components(blah), RooFit::Range("fitting"), LineColor(kBlue));
