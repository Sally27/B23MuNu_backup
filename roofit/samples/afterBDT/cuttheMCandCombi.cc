...
string pathname = "";
string filename = "B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut";
string decaytreename = "DecayTree";
string ext = ".root";
...
//string namecuttree2 = (filename+cuttag).c_str();
//cut2 = "Bplus_Corrected_Mass > 6000";
...
string namecuttree2 = (filename+cuttag).c_str();
cut2 = "CombinatorialNormalBDTNTrees60_MinNodeSize2_MaxDepth3_SeparationTypeGiniIndex_PruneMethodNoPruning_DoPreselection > 0.57";
