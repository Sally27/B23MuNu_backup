...
double cutTree(string nametree, string decaytreename, string namecuttree, string cuts)
{
  ...
  *py=Bplus_Corrected_Mass;
  ...
  TFile* f = new TFile("/vols/lhcbdisk05/ss4314/preparetuplesforBDTfinalallvartrigger/Combinatorialpreparetuple/bin/Data2012and2011_corrm_cut_trigger_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root");
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
//  double notuseful;
