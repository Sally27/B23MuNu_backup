  ...
  if(l==0.0)
  {
   //       gROOT->ProcessLine(".x lhcbSally.C");
	...
	cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > 0.0)_All");
       ...
       softmceff=calaveffofasamplesoft(filename3,cuts3.at(3));
       cutTree("mcsigtoreadfrom.root", "DecayTree", "mcsigtoreadfrom.root", "weight_soft != -1.0");
     
       hardmceff=calaveffofasamplehard(filename3,cuts3.at(3));
...
//       string cutonhard="0.0";
        ...
        cuts.push_back(("((identify==3.0) && (mu3_NNmu - mu3_NNpi > "+cutonsoft+") && (mu1_NNmu - mu1_NNpi > "+cutonhard+"))||((identify==1.0) && (mu1_NNmu - mu1_NNpi > "+cutonsoft+") && (mu3_NNmu - mu3_NNpi > "+cutonhard+"))").c_str());
...
//                  cout<<"Amount of partreco:"
		  ...
		  // Plot total PDF.
                  ...
                  out<<"combi  & "<< cutonsoft <<" & "<< cutonhard << " & "<< numberofcombi <<" \\\\ "<<endl;
                  ...
                  out<<"combi  & "<< cutonsoft <<" & "<< cutonhard << " & "<< combinatorialres.getVal() <<" \\\\ "<<endl;
