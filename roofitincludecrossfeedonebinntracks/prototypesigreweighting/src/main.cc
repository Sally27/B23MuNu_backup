...
//          cuts.push_back("((identify==3.0) && (mu3_isMuon==1.0) && (mu3_PIDmu > 0.0) && ((mu3_PIDmu - mu3_PIDK) > 0.0) && (mu3_nShared==0) && (mu3_NNmu - mu3_NNpi > 0.0))||((identify==1.0) && (mu1_isMuon==1.0) && (mu1_PIDmu > 0.0) && ((mu1_PIDmu - mu1_PIDK) > 0.0) && (mu1_nShared==0) && (mu1_NNmu - mu1_NNpi > 0.0))");
...
//                  cout<<"Amount of partreco:"
		  ...
		  // Plot total PDF.
                  ...
                  out<<"mcsig  & "<<"no cut"<<" & "<< "no cut" << " & "<< numberofsigevents <<"  \\\\ "<<endl;
                  ...
                  out<<"mcsig  & "<<"no cut"<<" & "<< "no cut" << " & "<< mysigres.getVal() <<"  \\\\ "<<endl;
