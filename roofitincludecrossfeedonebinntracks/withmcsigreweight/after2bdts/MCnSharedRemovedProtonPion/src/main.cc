...
//			TTree* treer = gettreemcsig(("B23MuNuMC"+mcname.at(indexofcut)+stripping+polarity+".root").c_str(),"mcweight");
		...
		//	TTree* treez =  gettreepartreco(partrecosource.c_str());
...

			{
				...
				paramsformisid=fitmisidcut(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionProton/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic.root").c_str(), ("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionProton/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str(), tags.at(i));

                                string kaonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionProton/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic.root").c_str();
                                string pionsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionProton/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str();
