...
double cutTree(string nametree, string decaytreename, string namecuttree, string cuts)
{
  ...
  TH1* getcorrmspec()
   {
  //Read in  histogram
   TFile* f = new TFile("samples/afterBDT/B23MuNuMCallvar_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut_60TreesComAllVar_60TreesMisAllVar.root");
  ...
  TH1* getcorrmspeccomb()
   {
  //Read in  histogram
   TFile* f = new TFile("samples/afterBDT/Data2012and2011_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut_corrm_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi_qmincut_60TreesComAllVar_60TreesMisAllVar.root");
   TTree* t = (TTree*)f->Get("DecayTree");
   Double_t Bplus_Corrected_Mass;
   t->SetBranchAddress("Bplus_Corrected_Mass", &Bplus_Corrected_Mass);
   TH1D *h = new TH1D("h","h",100,2500,10000);
...
//  TFile* f = new TFile("/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi60treesincludePallvarafterCOMBI/CombinatorialBackgroundpreparetuple/Data2012and2011_corrm_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComAllVar_60TreesMisAllVar.root");
//  TTree* t = (TTree*)f->Get("DecayTree");
//  TTree* tree = new TTree("tree","tree") ;
  double notuseful;

  notuseful= cutTree("/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi60treesincludePallvarafterCOMBI/Data2012and2011_corrm_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComAllVar_60TreesMisAllVar.root", "DecayTree", ("combi_soft"+tagsoft+"_hard"+taghard+".root").c_str(), cuts.c_str());
...
//  TTree* tree = new TTree("tree","tree") ;
  ...
  notuseful= cutTree("/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi60treesincludePallvarafterCOMBI/Data2012and2011_corrm_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComAllVar_60TreesMisAllVar.root", "DecayTree", ("combi_cut"+tag+".root").c_str(), cuts.c_str());
...
//  }
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/allthreecutsallvar/bin/modifiedandcut"+tags+"SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60TreesComAllVar_60TreesMisAllVar.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/allthreecutsallvartighteroptimize1/soft/modifiedandcut"+tags+"SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60andPPUNZIoptBDT_MISIDafter60_idsoft.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/allthreecutsallvartighteroptimize1/hard/modifiedandcut"+tags+"SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60andPPUNZIoptBDT_MISIDafter60_idhard.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/allthreecutsallvar/bin/modifiedandcut"+tags+"SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60TreesComAllVar_60TreesMisAllVar.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/allthreecutsallvartighteroptimize1/soft/modifiedandcut"+tags+"SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60andPPUNZIoptBDT_MISIDafter60_idsoft.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/allthreecutsallvartighteroptimize1/hard/modifiedandcut"+tags+"SSMisIDsmalldatasample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60andPPUNZIoptBDT_MISIDafter60_idhard.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile("/vols/lhcbdisk05/ss4314/misidshape/modifiedandcutSSMisIDsmalldatasample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut_KaonPID_cut_60TreesComAllVar_60TreesMisAllVar.root");
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  ...
  *px=normalizedcrossfeedweight;
  ...
  TFile* f = new TFile("/vols/lhcbdisk05/ss4314/misidshape/modifiedandcutSSMisIDsmalldatasample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut_PionPID_cut_60TreesComAllVar_60TreesMisAllVar.root");
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t normalizedcrossfeedweight;
  ...
  *px=normalizedcrossfeedweight;
  ...
  TFile* f = new TFile("/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi60treesincludePallvarafterCOMBI/B23Pimu_MCtruth_Jpsi_cut_mu3nShared_qmincut_60TreesComAllVar_60TreesMisAllVar.root");
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t* py = new Double_t ;
  ...
  *py=Bplus_Corrected_Mass;
  ...
  //PLOT unbinned histogram for For Signal//
      ...
      TTree* treer = gettreemcsig(file.c_str(),weightname.c_str());
...
//     myresults.push_back(cbsignalrar.getVal());
 ...
 //     myresults.push_back(1.4);
       ...
       vector<double> paramfitcombi(string cut, string tagsoft, string taghard)
	{
	  ...
	  TTree* tree = gettreecomb(cut,tagsoft,taghard);
       ...
       vector<double> paramfitcombi(string cut, string tag)
	{
	  ...
	  TTree* tree = gettreecomb(cut,tag);
	  ...
	  canv2->SaveAs("FittingCombiUnBinnednotinmain.pdf");
         ...
         vector<double> fitmisidcut(string cut)
		  ...
		  TTree* treek =  gettreemisidkaon(cut);
		  ...
		  TTree* treep =  gettreemisidpion(cut);
...
//		  canvshift->cd(i+1) ; gPad->SetLeftMargin(0.15) ; misidtotal->GetYaxis()->SetTitleOffset(1.4) ; misidtotal->GetXaxis()->SetTitle("Corrected Mass") ;  misidtotal->Draw() ;      
		  ...
		  // canvshift->SaveAs("misidshiftafter2bdts/allthreecutsallvar.pdf");          
...
double calaveffofasamplesoft(string softfile, string softweight) {
	...
	TFile* f = new TFile("/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi60treesincludePallvarafterCOMBI/B23MuNuMCallvar_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComAllVar_60TreesMisAllVar.root");
	TTree* t = (TTree*)f->Get("DecayTree");
...
//	TFile* s = new TFile("/vols/lhcbdisk05/ss4314/tightPIDinvestigation/nontrackcalculation/after2bdts/allthreecutsallvar/muon/PerfHists_Mu_Strip20_MagDown_P_ETA.root");
