...
int main(){
  ...
  gROOT->ProcessLine(".x lhcbSally.C");
        ...
        vector<string> cuts3; 
	string filename3="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/nontrackcalculation/basiccutforallthree/combinethetwo/muon/PerfHists_Mu_Strip20_MagDown_P_ETA.root";
  ...
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.5) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 1.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 1.5) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 2.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.5) && (nShared==0)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 1.0) && (nShared==0)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 1.5) && (nShared==0)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 2.0) && (nShared==0)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > -0.6)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > -0.5)_All");
  ...
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.25)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.3)_All");
  cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.35)_All");
...
//	cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > 0.0)_All");
        string mcmuonsample="/vols/lhcbdisk05/ss4314/cutonBDTs/fullsetwithJpsi60treesincludePallvarafterCOMBI/B23MuNuMCallvar_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComAllVar_60TreesMisAllVar.root";
        string justfilename="B23MuNuMCallvar_MCtruth_Jpsi_cut_mu1nShared_mu2nShared_mu3nShared_qmincut_60TreesComAllVar_60TreesMisAllVar.root";
...
//       softmceff=calaveffofasamplesoft(filename3,cuts3.at(softi));
//       cutTree("mcsigtoreadfrom.root", "DecayTree", "mcsigtoreadfrom.root", "weight_soft != -1.0");
     
//       hardmceff=calaveffofasamplehard(filename3,cuts3.at(hardi));
//       cutTree("mcsigtoreadfromhard.root", "DecayTree", "mcsigtoreadfromhard.root", "weight_hard != -1.0");
      
//       addmultiplicationofbranches(); 

//       double finalmceff=softmceff*hardmceff;
//       cout<<"Soft MC eff: "<<softmceff<<" Hard MC eff: "<<hardmceff<<" Product: "<<finalmceff <<endl;


       double mu1eff, mu2eff, mu3eff;
       mu1eff= calaveffofasamplemu1(mcmuonsample, filename3 , cuts3.at(indexofcut), "mu1_P", "mu1_ETA", "mu1weight", justfilename);
       cutTree(justfilename, "DecayTree", justfilename, "mu1weight != -1.0");
       mu2eff= calaveffofasamplemu1(justfilename, filename3 , cuts3.at(indexofcut), "mu2_P", "mu2_ETA", "mu2weight", justfilename);
       cutTree(justfilename, "DecayTree", justfilename, "mu2weight != -1.0");
       mu3eff= calaveffofasamplemu1(justfilename, filename3 , cuts3.at(indexofcut), "mu3_P", "mu1_ETA", "mu3weight", justfilename);
       cutTree(justfilename, "DecayTree", justfilename, "mu3weight != -1.0");
      ...
      addmultiplicationofbranches(justfilename, "mu1weight","mu2weight","mu3weight","mcweight",("B23MuNuMC"+mcname.at(indexofcut)+".root").c_str());
      
        
       vector<double> mcsigval;
       mcsigval=paramfitsignal(("B23MuNuMC"+mcname.at(indexofcut)+".root").c_str(),"mcweight");
//       return(1);
...
//
//
//       vector<string> cutonall;
//       cutonall.push_back("0.0");
//       cutonall.push_back("0.0");
//       cutonall.push_back("0.0");
//       cutonall.push_back("0.0");
//       cutonall.push_back("0.0");
//       cutonall.push_back("0.2");
//       cutonall.push_back("0.4");
//       cutonall.push_back("0.6");
//       cutonall.push_back("0.8");

       vector<string> cuts;


       vector<string> cutonall;
//       cutonall.push_back("-1.0");
//       cutonall.push_back("-1.0");
 //      cutonall.push_back("-1.0");
 //      cutonall.push_back("-1.0");
  //     cutonall.push_back("-1.0");
...
//       cutonall.push_back("0.0");
  ...
  cutonall.push_back("");
  cutonall.push_back("(mu3_PIDmu > 0.5) && (mu2_PIDmu > 0.5) && (mu1_PIDmu > 0.5)");
  cutonall.push_back("(mu3_PIDmu > 1.0) && (mu2_PIDmu > 1.0) && (mu1_PIDmu > 1.0)");
  cutonall.push_back("(mu3_PIDmu > 1.5) && (mu2_PIDmu > 1.5) && (mu1_PIDmu > 1.5)");
  cutonall.push_back("(mu3_PIDmu > 2.0) && (mu2_PIDmu > 2.0) && (mu1_PIDmu > 2.0)");
  cutonall.push_back("(mu3_PIDmu - mu3_PIDK > 0.5) && (mu2_PIDmu - mu2_PIDK > 0.5) && (mu1_PIDmu - mu3_PIDK > 0.5)");
  cutonall.push_back("(mu3_PIDmu - mu3_PIDK > 1.0) && (mu2_PIDmu - mu2_PIDK > 1.0) && (mu1_PIDmu - mu3_PIDK > 1.0)");
  cutonall.push_back("(mu3_PIDmu - mu3_PIDK > 1.5) && (mu2_PIDmu - mu2_PIDK > 1.5) && (mu1_PIDmu - mu3_PIDK > 1.5)");
  cutonall.push_back("(mu3_PIDmu - mu3_PIDK > 2.0) && (mu2_PIDmu - mu2_PIDK > 2.0) && (mu1_PIDmu - mu3_PIDK > 2.0)");
  cutonall.push_back("(mu3_NNmu - mu3_NNpi > -0.6) && (mu2_NNmu - mu2_NNpi > -0.6) && (mu1_NNmu - mu1_NNpi > -0.6)");
  cutonall.push_back("(mu3_NNmu - mu3_NNpi > -0.5) && (mu2_NNmu - mu2_NNpi > -0.5) && (mu1_NNmu - mu1_NNpi > -0.5)");
  cutonall.push_back("(mu3_NNmu - mu3_NNpi > -0.4) && (mu2_NNmu - mu2_NNpi > -0.4) && (mu1_NNmu - mu1_NNpi > -0.4)");
  cutonall.push_back("(mu3_NNmu > 0.2) && (mu2_NNmu > 0.2) && (mu1_NNmu > 0.2)");
  cutonall.push_back("(mu3_NNmu > 0.25) && (mu2_NNmu > 0.25) && (mu1_NNmu > 0.25)");
  cutonall.push_back("(mu3_NNmu > 0.3) && (mu2_NNmu > 0.3) && (mu1_NNmu > 0.3)");
  cutonall.push_back("(mu3_NNmu > 0.35) && (mu2_NNmu > 0.35) && (mu1_NNmu > 0.35)");
//       cuts.push_back(("( (mu3_NNmu > "+cutonall.at(indexofcut)+") && (mu2_NNmu > "+cutonall.at(indexofcut)+") && (mu1_NNmu > "+cutonall.at(indexofcut)+") )").c_str());

      cuts.push_back(cutonall.at(indexofcut).c_str());
//       vector<string> cutonsoft;
//       cutonsoft.push_back("-1.0");
//       cutonsoft.push_back("-1.0");
//       cutonsoft.push_back("-1.0");
//       cutonsoft.push_back("-1.0");
//       cutonsoft.push_back("-1.0");
//       cutonsoft.push_back("-0.8");
//       cutonsoft.push_back("-0.6");
//       cutonsoft.push_back("-0.4");
//       cutonsoft.push_back("-0.2");
//       cutonsoft.push_back("0.0");

//       vector<string> cutonhard;
//      cutonhard.push_back("-1.0");
//       cutonhard.push_back("-1.0");
//       cutonhard.push_back("-1.0");
//       cutonhard.push_back("-1.0");
//       cutonhard.push_back("-1.0");
//       cutonhard.push_back("-0.8");
//       cutonhard.push_back("-0.6");
//       cutonhard.push_back("-0.4");
//       cutonhard.push_back("-0.2");
//       cutonhard.push_back("0.0");



 //      string cutonsoft="0.0";
 //      string cutonhard="-1.0";

//       string cutonsoft="-0.8";
//       string cutonhard="-0.8";

//       string cutonsoft="-0.6";
//       string cutonhard="-0.6";

//       string cutonsoft="-0.4";
//       string cutonhard="-0.4";

//       string cutonsoft="-0.2";
//       string cutonhard="-0.2";

//       string cutonsoft="0.0";
//       string cutonhard="0.0";



//        cuts.push_back(("((identify==3.0) && (mu3_NNmu - mu3_NNpi > "+cutonsoft.at(softi)+") && (mu1_NNmu - mu1_NNpi > "+cutonhard.at(hardi)+"))||((identify==1.0) && (mu1_NNmu - mu1_NNpi > "+cutonsoft.at(softi)+") && (mu3_NNmu - mu3_NNpi > "+cutonhard.at(hardi)+"))").c_str());
...
//          cuts.push_back("(mu3_isMuon==1.0) && (mu3_PIDmu > 0.0) && ((mu3_PIDmu - mu3_PIDK) > 0.0) && (mu3_nShared==0) && (mu3_NNmu > 0.0)");
//          cuts.push_back("(mu3_isMuon==1.0) && (mu3_PIDmu > 0.0) && ((mu3_PIDmu - mu3_PIDK) > 0.0) && (mu3_nShared==0) && (mu3_NNmu > 0.2)");
//          cuts.push_back("(mu3_isMuon==1.0) && (mu3_PIDmu > 0.0) && ((mu3_PIDmu - mu3_PIDK) > 0.0) && (mu3_nShared==0) && (mu3_NNmu > 0.4)");
//          cuts.push_back("(mu3_isMuon==1.0) && (mu3_PIDmu > 0.0) && ((mu3_PIDmu - mu3_PIDK) > 0.0) && (mu3_nShared==0) && (mu3_NNmu > 0.6)");
//          cuts.push_back("(mu3_isMuon==1.0) && (mu3_PIDmu > 0.0) && ((mu3_PIDmu - mu3_PIDK) > 0.0) && (mu3_nShared==0) && (mu3_NNmu > 0.8)");
...
//          vector<double> numofcomb;
         ...
         //-------Define tags on misid------------first soft-----second hard misid-----------------//
         


	  //Plot misid unbinned//
	  vector<string> tagstochoose;

//	  tagstochoose.push_back("IsMuon");
//	  tagstochoose.push_back("IsMuonandDLLmumorethan0");
//	  tagstochoose.push_back("IsMuonandDLLmuandDLLmumKmorethan0");
//	  tagstochoose.push_back("IsMuonandDLLmuandDLLmumKmorethan0nShared");
...
//	            tagstochoose.push_back("NNmumore0");
//	            tagstochoose.push_back("NNmumore02");
//	            tagstochoose.push_back("NNmumore04");
//	            tagstochoose.push_back("NNmumore06");
//	            tagstochoose.push_back("NNmumore08");


//       tagstochoose.push_back("NNmuminuspimorem1");
//       tagstochoose.push_back("NNmuminuspimorem08");
//       tagstochoose.push_back("NNmuminuspimorem06");
//       tagstochoose.push_back("NNmuminuspimorem04");
//       tagstochoose.push_back("NNmuminuspimorem02");
//       tagstochoose.push_back("NNmuminuspimorem00");

  tagstochoose.push_back("Basic cut");
  tagstochoose.push_back("Dllmumore05");
  tagstochoose.push_back("Dllmumore1");
  tagstochoose.push_back("Dllmumore15");
  tagstochoose.push_back("Dllmumore2");
  tagstochoose.push_back("Dllmuminkmore05");
  tagstochoose.push_back("Dllmuminkmore1");
  tagstochoose.push_back("Dllmuminkmore15");
  tagstochoose.push_back("Dllmuminkmore2");
  tagstochoose.push_back("NNmuminuspimorem06");
  tagstochoose.push_back("NNmuminuspimorem05");
  tagstochoose.push_back("NNmuminuspimorem04");
  tagstochoose.push_back("NNmumore02");
  tagstochoose.push_back("NNmumore025");
  tagstochoose.push_back("NNmumore03");
  tagstochoose.push_back("NNmumore035");
       ...
       vector<string> tags;
//       tags.push_back((tagstochoose.at(softi)).c_str());
//       tags.push_back((tagstochoose.at(hardi)).c_str());

       tags.push_back((tagstochoose.at(indexofcut)).c_str());
...
//        tags.push_back("NNmuminuspimore08");
	  ...
	  //PLOT unbinned histogram for For Signal//
        ...
        //  RooDataSet dr("dr","dr", RooArgSet(y,pw), Import(*treer), WeightVar("pw"));

	  TTree* treer = gettreemcsig(("B23MuNuMC"+mcname.at(indexofcut)+".root").c_str(),"mcweight");
          RooDataSet dr("dr","dr", RooArgSet(y,pw), Import(*treer), WeightVar("pw"));
...
//	  dr.Print();
	  ...
	  canv4->SaveAs(("fitdscbunbinned"+tagstochoose.at(indexofcut)+".pdf").c_str());
          ...
          canvsig->SaveAs(("fitofmmcsig"+tagstochoose.at(indexofcut)+".pdf").c_str()); 
...
//	  canvshifttotal->Divide(4,4) ;
...

	  {
           ...
           mycombicon=paramfitcombi(cuts.at(i),tags.at(i));
	  ...
	  RooRealVar o("o","o",mycombicon.at(0));
...
//          return(1);  
	  ...
	  RooPlot *frame = y.frame(Bins(25),Title("Toy fit"));
	  ds.plotOn(frame);
	  ...
	  model.paramOn(frame);
          ...
          TPaveLabel *texpo = new TPaveLabel(0.3,0.6,0.6,0.8, Form("Exp SB %f, Exp SR %f ",double(tree->GetEntries()),igmass_reg.getValV()),"BRNDC");
...
//	  cout<<"Integral: outcome :" <<" igmass_mod3->getValV(): "<<igmass_reg.getValV()<<endl;
          ...
          cout<<"This is what I push back: "<<igmass_reg.getValV()<<endl;
          numofcomb.push_back(igmass_reg.getValV());

//          return(1);
          vector<double> paramsformisid;
          paramsformisid=fitmisidcut(tags.at(i));
//          fitmisid(tags.at(i), tags.at(i+1));
...
//           return(1);
		  ...
		  canv5->SaveAs("FittingMisIDUnBinnedErrorsInMain.pdf");

//		  TTree* treek =  gettreemisidkaonsoft(tags.at(i));
//
//		  //  RooRealVar p("p","p",2500,10000);
//		  RooRealVar pw("pw","pw", 0.0 ,1.0);
//		  RooDataSet dk("dk","dk",RooArgSet(y),Import(*treek));
...
//		  row0->Print("v") ;
//
//		  TTree* treep =  gettreemisidpionsoft(tags.at(i));
//
//		  RooDataSet dp("dp","dp",RooArgSet(y),Import(*treep));
//		  RooDataSet dpw("dpw","dpw", RooArgSet(y,pw), Import(*treep), WeightVar("pw"));//, Import(*treew));
//		  dp.Print();
...
//		  canv5->cd(3) ; gPad->SetLeftMargin(0.15) ; frame13->GetYaxis()->SetTitleOffset(1.4) ; frame13->GetXaxis()->SetTitle("Corrected Mass") ;  frame13->Draw() ;
//		  canv5->cd(4) ; gPad->SetLeftMargin(0.15) ; frame14->GetYaxis()->SetTitleOffset(1.4) ; frame14->GetXaxis()->SetTitle("Corrected Mass") ; frame14->Draw() ;
//		  canv5->SaveAs("SoftFittingMisIDUnBinnedErrors.pdf");
//
// 	       //  return(1); 
//
//		  TTree* treekh =  gettreemisidkaonhard(tags.at(i+1));
//
//		  //  RooRealVar p("p","p",2500,10000);
//		 
...
//		  row0h->Print("v") ;
//
//		  TTree* treeph =  gettreemisidpionhard(tags.at(i+1));
//
...
//		  canv5h->SaveAs("HardFittingMisIDUnBinnedErrors.pdf");
...
//                  cout<< "Sum of entries for kaon and pion and pion hard and kaon hard:" <<dpw.sumEntries()<<endl;
		  ...
		  // canvshift->SaveAs("misidshiftbasiccutforallthree/combinethetwo.pdf");          
...
//		  cout<<"Amount of misidgoing into the fit: "<<scaledmisid<<endl;
//                  cout<<"Amount of combi gong into the fit: "<<igmass_reg.getValV()<<endl;
//                  cout<<"Amount of partreco:"
		  double numberofsigevents=((12.445)*finalmceff);
		  ...
		  RooPlot* finalfitframetruesig=y.frame(Bins(50), Name("Toy fit"), Title("Toy fit"));
                  
                  y.setRange("fitrange",4500,10000);
...
//                 normpdf.plotOn(finalfitframetruesig, Components(expoun), RooFit::Range("fitrange"), LineColor(kRed),RooFit::Name("combinatorial2"));
//                  normpdf.plotOn(finalfitframetruesig, Components(blah), RooFit::Range("fitrange"), LineColor(kGreen),RooFit::Name("signal2"));
//                  normpdf.plotOn(finalfitframetruesig, Components(twocbs), RooFit::Range("fitrange"), LineColor(kCyan),RooFit::Name("misid2"));
//                  normpdf.plotOn(finalfitframetruesig, Components(newpartreco), RooFit::Range("fitrange"), LineColor(kMagenta),RooFit::Name("partreco2"));
		  ...
		  // Plot total PDF.
                  ...
                  y.setRange("fitreg",4500,5500);

                  RooAbsReal* combinatorial = expoun.createIntegral(y,RooFit::NormSet(y),RooFit::Range("full"));
                  RooAbsReal* combinatorialfit = expoun.createIntegral(y,RooFit::NormSet(y),RooFit::Range("fitreg"));
                  ...
                  RooAbsReal* mymisid = twocbs.createIntegral(y,RooFit::NormSet(y),RooFit::Range("full"));
                  RooAbsReal* mymisidfit = twocbs.createIntegral(y,RooFit::NormSet(y),RooFit::Range("fitreg"));
                  ...
                  RooAbsReal* mysig = blah.createIntegral(y,RooFit::NormSet(y),RooFit::Range("full"));
                  RooAbsReal* mysigfit = blah.createIntegral(y,RooFit::NormSet(y),RooFit::Range("fitreg"));
                  ...
                  RooAbsReal* mypr = newpartreco.createIntegral(y,RooFit::NormSet(y),RooFit::Range("full"));
                  RooAbsReal* myprfit = newpartreco.createIntegral(y,RooFit::NormSet(y),RooFit::Range("fitreg"));
                 ...
                 cout<<"My punzi metric: "<< punzimetric << "Num of sig"<< mysigres.getVal() << endl;
                  ...
                  ofstream out;
                  out.open(("STATISTICS"+tags.at(i)+".txt").c_str());
                  ...
                  out<<"\\end{center}"<<endl;
                  out<<"\\caption{STATISTICS"<<tags.at(i)<<".txt}"<<endl;
                  out<<"\\end{table}"<<endl;


//                  ofstream out;
//                  out.open(("STATISTICSsoft"+tags.at(i)+"hard"+tags.at(i+1)+".txt").c_str());
//                  out<<"\\begin{table}[h]"<<endl;
//                  out<<"\\begin{center}"<<endl;
//                  out<<"\\begin{tabular}{| l | l | l | l |}"<<endl;
//                  out<<"\\hline"<<endl;
//                  out<<"Sample &  soft cut & hard cut & 3fb$^{-1}$ \\\\ "<<endl;
//                  out<<"misid  & "<<tags.at(i)<<" & "<< tags.at(i+1) << " & "<< scaledmisid <<" \\\\ " <<endl;
//                  out<<"mcsig  & "<<tags.at(i)<<" & "<< tags.at(i+1) << " & "<< numberofsigevents <<"  \\\\ "<<endl;
//                  out<<"combi  & "<< cutonsoft.at(softi) <<" & "<< cutonhard.at(hardi) << " & "<< numberofcombi <<" \\\\ "<<endl;
//                  out<<"partreco  & "<<"no cut"<<" & "<< "no cut" << " & " << numberofpartreco << " \\\\ "<<endl;
//                  out<<"\\hline"<<endl;
//                  out<<"Sample REG 4.5-5.5 &  soft cut & hard cut & 3fb$^{-1}$ \\\\ "<<endl;
//                  out<<"\\hline"<<endl;
//                  out<<"misid  & "<<tags.at(i)<<" & "<< tags.at(i+1) << " & "<< mymisidres.getVal() <<" \\\\ " <<endl;
//                  out<<"mcsig  & "<<tags.at(i)<<" & "<< tags.at(i+1) << " & "<< mysigres.getVal() <<"  \\\\ "<<endl;
//                  out<<"combi  & "<< cutonsoft.at(softi) <<" & "<< cutonhard.at(hardi) << " & "<< combinatorialres.getVal() <<" \\\\ "<<endl;
//                  out<<"partreco  & "<<"no cut"<<" & "<< "no cut" << " & " << myprres.getVal() << " \\\\ "<<endl;
//                  out<<"\\hline"<<endl;
//                  out<<"punzi metric & " <<" S/sqrt(B)+3/2 & "<< punzimetric << " & "<< " \\\\ "<<endl;
//                  out<<"\\hline"<<endl;
//                  out<<"\\end{tabular}"<<endl;
//                  out<<"\\end{center}"<<endl;
//                  out<<"\\caption{STATISTICSsoft"<<tags.at(i)<<"hard"<<tags.at(i+1)<<".txt}"<<endl;
//                  out<<"\\end{table}"<<endl;
...
//                  finalfitframetruesig->SetMinimum(4500);
//                  finalfitframetruesig->SetMaximum(10000);
