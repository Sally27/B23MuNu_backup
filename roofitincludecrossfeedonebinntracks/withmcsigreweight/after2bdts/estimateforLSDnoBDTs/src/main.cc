...
int main(int argc, char *argv[]){
        ...
        //kaonsample=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts/triggerallvarnewSSmisidsamplesVS2/bin/modifiedandcut"+tags.at(i)+stripping+polarity+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID.root").c_str()
       
        //pionsample=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts/triggerallvarnewSSmisidsamplesVS2/bin/modifiedandcut"+tags.at(i)+stripping+polarity+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID.root").c_str()
 
        //mcsample=("/vols/lhcb/ss4314/misidsplitting/beforeBDTs/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root").c_str()
 
        //partrecosample=("/vols/lhcb/ss4314/misidsplitting/beforeBDTs/B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut.root")

        //combisource=(""/vols/lhcb/ss4314/misidsplitting/beforeBDTs/Data2012and2011_corrm_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root"")
	...
	if(l==0.0)
	{
		...
		for(int h(14); h<15; h++)
		{
			...
			string mcmuonsample="/vols/lhcb/ss4314/misidsplitting/beforeBDTs/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
			string mcmuonhist="B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
...
//			TTree* treer = gettreemcsig(("B23MuNuMC"+mcname.at(indexofcut)+stripping+polarity+".root").c_str(),"mcweight");
			...
			//--------Fit with 2CBS Part Reco Fit-----------//
                        ...
                        string partrecosource="/vols/lhcb/ss4314/misidsplitting/beforeBDTs/B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut.root";
		...
		//	TTree* treez =  gettreepartreco(partrecosource.c_str());
...

			{
				...
				vector<double> mycombicon;
                                string mycombisource= "/vols/lhcb/ss4314/misidsplitting/beforeBDTs/Data2012and2011_corrm_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut.root";
				...
				Bplus_Corrected_Mass.setRange("sideband",6100,10000);
				...
				paramsformisid=fitmisidcuts3samples(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts//triggerallvarnewSSmisidsamplesVS3/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID.root").c_str(), ("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts//triggerallvarnewSSmisidsamplesVS3/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID.root").c_str(),("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts/protonpion/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID.root").c_str(),tags.at(i));

                                string kaonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts//triggerallvarnewSSmisidsamplesVS3/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID.root").c_str();
                                string pionsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts//triggerallvarnewSSmisidsamplesVS3/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID.root").c_str();
       
                                string protonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts/protonpion/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID.root").c_str();
...
//				TTree* treek =  gettreemisidkaon(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts//triggerallvarnewSSmisidsamplesVS3/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID.root").c_str(),tags.at(i));
...
//				TTree* treep =  gettreemisidpion(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/before2bdts//triggerallvarnewSSmisidsamplesVS3/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID.root").c_str(),tags.at(i));
				...
				double numberofsigevents=((72)*finalmceff);
				double numberofcombi=igmass_reg.getValV();
				double numberofpartreco=800;
				...
				canvshifttotal->cd(indexofcut+1) ; gPad->SetLeftMargin(0.15) ; finalfitframetruesig->GetYaxis()->SetTitleOffset(1.4) ; finalfitframetruesig->GetXaxis()->SetTitle("Corrected Mass"); finalfitframetruesig->Draw(); leg2->Draw();
                                ...
                                TFile* lsmdfile = new TFile("/vols/lhcb/ss4314/cutonProbnnmu/beforebdts/Data2012and2011_corrmLSD_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_Probnnmu3.root");
 ...
 //                             datamisid->plotOn(framedlsmd, MarkerSize(0.9), MarkerColor(kCyan),LineColor(kCyan));
                              ...
                              //  dpw.plotOn(framedlsmd,DataError(RooAbsData::SumW2),MarkerColor(kRed),LineColor(kRed));
                               ...
                               // expoun.fitTo(ds,RooFit::Range("sideband"));                               
                                ...
                                dlsmd2.Print();
                                RooPlot* framedlsmd2 = Bplus_Corrected_Mass.frame(Title("Fit to my beautiful LMSD"),Bins(25));
