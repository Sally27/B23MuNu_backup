...
//			TTree* treer = gettreemcsig(("B23MuNuMC"+mcname.at(indexofcut)+stripping+polarity+".root").c_str(),"mcweight");
		...
		//	TTree* treez =  gettreepartreco(partrecosource.c_str());
...

			{
				...
				Bplus_Corrected_Mass.setRange("sideband",6001,10000);


				RooRealVar o("o","o",mycombicon.at(0)-mycombicon.at(1));
				RooExponential expoun("expoun", "exponential",Bplus_Corrected_Mass,o);
				RooPlot* frame6 = Bplus_Corrected_Mass.frame(Title("Fit with exponential function Unbinned"),Bins(80)) ;
				ds.plotOn(frame6);
				...
				RooPlot *frame = Bplus_Corrected_Mass.frame(Bins(60),Title("Toy fit"));
				ds.plotOn(frame);
...
//				RooAddPdf twocbs("twocbs","",RooArgList(cballr1,cballr2),RooArgList(frac1));
				...
				RooRealVar nbkg33("nbkg33","number of backgnd events3",numberofpartreco);
                                ...
                                RooRealVar ses("ses","Single event sensitivity",2.6e-9,2.1e-9,2.8e-9);
				...
				RooPlot* finalfitframetruesig=Bplus_Corrected_Mass.frame(Bins(60), Name("Toy fit"), Title("Toy fit"));

				Bplus_Corrected_Mass.setRange("fitrange",4000,10000);

                                //Create a workspace

				// Display fit parameters.
				RooAddPdf normpdf("normpdf","extended sum pdf",RooArgList(blah,expoun,twocbs,newpartreco), RooArgList(nsigform,nbkg11,nbkg22,nbkg33)); 
                                RooAddPdf fLL("fLL","extended sum pdfLL",RooArgList(expoun,twocbs,newpartreco), RooArgList(nbkg11,nbkg22,nbkg33));
				...
				datafinalnorm->plotOn(finalfitframetruesig, MarkerSize(0.9));
                                ...
                                string namews="fitallafterMCnSharedRemovedFullUMSB";
				...
				cout<<"Integral in the 4000 to 10000 wrt to the 2.5-10 :"<< combinatorial->getVal()<<endl;
				...
				cout<<"Integral in the 4000 to 10000 wrt to the 2.5-10 :"<< mymisid->getVal()<<endl;
				...
				cout<<"Integral in the 4000 to 10000 wrt to the 2.5-10 :"<< mysig->getVal()<<endl;
				...
				cout<<"Integral in the 4000 to 10000 wrt to the 2.5-10 :"<< mypr->getVal()<<endl;
				...
				cout<<"Integral: outcome :"<<myprres.getVal()<<endl;
                                ...
                                RooFormulaVar mysigreslsd("mysigreslsd", "mysigreslsd", "(@1/@0)*@2" , RooArgList(*mysig, *mysigfitlsd, nsigform ));
                                cout<<"Integral in the 4000 to 10000 wrt to the 2.5-10 :"<< mysig->getVal()<<endl;
				...
				canvasfit2->SaveAs(("generatedtoyandits_fit_"+stripping+"_"+polarity+"_"+tags.at(i)+".pdf").c_str());
 ...
 //                             datamisid->plotOn(framedlsmd, MarkerSize(0.9), MarkerColor(kCyan),LineColor(kCyan));
                              ...
                              //  dpw.plotOn(framedlsmd,DataError(RooAbsData::SumW2),MarkerColor(kRed),LineColor(kRed));
                               ...
                               // expoun.fitTo(ds,RooFit::Range("sideband"));                               
                                ...
                                cout<<"Integral in the 4000 to 10000 wrt to the 2.5-10 :"<< myintegral->getVal()<<endl;
                                ...
                                lsmd->SaveAs("generatedtoyandits_fit_expected_overlayedrealdata.pdf");
                                ...
                                dlsmd2.Print();
                                RooPlot* framedlsmd2 = Bplus_Corrected_Mass.frame(Title("Fit to my beautiful LMSD"),Bins(60));
                                ...
                                lsmd2->SaveAs("data_combi_misid_fit.pdf");
