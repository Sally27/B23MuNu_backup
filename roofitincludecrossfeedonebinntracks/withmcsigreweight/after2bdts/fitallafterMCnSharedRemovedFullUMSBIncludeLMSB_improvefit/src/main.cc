	...
	if(l==0.0)
	{
		...
		for(int h(14); h<15; h++)
		{
			...
			addmultiplicationofbranches(mcmuonhist, "mu1weight","mu2weight","mu3weight","mcweight",("B23MuNuMC"+mcname.at(indexofcut)+stripping+polarity+".root").c_str());
                        ...
                        //----------------CUT into 2 ranges-------------------------------------------------------------------------------//
                        double splitsample(0.025);
                        

                        ofstream splitstat;
                        splitstat.open("SPLITSTAT.txt");
                        
                        string lowstring="LowFCME";
                        string highstring="HighFCME";
                        string lowcut="(Bplus_corMassERR/Bplus_Corrected_Mass)<0.025";
                        string highcut="(Bplus_corMassERR/Bplus_Corrected_Mass)>0.025"; 
                        double lowsig;
                        double highsig;
                        lowsig=cutTree(("B23MuNuMC"+mcname.at(indexofcut)+stripping+polarity+".root").c_str(), "DecayTree", ("B23MuNuMC_"+mcname.at(indexofcut)+stripping+polarity+"_"+lowstring+".root").c_str(), lowcut.c_str());              
                        highsig=cutTree(("B23MuNuMC"+mcname.at(indexofcut)+stripping+polarity+".root").c_str(), "DecayTree", ("B23MuNuMC_"+mcname.at(indexofcut)+stripping+polarity+"_"+highstring+".root").c_str(), highcut.c_str());  
                        splitstat<<"---------------------------------------------------------------------"<<endl;
                        splitstat<<"Split:     (Bplus_corMassERR/Bplus_Corrected_Mass)  0.025             "<<endl;
                        splitstat<<"MCsigLow: "<<lowsig<<endl;
                        splitstat<<"MCsigHigh: "<<highsig<<endl;
...
//			TTree* treer = gettreemcsig(("B23MuNuMC"+mcname.at(indexofcut)+stripping+polarity+".root").c_str(),"mcweight");
			...
			canv4->SaveAs(("mcsigfit_MAIN_PULL_"+mcname.at(indexofcut)+".pdf").c_str());
			...
			canvsig->SaveAs(("mcsigfit_MAIN_"+mcname.at(indexofcut)+"_"+stripping+"_"+polarity+".pdf").c_str()); 
			...
			//--------Fit with 2CBS Part Reco Fit-----------//
                        ...
                        string partrecosource="/vols/lhcb/ss4314/cutonBDTs/MCnonsharedvsMisidFUMSB/B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic_MisidBasic.root";

                        string partrecosourcenew="B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic_MisidBasic";
                        double effpr;
                        effpr=cutTree(partrecosource, "DecayTree",(partrecosourcenew+".root").c_str() , "Bplus_Corrected_Mass > 4000");
                      
                        cout<<"Effpr: "<<effpr<<endl; 
   
                           
                        double lowpr;
                        double highpr;
                        
                        lowpr=cutTree((partrecosourcenew+".root").c_str(), "DecayTree", (partrecosourcenew+"_"+lowstring+".root").c_str(), lowcut.c_str());
                        highpr=cutTree((partrecosourcenew+".root").c_str(), "DecayTree", (partrecosourcenew+"_"+highstring+".root").c_str(), highcut.c_str());
                        splitstat<<"PRLow: "<<lowpr<<endl;
                        splitstat<<"PRHigh: "<<highpr<<endl;



                        vector<double> paramspr;
                        paramspr=fitpartreco(partrecosourcenew+".root");

                        TFile* fpr = new TFile((partrecosourcenew+".root").c_str());
			...
			RooRealVar cbmeanrpr("cbmeanrpr","cbmeanr",paramspr.at(0));
			RooRealVar cbsigmarpr("cbsigmarpr","cbsigmar",paramspr.at(1));//,0.1,50) ;
			RooRealVar nrpr("nrpr","",paramspr.at(2));
			RooRealVar alpharpr("alpharpr","",paramspr.at(3));
			RooCBShape cballrpr("cballrpr", "crystal ball", Bplus_Corrected_Mass, cbmeanrpr, cbsigmarpr, alpharpr, nrpr);
			RooRealVar fracpr("fracpr","frac of events in cb 1",paramspr.at(4));

			RooRealVar cbmeanrpr2("cbmeanrpr2","cbmeanr",paramspr.at(5));
			RooRealVar cbsigmarpr2("cbsigmarpr2","cbsigmar",paramspr.at(6));//,0.1,50) ;
			RooRealVar nrpr2("nrpr2","",paramspr.at(7));
			RooRealVar alpharpr2("alpharpr2","",paramspr.at(8));
			...
			canvibou2->SaveAs(("partrecofit_MAIN_"+stripping+polarity+".pdf").c_str());
                        delete canvibou2;
...

			{
				...
				vector<double> mycombicon;
                                string mycombisource= "/vols/lhcb/ss4314/cutonBDTs/MCnonsharedvsMisidFUMSB/Data2012and2011_corrmFUMSB_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root";
				...
				Bplus_Corrected_Mass.setRange("sideband",5500,10000);
				...
				canv2->SaveAs(("combifit_MAIN_"+stripping+"_"+polarity+".pdf").c_str());
                                delete canv2;
				...
				Bplus_Corrected_Mass.setRange("signal",4000,10000);
				...
				cv->SaveAs(("thexpofit_MAIN_"+tags.at(i)+".pdf").c_str());
                                delete cv;
                                //delete texpo;
                                //fcombi->Close();
				...
				paramsformisid=fitmisidcuts3samples2(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedFullCombiAfterMisid/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic.root").c_str(), ("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedFullCombiAfterMisid/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str(),("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedFullCombiAfterMisid/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic.root").c_str(),tags.at(i));

                                string kaonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedFullCombiAfterMisid/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic.root").c_str();
                                string kaonsamplenew=("modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic").c_str();
                                 

                                addratioofbranches(kaonsamplename, "Bplus_corMassERR", "Bplus_Corrected_Mass", "FCME",(kaonsamplenew+".root").c_str());
                               
                                printvalue((kaonsamplenew+".root").c_str(), "DecayTree", "Bplus_Corrected_Mass");
                                printvalue((kaonsamplenew+".root").c_str(), "DecayTree", "Bplus_corMassERR");
                                printvalue((kaonsamplenew+".root").c_str(), "DecayTree", "Bplus_corMassERR");
                                printvalue((kaonsamplenew+".root").c_str(), "DecayTree", "FCME");
                                
                                double kaonlow;
                                double kaonhigh;


                                kaonlow=cutTree((kaonsamplenew+".root").c_str(), "DecayTree",(kaonsamplenew+"_"+lowstring+".root").c_str(), lowcut.c_str()); 
                                kaonhigh=cutTree((kaonsamplenew+".root").c_str(), "DecayTree",(kaonsamplenew+"_"+highstring+".root").c_str(), highcut.c_str());
                                

                                splitstat<<"SSKaonLow: "<<kaonlow<<endl;
                                splitstat<<"SSKaonHigh: "<<kaonhigh<<endl;



                                string pionsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedFullCombiAfterMisid/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str();
                                string pionsamplenew=("modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic").c_str();

                                double pionlow;
                                double pionhigh;


                                addratioofbranches(pionsamplename, "Bplus_corMassERR", "Bplus_Corrected_Mass", "FCME",(pionsamplenew+".root").c_str());                                

                                pionlow=cutTree((pionsamplenew+".root").c_str(), "DecayTree",(pionsamplenew+"_"+lowstring+".root").c_str(), lowcut.c_str());
                                pionhigh=cutTree((pionsamplenew+".root").c_str(), "DecayTree",(pionsamplenew+"_"+highstring+".root").c_str(), highcut.c_str());
                                
                                splitstat<<"SSPionLow: "<<pionlow<<endl;
                                splitstat<<"SSPionHigh: "<<pionhigh<<endl;

                                string protonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedFullCombiAfterMisid/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic.root").c_str();
                                string protonsamplenew=("modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic").c_str();

                                double protonlow;
                                double protonhigh;

                                addratioofbranches(protonsamplename, "Bplus_corMassERR", "Bplus_Corrected_Mass", "FCME",(protonsamplenew+".root").c_str());

                                protonlow=cutTree((protonsamplenew+".root").c_str(), "DecayTree",(protonsamplenew+"_"+lowstring+".root").c_str(), lowcut.c_str());
                                protonhigh=cutTree((protonsamplenew+".root").c_str(), "DecayTree",(protonsamplenew+"_"+highstring+".root").c_str(), highcut.c_str());

                                splitstat<<"SSProtonLow: "<<protonlow<<endl;
                                splitstat<<"SSProtonHigh: "<<protonhigh<<endl;
...
//				TTree* treep =  gettreemisidpion(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedFullCombiAfterMisid/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str(),tags.at(i));
				...
				canv5->SaveAs(("Misid_Components_MAIN_"+stripping+"_"+polarity+"_"+tags.at(i)+".pdf").c_str());
				...
				misid = dpw.sumEntries();           
                             ...
                             //   Bplus_Corrected_Mass.setRange("high",6000,10000);

                                double sumofrange;
                                sumofrange = dpw.sumEntries("(Bplus_Corrected_Mass < 4500) || (Bplus_Corrected_Mass > 5500)");
                                cout<<"Sum of Range:"<<sumofrange<<endl; 
				...
				canvtot->SaveAs(("totalmisid_MAIN_"+tags.at(i)+".pdf").c_str());
                                delete canvtot;
...
//				RooRealVar frac1("frac1","frac of events in cb 1",paramsformisid.at(4)); 
				...
				RooRealVar cbmeanr2("cbmeanr2","cbmeanr", paramsformisid.at(0));
				RooRealVar cbsigmar2("cbsigmar2","cbsigmar",paramsformisid.at(1));//,0.1,50) ;
				RooRealVar nr2("nr2","",paramsformisid.at(2));
				RooRealVar alphar2("alphar2","",paramsformisid.at(3));
...
//				RooAddPdf twocbs("twocbs","",RooArgList(cballr1,cballr2),RooArgList(frac1));
				...
				canvibou->SaveAs(("totalmisidfit_MAIN_"+stripping+"_"+polarity+"_"+tags.at(i)+".pdf").c_str());         
				...
				RooPlot* finalfitframe=Bplus_Corrected_Mass.frame(Bins(60));//, Name("myfinalfit"), Title("myfinalfit"));
				...
				double scaledmisid=(100.0)*misid;//sumofrange;// only 5.8 inverse femtobarns
				double numberofsigevents=((1.0)*finalmceff);
				double numberofcombi=igmass_reg.getValV();
				double numberofpartreco=54.65*effpr;
			...
			//	double totalforfit=numberofsigevents+numberofcombi+scaledmisid+numberofpartreco;
				...
				RooRealVar nsig00("nsig00","number of signal events",numberofsigevents,0.1,30.0) ;
				RooRealVar nbkg11("nbkg11","number of backgnd events", 0.1, 1500);
				...
				RooRealVar nbkg33("nbkg33","number of backgnd events3",numberofpartreco);
                                ...
                                RooRealVar nbkg222("nbkg222","number of backgnd events2",sumofrange*100);
                        //        RooRealVar totalev("totalev","number all ev",totalforfit);
                                ...
                                RooFormulaVar nsigform("nsigform","nsigfromformula","@1/@0",RooArgList(ses,BR));
				...
				Bplus_Corrected_Mass.setRange("truesig",4900,6000);
                                ...
                                //-------------READ DATA -------------//
                                TFile* finaldata = new TFile("/vols/lhcb/ss4314/cutonProbnnmu/probnnmugreaterthen03afterremovenSharedfullUMSB/fullcombi.root");


                                TTree* treefinal = (TTree*)finaldata->Get("DecayTree");

                                string finaldatas="/vols/lhcb/ss4314/cutonProbnnmu/probnnmugreaterthen03afterremovenSharedfullUMSB/fullcombi.root";
                                string finaldatanew="finaldata";
                        
                        	double efffd;
                        	efffd=cutTree(finaldatas, "DecayTree",(finaldatanew+".root").c_str() , "Bplus_Corrected_Mass > 4000");

                        	double lowfd;
                        	double highfd;

                        	lowfd=cutTree((finaldatanew+".root").c_str(), "DecayTree", (finaldatanew+"_"+lowstring+".root").c_str(), lowcut.c_str());
                        	highfd=cutTree((finaldatanew+".root").c_str(), "DecayTree",(finaldatanew+"_"+highstring+".root").c_str(), highcut.c_str());
                        	splitstat<<"FinalDataLow: "<<lowfd<<endl;
                        	splitstat<<"FinalDataHigh: "<<highfd<<endl;
				...
				//RooRealVar Bplus_Corrected_Mass("Bplus_Corrected_Mass","Bplus_Corrected_Mass",2500,10000);
				RooDataSet finaldataset("finaldataset","finaldataset",RooArgSet(Bplus_Corrected_Mass),Import(*treefinal));
				finaldataset.Print();
				// Create RooPlot object with r on the axis.
...
//				Bplus_Corrected_Mass.setRange("low",4000,4500);
				...
				// Display fit parameters.
				RooAddPdf normsigpdf("normsigpdf","extended sum pdf",RooArgList(blah,newexpoun,twocbs,newpartreco), RooArgList(nsigform,nbkg11,nbkg22,nbkg33));
				RooAddPdf normpdf("normpdf","extended sum pdf",RooArgList(newexpoun,twocbs,newpartreco), RooArgList(nbkg11,nbkg22,nbkg33)); 
                                RooAddPdf normpdf2("normpdf2","extended sum pdf",RooArgList(newexpoun,twocbs,newpartreco), RooArgList(nbkg11,nbkg222,nbkg33));
			//	RooDataSet *datafinalnorm = normsigpdf.generate(RooArgSet(Bplus_Corrected_Mass),totalforfit)  ;

                        //        RooAbsPdf* modelsb= new RooAddPdf("modelsb","S+B pdf",RooArgList(blah,newexpoun,twocbs,newpartreco), RooArgList(nsigform,nbkg11,nbkg22,nbkg33));
                        //        RooAbsPdf* modelbkg= new RooAddPdf("modelbkg","B pdf",RooArgList(newexpoun,twocbs,newpartreco), RooArgList(nbkg11,nbkg22,nbkg33));


                                //Create a workspace
                                RooWorkspace *w8 = new RooWorkspace("w","workspace");
                                //
                                string namews8="beforefit";

                                TFile wrkspc8(("myworkspace_"+namews8+".root").c_str(),"RECREATE");  
                                w8->import(Bplus_Corrected_Mass);
                                w8->import(normsigpdf,RecycleConflictNodes());
                                w8->import(normpdf,RecycleConflictNodes());
                           //     w8->import(*datafinalnorm);
                          //      w->import(totalev);
				...
				finaldataset.plotOn(finalfitframetruesig, MarkerSize(0.9), LineColor(kBlack),RooFit::Name("data2"),RooFit::Range("low,high"));
                                normpdf.fitTo(finaldataset,RooFit::Range("low,high"),Extended(kTRUE));
                                normpdf.getParameters(Bplus_Corrected_Mass)->Print("s");
                                normpdf.paramOn(finalfitframetruesig, Format("NELU", AutoPrecision(2)), Layout(0.4, 0.4, 0.4));
                                normpdf.plotOn(finalfitframetruesig, Components(newexpoun), RooFit::Range("low,high"),RooFit::NormRange("full") ,LineColor(kRed),RooFit::Name("combinatorial2"));
                                normpdf.plotOn(finalfitframetruesig, Components(blah), RooFit::Range("low,high"),RooFit::NormRange("full"), LineColor(kGreen),RooFit::Name("signal2"));
                                normpdf.plotOn(finalfitframetruesig, Components(twocbs), RooFit::Range("low,high"),RooFit::NormRange("full") ,LineColor(kCyan),RooFit::Name("misid2"));
                                normpdf.plotOn(finalfitframetruesig, Components(newpartreco), RooFit::Range("low,high"),RooFit::NormRange("full"),LineColor(kMagenta),RooFit::Name("partreco2"));
                                normpdf.plotOn(finalfitframetruesig,LineColor(kBlue),RooFit::Range("low,high"),RooFit::Name("fit2")); // plot fit pdf

                                double nrealbkg=nbkg11.getVal();
                                double nrealsig=nsigform.getVal();
                                double totalforfit=nrealbkg+nrealsig+scaledmisid+numberofpartreco;
                                RooDataSet *datafinalnorm = normsigpdf.generate(RooArgSet(Bplus_Corrected_Mass),totalforfit)  ;        

                                TLegend *leg2 = new TLegend(0.6,0.6,0.8,0.8);
                                leg2->AddEntry(finalfitframetruesig->findObject("combinatorial2"),"Combinatorial","l");
                                leg2->AddEntry(finalfitframetruesig->findObject("signal2"),"B^{+} -> #mu^{+} #mu^{-} #mu^{+}","l");
                                leg2->AddEntry(finalfitframetruesig->findObject("misid2"),"MisID","l");
                                leg2->AddEntry(finalfitframetruesig->findObject("partreco2"),"B^{+} -> (D^{0} -> #pi #pi) #mu","l");
                                leg2->AddEntry(finalfitframetruesig->findObject("data2"),"Data","l");
                                ...
                                //gPad->SetLogy();
                                //finalfitframetruesig->SetMinimum(0.0001) ;
                                gPad->SetLeftMargin(0.15) ; finalfitframetruesig->GetYaxis()->SetTitleOffset(1.4); finalfitframetruesig->GetXaxis()->SetTitle("Corrected Mass"); finalfitframetruesig->GetYaxis()->SetRangeUser(0.0,200.0); finalfitframetruesig->Draw(); leg2->Draw();
                                canvasfit2->SaveAs(("finalfitnormalized_FITlowhigh_EXTE_"+stripping+"_"+polarity+"_"+tags.at(i)+".pdf").c_str());

                                TCanvas* logy2 = new TCanvas("logy2", "logy2",800,800);
                                gPad->SetLeftMargin(0.15) ; logy2->SetLogy(); finalfitframetruesig->GetYaxis()->SetTitleOffset(1.4);  finalfitframetruesig->GetYaxis()->SetRangeUser(1.0,200.0); finalfitframetruesig->GetXaxis()->SetTitle("Corrected Mass"); finalfitframetruesig->Draw(); leg2->Draw();
                                logy2->SaveAs(("finalfitnormalized_FITlowhigh_EXTE_LOG_"+stripping+"_"+polarity+"_"+tags.at(i)+".pdf").c_str());
                                ...
                                //
                                string namews="fitallafterMCnSharedRemovedFullUMSBIncludeLMSB";

                                TFile wrkspc(("myworkspace_"+namews+".root").c_str(),"RECREATE");  
                                w->import(Bplus_Corrected_Mass);
                                w->import(*modelsb,RecycleConflictNodes());
                                w->import(*modelbkg,RecycleConflictNodes());
                                w->import(*datafinalnorm);
                          //      w->import(totalev);
                                ...
                                RooWorkspace *w2 = new RooWorkspace("w2","workspace2");
                                TFile wrkspc2(("myworkspace2_"+namews+".root").c_str(),"RECREATE");
                                w2->import(Bplus_Corrected_Mass);
                                w2->import(*modelbkg);
                                w2->Print();
                                w2->Write();
                                wrkspc2.Write();
                                ...
                                RooAbsReal* combinatorial = newexpoun.createIntegral(Bplus_Corrected_Mass,RooFit::NormSet(Bplus_Corrected_Mass),RooFit::Range("low,high"));
                                RooAbsReal* combinatorialfit = newexpoun.createIntegral(Bplus_Corrected_Mass,RooFit::NormSet(Bplus_Corrected_Mass),RooFit::Range("fitreg"));
                                ...
                                RooFormulaVar mysigres("mysigres", "mysigres", "(@1/@0)*@2" , RooArgList(*mysig, *mysigfit, nsigform ));
				...
				ofstream out;
				out.open(("STATISTICS_"+stripping+"_"+polarity+"_"+tags.at(i)+".txt").c_str());
				...
				out<<"mcsig  & "<<tags.at(i)<<" & "<< nsigform.getVal() <<"  \\\\ "<<endl;
				out<<"combi  & "<<tags.at(i) <<" & "<< nbkg11.getVal() <<" \\\\ "<<endl;
				...
				out<<"\\end{table}"<<endl;
                                ...
                                RooPlot* works=Bplus_Corrected_Mass.frame(Bins(60), Name("Fit to data"), Title("Fit to data"));
				finaldataset.plotOn(works, MarkerSize(0.9), LineColor(kBlack),RooFit::Name("data2"));
                                normpdf.fitTo(finaldataset,RooFit::Range("full"),Extended(kTRUE));
                                normpdf.getParameters(Bplus_Corrected_Mass)->Print("s");
                                normpdf.paramOn(works, Format("NELU", AutoPrecision(2)), Layout(0.4, 0.4, 0.4));
                                normpdf.plotOn(works, Components(newexpoun), RooFit::Range("full"), LineColor(kRed),RooFit::Name("combinatorial2"));
                                normpdf.plotOn(works, Components(blah), RooFit::Range("full"), LineColor(kGreen),RooFit::Name("signal2"));
                                normpdf.plotOn(works, Components(twocbs), RooFit::Range("full"), LineColor(kCyan),RooFit::Name("misid2"));
                                normpdf.plotOn(works, Components(newpartreco), RooFit::Range("full"), LineColor(kMagenta),RooFit::Name("partreco2"));
                                normpdf.plotOn(works, LineColor(kBlue),RooFit::Range("full"),RooFit::Name("fit2")); // plot fit pdf

                                TLegend *leg6 = new TLegend(0.6,0.6,0.8,0.8);
                                leg6->AddEntry(works->findObject("combinatorial2"),"Combinatorial","l");
                                leg6->AddEntry(works->findObject("signal2"),"B^{+} -> #mu^{+} #mu^{-} #mu^{+}","l");
                                leg6->AddEntry(works->findObject("misid2"),"MisID","l");
                                leg6->AddEntry(works->findObject("partreco2"),"B^{+} -> (D^{0} -> #pi #pi) #mu","l");
                                leg6->AddEntry(works->findObject("data2"),"Data","l");


                                //finalfitframetruesig->SetMaximum(70);

                                TCanvas* canvasfit3 = new TCanvas("fit6", "Fit6",800,800);
                                //gPad->SetLogy();
                                //finalfitframetruesig->SetMinimum(0.0001) ;
                                gPad->SetLeftMargin(0.15) ; works->GetYaxis()->SetTitleOffset(1.4); works->GetXaxis()->SetTitle("Corrected Mass"); works->GetYaxis()->SetRangeUser(0.0,200.0); works->Draw(); leg6->Draw();
                                canvasfit3->SaveAs(("finalfitnormalized_FITfull_EXTE_"+stripping+polarity+tags.at(i)+".pdf").c_str());
                                 
                                TCanvas* logy = new TCanvas("logy", "logy",800,800);
                                gPad->SetLeftMargin(0.15) ; logy->SetLogy(); works->GetYaxis()->SetTitleOffset(1.4);works->GetYaxis()->SetRangeUser(1.0,200.0); works->GetXaxis()->SetTitle("Corrected Mass"); works->Draw(); leg6->Draw();
                                logy->SaveAs(("finalfitnormalized_FITfull_EXTE_LOG_"+stripping+polarity+tags.at(i)+".pdf").c_str());
...
//                                Bplus_Corrected_Mass.setRange("lsdreg",4000,4500);
//
...
//
				...
				canvasfit->SaveAs(("LASTPLOT_finalfitnormalized"+tags.at(i)+".pdf").c_str());

                                delete canvasfit;
				canvshifttotal->cd(indexofcut+1) ; gPad->SetLeftMargin(0.15) ; finalfitframetruesig->GetYaxis()->SetTitleOffset(1.4) ; finalfitframetruesig->GetYaxis()->SetRangeUser(0.0,200.0); finalfitframetruesig->GetXaxis()->SetTitle("Corrected Mass"); finalfitframetruesig->Draw(); leg2->Draw();

                                TCanvas* lsmd = new TCanvas("LMSD", "LMSD",800,800); 
                                
                                TFile* lsmdfile = new TFile("/vols/lhcb/ss4314/cutonProbnnmu/probnnmugreaterthen03afterremovenSharedfullUMSB/fullcombi.root");
                                TTree* lsmdtree = (TTree*)lsmdfile->Get("DecayTree");                       
                                RooDataSet dlsmd("dlsmd","dlsmd",RooArgSet(Bplus_Corrected_Mass),Import(*lsmdtree));
                                dlsmd.Print();
                                RooPlot* framedlsmd = Bplus_Corrected_Mass.frame(Title("Fit to toydata vs LMSD"),Bins(50)) ;
