...
int main(int argc, char *argv[]){
        ...
        //mcsample=("/vols/lhcb/ss4314/cutonBDTs/MCsigNewvsMisid/B23MuNuMCallvar_MCtruth_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root").c_str()
 
        //partrecosample=("/vols/lhcb/ss4314/cutonBDTs/MCsigNewvsMisid/B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic_MisidBasic.root")

        //combisource=(""/vols/lhcb/ss4314/cutonBDTs/MCsigNewvsMisid/Data2012and2011_corrm_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root"")
	...
	if(l==0.0)
	{
		...
		for(int h(14); h<15; h++)
		{
			...
			string mcmuonsample="/vols/lhcb/ss4314/cutonBDTs/MCsigNewvsMisid/B23MuNuMCallvar_MCtruth_trigger_Jpsi_qmincut_CombBasic_MisidBasic.root";
...
//			TTree* treer = gettreemcsig(("B23MuNuMC"+mcname.at(indexofcut)+stripping+polarity+".root").c_str(),"mcweight");
			...
			//--------Fit with 2CBS Part Reco Fit-----------//
                        ...
                        string partrecosource="/vols/lhcb/ss4314/cutonBDTs/MCsigNewvsMisid/B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic_MisidBasic.root";
                        string partrecosourcenew="B23Pimu_MCtruth_trigger_Jpsi_mu3nShared_qmincut_CombBasic_MisidBasic.root";
                        double effpr;
                        effpr=cutTree(partrecosource, "DecayTree",partrecosourcenew , "Bplus_Corrected_Mass > 4000");


                        vector<double> paramspr;
                        paramspr=fitpartreco(partrecosourcenew);
		...
		//	TTree* treez =  gettreepartreco(partrecosource.c_str());
...

			{
				...
				vector<double> mycombicon;
                                string mycombisource= "/vols/lhcb/ss4314/cutonBDTs/MCsigNewvsMisid/Data2012and2011_corrm_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root";
				...
				paramsformisid=fitmisidcuts3samples2(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionKaon/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic.root").c_str(), ("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionKaon/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str(),("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionProton/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic.root").c_str(),tags.at(i));

                                string kaonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionKaon/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic.root").c_str();
                                string pionsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionKaon/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str();
       
                                string protonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionProton/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic.root").c_str();
...
//				TTree* treek =  gettreemisidkaon(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionKaon/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic.root").c_str(),tags.at(i));
...
//				TTree* treep =  gettreemisidpion(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/MCnSharedRemovedPionKaon/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str(),tags.at(i));
				...
				misid = dpw.sumEntries();           
                             ...
                             //   Bplus_Corrected_Mass.setRange("high",6000,10000);
                                ...
                                double sumofrange;
                                sumofrange = dpw.sumEntries("(Bplus_Corrected_Mass < 4500) || (Bplus_Corrected_Mass > 6000)");
...
//				RooAddPdf twocbs("twocbs","",RooArgList(cballr1,cballr2),RooArgList(frac1));
				...
				RooRealVar nbkg33("nbkg33","number of backgnd events3",numberofpartreco);
                                ...
                                RooRealVar ses("ses","Single event sensitivity",1.48e-9,1.2e-9,1.6e-9);
				...
				Bplus_Corrected_Mass.setRange("truesig",4900,6000);
                                ...
                                //-------------READ DATA -------------//
                                TFile* finaldata = new TFile("/vols/lhcb/ss4314/cutonProbnnmu/probnnmugreaterthen03afterremovenShared/finalcombi.root");
...
//				Bplus_Corrected_Mass.setRange("low",4000,4500);
                                Bplus_Corrected_Mass.setRange("high",6001,10000);
...
//				RooDataSet *datafinalnorm = .generate(RooArgSet(Bplus_Corrected_Mass),totalforfit)  ;
				finaldataset.plotOn(finalfitframetruesig, MarkerSize(0.9), LineColor(kBlack),RooFit::Name("data2"));
                                ...
                                normpdf.plotOn(finalfitframetruesig, Components(newexpoun), RooFit::Range("low,high"), LineColor(kRed),RooFit::Name("combinatorial2"));
                                normpdf.plotOn(finalfitframetruesig, Components(blah), RooFit::Range("low,high"), LineColor(kGreen),RooFit::Name("signal2"));
                                normpdf.plotOn(finalfitframetruesig, Components(twocbs), RooFit::Range("low,high"), LineColor(kCyan),RooFit::Name("misid2"));
                                normpdf.plotOn(finalfitframetruesig, Components(newpartreco), RooFit::Range("low,high"), LineColor(kMagenta),RooFit::Name("partreco2"));
                                ...
                                //
                                string namews="fitallafterMCnSharedRemovedIncludeLMSB";
                          ...
                          //      w->import(totalev);
                                ...
                                cout<<"COMBI"<<endl;
                                cout<<"Integral in the 4000 to 10000 wrt to the 4.5-5.5 :"<< combinatorial->getVal()<<endl;
                                ...
                                cout<<"MISID"<<endl;
                                cout<<"Integral in the 4000 to 10000 wrt to the 4.5-5.5 :"<< mymisid->getVal()<<endl;
                                ...
                                cout<<"SIG"<<endl;
                                cout<<"Integral in the 4000 to 10000 wrt to the 4.5-5.5 :"<< mysig->getVal()<<endl;
                                ...
                                cout<<"PARTRECO"<<endl;
                                cout<<"Integral in the 4000 to 10000 wrt to the 4.5-5.5 :"<< mypr->getVal()<<endl;
				...
				out<<"\\hline"<<endl;
				out<<"Sample REG 4.0-10.0 &   cut & 3fb$^{-1}$ \\\\ "<<endl;
				...
				canvshifttotal->cd(indexofcut+1) ; gPad->SetLeftMargin(0.15) ; finalfitframetruesig->GetYaxis()->SetTitleOffset(1.4) ; finalfitframetruesig->GetXaxis()->SetTitle("Corrected Mass"); finalfitframetruesig->Draw(); leg2->Draw();
                                ...
                                TFile* lsmdfile = new TFile("/vols/lhcb/ss4314/cutonProbnnmu/probnnmugreaterthen03afterremovenShared/Data2012and2011_corrmLSDfull_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_Probnnmu3.root");
