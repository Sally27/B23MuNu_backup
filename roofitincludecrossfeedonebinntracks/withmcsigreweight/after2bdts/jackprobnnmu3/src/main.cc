		...
		//	TTree* treez =  gettreepartreco(partrecosource.c_str());
...

			{
				...
				vector<double> mycombicon;
                                string mycombisource= "/vols/lhcb/ss4314/cutonBDTs/MisidBackTonomu1mu3ETAtighterproton/Data2012and2011_corrm_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic.root";
				...
				paramsformisid=fitmisidcuts3samples(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/includeJackMisidPionKaonjackefficiency/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic.root").c_str(), ("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/includeJackMisidPionKaonjackefficiency/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str(),("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/includeJackMisidPionProton/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic.root").c_str(),tags.at(i));

                                string kaonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/includeJackMisidPionKaonjackefficiency/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_KaonPID_CombBasic_MisidBasic.root").c_str();
                                string pionsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/includeJackMisidPionKaonjackefficiency/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str();
       
                                string protonsamplename=("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/includeJackMisidPionProton/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_ProtonPID_CombBasic_MisidBasic.root").c_str();
...
//				TTree* treep =  gettreemisidpion(("/vols/lhcb/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/includeJackMisidPionKaonjackefficiency/finaltuples/modifiedandcut"+tags.at(i)+"B23MuNuFakeSStotal_mu3isNotMuon_mu3inMuonAcc_trigger_Jpsi_mu1nShared_mu2nShared_qmincut_PionPID_CombBasic_MisidBasic.root").c_str(),tags.at(i));
				...
				canvshifttotal->cd(indexofcut+1) ; gPad->SetLeftMargin(0.15) ; finalfitframetruesig->GetYaxis()->SetTitleOffset(1.4) ; finalfitframetruesig->GetXaxis()->SetTitle("Corrected Mass"); finalfitframetruesig->Draw(); leg2->Draw();
                                ...
                                TFile* lsmdfile = new TFile("/vols/lhcb/ss4314/cutonProbnnmu/probnnmugreaterthen03/Data2012and2011_corrmLSD_trigger_Jpsi_mu1nShared_mu2nShared_mu3nShared_qmincut_CombBasic_MisidBasic_Probnnmu3.root");
