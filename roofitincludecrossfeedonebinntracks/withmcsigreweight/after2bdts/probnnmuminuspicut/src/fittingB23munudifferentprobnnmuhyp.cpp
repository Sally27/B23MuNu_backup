...
//  }
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/probnnmuminuspi/bin/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60andPPUNZIoptBDT_MISIDafter60.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/probnnmuminuspitighteroptimize1/soft/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60andPPUNZIoptBDT_MISIDafter60_idsoft.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/probnnmuminuspitighteroptimize1/hard/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60andPPUNZIoptBDT_MISIDafter60_idhard.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/probnnmuminuspi/bin/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60andPPUNZIoptBDT_MISIDafter60.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/probnnmuminuspitighteroptimize1/soft/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60andPPUNZIoptBDT_MISIDafter60_idsoft.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/after2bdts/probnnmuminuspitighteroptimize1/hard/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60andPPUNZIoptBDT_MISIDafter60_idhard.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
...
//		  canvshift->cd(i+1) ; gPad->SetLeftMargin(0.15) ; misidtotal->GetYaxis()->SetTitleOffset(1.4) ; misidtotal->GetXaxis()->SetTitle("Corrected Mass") ;  misidtotal->Draw() ;      
		  ...
		  // canvshift->SaveAs("misidshiftafter2bdts/probnnmuminuspi.pdf");          
...
//	TFile* s = new TFile("/vols/lhcbdisk05/ss4314/tightPIDinvestigation/nontrackcalculation/after2bdts/probnnmuminuspi/muon/PerfHists_Mu_Strip20_MagDown_P_ETA.root");
