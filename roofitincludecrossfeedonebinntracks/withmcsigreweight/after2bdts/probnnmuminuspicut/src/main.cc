...
//       cuts.push_back(("( (mu3_NNmu > "+cutonall.at(indexofcut)+") && (mu2_NNmu > "+cutonall.at(indexofcut)+") && (mu1_NNmu > "+cutonall.at(indexofcut)+") )").c_str());
      ...
      cuts.push_back(("( (mu3_NNmu - mu3_NNpi > "+cutonall.at(indexofcut)+") && (mu2_NNmu - mu2_NNpi > "+cutonall.at(indexofcut)+") && (mu1_NNmu - mu1_NNpi > "+cutonall.at(indexofcut)+") )").c_str());
...
//                  cout<<"Amount of partreco:"
		  ...
		  // Plot total PDF.
                  ...
                  punzimetric=(mysigres.getVal())/(sqrt(combinatorialres.getVal()+mymisidres.getVal()+myprres.getVal())+(3/2));
                  ...
                  out<<"combi  & "<< cutonall.at(indexofcut) <<" & "<< numberofcombi <<" \\\\ "<<endl;
                  ...
                  out<<"combi  & "<< cutonall.at(indexofcut) <<" & "<< combinatorialres.getVal() <<" \\\\ "<<endl;
