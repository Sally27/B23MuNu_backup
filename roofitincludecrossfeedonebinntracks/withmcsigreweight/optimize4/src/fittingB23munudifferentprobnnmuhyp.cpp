...
//  }
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/probnnmutighteroptimize1/soft/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60andPPUNZIoptBDT_idsoft.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/probnnmutighteroptimize1/hard/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_KaonPID_60andPPUNZIoptBDT_idhard.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/probnnmutighteroptimize1/soft/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60andPPUNZIoptBDT_idsoft.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
  ...
  *px=crossfeedweight;
  ...
  TFile* f = new TFile(("/vols/lhcbdisk05/ss4314/misidshapeincludecrossfeedonlyonebinntracks/probnnmutighteroptimize1/hard/modifiedandcut"+tags+"B23MuNuFakeSameSignMuonSmallDataSample_mu3isNotMuon_mu3inMuonAcc_Jpsi_cut_mu1nShared_mu2nShared_qmincut_PionPID_60andPPUNZIoptBDT_idhard.root").c_str());
  TTree* t = (TTree*)f->Get("DecayTree");
  TTree* tree = new TTree("tree","tree") ;
  Double_t Bplus_Corrected_Mass;
  Double_t crossfeedweight;
