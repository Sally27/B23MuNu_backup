...
//	cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && ((V2ProbNNmu - V2ProbNNpi) > 0.0)_All");
	...
	cuts3.push_back("Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.8)_All");
       ...
       mcsigval=paramfitsignal("finalmc.root");
//          return(1);
...
//       string cutonhard="0.0";
        ...
        cuts.push_back(("((identify==3.0) && (mu3_NNmu > "+cutonsoft.at(softi)+") && (mu1_NNmu > "+cutonhard.at(hardi)+"))||((identify==1.0) && (mu1_NNmu > "+cutonsoft.at(softi)+") && (mu3_NNmu > "+cutonhard.at(hardi)+"))").c_str());
...
//        tags.push_back("NNmuminuspimore08");
	  ...
	  TTree* treer = gettreemcsig("finalmc.root");
          RooDataSet dr("dr","dr", RooArgSet(y,pw), Import(*treer), WeightVar("pw"));
...
//	  dr.Print();
  ...
  //        return(1);
...

	  {
           ...
           mycombicon=paramfitcombi(cuts.at(i),tags.at(i), tags.at(i+1));

	  TTree* tree = gettreecomb(cuts.at(i),tags.at(i), tags.at(i+1));
...
//                  cout<<"Amount of partreco:"
		  double numberofsigevents=((29.7)*finalmceff);
