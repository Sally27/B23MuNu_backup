...
void addcostheta(string filename, string decaytreename, string newfilename)
{
	...
	//
	//              //veto J/psi
	t->SetBranchAddress("piplus_TRUEP_X", &mu3_PX);
	t->SetBranchAddress("piplus_TRUEP_Y", &mu3_PY);
	t->SetBranchAddress("piplus_TRUEP_Z", &mu3_PZ);
	t->SetBranchAddress("piplus_TRUEP_E", &mu3_PE);
