...
files_data.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2016/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID.root");
files_data.push_back("/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATACombi2016/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic.root");
files_data.push_back("/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic.root");
files_data.push_back("/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_NewTCK/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM.root");
...
run.sigfithypathia("true","mcweight","",(files_mine.at(0).c_str()),"2016",false);
//run.pimumufitweight("",(files_pimumu.at(0).c_str()),"mcweight",false);
//run.prepareWorkspace((files_data.at(0).c_str()));
//run.fitJpsiKDataHypathia3(false,"","2016");
//run.plotprettyhypathia3("2016");
////run.makeSWeightedTree("","", "Bu23JpsiKData2016.root");
//run.GetYields("2016",("2016"+cuts.at(0)).c_str());
