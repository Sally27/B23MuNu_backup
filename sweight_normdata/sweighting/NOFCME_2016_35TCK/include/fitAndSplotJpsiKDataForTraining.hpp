...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/sweight_normdata/sweighting/NOFCME_2016_35TCK/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/sweight_normdata/sweighting/NOFCME_2016_35TCK/workspace/"),
//   tupledir("/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_NOTsimultaneous_NewTCK/bin"),
//   tuplename("JpsiKdata_NOFCME_2016_35TCK_Probnnmu3.root"), 
   treename("DecayTree"),
   Bplus_MM_min(5200), 
   Bplus_MM_max(5400), 
//   mcdir("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights/bin/"),
   datadir("/vols/lhcb/ss4314/sweight_normdata/sweighting/NOFCME_2016_35TCK/Original")
