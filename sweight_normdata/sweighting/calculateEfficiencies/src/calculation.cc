...
int main(){
	...
	ofstream out;
	out.open("FittedJpsiK_Yields_Selection.tex");
	...
	out<<"\\hline"<<endl;
	out<<"Properties & 2011 & 2012 & 2016 & 2012/2011 & 2016/2012  \\\\ "<<endl;
	out<<"\\hline"<<endl;
	out<<"\\hline"<<endl;
	...
	number_obs_NOFCME_2016=(double(returnEff(("/home/hep/ss4314/public_html/fitcontrol_selection/2016/selection_7/FitResults/FitControl_2016_2016"+cuts.at(i)+".root").c_str(), "FitControl_2016", "NumNormObs")));
	number_obs_NOFCME_err_2016=(double(returnEff(("/home/hep/ss4314/public_html/fitcontrol_selection/2016/selection_7/FitResults/FitControl_2016_2016"+cuts.at(i)+".root").c_str(), "FitControl_2016", "NumNormObs_Err")));
        ...
        out << "N tuple"<<cuts.at(i)<<" & "<< (info2011).roundToError_diffbase(true)<<" & "<<(info2012).roundToError_diffbase(true)<<" & "<<(info2016).roundToError_diffbase(true)<< " & & " <<" \\\\ "<<endl;
	}
	...
	number_obs_NOFCME_old_2016=(double(returnEff(("/home/hep/ss4314/public_html/fitcontrol_selection/2016/selection_7/FitResults/FitControl_2016_2016"+cuts.at(i-1)+".root").c_str(), "FitControl_2016", "NumNormObs")));
	number_obs_NOFCME_old_err_2016=(double(returnEff(("/home/hep/ss4314/public_html/fitcontrol_selection/2016/selection_7/FitResults/FitControl_2016_2016"+cuts.at(i-1)+".root").c_str(), "FitControl_2016", "NumNormObs_Err")));
	...
	number_obs_NOFCME_err_2016=(double(returnEff(("/home/hep/ss4314/public_html/fitcontrol_selection/2016/selection_7/FitResults/FitControl_2016_2016"+cuts.at(i)+".root").c_str(), "FitControl_2016", "NumNormObs_Err")));
        ...
        out << "$\\varepsilon_{"<<cuts.at(i)<<"}$ & "<< (info2011/info2011_old).roundToError_diffbase(true)<<" & "<<(info2012/info2012_old).roundToError_diffbase(true)<<" & "<<(info2016/info2016_old).roundToError_diffbase(true)<<" & & "<<" \\\\ "<<endl;
	}
