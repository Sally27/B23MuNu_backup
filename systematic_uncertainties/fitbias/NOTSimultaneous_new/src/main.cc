...
//    TCanvas* canvas= new TCanvas("fit", "Fit",800,800);
   ...
   // RooAbsPdf* pdf_sb = ws->pdf("modelsb");
    ...
    RooFitResult* data_intresult_free = pdf_sb_int->fitTo(*data_int,RooFit::Extended(true),RooFit::Range("low,high"),ExternalConstraints(constraints),RooFit::Save(true),RooFit::Minos(true), RooFit::PrintLevel(-1));
    ...
    RooFitResult* data_intresult_fixed = pdf_sb_int->fitTo(*data_int,RooFit::Extended(true),RooFit::Range("low1,high1"),ExternalConstraints(constraints),RooFit::Save(true),RooFit::Minos(true), RooFit::PrintLevel(-1));
