...
//	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/";
	...
	tuples.push_back("MC_B2JpsiK_2012MCTruth__misidstrippingfull_2D_misidstrippingfull_trigger");
	tuples.push_back("MC_B2JpsiK_2012MCTruth__misidstrippingfull_2D_misidstrippingfull_trigger_CombBasic");
	tuples.push_back("MC_B2JpsiK_2012MCTruth__misidstrippingfull_2D_misidstrippingfull_trigger_CombBasic_MisidBasic");
	...
	TFile *fillinfos = new TFile("../efficiencytuples_sig/Efficiencies_NORMMC_2012_Combi.root","RECREATE");
