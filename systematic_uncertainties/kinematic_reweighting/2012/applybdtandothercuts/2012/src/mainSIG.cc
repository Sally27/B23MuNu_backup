...
int main(){
	...
	vector<string> tuples;
        ...
        string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2012_vs_DATAMisidRun1_ONLYMCSIGANDNORM_REWEIGHTED/";
//	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/";
        string pathname2 = "/vols/lhcb/ss4314/systematic_uncertainties/kinematic_reweighting/2012/applybdtandothercuts/2012/bin/";
	...
	tuples.push_back("Bu23MuNuMC2012_MCtruth_2D_L0MuonDecisionTOS_trigger_Jpsi_qmincut");
	tuples.push_back("Bu23MuNuMC2012_MCtruth_2D_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic");
	tuples.push_back("Bu23MuNuMC2012_MCtruth_2D_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic_MisidBasic");
	...
	TFile *fillinfos = new TFile("../efficiencytuples_sig/Efficiencies_SigMC_2012_Combi_Rew.root","RECREATE");
