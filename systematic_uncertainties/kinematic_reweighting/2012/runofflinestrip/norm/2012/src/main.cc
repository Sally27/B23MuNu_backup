...
//	string filename2 = (filename+cuttag).c_str();
 //       string filenameclean = filename;
        ...
        string pathname = "/vols/lhcb/ss4314/systematic_uncertainties/kinematic_reweighting/2012/initialmc/";
        string filename = "MC_B2JpsiK_2012MCTruth__misidstrippingfull_2D";
	...
	TFile *fillinfo = new TFile("Efficiencies_2012_REW.root","RECREATE");
