...
int main(){
	...
	vector<string> tuples;
        ...
        string pathname = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATAMisid2016_ONLYMCSIGANDNORM_REWEIGHTED/";
//	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/";
        string pathname2 = "/vols/lhcb/ss4314/systematic_uncertainties/kinematic_reweighting/2016/applybdtandothercuts/2016/bin/";
	...
	tuples.push_back("B2JpsiKMC2016_MCtruth_CutBased_misidstrippingfull_2D_misidstrippingfull_trigger");
	tuples.push_back("B2JpsiKMC2016_MCtruth_CutBased_misidstrippingfull_2D_misidstrippingfull_trigger_CombBasic");
	tuples.push_back("B2JpsiKMC2016_MCtruth_CutBased_misidstrippingfull_2D_misidstrippingfull_trigger_CombBasic_MisidBasic");


        vector<string> tags;
 
        tags.push_back("NormMC2016_PHSP");
        tags.push_back("NormMC2016_PHSP_aftercombi");
        tags.push_back("NormMC2016_PHSP_aftermisid");
	...
	for(int i(0); i<tuples.size(); i++)
	{
        ...
        ofstream out;
	out.open("EfficienciesCombiBDT_Rew.tex");
	...
	TFile *fillinfos = new TFile("../efficiencytuples_sig/Efficiencies_NORMMC_2016_Combi.root","RECREATE");
	TTree *fillinfotrees = new TTree("MC_Sig_2016","MC_Sig_2016");
	FillEffInfo(fillinfotrees, "combibdt",double(collection.find("NormMC2016_PHSP")->second),false);
	FillEffInfo(fillinfotrees, "misidbdt",double(collection.find("NormMC2016_PHSP_aftercombi")->second),false);
	FillEffInfo(fillinfotrees, "fitrange",double(collection.find("NormMC2016_PHSP_aftermisid")->second),false);
	fillinfos->cd();
