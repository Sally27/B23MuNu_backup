...
//	string pathname2 = "/vols/lhcb/ss4314/BDTrunonsamples/tuplesandbdtrun/MCSig2016_288888335_vs_DATACombi2016_2016only/";
	...
	tuples.push_back("Bu23MuNuMC2016_MCtruth_CutBased_2D_L0MuonDecisionTOS_trigger_Jpsi_qmincut");
	tuples.push_back("Bu23MuNuMC2016_MCtruth_CutBased_2D_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic");
	tuples.push_back("Bu23MuNuMC2016_MCtruth_CutBased_2D_L0MuonDecisionTOS_trigger_Jpsi_qmincut_CombBasic_MisidBasic");


        vector<string> tags;
 
        tags.push_back("SigMC2016_Mine");
        tags.push_back("SigMC2016_Mine_aftercombi");
        tags.push_back("SigMC2016_Mine_aftermisid");
	...
	TFile *fillinfos = new TFile("../efficiencytuples_sig/Efficiencies_SigMC_2016_Combi_Rew.root","RECREATE");
	TTree *fillinfotrees = new TTree("MC_Sig_2016","MC_Sig_2016");
	FillEffInfo(fillinfotrees, "combibdt",double(collection.find("SigMC2016_Mine")->second),false);
	FillEffInfo(fillinfotrees, "misidbdt",double(collection.find("SigMC2016_Mine_aftercombi")->second),false);
	FillEffInfo(fillinfotrees, "fitrange",double(collection.find("SigMC2016_Mine_aftermisid")->second),false);
	fillinfos->cd();
