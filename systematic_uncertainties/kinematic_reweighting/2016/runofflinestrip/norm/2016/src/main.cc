...
//	string filename2 = (filename+cuttag).c_str();
 //       string filenameclean = filename;
        ...
        string pathname = "/vols/lhcb/ss4314/systematic_uncertainties/kinematic_reweighting/2016/initialmc/";
        string filename = "B2JpsiKMC2016_MCtruth_CutBased_misidstrippingfull_2D";
        ...
        cutTree((pathname+filename+ext).c_str(),"DecayTree",(filename2+ext).c_str(),"");
	...
	TFile *fillinfo = new TFile("Efficiencies_2016_REW.root","RECREATE");
