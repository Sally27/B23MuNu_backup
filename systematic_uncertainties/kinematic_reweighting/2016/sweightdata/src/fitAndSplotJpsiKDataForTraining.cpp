...
void FitAndSplotJpsiKDataForTraining::GetYields(string dataset)
{
...
//   RooRealVar vc1("vc1", "vc1",0.75, 0.15,0.9);
   RooRealVar sig("sig","sig",120000 ,1000,2000000);
   RooRealVar bkg("bkg","bkg",100, 2 ,100000) ;
   RooRealVar bkg2("bkg2","bkg2",100, 2 ,100000) ;
