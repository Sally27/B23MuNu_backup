...
//		double cormjpsik=0.998631;
		...
		ValError jpsik_othereff_passed(double(t_final_norm->GetEntries()),0);

		ValError sig_othereff_total(number_bkk_sig,0);
		ValError jpsik_othereff_total(number_bkk_nor,0);
	...
	double effrecostrip= 0.111;
        ...
        ValError numberofobsevents(95225,315);
	...
	double numberofevents_low = 95225;
