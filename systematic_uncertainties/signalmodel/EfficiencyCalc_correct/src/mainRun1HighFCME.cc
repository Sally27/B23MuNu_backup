...
int main(){
        ...
        ofstream out;
        out.open("ComparisonSignalMC_PHSPmodelefficienciesbelow1Gev_HighFCME.tex");
...
//	cormjpsik=returnEff(("../efficiencytuples_norm/Efficiencies_NormMC_"+i2s(years.at(1))+"_Fitrange.root").c_str(), ("MC_Norm_"+i2s(years.at(1))).c_str(), "fitrange");
	...
	TFile f_final_sig("/vols/lhcb/ss4314/cutonBDTs/InvestigatePHSP_Combi/bin/Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM_HighFCME.root","READ");
	...
	TFile f_final_norm("/vols/lhcb/ss4314/cutonBDTs/InvestigatePHSP_Combi/bin/B23MuNuMCPHSP_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM_HighFCME.root","READ");
...
//        double jpsikPID=0.644225;
       ...
       // ValError sig_pid(0.663,0.007);
       // ValError jpsik_pid(0.660,0.011);

        ValError sig_pid(readPIDvar("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel/preparesignalweights_correct/preparesignalweights_FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level/bin/B23MuNuMC2012probnnmu035Strip21_selected_HighFCME.root", "DecayTree", "PIDweight"),0.007);
        ValError jpsik_pid(readPIDvar("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel/preparesignalweights_correct/preparesignalweights_FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level/bin/B23MuNuMCPHSP2012probnnmu035Strip21_selected_HighFCME.root","DecayTree", "PIDweight"),0.011);
        //--------decorprodcut-----------//
       ...
       files_mine.push_back("/vols/lhcb/ss4314/cutonBDTs/InvestigatePHSP_Combi/bin/Bu23MuNuMC2012_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM_HighFCME.root");
       ...
       files_phsp.push_back("/vols/lhcb/ss4314/cutonBDTs/InvestigatePHSP_Combi/bin/B23MuNuMCPHSP_MCtruth_L0MuonDecisionTOS_trigger_Jpsi_CombBasic_MisidBasic_FitCorM_HighFCME.root");
