...
int main(){
	...
	vector<string> PIDcut2016;
        ...
        string pathname = "/vols/lhcb/ss4314/systematic_uncertainties/signalmodel/preparesignalweights_correct/preparesignalweights_FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level/bin/";
	string pathname2 = "/vols/lhcb/ss4314/preparesignalweights/preparesignalweights_FUMSB_simultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level/tuples_nonsim/";
...
//	PIDcut.push_back("probnnmupi06");
	...
	for (int g(0); g<PIDcut.size(); g++)
	{
		...
		tuples.push_back(("B23MuNuMC2012"+PIDcut.at(g)+"Strip21_selected").c_str());
...
//	PIDcut2016.push_back("probmu35");
	...
	for (int g(0); g<PIDcut.size(); g++)
	{
		...
		tuples.push_back(("B23MuNuMCPHSP2012"+PIDcut.at(g)+"Strip21_selected").c_str());
