...
int main(){
	...
	string pathname = "/vols/lhcb/ss4314/systematic_uncertainties/signalmodel/rungeneratorlevel/2016/pythia8/";
	string filename = "MC_2016_nocuts_PYTHIA8";
...
//        addcostheta(filename2, "DecayTree", filename2);  
      ...
      vals.push_back("(muplus_eta>1.596 && muplus_eta<5.298) && (muminus_eta>1.596 && muminus_eta<5.298) && (muplus0_eta>1.596 && muplus0_eta<5.298)"); 

//        vals.push_back("((Math::atan(muplus_TRUEPT/muplus_TRUEP_Z))<0.4 && (Math::atan(muplus_TRUEPT/muplus_TRUEP_Z))>0.01) && ((Math::atan(muminus_TRUEPT/muminus_TRUEP_Z))<0.4 && (Math::atan(muminus_TRUEPT/muminus_TRUEP_Z))>0.01) && ((Math::atan(muplus0_TRUEPT/muplus0_TRUEP_Z))<0.4 && (Math::atan(muplus0_TRUEPT/muplus0_TRUEP_Z))>0.01)");
