...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel_fit/fitsignal_final_genlevelcor_allsyst/workspace/FitB23MuNuworkspace.root"),
    plotdir("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel_fit/fitsignal_final_genlevelcor_allsyst/workspace_plots/"), 
    fitdir("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel_fit/fitsignal_final_genlevelcor_allsyst/workspace_fit/"),
    clsdir("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel_fit/fitsignal_final_genlevelcor_allsyst/workspace_fitcls/"),
    workspacedir("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel_fit/fitsignal_final_genlevelcor_allsyst/workspace_preparation/"),
    fitresdir("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel_fit/fitsignal_final_genlevelcor_allsyst/fit_results"),
    comparedir("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel_fit/fitsignal_final_genlevelcor_allsyst/compare_fits"),

    partrecodir("/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_NewTCK/bin"), 
    sigdir("/vols/lhcb/ss4314/systematic_uncertainties/signalmodel/preparesignalweights_correct/preparesignalweights_FUMSB_NOTsimultaneous_NewTCK_PIDoptimisation_extremeweights_correct_gen_level/bin"),
    ...
    signalfilename("B23MuNuMC2012probnnmu035Strip21_selected"),
    signalfilename2("B23MuNuMCPHSP2012probnnmu035Strip21_selected"),
...
//Sally's addition//
   ...
   void plotprettysim_chi2_reallynice(string type, string pidcutRun1, string pidcutRun2);

   void plotpretty_plotnicely_paper_sigsim_drive(bool parameters);
   void plotpretty_plotnicely_paper_sigsim_drive_2model(bool parameters);
...
//   vector<double> fitsignalcomponent(string weightname, string type, string year, string PIDcut);
   vector<double> fitsignalcomponent_1model(string weightname, string type, string year, string PIDcut);
   vector<double> fitsignalcomponent_2model(string weightname, string type, string year, string PIDcut);
