...
//	out<<"or strip and reco & 0.33522 & 1365886(8043820) & TBD  \\\\ "<<endl;
	...
	TFile *fillinfo = new TFile("Efficiencies_Data_2012_trigger_TISTOS.root","RECREATE");
	...
	FillEffInfo(fillinfotree, "decprodcut",decprodcut2,false);
        ...
        string ext=".root";
        string filenameclean="Data_B2JpsiK_2012";
	...
	string filename3=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc").c_str();
	...
	string filename4=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTISTOS_Hlt1TrackMuonDecisionTISTOS").c_str();        
	...
	string filename7=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc").c_str();
	...
	string filename8=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_L0MuonDecisionTIS_Hlt1TrackMuonDecisionTIS").c_str();        
