...
//        vector<Int_t> mytcks(tcks, tcks+sizeof(tcks)/ sizeof(Int_t) );
        ...
        cutTree((filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc"+ext).c_str(), "DecayTree", (filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_288888335"+ext).c_str(), "HLT1TCK==288888335"); //most repretck
	...
	string filename3=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_288888335").c_str();
	...
	string filename4=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_288888335_L0MuonDecisionTISTOS_Hlt1TrackMuonDecisionTISTOS").c_str();        
	...
	string filename7=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_288888335").c_str();
	...
	string filename8=(filenameclean+"_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_288888335_L0MuonDecisionTIS_Hlt1TrackMuonDecisionTIS").c_str();        
