...
int main(){
	...
	decprodcutsig=returnEff(("../../mc/2016/bin/Efficiencies_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("MC_Norm_"+i2s(years.at(2))).c_str(), "L0MuonDecisionTISTOSnumberTISTOS");
	effrecostrsig=returnEff(("../../mc/2016/bin/Efficiencies_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("MC_Norm_"+i2s(years.at(2))).c_str(), "Hlt1TrackMuonDecisionTISTOSnumberTISTOS");
	effmyrecosig=returnEff(("../../mc/2016/bin/Efficiencies_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("MC_Norm_"+i2s(years.at(2))).c_str(), "Hlt2orofDecisionsTISTOSnumberTISTOS");

	combibdtsig=returnEff(("../../data/2016/bin/Efficiencies_Data_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "L0MuonDecisionTISTOSnumberTISTOS");
	misidbdtsig=returnEff(("../../data/2016/bin/Efficiencies_Data_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "Hlt1TrackMuonDecisionTISTOSnumberTISTOS");
	cormsig=returnEff(("../../data/2016/bin/Efficiencies_Data_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "Hlt2orofDecisionsTISTOSnumberTISTOS");

	swsig1=returnEff(("../../data/sweighted2016/bin/Efficiencies_Data_Sweighted_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "L0MuonDecisionTISTOSnumberTISTOS");
	swsig2=returnEff(("../../data/sweighted2016/bin/Efficiencies_Data_Sweighted_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "Hlt1TrackMuonDecisionTISTOSnumberTISTOS");
	swsig3=returnEff(("../../data/sweighted2016/bin/Efficiencies_Data_Sweighted_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "Hlt2orofDecisionsTISTOSnumberTISTOS");
	...
	decprodcutjpsik=returnEff(("../../mc/2016/bin/Efficiencies_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("MC_Norm_"+i2s(years.at(2))).c_str(), "L0MuonDecisionTISnumberTIS");
	effrecostrjpsik=returnEff(("../../mc/2016/bin/Efficiencies_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("MC_Norm_"+i2s(years.at(2))).c_str(), "Hlt1TrackMuonDecisionTISnumberTIS");
	effmyrecostrjpsik=returnEff(("../../mc/2016/bin/Efficiencies_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("MC_Norm_"+i2s(years.at(2))).c_str(), "Hlt2orofDecisionsTISnumberTIS");


	combibdtjpsik=returnEff(("../../data/2016/bin/Efficiencies_Data_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "L0MuonDecisionTISnumberTIS");
	misidbdtjpsik=returnEff(("../../data/2016/bin/Efficiencies_Data_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "Hlt1TrackMuonDecisionTISnumberTIS");
	cormjpsik=returnEff(("../../data/2016/bin/Efficiencies_Data_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "Hlt2orofDecisionsTISnumberTIS");

	swnor1=returnEff(("../../data/sweighted2016/bin/Efficiencies_Data_Sweighted_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "L0MuonDecisionTISnumberTIS");
	swnor2=returnEff(("../../data/sweighted2016/bin/Efficiencies_Data_Sweighted_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "Hlt1TrackMuonDecisionTISnumberTIS");
	swnor3=returnEff(("../../data/sweighted2016/bin/Efficiencies_Data_Sweighted_"+i2s(years.at(2))+"_trigger_TISTOS.root").c_str(), ("Data_Norm_"+i2s(years.at(2))).c_str(), "Hlt2orofDecisionsTISnumberTIS");
...
//        out << "All sum & & & "<<getRatioBinomial(ValError(swsig1,0),ValError(swnor1,0))*getRatioBinomial(ValError(swsig2,0),ValError(swnor2,0))*getRatioBinomial(ValError(swsig3,0),ValError(swnor3,0))<<" \\\\ "<<endl;
	...
	out.close();
        ...
        TFile fillinfo("../Systematic_Trigger/Systematic_Trigger.root","UPDATE");
