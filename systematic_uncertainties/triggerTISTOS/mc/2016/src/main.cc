...
//	out<<"or strip and reco & 0.33522 & 1365886(8043820) & TBD  \\\\ "<<endl;
	...
	TFile *fillinfo = new TFile("Efficiencies_2016_trigger_TISTOS.root","RECREATE");
	...
	FillEffInfo(fillinfotree, "decprodcut",decprodcut2,false);
        ...
        string ext=".root";
        string filenameclean="B2JpsiKMC2016_MCtruth";
	...
	string filename4=(filenameclean+"_misidstrippingfull_L0MuonDecisionTISTOS_Hlt1TrackMuonDecisionTISTOS").c_str();        
	...
	string filename7=(filenameclean+"_misidstrippingfull").c_str();
	...
	string filename8=(filenameclean+"_misidstrippingfull_L0MuonDecisionTIS_Hlt1TrackMuonDecisionTIS").c_str();        
