...
int main(){
	...
	ofstream out;
	out.open("Efficiencies_Alternative.tex");
...
//	out<<"or strip and reco & 0.33522 & 1365886(8043820) & TBD  \\\\ "<<endl;
	...
	TFile *fillinfo = new TFile("Efficiencies_2012_trigger_TISTOS_Alt.root","RECREATE");
	...
	FillEffInfo(fillinfotree, "decprodcut",decprodcut2,false);
        ...
        string ext=".root";
        string filenameclean="MC_B2JpsiK_2012MCTruth_";
