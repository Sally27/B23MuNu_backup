...
int main(){
	...
	ofstream out;
	out.open("Efficiencies_HLT2.tex");
...
//	out<<"or strip and reco & 0.33522 & 1365886(8043820) & TBD  \\\\ "<<endl;
	...
	TFile *fillinfo = new TFile("Efficiencies_2016_trigger_TISTOS_HLT2.root","RECREATE");
	...
	FillEffInfo(fillinfotree, "decprodcut",decprodcut2,false);
        ...
        string ext=".root";
        string filenameclean="B2JpsiKMC2016_MCtruth_misidstrippingfull";
