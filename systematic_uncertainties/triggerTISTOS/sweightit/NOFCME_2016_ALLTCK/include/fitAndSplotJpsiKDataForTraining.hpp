...
{ 
   ...
   :workspaceFileName("/vols/lhcb/ss4314/systematic_uncertainties/triggerTISTOS/sweightit/NOFCME_2016_ALLTCK/workspace/FitB2JpsiKworkspace.root"), plotdir("/vols/lhcb/ss4314/systematic_uncertainties/triggerTISTOS/sweightit/NOFCME_2016_ALLTCK/workspace/"),
//   tupledir("/vols/lhcb/ss4314/cutonProbnnmu/FUMSB_NOTsimultaneous_NewTCK/bin"),
//   tuplename("JpsiKdata_NOFCME2016_Probnnmu3.root"), 
   treename("DecayTree"),
   Bplus_MM_min(5150), 
   Bplus_MM_max(5450), 
   mcdir("/vols/lhcb/ss4314/preparecontrolweights/preparecontrolweights_FUMSB_NOTsimultaneous_NewTCK/bin/"),
   datadir("/vols/lhcb/ss4314/systematic_uncertainties/triggerTISTOS/data/2016_allTCK/bin"),
