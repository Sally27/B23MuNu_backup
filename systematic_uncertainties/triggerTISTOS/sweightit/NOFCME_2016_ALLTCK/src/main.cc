...
run3.prepareWorkspace("Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_ALLTCK.root");
run3.fitJpsiKDataHypathia3(false,"","2016");
run3.plotprettyhypathia3("2016");
run3.makeSWeightedTree("","", "Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_ALLTCK.root");
//run3.GetYields("2016");
