...
//        string PIDcut=argv[1];
  //      string PIDcut2016=argv[2];
        ...
        ofstream out;
        out.open("Information_FULL_ERRORS_JPSIK2012and2016Data_Sweighted.tex");
	...
	out<<"\\begin{document}"<<endl;
        ...
        out<<"Calculation of the $J/\\psi$ K differences between 2011 and 2012 and 2016 Data"<<endl;
	...
	TFile f_initial_sig("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2011/bin/Data_B2JpsiK_2011.root","READ");
	TTree* t_initial_sig =(TTree*)f_initial_sig.Get(("DecayTree"));

	TFile f_final_sig("/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_NewTCK/bin/Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM.root","READ");
	TTree* t_final_sig =(TTree*)f_final_sig.Get(("DecayTree"));

	TFile f_initial_norm("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2012/bin/Data_B2JpsiK_2012.root","READ");
	TTree* t_initial_norm =(TTree*)f_initial_norm.Get(("DecayTree"));

	TFile f_final_norm("/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_NewTCK/bin/Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM.root","READ");
	TTree* t_final_norm =(TTree*)f_final_norm.Get(("DecayTree"));
 
	TFile f_initial_norm2016("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2016/bin/Bu23JpsiKData2016.root","READ");
	TTree* t_initial_norm2016 =(TTree*)f_initial_norm2016.Get(("DecayTree"));

	TFile f_final_norm2016("/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_NewTCK/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_KaonPID_CombBasic_MisidBasic_FitCorM.root","READ");
...
//        ValError jpsik2016_decprod(decprodcutjpsik2016,decprodcutjpsik2016_err);
        ...
        ValError jpsik2016_othereff_total(double(t_initial_norm2016->GetEntries()),sqrt(double(t_initial_norm2016->GetEntries())));
...
// 
        out << "number total & "<< sig_othereff_total <<" & " <<jpsik_othereff_total <<" &   "<<jpsik2016_othereff_total<<" & "<<" - \\\\" <<endl;   
        out<<"\\hline"<<endl;
...
//        vector<string> files_2011;
        ...
        files_mine.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2011/bin/Data_B2JpsiK_2011.root");
        files_mine.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2011/bin/Data_B2JpsiK_2011_misidstrippingfull.root");
        files_mine.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2011/bin/Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc.root");
        files_mine.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2011/bin/Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger.root");
        files_mine.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2011/bin/Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID.root");
        files_mine.push_back("/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATACombi2016/bin/Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic.root");
        files_mine.push_back("/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic.root");
        files_mine.push_back("/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_NewTCK/bin/Data_B2JpsiK_2011_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM.root");




//        files_norm.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2012/bin/MC_B2JpsiK_2012.root");
        files_norm.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2012/bin/Data_B2JpsiK_2012.root");
        files_norm.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2012/bin/Data_B2JpsiK_2012_misidstrippingfull.root");
        files_norm.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2012/bin/Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc.root");
        files_norm.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2012/bin/Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger.root");
        files_norm.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2012/bin/Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID.root");
        files_norm.push_back("/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATACombi2016/bin/Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic.root");
        files_norm.push_back("/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic.root");
        files_norm.push_back("/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_NewTCK/bin/Data_B2JpsiK_2012_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1nShared_mu2nShared_KaonPID_CombBasic_MisidBasic_FitCorM.root");
 ...
 //      Int_t tcks[] = {287905280,287905283,287905284,287905285,288495113,288626185,288691721,288757257,288822793,288822798,288888329,288888334,288888335,288888337,288888338,288888339};
   ...
   //     vector<Int_t> mytcks(tcks, tcks+sizeof(tcks)/ sizeof(Int_t) );
	...
	files_norm2016.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2016/bin/Bu23JpsiKData2016.root");
	files_norm2016.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2016/bin/Bu23JpsiKData2016_misidstrippingfull.root");
	files_norm2016.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2016/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc.root");
	files_norm2016.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2016/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger.root");
	files_norm2016.push_back("/vols/lhcb/ss4314/final_tuples_analyser/data/B2jpsik_data/2016/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_KaonPID.root");
	files_norm2016.push_back("/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATACombi2016/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_KaonPID_CombBasic.root");
	files_norm2016.push_back("/vols/lhcb/ss4314/cutonBDTs/MCSig2016_288888335_vs_DATAMisid2016/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_KaonPID_CombBasic_MisidBasic.root");
	files_norm2016.push_back("/vols/lhcb/ss4314/cutonFitRange/FUMSB_NOTsimultaneous_NewTCK/bin/Bu23JpsiKData2016_misidstrippingfull_mu3isNotMuon_mu3inMuonAcc_trigger_mu1isMuonTight_mu2isMuonTight_mu1MuonNShared_mu2MuonNShared_KaonPID_CombBasic_MisidBasic_FitCorM.root");
...
////        out << "$\\epsilon\\_{PID}$ & "<<sig_pid.val<<"$\\pm$"<<sig_pid.err<< " & " << jpsik_pid.val<<" $\\pm$ "<<jpsik_pid.err<< " & "<<jpsik2016_pid.val<<" $\\pm$ "<<jpsik2016_pid.err<<" & "<< (jpsik_pid/sig_pid).val<< "$\\pm$"<< (jpsik_pid/sig_pid).err<<" \\\\ "<<endl;
        ...
        out<<"\\hline"<<endl;
        out<<"Number passed &"<<sig_othereff_passed.val<<"$\\pm$"<<sig_othereff_passed.err<<" & "<<jpsik_othereff_passed.val<<"$\\pm$"<<jpsik_othereff_passed.err<< " & "<<jpsik2016_othereff_passed.val<<"$\\pm$"<<jpsik2016_othereff_passed.err<< " & "<< (jpsik_othereff_passed/sig_othereff_passed).val<< "$\\pm$"<< (jpsik_othereff_passed/sig_othereff_passed).err<<" \\\\ "<<endl;

        out<<"$\\epsilon_{tot}$ &"<<sig_othereff.val<<"$\\pm$"<<sig_othereff.err<<" & "<<jpsik_othereff.val<<"$\\pm$"<<jpsik_othereff.err<< " & "<<jpsik2016_othereff.val<<"$\\pm$"<<jpsik2016_othereff.err<< " & "<< (jpsik_othereff/sig_othereff).val<< "$\\pm$"<< (jpsik_othereff/sig_othereff).err<<" \\\\ "<<endl;
//
        out<<"\\hline"<<endl;
        out<<" Ratios & "<<"- & "<<" $\\epsilon^{2012}_{tot}/\\epsilon^{2011}_{tot}$ ="<<(jpsik_othereff/sig_othereff).val<<"$\\pm$"<<(jpsik_othereff/sig_othereff).err<<" & "<<" $\\epsilon^{2016}_{tot}/\\epsilon^{2012}_{tot}$ ="<<(jpsik2016_othereff/jpsik_othereff).val<<"$\\pm$"<<(jpsik2016_othereff/jpsik_othereff).err <<" \\\\ "<<endl;
//
        out << "Efficiency & "<< " $B^{+} \\rightarrow J/\\psi\\ K^{+}$  2011 & " << " $B^{+} \\rightarrow J/\\psi\\ K^{+}$ 2012 & "<<" $B^{+} \\rightarrow J/\\psi\\ K^{+}$ 2016 & "<<" Ratio (2012/2011) \\\\" <<endl;   
        out<<"\\hline"<<endl;
        out<<"\\hline"<<endl;
