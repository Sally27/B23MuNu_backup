...
int main(int argc, char *argv[])
{
	...
	string PIDcut_Run1=argv[1];
        ...
        lhcbSally();
        ofstream out;
        out.open("Summary_plot_individualeff_"+PIDcut_Run1+"_"+PIDcut_2016+"_Pretty.tex");
...
//	mg->GetYaxis()->SetRightMargin(0.2);
	//c1->Update();
        c1->BuildLegend(0.78,0.05,1.18,0.95); 
	c1->SaveAs("Plot_ALL_Efficiencies_Overview_Pretty.pdf");
	delete c1;
