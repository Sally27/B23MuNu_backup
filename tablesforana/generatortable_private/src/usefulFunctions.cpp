...
void convertbranchname(string filename, string decaytreename, string newfilename, string branchname, string newbranchname)
{

	cout<<"converting and adding staff "<<endl;
	...
	std::string *Bplus_ppMuMu_SV_CHI2=0;
	//
	t->SetBranchAddress(branchname.c_str(), &Bplus_ppMuMu_SV_CHI2);
	...
	t2->Branch(newbranchname.c_str(),&svss);
