...
//                        varia.push_back("Hlt2DiMuonDetachedHeavyDecision");
	...
	out<<"\\end{center}"<<endl;
	out<<"\\caption{*Name different in 2016. Trigger Selection for Normalisation Data Channel. This has been applied on the top of misid stripping selection and requiring kaon not to be isMuon but in muon acceptance.}"<<endl;
	out<<"\\end{table}"<<endl;
