...
string filename="PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root"; 
...
string filename2="PerfHists_Mu_Strip20_MagDown_P_ETA_nTracks.root";
...
string ifilename="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/probnnmu/samples/pion/PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root";
string ith3namefirst ="Pi_(IsMuon==1.0)_All";
string ith3namesecond ="Pi_(IsMuon==1.0) && (DLLmu > 0.0)_All";
string ith3namethird ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All";
string ith3namefourth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string ith3namefifth ="Pi_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.0)_All";
...
string ifilename2="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/probnnmu/samples/muon/PerfHists_Mu_Strip20_MagDown_P_ETA_nTracks.root";
string ith3namefirst2 ="Mu_(IsMuon==1.0)_All";
string ith3namesecond2 ="Mu_(IsMuon==1.0) && (DLLmu > 0.0)_All";
string ith3namethird2 ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All";
string ith3namefourth2 ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string ith3namefifth2 ="Mu_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.0)_All";
...
TLatex *blatex = new TLatex(grsecond->GetX()[4], grsecond->GetY()[4], "(V3ProbNNmu > 0.0)");
blatex->SetTextSize(0.02);
blatex->SetTextColor(i+1);

TLatex *blatex1 = new TLatex(grsecond->GetX()[5], grsecond->GetY()[5], "(V3ProbNNmu > 0.7)");
blatex1->SetTextSize(0.02);
blatex1->SetTextColor(i+1);

TLatex *blatex2 = new TLatex(grsecond->GetX()[6], grsecond->GetY()[6], "(V3ProbNNmu > 0.75)");

blatex2->SetTextSize(0.02);
blatex2->SetTextColor(i+1);

TLatex *blatex3 = new TLatex(grsecond->GetX()[7], grsecond->GetY()[7], "(V3ProbNNmu > 0.8)");
blatex3->SetTextSize(0.02);
blatex3->SetTextColor(i+1);

TLatex *blatex4 = new TLatex(grsecond->GetX()[8], grsecond->GetY()[8], "(V3ProbNNmu > 0.85)");
...
TGraph *grthird =  new TGraph(9,ifirstmisideffi2,ifirstmisideffi);



grthird->SetTitle(("P bin: "+(d2s(mymombin.at(i-1)))+" to "+(d2s(mymombin.at(i)))).c_str());
grthird->SetMarkerColor(i);
grthird->SetLineColor(i);
grthird->SetMarkerStyle(i+19);
grthird->SetFillStyle(0);
TLatex *platex = new TLatex(grthird->GetX()[4], grthird->GetY()[4], "(V2ProbNNmu > 0.0)");
platex->SetTextSize(0.02);
platex->SetTextColor(i);

TLatex *platex1 = new TLatex(grthird->GetX()[5], grthird->GetY()[5], "(V2ProbNNmu > 0.2)");
platex1->SetTextSize(0.02);
platex1->SetTextColor(i);

TLatex *platex2 = new TLatex(grthird->GetX()[6], grthird->GetY()[6], "(V2ProbNNmu > 0.4)");
platex2->SetTextSize(0.02);
platex2->SetTextColor(i);

TLatex *platex3 = new TLatex(grthird->GetX()[7], grthird->GetY()[7], "(V2ProbNNmu > 0.6)");
platex3->SetTextSize(0.02);
platex3->SetTextColor(i);

TLatex *platex4 = new TLatex(grthird->GetX()[8], grthird->GetY()[8], "(V2ProbNNmu > 0.8)");
...
double* ifirstmisideffi2 = &ifirstcut2[9];
double* ifirstmisideffi = &ifirstcut[9];
TGraph *grfourth =  new TGraph(9,ifirstmisideffi2,ifirstmisideffi);
grfourth->SetTitle(("P bin: "+(d2s(mymombin.at(i)))+" to "+(d2s(mymombin.at(i+1)))).c_str());
grfourth->SetMarkerColor(i+1);
grfourth->SetLineColor(i+1);
grfourth->SetMarkerStyle(i+20);
grfourth->SetFillStyle(0);
TLatex *ulatex = new TLatex(grfourth->GetX()[4], grfourth->GetY()[4], "(V2ProbNNmu > 0.0)");
ulatex->SetTextSize(0.02);
ulatex->SetTextColor(i+1);

TLatex *ulatex1 = new TLatex(grfourth->GetX()[5], grfourth->GetY()[5], "(V2ProbNNmu > 0.2)");
ulatex1->SetTextSize(0.02);
ulatex1->SetTextColor(i+1);

TLatex *ulatex2 = new TLatex(grfourth->GetX()[6], grfourth->GetY()[6], "(V2ProbNNmu > 0.4)");
ulatex2->SetTextSize(0.02);
ulatex2->SetTextColor(i+1);

TLatex *ulatex3 = new TLatex(grfourth->GetX()[7], grfourth->GetY()[7], "(V2ProbNNmu > 0.6)");
ulatex3->SetTextSize(0.02);
ulatex3->SetTextColor(i+1);

TLatex *ulatex4 = new TLatex(grfourth->GetX()[8], grfourth->GetY()[8], "(V2ProbNNmu > 0.8)");
