...
string ifilename="PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root";
...
string ifilename2="PerfHists_Mu_Strip20_MagDown_P_ETA_nTracks.root";
...
TLatex *3latex = new TLatex(grthird->GetX()[4], grthird->GetY()[4], "(V2ProbNNmu > 0.0)");
3latex->SetTextSize(0.02);

TLatex *3latex1 = new TLatex(grthird->GetX()[5], grthird->GetY()[5], "(V2ProbNNmu > 0.2)");
3latex1->SetTextSize(0.02);

TLatex *3latex2 = new TLatex(grthird->GetX()[6], grthird->GetY()[6], "(V2ProbNNmu > 0.4)");
3latex2->SetTextSize(0.02);

TLatex *3latex3 = new TLatex(grthird->GetX()[7], grthird->GetY()[7], "(V2ProbNNmu > 0.6)");
3latex3->SetTextSize(0.02);

TLatex *3latex4 = new TLatex(grthird->GetX()[8], grthird->GetY()[8], "(V2ProbNNmu > 0.8)");
3latex4->SetTextSize(0.02);


grthird->GetListOfFunctions()->Add(3latex);
grthird->GetListOfFunctions()->Add(3latex1);
grthird->GetListOfFunctions()->Add(3latex2);
grthird->GetListOfFunctions()->Add(3latex3);
grthird->GetListOfFunctions()->Add(3latex4);
