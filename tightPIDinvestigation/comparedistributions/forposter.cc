...
*/
  ...
  double yaxismax(11000);

  TCanvas* mp3 = new TCanvas("mp3", "mp3", 700, 600);
 
//  printLHCb("L","Prelim","");
  DataSample hist3("/vols/lhcbdisk05/ss4314/preparetuplesforBDTnoJpsi/MCSigpreparetuple/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_qmincut.root", "DecayTree");
...
//    leg->SetTextSize(0.02);
    leg->SetBorderSize(0);
    leg->AddEntry(hm,"PION data","l");
    leg->AddEntry(a,"KAON data","l");   // h1 and h2 are histogram pointers
