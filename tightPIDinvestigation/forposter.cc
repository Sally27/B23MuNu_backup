...
*/
  ...
  DataSample hist1("/vols/lhcbdisk05/ss4314/misidstudies/misidcrossfeed/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut_KaonPID.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  /*Double_t nSel1, nGen1, nSel2, nGen2, nSel3, nGen3, nSel4, nGen4;*/
...
//  printLHCb("L","Prelim","");
  ...
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, 2500.0, 10200.0);
  hist1.t->Draw("Bplus_Corrected_Mass >> bpluscorrmass");
  double nSel1 = hist1.t->GetEntries();
  ...
  DataSample hist2("/vols/lhcbdisk05/ss4314/misidstudies/misidcrossfeed/B23MuNuFakeSameSignMuonSmallDataSample_cut_mu1nShared_mu2nShared_mu3isNotMuon_mu3inMuonAcc_Jpsi_qmincut_PionPID.root", "DecayTree");
  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, 2500.0, 10000.0);
  double nSel2 = hist2.t->GetEntries();
  hist2.t->Draw("Bplus_Corrected_Mass>>bplusmm2");
  cout<<"number of events signal"<<nSel2<<endl;
    
  DataSample hist3("/vols/lhcbdisk05/ss4314/preparetuplesforBDT/MCSigpreparetuple/tuplewithnSharedrefinedscript/B23MuNuNewMCNShared_MCtruth_cut_mu1nShared_mu2nShared_mu3nShared_Jpsi.root", "DecayTree");

  TH1F* la = new TH1F("bplusmm2", "bplusmm2", 100, 2500.0, 10000.0);
  ...
  gStyle->SetOptStat(0);
   ...
   la->SetTitle("Bplus_Corrected_Mass NOT TO SCALE");
   la->SetXTitle("Bplus_Corrected_Mass");
   la->SetYTitle("Number of Events");
   la->Draw();

   hm->SetTitle("Bplus_Corrected_Mass NOT TO SCALE");
  ...
  // printLHCb("R","Prelim","");
   ...
   a->SetLineColor(8);
   a->SetTitle("Bplus_Corrected_Mass NOT TO SCALE");
   a->SetXTitle("Bplus_Corrected_Mass");
...
//    leg->SetTextSize(0.02);
    ...
    leg->AddEntry(a,"KAON","l");   // h1 and h2 are histogram pointers
    leg->AddEntry(la,"MC","l");
   ...
   mp3->Update();
   mp3->SaveAs("compareinputvarforbdtBplus_Corrected_Mass.pdf");
