...
string filename="/vols/lhcbdisk05/ss4314/tightPIDinvestigation/probnnmu/samples/proton/PerfHists_P_Strip20_MagDown_P_ETA_nTracks.root"; 
string th3namefirst ="P_(IsMuon==1.0)_All";
string th3namesecond ="P_(IsMuon==1.0) && (DLLmu > 0.0)_All";
string th3namethird ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All";
string th3namefourth ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0)_All";
string th3namefifth ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.0)_All";
string th3namesixth ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.2)_All";
string th3nameseventh ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.4)_All";
string th3nameeighth ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.6)_All";
string th3namenineth ="P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0) && (nShared==0) && (V2ProbNNmu > 0.8)_All";
...
mg->SetTitle("Proton Mis id rate as a function of momentum pt");
...
c1->BuildLegend();
c1->SaveAs("protonmisidrateoriginal2.pdf");
return;
}
