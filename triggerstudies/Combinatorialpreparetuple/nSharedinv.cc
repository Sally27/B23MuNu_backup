...
//string nametree = "/vols/lhcbdisk05/ss4314/tuples/Data2012and2011/B23MuNuSignal2012and2011data.root";
//string filename = "B23MuNuSignal2012and2011data";
...
//string mycut="Bplus_Corrected_Mass < 4000";
...
string namecuttree2 = (filename+cuttag).c_str();
double jpsieff;
jpsieff=Jpsi((pathname+filename).c_str(), decaytreename, (namecuttree2).c_str());
...
//double jpsieff;
//jpsieff=Jpsi((filename).c_str(), decaytreename, (namecuttree2).c_str());
