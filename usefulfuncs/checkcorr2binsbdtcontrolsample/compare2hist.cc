...
//  double nSel2 = hist2.t->GetEntries();
  ...
  DataSample hist1("ControlBkgSamplelowbdt.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  ...
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, 5400 , 6300);
...
//  a->Scale(0.800456);
  ...
  DataSample hist2("ControlBkgSamplehighbdt.root", "DecayTree");

  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, 5400 , 6300);
...
mp3->SetLeftMargin(0.25);
   ...
   hm->SetLineColor(8);
   hm->SetTitle("Check for correlation BDT output control sample");
   ...
   mp3->SetLeftMargin(0.25);
   a->SetTitle("Check for correlation BDT output control sample");
...
/*   ha->SetLineColor(8);
   ...
   ha->Draw("same");*/
    ...
    Double_t xl1=.75, yl1=0.55, xl2=xl1+.35, yl2=yl1+.125;
    TLegend *leg = new TLegend(xl1,yl1,xl2,yl2);
    leg->SetTextSize(0.025);
    leg->SetBorderSize(0);
    leg->AddEntry(a,"High BDT > 0.09","l");   // h1 and h2 are histogram pointers
    leg->AddEntry(hm,"Low BDT < 0.09","l");
