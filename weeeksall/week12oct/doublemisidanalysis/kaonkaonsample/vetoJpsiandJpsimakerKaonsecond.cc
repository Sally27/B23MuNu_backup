...
void pid()
{
  ...
  Double_t mu3_MINIPCHI2, mu3_PIDmu, mu3_PIDK, mu3_ghost, mu3_TRACK_CHI2, mu3_PIDp;
  Double_t mu1_MINIPCHI2, mu1_PIDmu, mu1_PIDK, mu1_ghost, mu1_TRACK_CHI2, mu1_PIDp;
  Double_t mu2_MINIPCHI2, mu2_PIDmu, mu2_PIDK, mu2_ghost, mu2_TRACK_CHI2, mu2_PIDp;
  ...
  t->SetBranchAddress("mu1_PIDp", &mu1_PIDp);
  ...
  t->SetBranchAddress("mu2_PIDp", &mu2_PIDp);
...
//veto J/psi
  ...
  TFile *filefort2 = new TFile("doublemisidsmallsampleKaonvetoJpsi.root", "RECREATE");
...
//      cout<<"Inv mass 1 and 2:"<< mu1mu2<<endl;
      ...
      cout<<count<<endl;
      if ((mu1_isMuon==0.0) && (mu1_inMuon==1.0) && (mu1_MINIPCHI2>9.0) && (mu1_ghost < 0.35) && (mu1_TRACK_CHI2 < 3.0) && (mu1_PIDK > 0) && (mu1_PIDp - mu1_PIDK < 5) && (mu2_isMuon==0.0) && (mu2_inMuon==1.0) && (mu2_MINIPCHI2>9.0) && (mu2_ghost < 0.35) && (mu2_TRACK_CHI2 < 3.0) && (mu2_PIDK > 0) && (mu2_PIDp - mu2_PIDK < 5) )// && ((mu1mu2<jpsimin)|| ((mu1mu2>jpsimax) && (mu1mu2<psi2smin)) || (mu1mu2>psi2smax)))// && ((mu2mu3<jpsimin)|| ((mu2mu3>jpsimax) && (mu2mu3<psi2smin)) || (mu2mu3>psi2smax)))
     {       
      	t2->Fill();
        count2++;
//        cout<<"YouMayPass,";
