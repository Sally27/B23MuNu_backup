...
void eff()
{
  ...
  TFile* f = new TFile("doublemisidsmallsampleKaonPionvetoJpsi.root");
...
//             					cout<<"Allocated to bin: "<< i << " "<< j << " " << k << " . Number of events in this bin" << MultiArr[i][j][k] <<endl;	
 //                                               cout<< "Multiarr: "<< i << " "<< j << " " << k << " :" << MultiArr[i][j][k]<<endl;
  ...
  TFile s("../../../week20july/PIDefficiencies/newpidsample/KisMuonDLLmumorethanzeroDLLmuminusKmorethanzero/PerfHists_K_Strip20_MagDown_P_ETA_nTracks.root"); 
