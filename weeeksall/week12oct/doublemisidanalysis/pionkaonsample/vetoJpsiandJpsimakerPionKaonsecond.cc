...
//veto J/psi
  ...
  TFile *filefort2 = new TFile("doublemisidsmallsamplePionKaonvetoJpsi.root", "RECREATE");
  ...
  TFile *f1 = new TFile("JpsimakerKaonPion.root","RECREATE");
...
//      cout<<"Inv mass 1 and 2:"<< mu1mu2<<endl;
     ...
     if ((mu1_isMuon==0.0) && (mu1_inMuon==1.0) && (mu1_MINIPCHI2>9.0) && (mu1_ghost < 0.35) && (mu1_TRACK_CHI2 < 3.0) && (mu1_PIDK < 0) && (mu1_PIDp < 5) && (mu2_isMuon==0.0) && (mu2_inMuon==1.0) && (mu2_MINIPCHI2>9.0) && (mu2_ghost < 0.35) && (mu2_TRACK_CHI2 < 3.0) && (mu2_PIDK > 0) && (mu2_PIDp - mu2_PIDK < 5)  )
