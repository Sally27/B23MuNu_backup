...
void invmass()
{
  ...
  TFile *f1 = new TFile("redoagain11_1.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
 ...
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   TBranch *bpt = t1->Branch("m1andm2munu2gevandtos",&invmassmu1mu2,"invmassmu1mu2/D");
   count=0;
   count2=0;
   ...
   for(int i(0); i<t->GetEntries(); ++i)
   {
      ...
      if ((abs(mu2_TRUEID)==13)&&(abs(mu3_TRUEID)==13)&&(abs(mu1_TRUEID)==13)&&(abs(Bplus_TRUEID)==521)&&Bplus_L0Global_TOS==true)
         {
...
void invmassmuplus0muplus()
{
  ...
  TFile *f01 = new TFile("redoagain22_2.root","RECREATE");
  TTree *t01 = new TTree("pt2","");
   ...
   TBranch *bpt2 = t01->Branch("mplusandmminusinvmass2gevandtos",&muplusmuminusinvmass,"muplusmuminusinvmass/D");
