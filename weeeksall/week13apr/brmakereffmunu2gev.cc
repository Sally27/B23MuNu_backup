...
void invmass()
{
  ...
  TFile *f1 = new TFile("redoagain1_2gev.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
 ...
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   TBranch *bpt = t1->Branch("m1andm2munu2gev",&invmassmu1mu2,"invmassmu1mu2/D");
   count=0;
   count2=0;
   ...
   for(int i(0); i<t->GetEntries(); ++i)
   {
      ...
      if ((abs(mu2_TRUEID)==13)&&(abs(mu3_TRUEID)==13)&&(abs(mu1_TRUEID)==13)&&(abs(Bplus_TRUEID)==521))
         {
...
void invmassmuplus0muplus()
{
  ...
  TFile *f01 = new TFile("redoagain2_2gev.root","RECREATE");
  TTree *t01 = new TTree("pt2","");
   ...
   TBranch *bpt2 = t01->Branch("mplusandmminusmunu2gev",&muplusmuminusinvmass,"muplusmuminusinvmass/D");
