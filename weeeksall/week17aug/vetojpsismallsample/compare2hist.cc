...
//  double nSel2 = hist2.t->GetEntries();
  ...
  DataSample hist1("B23MuNuBackgroundDatacutPionvetoJpsi.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  ...
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, 2000 , 10010);
...
//  a->Scale(0.01);
  ...
  DataSample hist2("B23MuNuBackgroundDatacutKaonvetoJpsi.root", "DecayTree");

  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100,  2000, 10010);
  hist2.t->Draw("Bplus_Corrected_Mass >>bplusmm2");
  double nSel2 = hist2.t->GetEntries();
...
/*   ha->SetLineColor(8);
   ...
   ha->Draw("same");*/
    ...
    leg->SetBorderSize(0);
    leg->AddEntry(a,"Pion","l");   // h1 and h2 are histogram pointers
    leg->AddEntry(hm,"Kaon","l");
...
*/
   ...
   mp3->Update();
   mp3->SaveAs("BcorrMassPionandKaondistr.pdf");
