...
//      }    
      ...
      cout<<count<<endl;
      if ((mu3_isMuon==0.0) && (mu3_inMuon==1.0) && (mu3_MINIPCHI2>9) && (mu3_ghost < 0.35) && (mu3_TRACK_CHI2 < 3) && (mu3_PIDK < 0) && (mu3_PIDp < 5) &&((mu1mu2<jpsimin)|| ((mu1mu2>jpsimax) && (mu1mu2<psi2smin)) || (mu1mu2>psi2smax)))
     {       
      	t2->Fill();
        count2++;
        cout<<"YouMayPass,";
