...
void pid()
{
  ...
  TFile* s = new TFile("finalsignaldata.root");
...
//veto J/psi
  ...
  TFile *filefort2 = new TFile("B23MuNuSignalDatacutvetoJpsi.root", "RECREATE");
...
//      cout<<"Inv mass 1 and 2:"<< mu1mu2<<endl;
      ...
      cout<<count<<endl;
      if ((mu3_MINIPCHI2>9.0) && (mu3_ghost < 0.35) && (mu3_TRACK_CHI2 < 3.0) && ((mu1mu2<jpsimin) || ((mu1mu2>jpsimax) && (mu1mu2<psi2smin)) || (mu1mu2>psi2smax)) && ((mu2mu3<jpsimin) || ((mu2mu3>jpsimax) && (mu2mu3<psi2smin)) || (mu2mu3>psi2smax)))
     {       
      	t2->Fill();
        count2++;
        cout<<"YouMayPass,";
