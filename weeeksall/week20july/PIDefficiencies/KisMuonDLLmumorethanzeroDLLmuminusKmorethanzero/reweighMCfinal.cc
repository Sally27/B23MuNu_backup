...
void eff()
{
  ...
  TFile* f = new TFile("B23MuNuBackgroundData.root");
...
/*   for(int b(0); b<t->GetEntries(); ++b)
 ...
 // cout<< " myeff: " << myeff << " newcount: " << newcount[g] << " effi: " << effi[g] << " " <<endl;
  finalmyeff = (myeff + (newcount[g]*effi[g]))/double(g+1.0);
  myeff = finalmyeff;
  cout<< " Finalmyeff: " << finalmyeff << " myeff: " << myeff << " newcount: " << newcount[g] << " effi: " << effi[g] << " " <<endl;
  }
