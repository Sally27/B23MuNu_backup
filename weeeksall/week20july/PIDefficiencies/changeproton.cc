...
void eff()
{
  ...
  TFile* f = new TFile("ProtonisMuonDLLmumorethanzeroDLLmuminusKmorethanzero/B23MuNuBackgroundDatacutProton.root");
...
//             					cout<<"Allocated to bin: "<< i << " "<< j << " " << k << " . Number of events in this bin" << MultiArr[i][j][k] <<endl;	
 //                                               cout<< "Multiarr: "<< i << " "<< j << " " << k << " :" << MultiArr[i][j][k]<<endl;
  ...
  TFile s("ProtonisMuonDLLmumorethanzeroDLLmuminusKmorethanzero/PerfHists_P_Strip20_MagDown_P_ETA_nTracks.root"); 
  TH3F *hname =(TH3F*)s.Get("P_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All");
  ...
  TFile s2("ProtonisnotMuonDLLpmorethantenandDLLpKmorethanten/PerfHists_P_Strip20_MagDown_P_ETA_nTracks.root");
  TH3F *hname2 =(TH3F*)s2.Get("P_IsMuon==0.0 && DLLp > 10.0 && DLLpK > 10.0_All");
