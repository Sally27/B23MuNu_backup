...
*/
 ...
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  ...
  TCanvas* mp3 = new TCanvas("mp3", "mp3", 700, 600);
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, 0 , 100000);
  hist1.t->Draw("mu3_P >> bpluscorrmass");
  a->Scale(1.07362);
  double nSel1 = hist1.t->GetEntries();
  /*print nSel1;*/
  ...
  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, 0 , 100000);
  hist2.t->Draw("mu3_P >>bplusmm2");
  double nSel2 = hist2.t->GetEntries();
...
*/
   ...
   mp3->Update();
   mp3->SaveAs("DistributionofKaonandPionSampleinmomentumscaled.pdf");
