...
*/
  ...
  DataSample hist1("../realrundata/B23MuNuBackgroundDatacutKaon.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  /*Double_t nSel1, nGen1, nSel2, nGen2, nSel3, nGen3, nSel4, nGen4;*/

  TCanvas* mp3 = new TCanvas("mp3", "mp3", 700, 600);
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, 0 , 10000);
  hist1.t->Draw("mu3_PT >> bpluscorrmass");
  a->Scale(1.07362);
  double nSel1 = hist1.t->GetEntries();
  /*print nSel1;*/


  DataSample hist2("../realrundata/B23MuNuBackgroundDatacutPion.root", "DecayTree");

  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, 0 , 10000);
  hist2.t->Draw("mu3_PT >>bplusmm2");
  double nSel2 = hist2.t->GetEntries();
  ...
  // gROOT->ProcessLine(".x lhcbStyle.C");
   ...
   hm->SetTitle("#mu_{3} PT");
   hm->SetXTitle(" transverse momentum");
...
*/
   ...
   mp3->Update();
   mp3->SaveAs("DistributionofKaonandPionSampleintransversemomentumscaled.pdf");
