...
void eff()
{
  ...
  TFile* f = new TFile("PisMuonDLLmumorethanzeroDLLmuminusKmorethanzero/B23MuNuBackgroundDatacutPion.root");
...
//  TH3F *hname =(TH3F*)s.Get("K_(IsMuon==1.0) && (DLLmu > 0.0) && ((DLLmu - DLLK) > 0.0)_All");
  ...
  TFile s("newpidsample/PisMuonDLLmumorethanzeroDLLmuminusKmorethanzero/PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root");
...
//  TH3F *hname2 =(TH3F*)s2.Get("K_IsMuon==0.0 && DLLK > 0.0 && DLLpK < 5.0_All");
  TFile s2("PisnotMuonDLLKlessthanzeroDLLplessthanfive/PerfHists_Pi_Strip20_MagDown_P_ETA_nTracks.root");
...
//  TH2D *h2e = new TH2D("h2e","MISID mom pion second bin in eta and second bin in ntracks",11,0,100000,100,0,0.020);
...
//  }
  ...
  TCanvas *m3p = new TCanvas("m3p", "m3p", 600, 600);
  TH2D *h2e = new TH2D("h2e","MIS-ID rate as a function of pion momentum 2nd bin in eta and ntracks",11,0,100000,100,0,0.011);
  h2e->SetMarkerStyle(24);
  ...
  m3p->SaveAs("misidratemompionnewsample.pdf");
