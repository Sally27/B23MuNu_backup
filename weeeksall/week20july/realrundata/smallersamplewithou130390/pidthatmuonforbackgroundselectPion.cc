...
//  t->SetBranchAddress("mu2_inMuon", &mu2_inMuon);
  ...
  TFile *filefort2 = new TFile("B23MuNuBackgroundDatacutPion.root", "RECREATE");
  ...
  for(int i=0; i<t->GetEntries(); ++i)
  {
      ...
      cout<<count<<endl;
      if ((mu3_isMuon==0.0) && (mu3_inMuon==1.0) && (mu3_MINIPCHI2>9) && (mu3_ghost < 0.35) && (mu3_TRACK_CHI2 < 3) && (mu3_PIDK < 0) && (mu3_PIDp < 5))
     {       
      	t2->Fill();
        count2++;
        cout<<"YouMayPass,";
