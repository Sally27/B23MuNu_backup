...
void invmass()
{
  ...
  TFile* f = new TFile("Bplus23munu.root");
  TTree* t = (TTree*)f->Get("B23MuNu_Tuple/DecayTree");

  TFile *f1 = new TFile("mctruthmatchtos.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
 ...
 /*  Double_t sqrtinvmassmu3nu, sqrtinvmassmu1mu2;*/
   Int_t count,count2;
   TLorentzVector nu, mu3nu, mu2mu3;
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   TBranch *bpt = t1->Branch("m2andm3whereinvtos",&invmassmu2mu3,"invmassmu2mu3/D");
   count=0;
   count2=0;
   ...
   for(int i(0); i<t->GetEntries(); ++i)
   {
      ...
      if (((Bplus_TRUEID==521)&&(mu1_TRUEID==-13)&&(mu1_MC_MOTHER_ID==25)&&(mu1_MC_GD_MOTHER_ID==521)&&(mu2_TRUEID==13)&&(mu2_MC_MOTHER_ID==521)&&(mu3_TRUEID==-13)&&(mu3_MC_MOTHER_ID==521))||((Bplus_TRUEID==-521)&&(mu1_TRUEID==13)&&(mu1_MC_MOTHER_ID==35)&&(mu1_MC_GD_MOTHER_ID==-521)&&(mu2_TRUEID==-13)&&(mu2_MC_MOTHER_ID==-521)&&(mu3_TRUEID==13)&&(mu3_MC_MOTHER_ID==-521))&&Bplus_L0Global_TOS==true)
         {
	      ...
	      /*cout<<trial<<endl;*/
      	      ...
      	      mu1mu3[0] = mu2_TRUEP_X+mu3_TRUEP_X;
              mu1mu3[1] = mu2_TRUEP_Y+mu3_TRUEP_Y;
              mu1mu3[2] = mu2_TRUEP_Z+mu3_TRUEP_Z;
              mu1mu3[3] = mu2_TRUEP_E+mu3_TRUEP_E;
