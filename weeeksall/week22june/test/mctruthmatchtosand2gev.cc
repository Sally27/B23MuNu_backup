...
void invmass()
{
  ...
  Int_t mu1_MC_MOTHER_ID, mu2_MC_MOTHER_ID, mu3_MC_MOTHER_ID, mu1_MC_GD_MOTHER_ID;
 

  TFile* f = new TFile("B23MuNuMChierarchy.root");
  TTree* t = (TTree*)f->Get("B23MuNu_Tuple/DecayTree");

  TFile *f1 = new TFile("mctruthmatch2gevtos.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
   ...
   Double_t invmassmu1nu, invmassmu2mu3;
 /*  Double_t sqrtinvmassmu3nu, sqrtinvmassmu1mu2;*/
   Int_t count,count2;
   TLorentzVector nu, mu1nu, mu2mu3;
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   TBranch *bpt = t1->Branch("m2andm3invtosand2gev",&invmassmu2mu3,"invmassmu2mu3/D");
   count=0;
   count2=0;
