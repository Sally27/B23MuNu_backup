...
// here hm has data ini it
   ...
   hg->Sumw2();
   B23MuNu_gen.t->Draw("mplusandmminusinvmass>>mplusmminusinvmassmunusel_gen");
// here hg has data ini it
   double nGen2 = B23MuNu_gen.t->GetEntries();
...
// here hm has data ini it
   ...
   B23MuNu_gen.t->Draw("mplusandmminusinvmass>>mplusandmminusinvmasstos_gen");
// here hg has data ini it
   double nGen3 = B23MuNu_gen.t->GetEntries();
...
// here hm has data ini it
   ...
   ai->Sumw2();
   B23MuNu_gen.t->Draw("mplusandmminusinvmass>>mplusandmminusinvmasstosandmunu_gen");
// here hg has data ini it
   double nGen4 = B23MuNu_gen.t->GetEntries();
...
//   c->SetTitle("Efficiency of #mu_{+} and #mu{-} with q^2(#mu_{+} & #nu)>4000 GeV with TOS");
   c->SetTitle("Efficiency of reconstructed simulation sample");
   ...
   mp3->Update();
   mp3->SaveAs("plotforreportplay.pdf");
