...
//  double nSel2 = hist2.t->GetEntries();
  ...
  DataSample hist1("B2D3piD0inclusivelowrightMC.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  ...
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, 2400 , 11000);
...
//  a->Scale(0.800456);
  ...
  DataSample hist2("B2D3piD0inclusivehighrightMC.root", "DecayTree");

  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, 2400 , 11000);
...
mp3->SetLeftMargin(0.25);
   ...
   hm->SetLineColor(8);
   hm->SetTitle("Corrected Mass of B^{+}");
   ...
   mp3->SetLeftMargin(0.25);
   a->SetTitle("Check for correlation (ENDVERTEX)");
...
/*   ha->SetLineColor(8);
   ...
   ha->Draw("same");*/
    ...
    leg->AddEntry(hm,"650 < M[#pi^{+} #pi^{-}] < 900 ","l");
...
*/
   ...
   mp3->Update();
   mp3->SaveAs("compareinvpiplusandpiminusinclusiverightMC.pdf");
