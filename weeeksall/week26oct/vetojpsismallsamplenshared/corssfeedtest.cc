...
void eff(string filename, string decaytree, string misidPIDcalib, string misidcuts, string idPIDcalib, string idcuts)
{
...
eff(filename,decaytree, misidPIDcalib, misidcuts, idPIDcalib, idcuts);
return 0;
}
