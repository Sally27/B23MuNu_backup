...
numberofkaons = numofparticles(filename2, decaytree2);

vector<double> numberofkaons;
numberofpions = numofparticles(filename, decaytree);
...
pionideff = efficiency(misidPIDcalib2, misidcuts2, p, eta, ntracks);

vector<double> misidpiontomuon;
kaonideff = efficiency(misidPIDcalib, misidcuts, p, eta, ntracks);
