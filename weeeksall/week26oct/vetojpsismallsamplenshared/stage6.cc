...
cout<<"iterationkaon: "<< iterationkaon[i]<<endl;
}
...
cout<<"iterationpion: "<< iterationpion[i]<<endl;
}
...
cout<<"newmisidratepion: "<<newmisidratepion2[i]<<endl;
}
...
cout<<"newmisidratekaon: "<<newmisidratekaon2[i]<<endl;
}
