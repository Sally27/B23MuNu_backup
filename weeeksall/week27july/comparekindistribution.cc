...
*/
 ...
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  ...
  TCanvas* mp3 = new TCanvas("mp3", "mp3", 700, 600);
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, 0, 0.5 );
  hist1.t->Draw("mu3_ghost >> bpluscorrmass");
  double nSel1 = hist1.t->GetEntries();
  /*print nSel1;*/
  ...
  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, 0, 0.5);
  hist2.t->Draw("mu3_ghost >>bplusmm2");
  hm->Scale(1.699036);
  double nSel2 = hist2.t->GetEntries();
  ...
  // gROOT->ProcessLine(".x lhcbStyle.C");
   ...
   hm->SetTitle("#mu_{3} ghost");
   hm->SetXTitle("mu3_ghost");
