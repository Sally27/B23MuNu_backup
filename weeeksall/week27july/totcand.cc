...
*/
  ...
  DataSample hist1("/vols/lhcbdisk05/ss4314/week20july/realrundata/blah.root", "DecayTree");
 /* DataSample myfile("/home/hep/ss4314/Project/week22feb/redoagain1.root","pt1");*/
  /*Double_t nSel1, nGen1, nSel2, nGen2, nSel3, nGen3, nSel4, nGen4;*/

  TCanvas* mp3 = new TCanvas("mp3", "mp3", 700, 600);
  TH1F* a = new TH1F("bpluscorrmass", "bplusmm", 100, 0, 10);
  hist1.t->Draw("totCandidates >> bpluscorrmass");
  double nSel1 = hist1.t->GetEntries();
  /*print nSel1;*/


  DataSample hist2("finalsignaldata.root", "B_Tuple/DecayTree");

  TH1F* hm = new TH1F("bplusmm2", "bplusmm2", 100, 0, 10);
  hist2.t->Draw("totCandidates >>bplusmm2");
  hm->Scale(1.699036);
  double nSel2 = hist2.t->GetEntries();
  ...
  // gROOT->ProcessLine(".x lhcbStyle.C");
   ...
   hm->SetTitle("totcandidate");
   hm->SetXTitle("totcandidate");
...
/*   ha->SetLineColor(8);
   ...
   ha->Draw("same");*/
    ...
    leg->SetBorderSize(0);
    leg->AddEntry(a,"Background","l");   // h1 and h2 are histogram pointers
