...
void invmass()
{
  ...
  TFile *f1 = new TFile("bkgdcat2gevtos.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
   ...
   Double_t invmassmu3nu, invmassmu1mu2, invmassmu1mu3, invmassmu2mu3, newinvmassmu1andmu2, invmassmu1nu;
 /*  Double_t sqrtinvmassmu3nu, sqrtinvmassmu1mu2;*/
   Int_t count,count2;
   TLorentzVector nu, mu3nu, mu1mu2, mu1mu3, mu2mu3, newmu1mu2, mu1nu;
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   ...
   TBranch *bpt5 = t2->Branch("newinvmassmu1andmu22gevtos",&newinvmassmu1andmu2,"newinvmassmu1andmu2/D");   
              ...
              if (mu3_MC_MOTHER_ID==25)
                {
                   ...
                   mu1nu[0] = nu[0] + mu3_TRUEP_X;
                   mu1nu[1] = nu[1] + mu3_TRUEP_Y;
                   mu1nu[2] = nu[2] + mu3_TRUEP_Z;
                   mu1nu[3] = nu[3] + mu3_TRUEP_E;

                   invmassmu1nu=(mu1nu.Mag2());

                        if (invmassmu1nu>4000000)
                        {
                        newmu1mu2[0] = mu2_TRUEP_X+mu1_TRUEP_X;
                        newmu1mu2[1] = mu2_TRUEP_Y+mu1_TRUEP_Y;
                        newmu1mu2[2] = mu2_TRUEP_Z+mu1_TRUEP_Z;
                        newmu1mu2[3] = mu2_TRUEP_E+mu1_TRUEP_E;
                        newinvmassmu1andmu2 = (newmu1mu2.Mag2());
                        t2->Fill();
                        }
               }
