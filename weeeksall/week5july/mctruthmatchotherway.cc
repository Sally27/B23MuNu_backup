...
void invmass()
{
  ...
  Int_t mu1_MC_MOTHER_ID, mu2_MC_MOTHER_ID, mu3_MC_MOTHER_ID, mu1_MC_GD_MOTHER_ID, mu3_MC_GD_MOTHER_ID;
 

  TFile* f = new TFile("B23MuNuMChierarchy.root");
  TTree* t = (TTree*)f->Get("B23MuNu_Tuple/DecayTree");

  TFile *f1 = new TFile("mctruthmatchreconmcotherway.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
 ...
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   ...
   for(int i(0); i<t->GetEntries(); ++i)
   {
      ...
      if (((Bplus_TRUEID==521)&&(mu3_TRUEID==-13)&&(mu3_MC_MOTHER_ID==25)&&(mu3_MC_GD_MOTHER_ID==521)&&(mu2_TRUEID==13)&&(mu2_MC_MOTHER_ID==521)&&(mu1_TRUEID==-13)&&(mu1_MC_MOTHER_ID==521))||((Bplus_TRUEID==-521)&&(mu3_TRUEID==13)&&(mu3_MC_MOTHER_ID==35)&&(mu3_MC_GD_MOTHER_ID==-521)&&(mu2_TRUEID==-13)&&(mu2_MC_MOTHER_ID==-521)&&(mu1_TRUEID==13)&&(mu1_MC_MOTHER_ID==-521)))
         {
