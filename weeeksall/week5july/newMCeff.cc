...
void eff()
{
  ...
  DataSample myfile("bkgdcatreconmc.root","pt1");
...
// here hg has data ini it
   ...
   DataSample myfile2("bkgcatmatch2gev.root","pt1");
...
// here hg has data ini it
   ...
   DataSample myfile3("bkgcatmatchtos.root","pt1");
...
// here hg has data ini it
   ...
   DataSample myfile4("bkgcatmatch2gevtos.root","pt1");
...
//   c->SetTitle("Efficiency of #mu_{+} and #mu{-} with q^2(#mu_{+} & #nu)>4000 GeV with TOS");
  ...
  // c->GetYaxis()->SetRangeUser(0.,0.3);
   ...
   mp3->Update();
   mp3->SaveAs("plotMCeffbkgdcat.pdf");
