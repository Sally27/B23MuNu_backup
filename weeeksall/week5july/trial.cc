...
void invmass()
{
  ...
  TFile *f1 = new TFile("bkgcatmatch2gevtos.root","RECREATE");
...
/*  gStyle->SetOptStat(0);*/	
 ...
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   ...
   TBranch *bpt2 = t1->Branch("newm1andm2inv2gevtos",&newinvmassmu1mu2,"newinvmassmu1mu2/D");
      ...
      if (Bplus_BKGCAT < 30)
         {
	      ...
	      nu[3] = Bplus_TRUEP_E - (mu3_TRUEP_E+mu2_TRUEP_E+mu1_TRUEP_E);
              ...
              /*sqrtinvmassmu3nu = sqrt(invmassmu3nu);*/
       	      cout<<"This is count 2:"<<count2<<endl;
		...
		/*}*/
               ...
               if (Bplus_L0Global_TOS==true)
                {

                        count3++;
                        cout<<"this is count3: "<<count3<<endl;
