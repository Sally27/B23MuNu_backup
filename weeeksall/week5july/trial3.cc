...
/*  gStyle->SetOptStat(0);*/	
 ...
 /*  TH1F* hm = new TH1F("m1m2invmass", "m1m2invmass", 50, -10 , 10000);*/
   ...
   TBranch *bpt5 = t2->Branch("newinvmassmu1andmu2",&newinvmassmu1andmu2,"newinvmassmu1andmu2/D");   
...
/*              if  (mu1_MC_MOTHER_ID==25)
               ...
               if (mu1_MC_MOTHER_ID==25)
                        {
                                ...
                                t2->Fill();
                               p++;
                                cout<<"Number of passing mu3 25:"<<p<<endl;

                         }



                        else if (mu3_MC_MOTHER_ID==25)
                        {
                                newmu1mu2[0] = mu1_TRUEP_X+mu2_TRUEP_X;
                                newmu1mu2[1] = mu1_TRUEP_Y+mu2_TRUEP_Y;
                                newmu1mu2[2] = mu1_TRUEP_Z+mu2_TRUEP_Z;
                        ...
                        t2->Fill();
                        r++;
                              cout<<"Number of passing mu1 35:"<<r<<endl;
                        }

                         else if (mu3_MC_MOTHER_ID==35)
                        {
                        newmu1mu2[0] = mu1_TRUEP_X+mu2_TRUEP_X;
                        newmu1mu2[1] = mu1_TRUEP_Y+mu2_TRUEP_Y;
                        newmu1mu2[2] = mu1_TRUEP_Z+mu2_TRUEP_Z;
                        ...
                        t2->Fill();
                        s++;
                             cout<<"Number of passing mu3 35:"<<s<<endl;
    ...
    cout<<"Number of passing:"<<p<<q<<r<<s<<endl;
   }
